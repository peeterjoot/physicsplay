...
\mathImageTwoFigures{../../figures/ece1229/ps3p3LinearFig1}{../../figures/ece1229/ps3p3LogScale25Fig1}{Polar plot of \( \textrm{AF} \) in XY plane for various values of \( \alpha = s/\lambda \).}{fig:arrayFactorXY:arrayFactorXYCorrectedFig5}{scale=0.2}{ps3:p3.jl}

%\mathImageFigure{../../figures/ece1229/arrayFactorXYCorrectedFig5}{Polar plot of \( \textrm{AF} \) in XY plane for various values of \( \alpha = s/\lambda \).}{fig:arrayFactorXY:arrayFactorXYCorrectedFig5}{0.3}{ps3:ps3Q3plotsCorrected.nb}
%\mathImageFigure{../../figures/ece1229/ps3p3LogScale25Fig1}{Log polar plot of \( \textrm{AF} \) in XY plane for various values of \( \alpha = s/\lambda \).}{fig:ps3p3LogScale25:ps3p3LogScale25Fig1}{0.3}{ps3:p3.jl}
