...
For example, given \( M = 1 + \Be_1 \Be_2 \), multiplication by \( i = \Be_1 \Be_2 \) is a duality transformation with respect to the x-y plane, and multiplication by \( I = \Be_1 \Be_2 \Be_3 \) is a duality transformation with \R{3}.  For some concrete examples of duality transformations of blades, introduce the shorthand \( \Be_{ij\cdots k}  = \Be_i \Be_j \cdots \Be_k \).
...
whereas the duals to those bivectors are the original basis vectors

\begin{dmath}\label{eqn:definitions:400}
\begin{aligned}
\Be_{23} \Be_{123} &= \Be_{23}^2 \Be_1 \\
\Be_{31} \Be_{123} &= \Be_{31}^2 \Be_2 \\
\Be_{12} \Be_{123} &= \Be_{12}^2 \Be_3.
\end{aligned}
\end{dmath}
