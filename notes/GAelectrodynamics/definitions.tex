...
\begin{dmath}\label{eqn:definitions:n}
...
%When working with differential volume elements it will be useful to use volume weighted pseudoscalars.  For example
%
%d\Bx d\By d\Bz \spacegrad \wedge \Bf = -dV \spacegrad \cross \Bf.
