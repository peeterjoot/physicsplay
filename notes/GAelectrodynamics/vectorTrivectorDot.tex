...
\boxedEquation{eqn:vectorTrivectorDot:20}{
...
Repeating this from the other direction gives the same result.  It should be clear that the general pattern is
...
and that this dot product is symmetric(antisymmetric) when the grade of the blade the vector is dotted with is odd(even).
} % answer
