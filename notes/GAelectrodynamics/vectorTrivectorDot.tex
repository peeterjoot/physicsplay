...
This dot product is symmetric(antisymmetric) when the grade of the blade the vector is dotted with is odd(even).  See \citep{doran2003gap} for a demonstration that this holds for any metric.
} % problem
