...
Using \citep{problem:gradeselection:dotprod} and \cref{eqn:vectorproduct:80} it can be shown that the wedge product is an explict antisymetrized sum of vector products, just as the dot product is the symmetrized vector product sum
...
\makeproblem{Vector wedge antisymmtric structure}{problem:vectorproduct:wedgeantisym}{
