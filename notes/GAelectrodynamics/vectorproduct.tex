...
Given two vectors \( \Bx, \By \) the scalar grade of the vector product \( \Bx \By \) can be shown (\cref{problem:gradeselection:1}) to be
...
The grade two selection of this product was found (\cref{problem:gradeselection:4}) to be
...
When considering the Euclidean space \R{3}, an additional relationship follows (\cref{problem:gradeselection:4}), which is also incredibly useful
...
It will be seen later that it is actually more natural to express magnetic fields as a bivector \( I \BB \), after which the magnetostatic equation takes the form
