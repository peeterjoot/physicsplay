...
% ****************************************************************************************************
\newcommand{\myTitle}{Geometric Algebra for Engineering Electromagnetism\xspace}
\newcommand{\mySubtitle}{``The Italian Job''.\xspace}
\newcommand{\myDegree}{}
\newcommand{\myName}{Prof. Mauro Mongiardo, Peeter Joot\xspace}
\newcommand{\myProf}{}
...
\hypersetup{%
    ...
    pdfkeywords={Electromagnetic theory},%
    pdfcreator={pdfLaTeX},%
