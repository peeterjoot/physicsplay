...
\makeanswer{problem:gradeselectionProblems:dotprod}{
...
This might be viewed as a cheat, since it is not using the dot product as defined by grade zero selection according to \cref{dfn:gradeselectionProblems:100}.  Using that definition will produce the same result
...
It was shown in \cref{problem:gradeselectionProblems:cyclicpermutationtwo} that \( \gpgradezero{ \Bx \By } = \gpgradezero{ \By \Bx } \) so
\begin{dmath}\label{eqn:gradeselectionProblems:780}
2 \gpgradezero{ \Bx \By } = \Bx \By + \By \Bx.
\end{dmath}

Using \cref{dfn:gradeselectionProblems:100}, this completes the problem.
} % answer

\makeanswer{problem:gradeselectionProblems:ComplexNumbers}{
...
Rearranging \cref{eqn:vectorproduct:80} for the wedge product and substitution of the dot product symmetric sum from \cref{problem:gradeselectionProblems:dotprod} gives
...
\makeanswer{problem:gradeselectionProblems:PlaneRotations}{
\makeSubAnswer{}{problem:gradeselectionProblems:3:b}
...
= \cos \theta + i \sin\theta.
\end{dmath}
\makeSubAnswer{}{problem:gradeselectionProblems:3:c}
...
\makeSubAnswer{}{problem:gradeselectionProblems:3:d}
...
\makeSubAnswer{}{problem:gradeselectionProblems:3:e}
...
\makeanswer{problem:gradeselectionProblems:vectorwedge}{
...
\makeanswer{problem:gradeselectionProblems:WedgeRelationshipToCrossProduct}{
...
\makeanswer{problem:gradeselectionProblems:vectorBivectorDot}{
