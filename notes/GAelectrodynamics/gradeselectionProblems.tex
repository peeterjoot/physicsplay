...
\makeproblem{\R{3} pseudoscalar square}{problem:gradeselectionProblems:6}{
...
\makeanswer{problem:gradeselectionProblems:6}{
...
\makeproblem{\R{3} pseudoscalar commutation.}{problem:gradeselectionProblems:7}{
Show that \( I \) given by \cref{eqn:gaTutorial:140} commutes with any grade \R{3} multivector.
} % problem

\makeanswer{problem:gradeselectionProblems:7}{
