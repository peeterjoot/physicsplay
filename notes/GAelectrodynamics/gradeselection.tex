...
The dot product of a any component of a vector that has no common factor with a component of the bivector is zero, since such products results in trivector components.
