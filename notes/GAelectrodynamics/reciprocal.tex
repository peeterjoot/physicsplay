...
An example of a 2D oblique Euclidean basis and a corresponding reciprocal basis is plotted in \cref{fig:obliqueReciprocal:obliqueReciprocalFig2}.  Also plotted are the superposition of the projections required to arrive at a given point \( (4,2) \)).
In this plot, neither of the reciprocal frame vectors \( \Be^i \) are normal to the corresponding basis vectors \( \Be_i \).  If \( \Be_1 \), say, is increased(decreased) in magnitude, there will be a corresponding decrease(increase) in the magnitude of \( \Be^1 \), but if the orientation is remained fixed, the corresponding direction of the reciprocal frame vector stays the same.
...
\lr{ \Bx^1 \wedge \Bx^2 \wedge \Bx^3 } \cdot \lr{ \Bx_1 \wedge \Bx_2 \wedge \Bx_3 }
=
\Bx^1 \cdot \lr{ \Bx^2 \cdot \lr{ \Bx^3 \cdot \lr{ \Bx_1 \wedge \Bx_2 \wedge \Bx_3 } }}
=
\Bx^1 \cdot \lr{ \Bx^2 \cdot \lr{ \Bx_1 \wedge \Bx_2 } }
=
\Bx^1 \cdot \lr{ -\Bx_1 }
=
-1,
...
-\Bx^1 \wedge \Bx^2 \wedge \Bx^3 = \inv{ \Bx_1 \wedge \Bx_2 \wedge \Bx_3 },
\end{dmath}
