...
\imageFigure{../../figures/ece1236/ps1p4Fig1}{Electric field between two plates}{fig:ps1p4:ps1p4Fig1}{0.3}
...
\imageFigure{../../figures/ece1236/ps1p4Fig2}{Magnetic field and flux between two plates}{fig:ps1p4:ps1p4Fig2}{0.3}
...
\imageFigure{../../figures/ece1236/ps1p4Fig3}{Skin depth for parallel waveguide.}{fig:ps1p4:ps1p4Fig3}{0.3}

With the resistance in a length \( l \) being

\begin{equation}\label{eqn:uwavesproblemSet1Problem4:n}
R = \frac{l}{\sigma A_\eff},
\end{equation}

the resistance per unit length is

\boxedEquation{eqn:uwavesproblemSet1Problem4:n}{
R' = \frac{1}{\sigma w \delta_s}.
}
