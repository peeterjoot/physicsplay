...
%...
%
%Hence as we did for multisection transformers, associate \Delta Gamma with e^{- 2j \beta z}
%
%F
%
...
%\Gamma(\omega} 
%= \inv{2} \int_0^L e^{-2 j \beta z} \frac{d}{dz} \ln \frac{Z_L}{Z_0} dz
%= \frac{a}{2} 
%...
%\end{dmath}
%
