...
\begin{align}\label{eqn:pertubationDegeneracy:70}
H' &= U^\conj D U \\
D &= 
\begin{bmatrix}
...
\subsection{Energy eigenvalues of the unperturbed Hamiltonian in the new basis}
