...
%
%\renewcommand{\onlineurl}{http://sites.google.com/site/peeterjoot2/math2011/\basename.pdf}
%\beginArtNoToc
%
...
\imageFigure{figures/sincSquaredContour}{Contour distorted to one side of the double pole at the origin}{fig:sincIntegral:sincSquaredContour}{0.3}
...
\subsection{On the cavalier choice of contours}
