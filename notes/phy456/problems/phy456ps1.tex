...
\begin{equation}\label{eqn:phy456ps1:n}
...
Find the ground state energy of the Hamiltonian $H = H_o - \alpha X$. [Hint: This is a bit harder than part (b) but not much. Try "completing the square."]
} % makeoproblem
