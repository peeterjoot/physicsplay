...
\begin{align}\label{eqn:shortTimeDepPertubation:300}
...
This completes the desired verification of the Green's function for the Helmholtz operator.  Observe the perfect cancellation here, so the limit of $\epsilon \rightarrow 0$ can be independent of how large $k$ is made.  You have to complete the integrals for both the Laplacian and the $\Bk^2$ portions of the integrals and add them, \underline{before} taking any limits, or else you will get into trouble (as I did in my first attempt).
