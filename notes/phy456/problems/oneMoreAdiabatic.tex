...
Can we assume a similar representation to \ref{eqn:oneMoreAdiabatic:40} above, but allow $\ket{k}$ to vary in time?  This does not quite work since $\ket{k(t)}$ are no longer eigenkets of $H_0$
