...
READING: \S 30 of the text \cite{desai2009quantum} covers entangled states.  The rest of the composite state background is buried somewhere in some of the advanced material sections.  FIXME: what section?
...
With operators $\mathcal{O}_1$ and $\mathcal{O}_2$ on the respective Hilbert spaces.  We would now like to build 
...
I did not remember what the Zeeman term looked like, but wikipedia does \cite{wiki:zeeman}, and it is the magnetic field interaction
