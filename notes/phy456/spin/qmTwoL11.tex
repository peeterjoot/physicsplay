...
We will see that these behave qualitatively different than one component wave functions.  We also don't have to be considering multiple particle wave functions, but just \underline{one} particle that requires three functions in \R{3} to describe it (ie: we are moving in on spin).
