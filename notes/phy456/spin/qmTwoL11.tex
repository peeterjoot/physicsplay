...
\imageFigure{figures/qmTwoL11fig1}{Vector translation}{fig:qmTwoL11:qmTwoL11fig1}{0.2}
%figure (\ref{fig:qmTwoL11:qmTwoL11fig1})
...
\imageFigure{figures/qmTwoL11fig2}{Active spatial translation}{fig:qmTwoL11:qmTwoL11fig2}{0.2}
...
\imageFigure{figures/qmTwoL11fig3}{Active vector rotations}{fig:qmTwoL11:qmTwoL11fig3}{0.2}
...
\imageFigure{figures/qmTwoL11fig4}{A example pair of non-commuting rotations}{fig:qmTwoL11:qmTwoL11fig4}{0.2}
...
We will see that these behave qualitatively different than one component wave functions.  We also do not have to be considering multiple particle wave functions, but just \underline{one} particle that requires three functions in \R{3} to describe it (ie: we are moving in on spin).
...
``There is only bad analogies, since if the are good they'd be describing the same thing.  We can however, produce some useful bad analogies''
...
\imageFigure{figures/qmTwoL11fig5}{Rotated temperature (scalar) field}{fig:qmTwoL11:qmTwoL11fig5}{0.2}
...
\imageFigure{figures/qmTwoL11fig6}{Rotating a capacitance electric field}{fig:qmTwoL11:qmTwoL11fig6}{0.2}
