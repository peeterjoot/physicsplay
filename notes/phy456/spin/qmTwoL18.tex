...
\imageFigure{figures/qmTwoL18fig1}{Angular momentum triangle inequality}{fig:qmTwoL18:qmTwoL18fig1}{0.2}
...
\imageFigure{figures/qmTwoL18fig2}{active rotation}{fig:qmTwoL18:qmTwoL18fig2}{0.2}
...
\imageFigure{figures/qmTwoL18fig3}{Rotating a wavefunction}{fig:qmTwoL18:qmTwoL18fig3}{0.2}
...
\bra{\psi'} \mathcal{O} \ket{\psi'}
=
\bra{\psi} \myMathWithDescription{U^\dagger[M] \mathcal{O} U[M]}{$(\conj)$}{1} \ket{\psi}
\end{equation}
