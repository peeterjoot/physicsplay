...
so without the implied $\lambda$ perturbation of $\ket{\hat{\psi}_\alpha(t)}$ we can from \eqnref{eqn:qmTwoR3:470} write the \underline{exact} generalization of \eqnref{eqn:qmTwoR3:550} as
