...
We are continuing on the topic of Fermi golden rule, as also covered in \S 17.2 of the text \citep{desai2009quantum}.  Utilizing a wave train with peaks separation $\Delta t = 2\pi/\omega_0$, zero before some initial time (\ref{fig:qmTwoL10:unitStepSine}).

\imageFigure{figures/unitStepSine}{Sine only after an initial time}{fig:qmTwoL10:unitStepSine}{0.2}
...
\pdfTexFigure{figures/qmTwoL10fig2.pdf_tex}{Perturbation from $i$ to $m$th energy levels}{fig:qmTwoL10:2}{0.3}
...
\imageFigure{figures/qmTwoL10fig3}{Two sinc lobes}{fig:qmTwoL10:qmTwoL10fig3}{0.2}
...
\imageFigure{figures/continuumEnergyLevels}{Continuum of energy levels for ionized states of an atom}{fig:qmTwoL10:continuumEnergyLevels}{0.2}
...
\imageFigure{figures/semiConductorWell}{Semi-conductor well}{fig:qmTwoL10:semiConductorWell}{0.2}
...
\imageFigure{figures/qmTwoL10fig6}{}{fig:qmTwoL10:qmTwoL10fig6}{0.4}
...
In momentum space, we know have the sinc functions peaked at $\pm \overbar{p}$ as in figure (\ref{fig:qmTwoL10:qmTwoL10fig7})

\imageFigure{figures/qmTwoL10fig7}{Momentum space view}{fig:qmTwoL10:qmTwoL10fig7}{0.2}
...
where we can pull stuff out of the integral since the main contribution is at the peak.  Provided $\overbar{p}$ is large enough, using \ref{eqn:sincIntegral:50}, then 
...
=
\frac{4}{\hbar^2}
\myMathWithDescription{
\Abs{
\overbar{A}_{pi}
}^2 
}{matrix element}{1}
\myMathWithDescription{\evalbar{\frac{dp}{d\omega_{pi}}}{\overbar{p}}}{density of states}{2}
\frac{t}{2} \pi.
\end{equation}
