...
\paragraph{Reminder}.  Have considered this using \eqnref{eqn:qmTwoL9:450} for a pulse as in \cref{fig:qmTwoL9:gaussianWavePacket}

\imageFigure{../../figures/phy456/gaussianWavePacket}{Gaussian wave packet}{fig:qmTwoL9:gaussianWavePacket}{0.2}

Now we want to consider instead a non-terminating signal, that was zero before some initial time as illustrated in \cref{fig:qmTwoL9:unitStepSine}, where the separation between two peaks is \(\Delta t = 2\pi/\omega_0\).

\imageFigure{../../figures/phy456/unitStepSine}{Sine only after an initial time}{fig:qmTwoL9:unitStepSine}{0.2}
...
\pdfTexFigure{../../figures/phy456/qmTwoL9fig6.pdf_tex}{\(\omega_{mi}\) illustrated}{fig:qmTwoL9:6}{0.3}
%\cref{fig:qmTwoL9:6}
...
\pdfTexFigure{../../figures/phy456/qmTwoL9fig7.pdf_tex}{FIXME: qmTwoL9fig7}{fig:qmTwoL9:7}{0.3}
