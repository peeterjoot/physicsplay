...
That is consistent with problem set III where we did not diagonalize $H'$, but just the subset of it associated with the degenerate states.  I am unsure now if \ref{eqn:qmTwoL5:90} was copied in error or provided in error in class, but it definitely appears to be a more severe requirement than actually needed to deal with perturbation of a state found in a degenerate energy level.
...
Before doing this, let us review our dynamics as covered in \S 3 of the text \cite{desai2009quantum}.
