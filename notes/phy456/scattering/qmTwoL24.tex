...
\imageFigure{figures/qmTwoL22fig5}{Bounded potential}{fig:qmTwoL24:qmTwoL22fig5}{0.3}
...
\imageFigure{figures/qmTwoL24fig3}{plane wave front incident on particle}{fig:qmTwoL24:qmTwoL24fig3}{0.3}
...
\imageFigure{figures/qmTwoL24fig4}{k space localized wave packet}{fig:qmTwoL24:qmTwoL24fig4}{0.3}
...
We will normally look in a locality well away from the wave front as indicted in figure (\ref{fig:qmTwoL24:qmTwoL24fig5})

\imageFigure{figures/qmTwoL24fig5}{point of measurement of scattering cross section}{fig:qmTwoL24:qmTwoL24fig5}{0.3}

There are situations where we do look in the locality of the wave front that has been scattered.

\subsection{Incoming wave}
...
&=
j_{\text{incoming}}
\myMathWithDescription{\Abs{f_\Bk(\theta, \phi)}^2}{$d\sigma/d\Omega$}{1} d\Omega.
\end{align*}
...
We have been somewhat unrealistic here since we have used a plane wave approximation, and can as in figure (\ref{fig:qmTwoL24:qmTwoL24fig6})

\imageFigure{figures/qmTwoL24fig6}{Plane wave vs packet wave front}{fig:qmTwoL24:qmTwoL24fig6}{0.3}
