...
\include{oneMoreAdiabatic}
\include{shortTimeDepPertubation}
\include{helmoltzGreens}
\include{sincIntegral}
\include{adiabaticApproximation}
\include{hermiteDerivativeRecurranceRelation}
