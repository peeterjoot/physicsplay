...
=
\tikzmarkin
%[integral first,disable rounded corners=true]
[offset def, disable rounded corners=true]
{z4}
\left( \frac{2 \pi \Delta}{\omega} \right)^{3N}
\tikzmarkend{z4}
\]
...
\begin{split}
H_c&=
%\tikzmarkin[disable rounded corners=true,sums]
\tikzmarkin[disable rounded corners=true, offset def]
{xb}\frac{1}{2n} \sum^n_{l=0}(-1)^{l}(n-{l})^{p-2}
\sum_{l _1+\dots+ l _p=l}\prod^p_{i=1} \binom{n_i}{l _i}\tikzmarkend{xb}\\
&\quad\cdot[(n-l )-(n_i-l _i)]^{n_i-l _i}\cdot
\tikzmarkin
[offset def]
%[sums]
{xb1}%(0.05,-0.6)(-0.05,0.75)
...
\tikzmarkin
[blah2]
%[set fill color=magenta!60!purple!30]
%[below offset=-0.4,
%  above offset=0.55,
%  set fill color=magenta!60!purple!30]
{bla bla}
