...
\author{Peeter Joot}
\date{ Dec 02, 2008.  Last Revision: $Date: 2008/12/03 02:34:40 $ }
...
The relativistic Schroedinger's equation is given by (Wikipedia?) as 
...
\LL 
&= \eta^{\mu\nu} \partial_\mu \psi \partial_\nu \psi^\conj + m^2 \psi \psi^\conj \\
&= (\grad \psi) \cdot (\grad \psi^\conj) + m^2 \psi \psi^\conj \\
\end{align*}
...
\item Schroedinger non-relativistic wave equation.
...
\item Schroedinger relativistic wave equation.

\begin{align*}
\LL &= (\grad \psi) \cdot (\grad \psi^\conj) + m^2 \psi \psi^\conj \\
\grad^2 \psi &= m^2 \psi
\end{align*}
