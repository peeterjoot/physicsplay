...
\date{ Dec 02, 2008.  Last Revision: $Date: 2009/06/03 20:01:38 $ }
...
Equation \ref{eqn:maxwell} with the gauge condition $\grad \cdot A = 0$
...
This is looking more like \ref{eqn:maxlag} now.  It is expected that the gauge condition can be used to complete the reconciliation.  However, I've had trouble actually doing this, despite the fact that both Lagrangians appear to correctly
