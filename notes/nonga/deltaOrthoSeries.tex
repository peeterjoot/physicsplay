...
\date{ March 8, 2009.  $RCSfile: deltaOrthoSeries.tex,v $ Last $Revision: 1.10 $ $Date: 2009/06/14 23:51:45 $ }
...
\begin{align}\label{eqn:delta_ortho_series:deltaSum}
\sum_{k} u_k^\conj(x') u_k(x) \equiv \delta(x-x') 
\end{align}

I'd seen this in bra ket notation, in Susskind's lectures as noted in \citep{PJQmSusskind}, and also in \citep{mcmahon2005qmd} as the
identity operator
