...
\date{Oct 4, 2009}
\revisionInfo{$RCSfile: quadraticForm.tex,v $ Last $Revision: 1.4 $ $Date: 2009/10/21 23:43:40 $}
...
Solving for $a$ in \ref{eqn:quadratricForm:voo7} we have
...
\begin{align}\label{eqn:quadratricForm:voo17}
A 
&= 
\begin{bmatrix}
(1 - a^2)^{1/2} & \mp a \\
