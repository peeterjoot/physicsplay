...
\date{ May 11, 2009.  Last Revision: $Date: 2009/05/12 13:02:28 $ }
...
Which puts us a bit closer to a fully reduced expression for $T$
...
Where
\begin{align*}
\alpha &= \inv{2} \left(\frac{k}{\beta} - \frac{\beta}{k} \right)
\end{align*}
...
{\mu \cosh\left( i\theta -\beta a \right) }}
\end{align*}
