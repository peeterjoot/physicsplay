...
\author{Peeter Joot}
\date{ Dec 23, 2008.  Last Revision: $Date: 2008/12/29 05:57:30 $ }
...
\begin{align*}
\BraOpKet{A}{\hatH}{B}^\conj = \BraOpKet{B}{\hatH}{A}
\end{align*}

whereas an anti-Hermitian (or skew-Hermitian) operator is:

\begin{align*}
\BraOpKet{A}{\hatS}{B}^\conj = -\BraOpKet{B}{\hatS}{A}
\end{align*}
...
provided that the additional constraint $\alpha\bar{\alpha} + \beta\bar{\beta} = 1$ is imposed.  Here the combined state is a representation
...
\begin{align*}
\BraOpKet{\phi}{\hatx}{\phi} \rightarrow \int {\phi^\conj}(x) x \phi(x) dx
\end{align*}
