...
\begin{figure}[htp]
   ...
   \caption{Intersection of the \texorpdfstring{$i = 2$}{i equal 2} and \texorpdfstring{$i \le 4$}{i less than 4} events.}\label{fig:conditionalProbStatMech:conditionalProbStatMechFig4}
\end{figure}
