...
\date{ April 19, 2009.  Last Revision: $Date: 2009/04/20 04:08:42 $ }
...
Now, there isn't anything here that is particularily special in these two cases, so I'd expect the error has to be a plain old algebra problem 
