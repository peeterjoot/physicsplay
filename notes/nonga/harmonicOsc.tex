...
\date{ April 19, 2009.  Last Revision: $Date: 2009/04/22 03:23:46 $ }
...
\begin{align*}
\delta_{nm} = \IIinf H_n(x) H_m(x) \exp\left( - \frac{m \omega x^2}{\hbar} \right) dx
\end{align*}

Where use of the Graham-Schmidt procedure can be used to generate each of these polynomial functions.

FIXME: show that this orthogonality is enough to guarentee a solution.
