...
\date{ April 13, 2009.  Last Revision: $Date: 2009/04/14 03:13:14 $ }
...
Next, examine the reversion behaviour of repeated operators.  This appears to be used in the text (or is proved implicitly via some other operation not explained).
