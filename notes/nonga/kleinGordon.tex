...
seems somewhat problematic logically, since computing the derivative, as done in \citep{PJprobCurrent}
...
Also see here that this is exactly the result that was found in \citep{PJNoethersField} where the Noether equation for the conserved current
...
Now, comparing to problem 3.10 of \citep{byron1992mca} as worked in \chapcite{byronFullerCalcVar}{PJbyronFullerCalcVarProblems} the last two terms here differ by a sign factor, and there is also 
