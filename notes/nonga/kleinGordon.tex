...
\date{ March 27, 2009.  Last Revision: $Date: 2009/04/30 04:19:09 $ }
...
%I have the sign of my $m^2$ mixed up given my use of $+---$ metric.  That messes up pretty much everything below, although it's probably not too hard to fix since the $m^2$ bits always stay together.
%FIXME: check sign in \cite{PJNoethersField} as well.
%FIXME: check signs in all of:
%calculus/byron_fuller_calc_var.ltx
%geometric-algebra/dirac_lagrangian.ltx
%geometric-algebra/field_lagrangian.ltx
%geometric-algebra/sch.ltx
%geometric-algebra/wave_lagrangian.ltx
%relativity/pauli_qm_relativity_intro.ltx

% wrong here:
%@unpublished{PJFieldLagrangian,
%field_lagrangian.ltx:\title{ Derivation of Euler-Lagrange field equations.}
% think that's the only one in everything2008.pdf
% scan everything2009
% think that and this is the only place where it's wrong.

%these are all places where I've misspelled klein-gordon.  Also look for the 
%correct spellings.
% spellings corrected.  new list of suspect files in ../u
