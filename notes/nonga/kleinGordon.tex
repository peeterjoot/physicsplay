...
\date{ March 27, 2009.  Last Revision: $Date: 2009/03/28 02:00:22 $ }
...
seems somewhat problematic logically, since computing the derivative

\begin{align*}
\PD{t}{\psi\psi^\conj} = \PD{t}{\psi}\psi^\conj + \psi \PD{t}{\psi^\conj}
\end{align*}

leaves us with nowhere to go.  We don't have any sort of expression for $\PD{t}{\psi}$ since we have a second order wave equation.

One could, however, compute a second order ``probability current''.
