...
\date{ April 2d, 2009.  Last Revision: $Date: 2009/04/25 13:44:33 $ }
...
\begin{align*}
PV \IIinf \frac{u du }{u^2 + (\Delta x)^2} 
&= \inv{2} \lim_{R\rightarrow \infty} \ln\left( \frac{R^2 + (\Delta x)^2}{(-R)^2 + (\Delta x)^2} \right) \\
&= 0
\end{align*}

So we have, for all $\Delta x \ne 0$

\begin{align*}
\expectation{x} &= x_0 
\end{align*}

Hmm, I don't think that's sufficient to show that this wave function approaches an eigenfunction as $\Delta x \rightarrow 0$, since no limiting argument was required?
