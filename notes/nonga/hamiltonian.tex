...
\date{Sept 26, 2009}
\revisionInfo{$RCSfile: hamiltonian.tex,v $ Last $Revision: 1.8 $ $Date: 2009/09/29 04:43:24 $}
...
%Writing out \ref{eqn:hamiltonian:moo10} and \ref{eqn:hamiltonian:moo11} in full for the two particle case (because the matrix gets hellishly messy if you go any bigger)
...
FIXME: I think the $\propto G m_i m_j {r_{ij}}^{-3/2}$ in the matrix positions is the wrong way to linearize the matrix.  Probably need to take derivatives.
