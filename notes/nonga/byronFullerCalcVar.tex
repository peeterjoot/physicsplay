...
\date{ March 21, 2009.  Last Revision: $Date: 2009/03/22 05:17:30 $ }
...
\begin{align*}
0 
&= \left( \PD{\phi}{} - \frac{d}{d\theta} \PD{\phi'}{} \right) f \\
...
\begin{align*}
0 
&= \left( \PD{\theta}{} - \frac{d}{d\phi} \PD{\theta'}{} \right) \sqrt{\thetadot^2 + \sin^2\theta } \\
