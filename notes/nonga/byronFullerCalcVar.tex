...
\date{ March 21, 2009.  Last Revision: $Date: 2009/04/30 04:24:05 $ }
...
In \cite{PJkgNotes} the Klein-Gordon equation of this problem was explored.
Looks like I started off there with a different Lagrangian, and in particular
the sign of the $m^2$ term is negated.  Lookup this $\pi$-meson stuff and 
see what is correct (mathematically it makes little difference).  Try
computing the local-gauge transformation here and see if it matches 
with the interaction equation that was given.

Would also be nice to add in the proper units here (remove the $c = h = 1$ stuff).
