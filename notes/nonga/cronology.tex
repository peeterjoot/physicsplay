...
Chapter IV Notes and problems for Desai's "Quantum Mechanics and Introductory Field Theory" text.\item Oct 18, 2010 \ref{chap:desaiCh5} Notes and problems for Desai Chapter V.

Problems from Desai Chapter V.\item Oct 18, 2010 \ref{chap:desaiCh6} Notes and problems for Desai Chapter VI.

Notes and problems for Desai Chapter VI.\item Oct 22, 2010 \ref{chap:gaugeInteractionHamiltonian} Classical Electrodynamic gauge interaction.
...
A couple more problems from my QM1 course.\item Oct 23, 2010 \ref{chap:qmIproblemSet3} PHY356 Problem Set III.

My submission for problem set III.\item Oct 31, 2010 \ref{chap:desaiTypos} Believed to be typos in Desai's QM Text

Believed typos, some confirmed, in Desai's QM book.\item Nov 16, 2010 \ref{chap:qmIproblemSet4} PHY356 Problem Set 4.

PHY356 Problem Set 4.\item Nov 19, 2010 \ref{chap:desaiCh9} Desai Chapter 9 notes and problems.

Desai Chapter 9 notes and problems.\item Nov 20, 2010 \ref{chap:desaiCh10} Desai Chapter 10 notes and problems.

Desai Chapter 10 notes and problems.\item Nov 20, 2010 \ref{chap:desaiCh10} Desai Chapter 10 notes and problems.

Desai Chapter 10 notes and problems.\item Nov 24, 2010 \ref{chap:hyrdogenLaguerre} Hydrogen like atom, and Laguerre polynomials.

Playing with the math of Laguerre polynomials for the Hydrogen like atom.\item Nov 25, 2010 \ref{chap:qmIproblemSet5} PHY356 Problem Set 5.

PHY356 Problem Set 5.\item Dec 7, 2010 \ref{chap:PHY356F} PHY356F lecture notes.

PHY356F lecture notes.\item Dec 9, 2010 \ref{chap:desaiCh26} Notes for Desai Chapter 26.

Notes for Desai Chapter 26.\item Jan 4, 2011 \ref{chap:qmIexamPractice} Some worked problems from old PHY356 exams.

Some worked problems from old PHY356 exams.\end{itemize}
