...
\item Feb 11, 2012 \ref{chap:RungeLenz} Runge-Lenz vector conservation

phy354 lecture notes on the Runge-Lenz vector and its use in the Kepler problem.\item Feb 19, 2012 \ref{chap:infiniteSheetPotentials} Attempts at calculating potential distribution for infinite homogeneous plane.

\item Feb 24, 2012 \ref{chap:InfinitePlanePotentialTakeIII} Potential for an infinitesimal width infinite plane.  Take III
