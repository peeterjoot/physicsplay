...
Problems from Desai Chapter V.\item Oct 22, 2010 \ref{chap:gaugeInteractionHamiltonian} Classical Electrodynamic gauge interaction.
...
My submission for problem set III.\end{itemize}
