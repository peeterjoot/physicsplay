...
\author{Peeter Joot}
\date{ Jan 24, 2009.  Last Revision: $Date: 2009/02/01 16:21:10 $ }
...
verify my understanding, as well as diverge into additional areas 
that I needed to visit understand his treatment.
...
%Perhaps notable is that Pauli goes from \ref{eqn:EvP} to \ref{eqn:vEp} directly.
...
\section{ Review of some wave concepts. }

\section{ Light Quanta. }

\section{ Wave packet and the associated wave equation. }
