...
Work problem 4.1 from \citep{liboff2003iqm}, calculation of the eigensolution for an infinite square well, with boundaries $[-a/2, a/2]$.  It's actually a bit tidier seeming to generalize this slightly to boundaries $[a,b]$, which also implicitly solves the problem.  This isn't a problem that isn't done in 700 other QM texts, but I liked the way I did it this time so am writing it down.
