\makeproblem{Fresnel Lens (2012 Ps2 P2)}{modernOptics:problemSet2:2}{ 
...
\imageFigure{figures/modernOpticsProblemSet2Problem2Fig1}{Notation for Fresnel lens mask}{fig:modernOpticsProblemSet2Problem2:modernOpticsProblemSet2Problem2Fig1}{0.15}
...
\imageFigure{figures/modernOpticsProblemSet2Problem2Fig2}{Intensity ratio vs $u_0$}{fig:modernOpticsProblemSet2Problem2:modernOpticsProblemSet2Problem2Fig2}{0.2}
...
\imageFigure{figures/modernOpticsProblemSet2Problem2Fig2b}{Cornu spiral segment up to the point of the max intensity ratio}{fig:modernOpticsProblemSet2Problem2:modernOpticsProblemSet2Problem2Fig2b}{0.2}
...
% original logic:
%\imageFigure{figures/modernOpticsProblemSet2Problem2CornuSpiralMaskedFig4}{Cornu Spiral with regions blocked for equal phase differences}{fig:modernOpticsProblemSet2Problem2CornuSpiralMasked:modernOpticsProblemSet2Problem2CornuSpiralMaskedFig4}{0.4}
% fudging the logic:
\imageFigure{figures/modernOpticsProblemSet2Problem2CornuSpiralMaskedFig4a}{Cornu Spiral with regions blocked for equal phase differences}{fig:modernOpticsProblemSet2Problem2CornuSpiralMasked:modernOpticsProblemSet2Problem2CornuSpiralMaskedFig4}{0.4}
...
\imageFigure{figures/modernOpticsProblemSet2Problem2Fig3}{Geometry for path length interpretation}{fig:modernOpticsProblemSet2Problem2:modernOpticsProblemSet2Problem2Fig3}{0.3}
...
\sim 55 \mu \text{m}
\end{dmath}
FIXME: Grading response: original answer of 17 here due to a missing factor of 10.  Adjust below.
...
which after substitution of our numbers is the numerical maximization problem
...
% 
% is this due to exercise env?
%-------------------------------
% using a generator to avoid syntax errors:
% http://truben.no/latex/table/
%\begin{table}
%    \begin{tabular}{|l|l|}
%        \hline
%        k & difference ($\mu$ m) \\ \hline
%        1 & 1.58263              \\ 
%        2 & 0.848287             \\ 
%        3 & 0.51594              \\ 
%        4 & 0.315938             \\ 
...
for which we find the largest value is $k = 124$ (
%NSolve[ Sqrt[8 k + 3] - Sqrt[ 8 k - 1 ] > 1/(5 Sqrt[10]) && k > 0, k, Integers]
can make 124 additional pairs of openings after the central opening), or 249 zones in total.
