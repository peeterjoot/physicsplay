...
READING: Appendix C.  Grynberg, Aspect, Fabre.

\fxwarning{review lecture 21}{work through this lecture in detail.}

The spectral linewidth (or coherence time) of a laser is called the \underline{Schawlow-Townes limit}.

Laser depicted in \cref{fig:modernOpticsLecture21:modernOpticsLecture21Fig1}.
\imageFigure{figures/modernOpticsLecture21Fig1}{Laser cavity}{fig:modernOpticsLecture21:modernOpticsLecture21Fig1}{0.3}
...
\imageFigure{figures/modernOpticsLecture21Fig2}{Field associated with ground state}{fig:modernOpticsLecture21:modernOpticsLecture21Fig2}{0.3}
...
\imageFigure{figures/modernOpticsLecture21Fig3}{Random walk in phase}{fig:modernOpticsLecture21:modernOpticsLecture21Fig3}{0.3}

\begin{dmath}\label{eqn:modernOpticsLecture21:120}
\EE_{\mathrm{L}} = E_{\mathrm{L}} e^{i \phi(t)}
\end{dmath}

(underscore L stands for laser).

\begin{dmath}\label{eqn:modernOpticsLecture21:140}
\Psi = \EE_{\mathrm{L}} e^{-i \omega t} \times \mbox{spatial mode}
\end{dmath}

Random relative phase $\theta$.  Two components of $\EE_{\mathrm{sp}}$

\begin{enumerate}
\item Parallel to $\EE_{\mathrm{L}}$ changes amplitude, taken out by steady state operation of laser. 
...
\EE_{\mathrm{L}}' \sim \EE_{\mathrm{L}} e^{i \delta \phi}
\end{dmath}

This is a random walk \cref{fig:modernOpticsLecture21:modernOpticsLecture21Fig4} in phase!  

\imageFigure{figures/modernOpticsLecture21Fig4}{Angle is a random variable}{fig:modernOpticsLecture21:modernOpticsLecture21Fig4}{0.3}

Average step:

\begin{dmath}\label{eqn:modernOpticsLecture21:180}
\expectation{\delta \phi} = \frac{E_{\mathrm{sp}}}{E_{\mathrm{L}}} 
\mathLabelBox{
\expectation{\cos\phi}
}{$= 0$}
\end{dmath}
...
= \sqrt{ 
\frac{E_\mathrm{sp}^2}{E_{\mathrm{L}}^2} 
\mathLabelBox{\expectation{\cos^ \theta} }{$1/2$}
- 0
}
= \frac{E_\mathrm{sp}}{\sqrt{2} E_{\mathrm{L}}}
\end{dmath}
...
\sigma_\phi 
= \frac{E_\mathrm{sp}}{\sqrt{2} E_{\mathrm{L}}} \sqrt{N}
\end{dmath}
...
\expectation{n} = \frac{E_{\mathrm{L}}^2}{E_\mathrm{sp}^2}
\end{dmath}

After time $T = \tau_c$, $\sigma_\phi = 1$, or

\begin{dmath}\label{eqn:modernOpticsLecture21:280}
\frac{E_\mathrm{sp}}{\sqrt{2} E_{\mathrm{L}}} \sqrt{ \tau_c \Gamma_{\mathrm{st}} N_2} = 1
\end{dmath}

Referring to \cref{fig:modernOpticsLecture21:modernOpticsLecture21Fig5} we have 

\imageFigure{figures/modernOpticsLecture21Fig5}{Change in field due to spontaneous emission}{fig:modernOpticsLecture21:modernOpticsLecture21Fig5}{0.3}

\begin{dmath}\label{eqn:modernOpticsLecture21:300}
\frac{E_\mathrm{sp}}{E_{\mathrm{L}}} = \inv{\sqrt{\expectation{n}}}
\end{dmath}
...
P = \hbar \omega \expectation{n} \Gamma_cav
\end{dmath}

\begin{dmath}\label{eqn:modernOpticsLecture21:460}
\Gamma_st = \frac{\Gamma_cav \hbar \omega}{P}
\end{dmath}

\begin{dmath}\label{eqn:modernOpticsLecture21:480}
\Gamma_cav = (\text{Trans}) \frac{c}{2L}
\end{dmath}
...
\Gamma_st &= 4 \times 10^{-3} \mathrm{s}^-1
\end{aligned}
\end{equation}
