...
\makeproblem{Ray equation at a surface (2012 Ps1/P3)}{modernOptics:problemSet1:3}{
...
\imageFigure{figures/FigureSnell}{}{fig:modernOpticsProblemSet1:FigureSnell}{0.2}
}
...
We want to use this in the integrated Ray equation \cref{eqn:modernOpticsProblemSet1P3:930} which takes the form
...
\begin{dmath}\label{eqn:modernOpticsProblemSet1P3:770}
\boxed{
...
\begin{equation}\label{eqn:modernOpticsProblemSet1P3:870}
\boxed{
\begin{aligned}
\dds{} \left( 
\left( \theta(x) n_2 
