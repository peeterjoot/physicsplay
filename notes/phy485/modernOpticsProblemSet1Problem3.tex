...
We want to use this in the integrated Ray equation \cref{eqn:modernOpticsProblemSet1:930} which takes the form
...
\begin{equation}\label{eqn:modernOpticsProblemSet1:n}
