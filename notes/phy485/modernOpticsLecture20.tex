...
Guoy's work was circa 1890.  Was that experimental or theoretical work?  Some references can be found in \cite{winful2001physical}.

Let's consider the \underline{phase velocity} at $z \ll z_0$.

%\cref{fig:modernOpticsLecture20:modernOpticsLecture20Fig1}.
%\imageFigure{figures/modernOpticsLecture20Fig1}{CAPTION}{fig:modernOpticsLecture20:modernOpticsLecture20Fig1}{0.3}
...
\imageFigure{figures/modernOpticsLecture20Fig5}{Effective Phase velocity}{fig:modernOpticsLecture20:modernOpticsLecture20Fig5}{0.3}
...
\imageFigure{figures/modernOpticsLecture20Fig2}{Gaussian mode confined in cavity by a set of mirrors}{fig:modernOpticsLecture20:modernOpticsLecture20Fig2}{0.3}
...
\imageFigure{figures/modernOpticsLecture20Fig3}{Gaussian modes confined to mirror cavity}{fig:modernOpticsLecture20:modernOpticsLecture20Fig3}{0.3}
...
\imageFigure{figures/modernOpticsLecture20Fig4}{Equivalent to mirror cavity}{fig:modernOpticsLecture20:modernOpticsLecture20Fig4}{0.2}
