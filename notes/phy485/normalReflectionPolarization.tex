...
\tilde{\BE}_{\mathrm{I}} = E_{\mathrm{I}} e^{i (k z - \omega t)} \xcap
\end{equation}
\begin{equation}\label{eqn:normalReflectionPolarization:40}
\tilde{\BB}_{\mathrm{I}} = \inv{v} \zcap \cross \tilde{\BE}_{\mathrm{I}} = \inv{v} E_{\mathrm{I}} e^{i (k z - \omega t)} \ycap.
\end{equation}
\end{subequations}
...
\tilde{\BE}_{\mathrm{R}} = E_{\mathrm{R}} e^{i (-k z - \omega t)} (\xcap \cos\theta + \ycap \sin\theta)
\end{equation}
\begin{equation}\label{eqn:normalReflectionPolarization:80}
\tilde{\BB}_{\mathrm{R}} = \inv{v} (-\zcap) \cross \tilde{\BE}_{\mathrm{R}} = \inv{v} E_{\mathrm{R}} e^{i (-k z - \omega t)} (\xcap \sin\theta - \ycap \cos\theta).
\end{equation}
\end{subequations}
...
\tilde{\BE}_{\mathrm{T}} = E_{\mathrm{T}} e^{i (k' z - \omega t)} (\xcap \cos\phi + \ycap \sin\phi)
\end{equation}
\begin{equation}\label{eqn:normalReflectionPolarization:120}
\tilde{\BB}_{\mathrm{T}} = \inv{v} \zcap \cross \tilde{\BE}_{\mathrm{T}} = \inv{v'} E_{\mathrm{T}} e^{i (k' z - \omega t)} (-\xcap \sin\phi + \ycap \cos\phi).
\end{equation}
\end{subequations}
...
\lr{\tilde{\BE}_{\mathrm{I}} + \tilde{\BE}_{\mathrm{R}}}
_{x,y} = \lr{\tilde{\BE}_{\mathrm{T}}}
_{x,y}
\end{equation}
\begin{equation}\label{eqn:normalReflectionPolarization:160}
\lr{\inv{\mu}\lr{ \tilde{\BB}_{\mathrm{I}} + \tilde{\BB}_{\mathrm{R}}}}
_{x,y} = 
\lr{\inv{\mu'} \tilde{\BB}_{\mathrm{T}}}
_{x,y}.
\end{equation}
\end{subequations}
...
E_{\mathrm{I}} + E_{\mathrm{R}} \cos\theta = E_{\mathrm{T}} \cos\phi 
\end{equation}
\begin{equation}\label{eqn:normalReflectionPolarization:200}
E_{\mathrm{R}} \sin\theta = E_{\mathrm{T}} \sin\phi
\end{equation}
\begin{equation}\label{eqn:normalReflectionPolarization:220}
E_{\mathrm{R}} \sin\theta = - \beta E_{\mathrm{T}} \sin\phi
\end{equation}
\begin{equation}\label{eqn:normalReflectionPolarization:240}
E_{\mathrm{I}} - E_{\mathrm{R}} \cos\theta = \beta E_{\mathrm{T}} \cos\phi
\end{equation}
\end{subequations}
...
- \beta E_{\mathrm{T}} \sin\phi = E_{\mathrm{T}} \sin\phi,
\end{equation}
...
E_{\mathrm{I}} - E_{\mathrm{R}} &= \beta E_{\mathrm{T}},
\end{aligned}
\end{equation}
...
\begin{aligned}
\frac{E_{\mathrm{T}}}{E_{\mathrm{I}}} &= \frac{2}{1 + \beta} \\
\frac{E_{\mathrm{R}}}{E_{\mathrm{I}}} &= \frac{1 - \beta}{1 + \beta}.
\end{aligned}
\end{equation}
...
Effectively the sign for the magnitude of the transmitted phasor is toggled.  The polarization vectors in this case are \(\ncap = \xcap\), and \(\ncap' = -\xcap\), so the transmitted phasor magnitude change of sign does not change \(\tilde{\BE}_{\mathrm{T}}\) relative to that of the \((0,0)\) solution above.
...
This time, the sign for the magnitude of the reflected phasor is toggled.  The polarization vectors in this case are \(\ncap = -\xcap\), and \(\ncap' = \xcap\).  In this final variation the reflected phasor magnitude change of sign does not change \(\tilde{\BE}_{\mathrm{R}}\) relative to that of the \((0,0)\) solution.
\end{enumerate}
