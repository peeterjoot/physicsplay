...
This is called \underline{Etalon transmission}.  Plots of $I/I_{\mathrm{max}}$ vs. phase shifts for $R \in \{0.1, 0.3, 0.6, 0.97\}$ can be found in \cref{fig:etalon:etalonFig1}.
