...
This is called \underline{Etalon transmission}.  Plots of $I/I_{\text{max}}$ vs. phase shifts for $R \in \{0.1, 0.3, 0.6, 0.97\}$ can be found in \cref{fig:etalon:etalonFig1}.

\imageFigure{figures/etalonFig1}{Etalon transmission}{fig:etalon:etalonFig1}{0.3}
