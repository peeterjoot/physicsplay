...
%\end{dmath}
%
%Because this describes a paraxial system, these angles approximate the tangents, so we can recast \cref{eqn:modernOpticsProblemSet1Attempt1:1090} and \eqnref{eqn:modernOpticsProblemSet1Attempt1:1150} as
%
%\begin{subequations}
