...
%\end{dmath}
%
%Because this describes a paraxial system, these angles approximate the tangents, so we can recast \cref{eqn:modernOpticsProblemSet1Attempt1:1090} and \ref{eqn:modernOpticsProblemSet1Attempt1:1150} as
%
%\begin{subequations}
...
In the class notes, the magnification of the thin lens system described by \cref{eqn:modernOpticsProblemSet1Attempt1:1350} was given by

\begin{equation}\label{eqn:modernOpticsProblemSet1Attempt1:1370}
m = -\frac{s'}{s}.
\end{equation}

Other than the negation, this is a logical definition, the ratio of the output size with respect to the input size.  I'm guessing that this is defined as negated because the image is inverted.  From \cref{eqn:modernOpticsProblemSet1Attempt1:1270} we have

\begin{equation}\label{eqn:modernOpticsProblemSet1Attempt1:1390}
\frac{b}{a} = \frac{x'}{f}.
\end{equation}

Dividing the last two equalities in \cref{eqn:modernOpticsProblemSet1Attempt1:1210a} we have
