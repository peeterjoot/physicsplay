...
\imageFigure{figures/modernOpticsLecture17Fig1}{Cavity}{fig:modernOpticsLecture17:modernOpticsLecture17Fig1}{0.3}
...
( 
\mathWithDescription{1}{spontaneous emmission into cavity}{1}
 + 
\mathWithDescription{\expectation{n}}{stimulated emmission}{2}
 ) 
- 
\mathWithDescription{\Gamma_{\mathrm{cav}} 
\expectation{n}
}{out coupling}{3}
\end{dmath}
...
\imageFigure{figures/modernOpticsLecture17Fig2}{Probability distribution}{fig:modernOpticsLecture17:modernOpticsLecture17Fig2}{0.3}
...
Here $n_s$ is called the \underline{saturation photon number}, and $C$ is called the \underline{cooperation parameter}, a non-dimensional pump rate.  $R$ was the controllable quantity, the voltage of some such knob that we can vary.  The rest are fixed.
