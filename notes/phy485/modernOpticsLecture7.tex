...
\imageFigure{figures/modernOpticsLecture7Fig1}{Multiple sources potentially interfering}{fig:modernOpticsLecture7:modernOpticsLecture7Fig1}{0.2}
...
\paragraph{Isn't the average of cosine just zero?}  Answer: we are considering phases that can vary with time.  We don't necessarily have a constant phase difference here that would be wiped out in an average over one period.
...
\imageFigure{figures/modernOpticsLecture7Fig2}{A diffraction geometry to consider}{fig:modernOpticsLecture7:modernOpticsLecture7Fig2}{0.4}
...
\imageFigure{figures/modernOpticsLecture7Fig3}{Some intensity variation with visibility}{fig:modernOpticsLecture7:modernOpticsLecture7Fig3}{0.2}
...
\imageFigure{figures/modernOpticsLecture7Fig4}{Heterodyne detection}{fig:modernOpticsLecture7:modernOpticsLecture7Fig4}{0.2}
