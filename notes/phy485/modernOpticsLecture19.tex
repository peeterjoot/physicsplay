...
%\imageFigure{figures/modernOpticsLecture19Fig0}{CAPTION}{fig:modernOpticsLecture19:modernOpticsLecture19Fig0}{0.3}
%
...
\begin{equation}\label{eqn:modernOpticsLecture19:580}
\boxed{
u(r, z) 
...
We call $w_0$ the ``waste'' or the \underline{beam waste}, equivalently defining $q_0$ and $z_0$ in terms of the beam waste
...
which is called the \underline{Raleigh range}.
...
The quantity $w(z)$ is called the \underline{beam radius}.

\begin{dmath}\label{eqn:modernOpticsLecture19:340}
\inv{R(z)} = \frac{z}{z^2 + z_0^2}.
\end{dmath}

The quantity $1/R(z)$ is the \underline{phase curvature}.  Let's verify that this is correct.  Starting with the multiplicative term we have
...
This demonstrates the claimed identity \ref{eqn:modernOpticsLecture19:280}.
...
\begin{dmath}\label{eqn:modernOpticsLecture19:n}
\frac{r^2 }{w_0^2 \left( 1 + \frac{z^2}{z_0^2} \right)} = C^2 = \text{constant},
\end{dmath}
...
With $u = x/w_0 C, v = y/w_0 C, w = z/z_0$, this is plotted in \cref{fig:modernOpticsLecture19:modernOpticsLecture19Fig5}.
...
%\imageFigure{figures/modernOpticsLecture19Fig4}{Gaussian beam envelope}{fig:modernOpticsLecture19:modernOpticsLecture19Fig4}{0.3}

\imageFigure{figures/modernOpticsLecture19Fig5}{Gaussian beam envelope}{fig:modernOpticsLecture19:modernOpticsLecture19Fig5}{0.4}
...
\imageFigure{figures/modernOpticsLecture19Fig1}{Point source}{fig:modernOpticsLecture19:modernOpticsLecture19Fig1}{0.3}
...
%\imageFigure{figures/modernOpticsLecture19Fig2}{CAPTION}{fig:modernOpticsLecture19:modernOpticsLecture19Fig2}{0.3}
Waste angular dependence is roughly illustrated in \cref{fig:modernOpticsLecture19:modernOpticsLecture19Fig3}.

\imageFigure{figures/modernOpticsLecture19Fig3}{Waste angular dependence}{fig:modernOpticsLecture19:modernOpticsLecture19Fig3}{0.3}
...
Using \ref{eqn:modernOpticsLecture19:200} we can write this as
