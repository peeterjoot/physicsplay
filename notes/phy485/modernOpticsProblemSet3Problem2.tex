...
If we split our wave function into forward $\Psi_{+}(x)$ and reverse $\Psi_{-}(x)$ components we have from \eqnref{eqn:modernOptics:problemSet3:2:100}
