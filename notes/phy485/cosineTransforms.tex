...
\begin{equation}\label{eqn:cosineTransforms:70}
\myBoxed{
\tilde{f}_c(\omega) =
\int_0^{\infty}
\cos( \omega \tau )
...
\begin{equation}\label{eqn:cosineTransforms:110}
\myBoxed{
...
\begin{equation}\label{eqn:cosineTransforms:150}
\myBoxed{
f(\tau)
=
...
\begin{equation}\label{eqn:cosineTransforms:250}
\myBoxed{
\int_0^\infty d\tau \cos(\omega \tau)
% too small:
%\widetilde{
