...
k R = \mathWithDescription{k r}{$O(r\lambda)$}{1} - \mathWithDescription{k \rcap \cdot \Br'}{$O(d/\lambda)$}{2} + \mathWithDescription{\frac{k}{2r} \left( {\Br'}^2 - \left( \rcap \cdot \Br' \right)^2 \right)}{$O(d^2/\lambda r)$}{3} + \mathWithDescription{\cdots}{$O(d^3/\lambda r^2)$}{4}
\end{dmath}
