...
\imageFigure{figures/modernOpticsLecture4Fig1}{Laser on screen}{fig:modernOpticsLecture4:modernOpticsLecture4Fig1}{0.4}
...
We'll want to consider systems of this sort (light source, object in between, goes some distance, then observed) mathematically.  We consider the geometry of figure (\ref{fig:modernOpticsLecture4:modernOpticsLecture4Fig2}) where $\BR = \Br - \Br'$, and $\BR_s = \Br_s - \Br'$, and $R = \Abs{\BR}$, $R_s = \Abs{\BR_s}$.

\imageFigure{figures/modernOpticsLecture4Fig2}{Diffracting object (i.e. aperture)}{fig:modernOpticsLecture4:modernOpticsLecture4Fig2}{0.4}
...
%where $R = \Abs{\Br - \Br'}$.  
Recall that we previously demonstrated \citep{phy456:helmoltzGreens} that this Green's function works to solve the forced Helmoltz equation
...
\imageFigure{figures/modernOpticsLecture4Fig4}{Neglecting the surface at infinity}{fig:modernOpticsLecture4:modernOpticsLecture4Fig4}{0.4}
...
\imageFigure{figures/modernOpticsLecture4Fig5}{Source, aperture and observation point}{fig:modernOpticsLecture4:modernOpticsLecture4Fig5}{0.4}
