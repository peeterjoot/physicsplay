...
\fxwarning{research derivation of Fermat's theorem}{Question: how does one show Fermat's theorem from Maxwell's equations?}
}
...
\imageFigure{figures/snellsFermatFig1}{Snell's law light paths}{fig:snellsFermat:snellsFermatFig1}{0.4}
