...
\begin{equation}\label{eqn:planckBlackbody:70}
\boxed{
...
We expect this and \ref{eqn:planckBlackbody:90} to differ only by a constant.  For \ref{eqn:planckBlackbody:90}, or $dS_N/dx = 1 + 2 x + 3 x^2 + \cdots$, we have $1$ at the origin, the same as \ref{eqn:planckBlackbody:110}.  Our conclusion is

\begin{equation}\label{eqn:planckBlackbody:130}
\boxed{
\sum_{n=1}^{N-1} n x^n
=
\frac{x}{(1-x)^2} \left( 
...
\imageFigure{figures/negativeExponentialPlotFig1}{Plot of $e^{-x/5}$}{fig:negativeExponentialPlot:negativeExponentialPlotFig1}{0.3}
