...
Before doing so, let's introduce a bit of notation to be used throughout.  When we wish to refer to all the fields or angles, for example, $\BE_i, \BE_r, \BE_t$ then we'll write $\BE_p$ where $p \in \{i, r, t\}$.  Similarly, to refer to just the incident and transmitted components (or angles) we'll use $\BE_q$ where $q \in \{i, t\}$.  Following \citep{griffith1981introduction} we'll also write

\begin{subequations}
\label{eqn:fresnelAlternatePolarization:750a}
\begin{equation}\label{eqn:fresnelAlternatePolarization:750}
\myBoxed{
\beta = \frac{\mu_1 v_1} {\mu_2 v_2}
}
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:770}
\myBoxed{
...
\begin{equation}\label{eqn:fresnelAlternatePolarization:530a}
\myBoxed{
\frac{E_t}{E_i}
=
\frac
...
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:550a}
\myBoxed{
\frac{E_r}{E_i}
=
\frac
...
\begin{equation}\label{eqn:fresnelAlternatePolarization:790}
\myBoxed{
\frac{E_t}{E_i} = \frac{2 }{\beta + \alpha}
}
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:810}
\myBoxed{
