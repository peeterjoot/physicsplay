\makeproblem{Stability in a cavity (2012 Ps4, P2)}{modernOptics:problemSet4:2}{
...
%\end{dmath}
%
%Observe that we don't have to actually solve for the eigenvalues, just find these values $a$ and $b$ from \ref{eqn:problemSet4Problem2:680}.  That's still a pain in the butt and I resorted to using Mathematica for that part \cref{fig:modernOpticsProblemSet4:modernOpticsProblemSet4Fig1}.
%
%\imageFigure{figures/modernOpticsProblemSet4Fig1}{Ugly characteristic equation coefficient computation}{fig:modernOpticsProblemSet4:modernOpticsProblemSet4Fig1}{0.3}
%
%This gives us
%
%\begin{subequations}
...
%
%See on re-inspection that \ref{eqn:problemSet4Problem2:820} is wrong, which messes up everything after it.  It's also glaringly obvious that I need to somehow get $d$ out of the works if the final inequality is to only involve $\alpha_1$ and $\alpha_2$.  This should probably be done early, but how?
}
