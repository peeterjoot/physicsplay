...
\imageFigure{figures/modernOpticsLecture16Fig1}{Laser cavity}{fig:modernOpticsLecture16:modernOpticsLecture16Fig1}{0.2}
...
The history of this actually goes back to Einstein, who in 1917 did a thought experiment with atoms in a box, stimulating radiation, which is bouncing around, exciting the atoms, so that they in turn emit again.  We'll consider $N$ atoms in thermal equilibrium with the light in the box as in \cref{fig:modernOpticsLecture16:modernOpticsLecture16Fig2}.
\imageFigure{figures/modernOpticsLecture16Fig2}{Atoms in a box}{fig:modernOpticsLecture16:modernOpticsLecture16Fig2}{0.2}

We expect more in the ground state \cref{fig:modernOpticsLecture16:modernOpticsLecture16Fig3}.

\imageFigure{figures/modernOpticsLecture16Fig3}{Ground and excited state separation}{fig:modernOpticsLecture16:modernOpticsLecture16Fig3}{0.2}

\begin{dmath}\label{eqn:modernOpticsLecture16:10}
\frac{N_e}{N_g}
=\frac{P_e}{P_g} = e^{-(E_e - E_g)/k T}
\end{dmath}
...
\imageFigure{figures/modernOpticsLecture16Fig4}{Population inversion}{fig:modernOpticsLecture16:modernOpticsLecture16Fig4}{0.2}
