...
=
-\inv{2} \mathWithDescription{\left( \frac{d^2}{dz^2} \Brho - \frac{\alpha}{n_0} \Brho \right)}{$= 0$ by Eikonal}{1} \cdot \Brho
\end{dmath}
...
\tau 
= \frac{n_0 L}{c} 
+ \frac{n_0}{2 c} \mathWithDescription{\evalrange{ \Brho \cdot \ddz{\Brho} }{0}{L}}{$= 0$ if refocused}{2}
\end{dmath}
