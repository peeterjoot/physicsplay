...
\imageFigure{figures/modernOpticsLecture3Fig4r}{Ray variation with position through GRIN material}{fig:modernOpticsLecture3:modernOpticsLecture3Fig4r}{0.4}
...
Are path lengths equal?  Instead of dropping all but the $dz$ term in our $ds$ approximation \ref{eqn:modernOpticsLecture3:30}, how about we retain the first order Taylor expansion
...
=
-\inv{2} \underbrace{\left( \frac{d^2}{dz^2} \Brho - \frac{\alpha}{n_0} \Brho \right)}_{ \mbox{$= 0$ by Eikonal}} \cdot \Brho
\end{dmath}
...
T 
= \frac{n_0 L}{c} 
+ \frac{n_0}{2 c} \underbrace{\evalrange{ \Brho \cdot \ddz{\Brho} }{0}{L}}_{\mbox{$= 0$ if refocused}}
\end{dmath}
