...
\makeproblem{Average Poynting flux for complex 2D fields (problem 2.4)}{poyntingComplex:pr4}{
...
\makeproblem{Complex form of electric wave (problem 2.5)}{poyntingComplex:pr5}{
...
\makeproblem{Some polarization plots (problem 2.6)}{poyntingComplex:pr6}{
...
\imageFigure{figures/modernOpticsFigProblemCh2Pr6a}{Linear polarization at right angle}{fig:modernOptics:modernOpticsFigProblemCh2Pr6a}{0.2}
\imageFigure{figures/modernOpticsFigProblemCh2Pr6b}{Linear polarization at angle}{fig:modernOptics:modernOpticsFigProblemCh2Pr6b}{0.2}
\imageFigure{figures/modernOpticsFigProblemCh2Pr6c}{Circular polarization}{fig:modernOptics:modernOpticsFigProblemCh2Pr6c}{0.2}
\imageFigure{figures/modernOpticsFigProblemCh2Pr6d}{Elliptical polarization}{fig:modernOptics:modernOpticsFigProblemCh2Pr6d}{0.2}
}

\makeproblem{Geometry of general Jones vector (problem 2.8)}{poyntingComplex:pr8}{
...
Prior to attempting the problem as stated, let's explore the algebra of a parametric representation of an ellipse, rotated at an angle $\theta$ as in figure (\ref{fig:2dRotationOfEllipse:2dRotationOfEllipseFig2}).  The equation of the ellipse in the rotated coordinates is

\imageFigure{figures/2dRotationOfEllipseFig2}{Rotated ellipse}{fig:2dRotationOfEllipse:2dRotationOfEllipseFig2}{0.2}
...
We'd like to express $x'$ and $y'$ in the ``fixed'' frame.  Consider figure (\ref{fig:2dRotationOfCoordinates:2dRotationOfCoordinatesFig1}) where our coordinate conventions are illustrated.  With

\imageFigure{figures/2dRotationOfCoordinatesFig1}{2d rotation of frame}{fig:2dRotationOfCoordinates:2dRotationOfCoordinatesFig1}{0.2}
...
Squaring this and using $\sin^2 u = 1 - \cos^2 u$, and \ref{eqn:poyntingComplex:690} we have
...
This yields \ref{eqn:poyntingComplex:390} as desired.  We also end up with expressions for our major and minor axis lengths, which are respectively for $\sin \Delta \ne 0$
