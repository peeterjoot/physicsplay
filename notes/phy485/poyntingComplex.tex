...
For a field specified by \cref{eqn:poyntingComplex:100}, sketch diagrams to show the type of polarization for the following parameters
...
Squaring this and using $\sin^2 u = 1 - \cos^2 u$, and \cref{eqn:poyntingComplex:690} we have
...
This yields \cref{eqn:poyntingComplex:390} as desired.  We also end up with expressions for our major and minor axis lengths, which are respectively for $\sin \Delta \ne 0$
