...
Referring to \cref{fig:modernOpticsLecture6:modernOpticsLecture6Fig3},
...
Parametrically plotting these we get the \underline{Cornu Spiral} as roughly illustrated in \cref{fig:modernOpticsLecture6:modernOpticsLecture6Fig4}.
...
Once we understand that light does in fact take all the paths, we can utilize this to build a \underline{Fresnel lens} by blocking selectively as illustrated very roughly in \cref{fig:modernOpticsLecture6:modernOpticsLecture6Fig7}.
