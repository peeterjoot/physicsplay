...
exactly like our non-dimensionalized QM SHO \ref{eqn:modernOpticsLecture18:1140a}.  Instead of time evolution of the form $e^{-i (\epsilon/\omega) (\omega/c) (c t)}$ we now have non-transverse z evolution in the form $e^{-i (\epsilon/\sqrt{k_2/k_0}) \sqrt{k_2/k_0} z}$.
...
We see that our effective ``spring constant'' is $c \hbar k_2$, and our paraxial equation is put into exact coorespondance with the QM SHO
