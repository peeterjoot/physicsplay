...
Recall the identity for curl of curl \ref{eqn:crossCrossA:30}
...
and take curls of both sides of the $\BE$ curl equation \ref{eqn:modernOpticsLecture18:40}
...
\imageFigure{figures/modernOpticsLecture18Fig1}{Possible $\epsilon$ dependence in medium}{fig:modernOpticsLecture18:modernOpticsLecture18Fig1}{0.3}
...
\begin{dmath}\label{eqn:modernOpticsLecture18:400}
\boxed{
...
\begin{dmath}\label{eqn:modernOpticsLecture18:440}
\boxed{
...
\begin{dmath}\label{eqn:modernOpticsLecture18:480}
\boxed{
...
\imageFigure{figures/modernOpticsLecture18Fig2}{Radiation and matter wave equivalence}{fig:modernOpticsLecture18:modernOpticsLecture18Fig2}{0.3}
...
\imageFigure{figures/modernOpticsLecture18Fig3u0}{First order 1D SHO matter wave}{fig:modernOpticsLecture18:modernOpticsLecture18Fig3u0}{0.3}
\imageFigure{figures/modernOpticsLecture18Fig3u1}{Second order 1D SHO matter wave}{fig:modernOpticsLecture18:modernOpticsLecture18Fig3u1}{0.3}
\imageFigure{figures/modernOpticsLecture18Fig3u2}{Third order 1D SHO matter wave}{fig:modernOpticsLecture18:modernOpticsLecture18Fig3u2}{0.3}

%Recall that our 1D SHO solutions look like 
%\cref{fig:modernOpticsLecture18:modernOpticsLecture18Fig3}.
%\imageFigure{figures/modernOpticsLecture18Fig3}{First couple SHO solutions}{fig:modernOpticsLecture18:modernOpticsLecture18Fig3}{0.3}
...
\imageFigure{figures/modernOpticsLecture18Fig4}{2D SHO solutions}{fig:modernOpticsLecture18:modernOpticsLecture18Fig4}{0.3}
...
\imageFigure{figures/modernOpticsLecture18Fig5}{Dispersive electric field}{fig:modernOpticsLecture18:modernOpticsLecture18Fig5}{0.3}
...
That last subsection of class notes wasn't entirely clear to me.   Let's see if we can make more sense of things by comparing the Harmonic oscilator equation with this spatial light wave equation.
...
The QM form of the SHO was mentioned above in class.  Let's put this in a non-dimensional form for comparision to the paraxial wave equation.  After observing that

\begin{dmath}\label{eqn:modernOpticsLecture18:1000}
\dimensions{ \frac{ m \omega }{\hbar} } = \inv{\mathrm{L}^2},
\end{dmath}

we can non-dimensionalize the QM SHO \ref{eqn:modernOpticsLecture18:860} as
...
\begin{subequations}
\begin{dmath}\label{eqn:modernOpticsLecture18:1060}
\tau = \omega t
\end{dmath}
\begin{dmath}\label{eqn:modernOpticsLecture18:1080}
\epsilon = \frac{E}{\hbar \omega}
\end{dmath}
\begin{dmath}\label{eqn:modernOpticsLecture18:1100}
...
\begin{dmath}\label{eqn:modernOpticsLecture18:1140}
0 =
\left(
...
we can put the paraxial equation \ref{eqn:modernOpticsLecture18:480} in non-dimensionalized form
...
exactly like our non-dimensionalized QM SHO \ref{eqn:modernOpticsLecture18:1140}.  Instead of time evolution of the form $e^{-i (\epsilon/\omega) \omega t}$ we now have non-transverse z evolution in the form $e^{-i (\epsilon/\sqrt{k_2/k_0}) \sqrt{k_2/k_0} z}$.

From this we see that we can make the identifications

\begin{subequations}
\begin{dmath}\label{eqn:modernOpticsLecture18:1220}
\omega_{\mathrm{eff}} \equiv \sqrt{\frac{k_2}{k_0}}
\end{dmath}
\begin{dmath}\label{eqn:modernOpticsLecture18:1240}
m_{\mathrm{eff}} \equiv \hbar k_0,
\end{dmath}
\end{subequations}

FIXME: Professor Thywissen make the identification $m_{\mathrm{eff}} \equiv \hbar k_0/c$ in the class notes above.  Why does that differ from this non-dimensionalization result?

We see that our effective ``spring constant'' is $\hbar k_2$, and our paraxial equation is put into exact coorespondance with the QM SHO

\begin{dmath}\label{eqn:modernOpticsLecture18:1260}
-\frac{\hbar^2}{2 m_{\mathrm{eff}}} \spacegrad_{\mathrm{T}}^2 u + \inv{2} m_{\mathrm{eff}} \left(\omega_{\mathrm{eff}} \right)^2 r^2 u = i \hbar \PD{z}{u}.
\end{dmath}

We can also write express our media's spatial dependance in terms of this effective angular velocity
