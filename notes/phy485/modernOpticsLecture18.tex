...
-\frac{\hbar^2}{2m} \spacegrad_T^2 \Psi + \inv{2} m \omega^2 r^2 \Psi = i \hbar \PD{t}{\Psi}.
\end{dmath}
...
\frac{\hbar}{m \omega} \spacegrad_T^2 \Psi - \frac{m \omega}{\hbar} r^2 \Psi 
...
\inv{U} \left(
\frac{\hbar}{m \omega} \spacegrad_T^2 U - \frac{m \omega}{\hbar} r^2 U
\right)
=
...
\omega_eff \equiv \frac{\sqrt{k_2}{k_0}}
\end{dmath}
\begin{dmath}\label{eqn:modernOpticsLecture18:1240}
m_eff \equiv \hbar k_0,
\end{dmath}
\end{subequations}
...
-\frac{\hbar^2}{2 m_eff} \spacegrad_T^2 u(r,z) + \inv{2} m_eff \left(\omega_eff \right)^2 r^2 u(r, z) = i \hbar \PD{z}{} u(r, z).
\end{dmath}
