...
Instead of time evolution of the form $e^{-i (\epsilon/\omega) \omega t}$ we now have non-transverse z evolution in the form $e^{-i (\epsilon/\sqrt{k_2/k_0}) \sqrt{k_2/k_0} z}$.
...
which puts our paraxial equation in the form
...
where we are working in a media for which

\begin{dmath}\label{eqn:modernOpticsLecture18:n}
k(r) = k_0^2 \left( 1 - \left( \omega_{\mathrm{eff}} \right)^2 r^2 \right)
\end{dmath}
