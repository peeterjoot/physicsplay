...
To get a bit of a feeling for what this looks like we can check out a plot, as in \cref{fig:lecture15figures5aperaturesIntensityPlot:lecture15figures5aperaturesIntensityPlotFig8}, plotting $n = 5, a = 0.869, b = 0.172, \lambda = 1$.
...
\fxwarning{reference mathematica notebook link in appendix.}{have mathematica workbook to plot this interactively.}
