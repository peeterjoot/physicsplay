...
\begin{equation}\label{eqn:modernOpticsProblemSet1P1:1590}
\myBoxed{
x x' = f^2,
}
\end{equation}
...
In particular
\begin{equation}\label{eqn:modernOpticsProblemSet1P1:1650}
\myBoxed{
y' = f \theta,
}
\end{equation}
...
\begin{equation}\label{eqn:modernOpticsProblemSet1P1:1710}
\myBoxed{
\frac{y'}{y} = -1,
}
\end{equation}
