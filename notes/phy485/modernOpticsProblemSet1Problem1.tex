...
\begin{equation}\label{eqn:modernOpticsProblemSet1P1:1870}
\myBoxed{
\inv{s'} + \inv{s} = \inv{f},
}
\end{equation}
...
\begin{equation}\label{eqn:modernOpticsProblemSet1P1:1550}
\myBoxed{
m = - \frac{x'}{f} = \frac{y'}{y}.
}
\end{equation}
...
\begin{dmath}\label{eqn:modernOpticsProblemSet1P1:1590}
\myBoxed{
x x' = f^2,
}
\end{dmath}
...
In particular
\begin{dmath}\label{eqn:modernOpticsProblemSet1P1:1650}
\myBoxed{
y' = f \theta,
}
\end{dmath}
...
\begin{dmath}\label{eqn:modernOpticsProblemSet1P1:1710}
\myBoxed{
\frac{y'}{y} = -1,
}
\end{dmath}
