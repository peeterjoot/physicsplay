...
\imageFigure{figures/modernOpticsLecture14Fig2}{Fabry-Perot Etalon}{fig:modernOpticsLecture14:modernOpticsLecture14Fig2}{0.3}
...
\imageFigure{figures/modernOpticsLecture14Fig1}{Etonal response by frequency}{fig:modernOpticsLecture14:modernOpticsLecture14Fig1}{0.3}

something that is an idealization of \cref{fig:modernOpticsLecture14:modernOpticsLecture14Fig3}.
\imageFigure{figures/modernOpticsLecture14Fig3}{Ideal Etalon response}{fig:modernOpticsLecture14:modernOpticsLecture14Fig3}{0.3}
...
What would make sense to me is to consider the angular dependence of $\Delta$ for two sets of frequencies.  Plotting that for a narrow range of angles for $500 \text{nm}$ and $650 \text{nm}$ light, and $R = 0.97$ we have \cref{fig:etalonAngularDependencyForTwoWavelengths:etalonAngularDependencyForTwoWavelengthsFig11}.

\imageFigure{figures/etalonAngularDependencyForTwoWavelengthsFig11}{Etalon angular dependencies}{fig:etalonAngularDependencyForTwoWavelengths:etalonAngularDependencyForTwoWavelengthsFig11}{0.3}

So, if we have a source at a distance, we can expect a different intensity result at the output for different frequencies, depending on the angle between the source and the device.  This I can picture as an experimental setup.
...
\imageFigure{figures/modernOpticsLecture14Fig4}{Wavelength packing in a cavity}{fig:modernOpticsLecture14:modernOpticsLecture14Fig4}{0.3}
...
\imageFigure{figures/modernOpticsLecture14Fig5}{Cavity as an oscillator}{fig:modernOpticsLecture14:modernOpticsLecture14Fig5}{0.3}

is basically the same idea as in an implementation of a laser \cref{fig:modernOpticsLecture14:modernOpticsLecture14Fig6}.
\imageFigure{figures/modernOpticsLecture14Fig6}{Semiconductor cavity}{fig:modernOpticsLecture14:modernOpticsLecture14Fig6}{0.3}
...
\imageFigure{figures/modernOpticsLecture14Fig7}{Frequency comb}{fig:modernOpticsLecture14:modernOpticsLecture14Fig7}{0.3}
...
\imageFigure{figures/modernOpticsLecture14Fig8}{Lorentzian}{fig:modernOpticsLecture14:modernOpticsLecture14Fig8}{0.3}
...
\imageFigure{figures/modernOpticsLecture14Fig9}{Squared sine plot}{fig:modernOpticsLecture14:modernOpticsLecture14Fig9}{0.3}
...
or
\begin{dmath}\label{eqn:modernOpticsLecture14:350}
\boxed{
\frac{I}{I_0} 
...
\imageFigure{figures/modernOpticsLecture14Fig10}{Exponential decay}{fig:modernOpticsLecture14:modernOpticsLecture14Fig10}{0.3}
