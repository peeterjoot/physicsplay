\makeproblem{Doublets and Combs (2012 Ps3 P1)}{modernOptics:problemSet3:1}{
...
\imageFigure{figures/frequencySingletsFig2}{Comparison to doubled frequency form}{fig:frequencySinglets:frequencySingletsFig2}{0.3}
...
\imageFigure{figures/frequencySingletsFig3}{More widely separated peak frequencies}{fig:frequencySinglets:frequencySingletsFig3}{0.3}
...
\imageFigure{figures/problemSet3SketchFig1a}{Intensity as a function of additional path length}{fig:problemSet3Sketch:problemSet3SketchFig1a}{0.3}

%Plotted in \cref{fig:problemSet3:problemSet3Fig1a}.
%\imageFigure{figures/problemSet3Fig1a}{Sample time domain interference}{fig:problemSet3:problemSet3Fig1a}{0.3}
...
\imageFigure{figures/problemSet3Problem1bPlotFig4}{10 frequency input to Michelson interferometer}{fig:problemSet3Problem1bPlot:problemSet3Problem1bPlotFig4}{0.3}
}
