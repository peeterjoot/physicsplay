...
Writing the $C$ term as $-1/f$ we have what's called the \underline{Lens makers formula} (for a thick lens in this case), and putting back in $n$ and $n'$ we have
...
For our focus in \cref{eqn:modernOpticsLecture1:590} we get
...
\fxwarning{Demonstrate}{demonstrate.}
...
\fxwarning{Review}{Understand this.}
