...
\imageFigure{figures/modernOpticsMidtermReflectionFig1}{Lloyd's mirror}{fig:modernOpticsMidtermReflection:modernOpticsMidtermReflectionFig1}{0.3}
} % makeproblem
...
\imageFigure{figures/gaussianWavePacketFig2}{Gaussian wave packet}{fig:gaussianWavePacket:gaussianWavePacketFig2}{0.2}
...
\imageFigure{figures/ftOfgaussianSquaredAtRetardedTimeFig3}{Mutual coherence of Gaussian source}{fig:ftOfgaussianSquaredAtRetardedTime:ftOfgaussianSquaredAtRetardedTimeFig3}{0.2}
...
\imageFigure{figures/modernOpticsMidtermReflectionFig2}{Lloyd's mirror configuration for a distributed source}{fig:modernOpticsMidtermReflection:modernOpticsMidtermReflectionFig2}{0.3}
...
\imageFigure{figures/modernOpticsMidtermReflectionFig6}{Spatial interferometry with Lloyd's mirror}{fig:modernOpticsMidtermReflection:modernOpticsMidtermReflectionFig6}{0.3}
...
\imageFigure{figures/modernOpticsMidtermReflectionFig7}{Coordinates for Lloyd's mirror spatially distributed interferometry problem}{fig:modernOpticsMidtermReflection:modernOpticsMidtermReflectionFig7}{0.3}

We have

\begin{align}\label{eqn:modernOpticsMidtermReflection:1400}
r_1^2 &= L^2 + y^2 \\
r_2^2 &= L^2 + (2 h + y)^2 \\
R_1^2 &= L^2 + (y-x)^2 \\
...
\begin{align}\label{eqn:modernOpticsMidtermReflection:1420}
...
\imageFigure{figures/modernOpticsMidtermReflectionFig9}{Angle from mirror to observation point}{fig:modernOpticsMidtermReflection:modernOpticsMidtermReflectionFig9}{0.3}

So that our plug into \ref{eqn:modernOpticsMidtermReflection:1340} takes the form
...
\imageFigure{figures/modernOpticsMidtermReflectionFig8}{Visibility curve for Lloyd's mirror and spatially distributed source}{fig:modernOpticsMidtermReflection:modernOpticsMidtermReflectionFig8}{0.3}
...
\begin{dmath}\label{eqn:modernOpticsMidtermReflection:1560}
\boxed{
\Delta w
= \frac{\sqrt{3}}{k \theta}.
}
