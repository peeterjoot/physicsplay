\makeproblem{Solar interference (2012 Ps2 P3)}{modernOptics:problemSet2:3}{ 
...
\Br_1 = \Br_{\text{av}} + \frac{d}{2} \xcap
\end{equation}
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P3:130}
\Br_2 = \Br_{\text{av}} - \frac{d}{2} \xcap
\end{equation}
...
\imageFigure{figures/modernOpticsProblemSet2Problem3Fig1}{Geometry for solar disk interference problem}{fig:modernOpticsProblemSet2Problem3:modernOpticsProblemSet2Problem3Fig1}{0.4}
...
\imageFigure{figures/modernOpticsProblemSet2Problem3Fig3}{Sinc like first order Bessel function}{fig:modernOpticsProblemSet2Problem3:modernOpticsProblemSet2Problem3Fig3}{0.3}
...
%\imageFigure{figures/modernOpticsProblemSet2Problem3Fig2}{Bessel $J_1$}{fig:modernOpticsProblemSet2Problem3:modernOpticsProblemSet2Problem3Fig2}{0.3}
...
%
%\imageFigure{figures/wikipediaPlanksBlack_body}{Plank's law distributions}{fig:Black_body:wikipediaPlanksBlack_body}{0.3}

\fxwarning{rework}{Unsuprisingly, I lost marks on this part of my solution.  A numeric result was desired, but I think I should have approached this much differently.}
...
\imageFigure{figures/modernOpticsProblemSet2Problem3Fig4}{Possible fringes from two sources at the boundaries of the spectral width}{fig:modernOpticsProblemSet2Problem3:modernOpticsProblemSet2Problem3Fig4}{0.2}
...
\fxwarning{rework}{Also lost marks for this response.  Numeric result was desired (which I knew, but was rushing by this point)}
