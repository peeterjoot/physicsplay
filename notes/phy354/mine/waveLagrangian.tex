...
This is looking more like \ref{eqn:wave_lagrangian:maxlag} now.  It is expected that the gauge condition can be used to complete the reconciliation.  However, I have had trouble actually doing this, despite the fact that both Lagrangians appear to correctly
