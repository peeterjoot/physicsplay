...
\frac{d}{dt} \left( m \sum_j \dot{x}^j \myMathWithDescription{\sum_k \Be^k \Be_k \cdot \Be_j}{$=\Be_j$}{1} \right) &= \\
...
&= \alpha \norm{\Br}^{\alpha-2} \sum_i x^i \myMathWithDescription{\sum_k \Be^k \Be_k \cdot \Be_i}{$=\Be_i$}{1} \\
&= \alpha \norm{\Br}^{\alpha-2} \Br
\end{align*}
