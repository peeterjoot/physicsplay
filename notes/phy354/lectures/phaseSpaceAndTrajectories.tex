...
\imageFigure{figures/phaseSpaceAndTrajectoriesFig1}{Harmonic oscillator phase space trajectory}{fig:phaseSpaceAndTrajectories:phaseSpaceAndTrajectoriesFig1}{0.2}
...
\imageFigure{figures/phaseSpaceAndTrajectoriesFig2}{Variable length pendulum}{fig:phaseSpaceAndTrajectories:phaseSpaceAndTrajectoriesFig2}{0.2}
...
is the so-called ``adiabatic invariant''.  There is an important application to this (and some relations to QM).  Imagine that we have a particle bounded by two walls, where the walls are moved very slowly as in figure (\ref{fig:phaseSpaceAndTrajectories:phaseSpaceAndTrajectoriesFig3})
\imageFigure{figures/phaseSpaceAndTrajectoriesFig3}{Particle constrained by slowly moving walls}{fig:phaseSpaceAndTrajectories:phaseSpaceAndTrajectoriesFig3}{0.2}
...
Let us verify the angular momentum relations of \ref{eqn:phaseSpaceAndTrajectories:330} above (summation over $k$ implied):
...
Since we have referred to a variable length pendulum above, let us recall what form the EOM for this system take.  With cylindrical coordinates as in figure (\ref{fig:phaseSpaceAndTrajectories:phaseSpaceAndTrajectoriesFig4}), and a spring constant $\omega_0^2 = k/m$ our Lagrangian is

\imageFigure{figures/phaseSpaceAndTrajectoriesFig4}{phaseSpaceAndTrajectoriesFig4}{fig:phaseSpaceAndTrajectories:phaseSpaceAndTrajectoriesFig4}{0.2}
