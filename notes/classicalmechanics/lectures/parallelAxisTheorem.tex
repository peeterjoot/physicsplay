...
\imageFigure{figures/parallelAxisTheoremFig1}{Volume element for continous mass distribution}{fig:parallelAxisTheorem:parallelAxisTheoremFig1}{0.3}
...
\imageFigure{figures/parallelAxisTheoremFig2}{Shift of origin}{fig:parallelAxisTheorem:parallelAxisTheoremFig2}{0.3}
...
\imageFigure{figures/parallelAxisTheoremFig3}{Infinite rolling cylinder on plane}{fig:parallelAxisTheorem:parallelAxisTheoremFig3}{0.3}

Take the mass as uniform and set up coordinates as in \cref{fig:parallelAxisTheorem:parallelAxisTheoremFig4}.

\imageFigure{figures/parallelAxisTheoremFig4}{Coordinates for infinite cylinder}{fig:parallelAxisTheorem:parallelAxisTheoremFig4}{0.3}
...
\imageFigure{figures/parallelAxisTheoremFig5}{Displaced CM for infinite cylinder}{fig:parallelAxisTheorem:parallelAxisTheoremFig5}{0.3}
...
\imageFigure{figures/parallelAxisTheoremFig6}{Hollow tube with blob}{fig:parallelAxisTheorem:parallelAxisTheoremFig6}{0.3}
...
\imageFigure{figures/parallelAxisTheoremFig7}{Hollow tube with cylindrical blob}{fig:parallelAxisTheorem:parallelAxisTheoremFig7}{0.3}

Recall for a general body as in \cref{fig:parallelAxisTheorem:parallelAxisTheoremFig8}.

\imageFigure{figures/parallelAxisTheoremFig8}{general body coordinates}{fig:parallelAxisTheorem:parallelAxisTheoremFig8}{0.3}
...
\imageFigure{figures/parallelAxisTheoremFig9}{Cone on rod}{fig:parallelAxisTheorem:parallelAxisTheoremFig9}{0.3}
...
\imageFigure{figures/parallelAxisTheoremFig10}{Momentary axes of rotation}{fig:parallelAxisTheorem:parallelAxisTheoremFig10}{0.3}

\paragraph{Aside}

more interesting is the cone viewed from above as in \cref{fig:parallelAxisTheorem:parallelAxisTheoremFig11}.

\imageFigure{figures/parallelAxisTheoremFig11}{Cone from above}{fig:parallelAxisTheorem:parallelAxisTheoremFig11}{0.3}

Coordinates for this problem as in \cref{fig:parallelAxisTheorem:parallelAxisTheoremFig12}.

\imageFigure{figures/parallelAxisTheoremFig12}{Momentary axes of rotation for cone on stick}{fig:parallelAxisTheorem:parallelAxisTheoremFig12}{0.3}
...
\imageFigure{figures/parallelAxisTheoremFig13}{Coordinates}{fig:parallelAxisTheorem:parallelAxisTheoremFig13}{0.3}
