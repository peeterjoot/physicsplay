...
%\author{Peeter Joot
%\smallskip\\
%\small{e-mail: peeter.joot$@$gmail.com}}
%\date{\small{\today}}
%\maketitle
...
\begin{equation}\label{eqn:mp250}
\begin{aligned}
\rcap = 
\begin{bmatrix}
C_\phi S_\theta \\
...
\begin{equation}\label{eqn:mp251}
\begin{aligned}
...
\begin{equation}\label{eqn:mp260}
\begin{aligned}
\dot{\rcap} = 
\begin{bmatrix}
...
\begin{equation}\label{eqn:mp261}
\begin{aligned}
...
\begin{equation}\label{eqn:mp262}
\begin{aligned}
\Omega = 
\begin{bmatrix}
\dot{\theta} \\
...
Now the unit polar derivative \eqnref{eqn:mp260} can be factored as

\begin{subequations}
\begin{equation}\label{eqn:mp260b}
\begin{aligned}
\dot{\rcap} &= A^\T \Omega \\
A
&= 
...
\begin{subequations}
\begin{equation}\label{eqn:mp251b}
\begin{aligned}
...
%\subsection{Double spherical pendulum}
%
...
\begin{aligned}
z_k &= z_{k-1} + l_k \rcap_k \\
\rcap_k &= {A_k}^\T \dot{\BTheta}_k \\
A_k
&= 
\begin{bmatrix}
...
\begin{equation}\label{eqn:mp360}
\begin{aligned}
(\dot{z}_k - \dot{z}_{k-1})^2 = l_k^2 {\dot{\BTheta}_k}^\T A_k A_k^\T \dot{\BTheta}_k.
\end{aligned}
\end{equation}
...
\begin{subequations}
\begin{equation}\label{eqn:mp370}
\begin{aligned}
\BTheta &=
\begin{bmatrix}
\BTheta_1 \\
...
\begin{subequations}
\begin{equation}\label{eqn:mp380}
\begin{aligned}
K &=
...
\begin{equation}\label{eqn:mp390}
\begin{aligned}
\dot{\BTheta}^\T
B_k B_k^\T
\dot{\BTheta}
...
\begin{equation}\label{eqn:mp410}
\begin{aligned}
\sum_k m_k
\dot{\BTheta}^\T
B_k B_k^\T
...
\begin{subequations}
\begin{equation}\label{eqn:mp420}
\begin{aligned}
\mu_k &= \sum_{j=k}^N m_j \\
Q &=
{\begin{bmatrix}
...
After some expansion one can find that the block matrices $A_r A_c^\T$ contained in $Q$ are

\begin{equation}\label{eqn:mp430}
\begin{aligned}
...
\begin{equation}\label{eqn:mp440}
\begin{aligned}
\gpgradezeroNoOp{A_r A_r^\T}
=
\begin{bmatrix}
1 & 0 \\
0 & \sin^2 \theta_r
...
\subsubsection{Evaluating the Euler-Lagrange equations}
...
\begin{equation}\label{eqn:mp240}
\begin{aligned}
...
\begin{equation}\label{eqn:mp460}
\begin{aligned}
\grad_{\dot{\BTheta}} \LL =
{\begin{bmatrix}
\begin{bmatrix}
...
\begin{equation}\label{eqn:mp470}
\begin{aligned}
...
\begin{equation}\label{eqn:mp480}
\begin{aligned}
...
\begin{equation}\label{eqn:mp490}
\begin{aligned}
\gpgradezeroNoOp{Q} =
m l^2
\begin{bmatrix}
...
\begin{equation}\label{eqn:mp500}
\begin{aligned}
...
With back substitution of \eqnref{eqn:mp430}, and \eqnref{eqn:mp440} we have a complete and explicit matrix expansion of the left hand side.  For the right hand side taking the $\theta_a$ and $\phi_a$ derivatives respectively we get

\begin{subequations}
\begin{equation}\label{eqn:mp510}
\begin{aligned}
\PD{\theta_a}{\LL}
=
\inv{2} \dot{\BTheta}^\T
...
\end{aligned}
\end{equation}
\begin{equation}\label{eqn:mp520}
\begin{aligned}
\PD{\phi_a}{\LL}
=
\inv{2} \dot{\BTheta}^\T
...
\begin{equation}\label{eqn:mp530}
\begin{aligned}
...
\begin{equation}\label{eqn:mp540}
\begin{aligned}
\PD{\theta_a}{\LL}
&=
\sum_{k}
...
\begin{equation}\label{eqn:mp550}
\begin{aligned}
\PD{\phi_a}{\LL}
&=
\sum_{k}
...
Utilizing \eqnref{eqn:mp430}, one obtains easily

\begin{equation}\label{eqn:mp560}
\begin{aligned}
\gpgradezeroNoOp{ A_k \PD{\theta_c}{A_c}^\T }
&=
\begin{bmatrix}
...
\begin{equation}\label{eqn:mp570}
\begin{aligned}
\gpgradezeroNoOp{ A_k \PD{\phi_a}{A_a}^\T }
&=
\begin{bmatrix}
...
\begin{equation}\label{eqn:mp580}
\begin{aligned}
\grad_{\BTheta} \LL =
\sum_k
{\begin{bmatrix}
...
\begin{subequations}
\begin{equation}\label{eqn:mp420s}
\begin{aligned}
\mu_k &= \sum_{j=k}^N m_j \\
\BTheta_k &=
\begin{bmatrix}
...
\begin{equation}\label{eqn:mp580s}
\begin{aligned}
...
Making this explicit requires evaluation of some of the matrix products, and for those we found

\begin{subequations}
\begin{equation}\label{eqn:mp430s}
\begin{aligned}
\gpgradezeroNoOp{A_r A_c^\T}
&=
\begin{bmatrix}
