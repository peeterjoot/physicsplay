...
\begin{align}\label{eqn:multiPendulumSpherical2:boo60}
\Bz = 
\begin{bmatrix}
P_{\BTheta} \\
\BTheta
...
\begin{align}\label{eqn:multiPendulumSpherical2:boo64}
M \Bx' = f(\Bx)
\end{align}
...
\begin{align}\label{eqn:multiPendulumSpherical2:zoo3}
z_k &= z_{k-1} + \Be_3 l_k e^{j_k \theta_k} \\
j_k &= \Be_3 \wedge \left( \Be_1 e^{i \phi_k} \right) \\
i &= \Be_1 \wedge \Be_2
\end{align}
...
\begin{align}\label{eqn:multiPendulumSpherical2:zoo1}
\BTheta_k &=
\begin{bmatrix}
\theta_k \\
\phi_k
\end{bmatrix}
\end{align}
\begin{align}\label{eqn:multiPendulumSpherical2:zoo2}
\BTheta &=
{\begin{bmatrix}
\BTheta_1 &
\BTheta_2 &
...
\begin{align}\label{eqn:multiPendulumSpherical2:zoo4}
A_k &=
\begin{bmatrix}
\Be_1 e^{i \phi_k} e^{j_k \theta_k} \\
...
\end{bmatrix} 
\end{align}
\begin{align}\label{eqn:multiPendulumSpherical2:zoo5}
\mu_k &= \sum_{j=k}^N m_j \\
\gpgradezero{Q} &= 
{\begin{bmatrix}
...
\begin{align}\label{eqn:multiPendulumSpherical2:zoo6}
...
\begin{align}\label{eqn:multiPendulumSpherical2:zoo7}
K = 
...
\begin{align}\label{eqn:multiPendulumSpherical2:zoo8}
\grad_{\BTheta_k} &= 
\begin{bmatrix}
\PD{\theta_k}{} \\
\PD{\phi_k}{} 
...
\begin{align}\label{eqn:multiPendulumSpherical2:zoo9}
\frac{d}{dt} \grad_{\dot{\BTheta}} \LL = \grad_{\BTheta} \LL
\end{align}

For the canonical momenta we found the simple result

\begin{align}\label{eqn:multiPendulumSpherical2:zoo10}
...
\begin{align}\label{eqn:multiPendulumSpherical2:zoo11}
\grad_{\BTheta} \LL =
\sum_k
{\begin{bmatrix}
\begin{bmatrix}
...
\begin{align}\label{eqn:multiPendulumSpherical2:zoo12}
\gpgradezero{ A_k \PD{\theta_c}{A_c}^\dagger }
&=
\begin{bmatrix}
-C_{\phi_a - \phi_k} C_{\theta_k} S_{\theta_a} + S_{\theta_k} C_{\theta_a} &
...
\begin{align}\label{eqn:multiPendulumSpherical2:zoo13}
\gpgradezero{ A_k \PD{\phi_a}{A_a}^\dagger }
&=
\begin{bmatrix}
-S_{\phi_a - \phi_k} C_{\theta_k} C_{\theta_a} + S_{\theta_k} S_{\theta_a} &
