...
\begin{align}\label{eqn:sPolarMultiPendulum:noo3a}
I j' = \kappa
\end{align}
...
\begin{align}\label{eqn:sPolarMultiPendulum:noo3e}
...
\begin{align}\label{eqn:sPolarMultiPendulum:noo5b}
...
\begin{align}\label{eqn:sPolarMultiPendulum:noo20}
\LL = -\inv{2} I (j')^2 + \lambda (j^2 + 1)
\end{align}

Doing the variation we get a set of two equations

\begin{align}\label{eqn:sPolarMultiPendulum:noo21}
- I j'' &= 2 \lambda j \\
j^2 &= -1
\end{align}
...
\begin{align}\label{eqn:sPolarMultiPendulum:noo22}
e^{i\phi} = A \sin(\sqrt{I/2\lambda} t) + B \cos(\sqrt{I/2\lambda} t)
\end{align}

Setting $\lambda = 1$, $A = i$, $B = 1$, we have 

\begin{align}\label{eqn:sPolarMultiPendulum:noo23}
\phi \propto t
\end{align}
...
\begin{align}\label{eqn:sPolarMultiPendulum:roo1}
\LL = \LL(X_k, X_k')
\end{align}
...
\begin{align}\label{eqn:sPolarMultiPendulum:roo2}
...
\begin{align}\label{eqn:sPolarMultiPendulum:roo3}
...
\begin{align}\label{eqn:sPolarMultiPendulum:roo4}
...
\begin{align}\label{eqn:sPolarMultiPendulum:eoo1}
...
\begin{align}\label{eqn:sPolarMultiPendulum:eoo2}
\PD{\theta_a}{K}
=
\dot{\BTheta}^\dagger Q 
{\begin{bmatrix}
...
\begin{align}\label{eqn:sPolarMultiPendulum:eoo3}
\grad_{j_a'} K
&=
...
\begin{align}\label{eqn:sPolarMultiPendulum:eoo4}
\frac{d}{dt} \left(
\dot{\BTheta}^\dagger Q 
{\begin{bmatrix}
\delta_{ar}
...
\begin{align}\label{eqn:sPolarMultiPendulum:eoo5}
 3 \frac{d}{dt} \left(
\dot{\BTheta}^\dagger Q 
{\begin{bmatrix}
\delta_{ar}
...
\begin{align}\label{eqn:sPolarMultiPendulum:moo4}
