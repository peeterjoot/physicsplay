...
I believe that I am slowly accumulating the tools required to understand this paper.  One such tool is likely the exponential rotational generator examined in \citep{gabook:rotationGenerator}, utilizing the angular momentum operator.
...
\begin{align}\label{eqn:rotationCurrents:EOF1}
S &= \int \LL d^4 x
\end{align}
...
\begin{align}\label{eqn:rotationCurrents:EOF2}
...
\begin{align}\label{eqn:rotationCurrents:EOF3}
\delta S
&=
...
\begin{align}\label{eqn:rotationCurrents:EOF4}
\delta S
&=
...
\begin{align}\label{eqn:rotationCurrents:EOF5}
...
\begin{align}\label{eqn:rotationCurrents:EOF6}
\delta S
&=
...
\begin{align}\label{eqn:rotationCurrents:EOF7}
\PD{A_\nu}{\LL} - \partial_\mu \PD{(\partial_\mu A_\nu)}{\LL} = 0
\end{align}
...
\begin{align}\label{eqn:rotationCurrents:FieldNoeth1}
\LL' = \LL(\phi', \partial_\mu \phi')
\end{align}
...
\begin{align}\label{eqn:rotationCurrents:FieldNoeth2}
\frac{d \LL'}{d \theta}
=
...
\begin{align}\label{eqn:rotationCurrents:FieldNoeth3}
\frac{d \LL'}{d \theta}
=
...
\begin{align}\label{eqn:rotationCurrents:FieldNoeth4}
\frac{d \LL'}{d \theta}
=
...
\begin{align}\label{eqn:rotationCurrents:FieldNoeth5}
...
\begin{align}\label{eqn:rotationCurrents:FieldNoeth6}
...
\begin{align}\label{eqn:rotationCurrents:transCurrent1}
...
\begin{align}\label{eqn:rotationCurrents:transCurrent2}
...
\begin{align}\label{eqn:rotationCurrents:transCurrent3}
...
\begin{align}\label{eqn:rotationCurrents:transCurrent4}
...
\begin{align}\label{eqn:rotationCurrents:transCurrent5}
...
\begin{align}\label{eqn:rotationCurrents:transCurrent6}
...
\begin{align}\label{eqn:rotationCurrents:transCurrent7}
\frac{\delta }{\delta \phi} \Ba \cdot \spacegrad \LL
&=
...
\begin{align}\label{eqn:rotationCurrents:transCurrent8}
0 =
\partial_\alpha \left(
...
\begin{align}\label{eqn:rotationCurrents:transCurrent9}
...
\begin{align}\label{eqn:rotationCurrents:hoo1}
...
\begin{align}\label{eqn:rotationCurrents:hoo2}
...
\begin{align}\label{eqn:rotationCurrents:hoo3}
...
\begin{align}\label{eqn:rotationCurrents:hoo4}
...
\begin{align}\label{eqn:rotationCurrents:hoo5}
\overbar{T}(\grad) &=
\inv{2} \gpgradeone{ v^\beta \lrgrad \Pi_\beta + \grad (\Pi_\beta v^\beta) } - \grad \LL 
\end{align}
...
\begin{align}\label{eqn:rotationCurrents:hoo6}
...
\begin{align}\label{eqn:rotationCurrents:hoo10}
\grad \LL &= 
...
\begin{align}\label{eqn:rotationCurrents:LorTx1}
...
\begin{align}\label{eqn:rotationCurrents:LorTx2}
...
\begin{align}\label{eqn:rotationCurrents:LorTx3}
a \cdot \grad \LL
&=
\partial_\alpha \left(
\PD{(\partial_\alpha A^\beta)}{\LL} (a \cdot \grad) {A^\beta}
...
\begin{align}\label{eqn:rotationCurrents:LorTx4}
...
\begin{align}\label{eqn:rotationCurrents:LorTx5}
(i \cdot x) \cdot \grad \LL
&=
x_\nu
\partial_\alpha \left(
...
\begin{align}\label{eqn:rotationCurrents:LorTx6}
0 =
x_\nu
\partial_\alpha \left(
\PD{(\partial_\alpha A^\beta)}{\LL} \partial_\mu {A^\beta}
...
\begin{align}\label{eqn:rotationCurrents:LorTx7}
...
\begin{align}\label{eqn:rotationCurrents:LorTx8}
...
\begin{align}\label{eqn:rotationCurrents:LorTx9}
...
\begin{align}\label{eqn:rotationCurrents:LorTx10}
...
\begin{align}\label{eqn:rotationCurrents:LorTx11}
...
\begin{align}\label{eqn:rotationCurrents:LorTx12}
...
\begin{align}\label{eqn:rotationCurrents:LorTx13}
...
\begin{align}\label{eqn:rotationCurrents:LorTx14}
...
\begin{align}\label{eqn:rotationCurrents:LorTx15}
...
\begin{align}\label{eqn:rotationCurrents:LorSymExistence1}
