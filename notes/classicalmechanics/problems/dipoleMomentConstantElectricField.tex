...
\imageFigure{figures/dipoleMomentConstantElectricFieldFig1}{Dipole moment coordinates}{fig:dipoleMomentConstantElectricField:dipoleMomentConstantElectricFieldFig1}{0.3}
...
\BF_i = q_i \mathcal{E} \xcap = -\grad \phi_i = -\xcap \ddx{\phi_i}
\end{dmath}
...
\phi_1 = -q_1 \mathcal{E} \frac{r}{2} \cos\theta + \phi_0
\end{dmath}
\begin{dmath}\label{eqn:dipoleMomentConstantElectricField:160}
\phi_2 = q_2 \mathcal{E} \frac{r}{2} \cos\theta + \phi_0
\end{dmath}
\end{subequations}
...
= 
\inv{2} (m_1 + m_2) \left( \frac{r}{2} \right)^2 \thetadot^2
+q_1 \mathcal{E} \frac{r}{2} \cos\theta
-q_2 \mathcal{E} \frac{r}{2} \cos\theta
\end{dmath}
...
\LL 
= 
\inv{4} m r^2 \thetadot^2 + q r \mathcal{E} \cos\theta
\end{dmath}
...
\PD{\theta}{\LL} = -q r \mathcal{E} \sin\theta
=
\ddt{p_\theta}
=
...
F_\theta = \ddt{p_\theta} = -p \mathcal{E} \sin\theta.
\end{equation}
