...
\makesubproblem{Consider first the case of time-independent $\BA$ and $\phi$. Find the expression for the conserved energy, $\mathcal{E}$, of the particle.}{classicalMechanicsPs2:problem:1:1}
\makesubproblem{For external $\BA$ and $\phi$ dependent on time, find $d \mathcal{E}/dt$.}{classicalMechanicsPs2:problem:1:2}
...
\makesubanswer{Find $d\mathcal{E}/dt$}{classicalMechanicsPs2:problem:1:2}
...
\ddt{\mathcal{E}_{\mathrm{kin}}} = q \Bv \cdot \BE,
\end{dmath}

where $\mathcal{E}_{\mathrm{kin}} = \gamma m c^2$.  To first order, removing an additive constant, we have $\gamma m c^2 \approx m \Bv^2/2$, so everything checks out.
...
%\makesubproblem{Is energy conserved? Find the energy of the particle $\mathcal{E}$ as a function of $\Bv$, $\Br$, ... as appropriate to the case in hand.}{classicalMechanicsPs2:problem:3:4}
%
