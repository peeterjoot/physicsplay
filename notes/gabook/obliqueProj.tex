...
\date{ May 16, 2008.  Last Revision: $Date: 2008/09/19 15:38:32 $ }
...
Note that there is a freedom to remove the dot product
in \ref{eqn:projmatrix} that may not be obvious
 expressing
the entire result as in matrix form.  I did not find that this 
...
following
\href{http://www.geocities.com/peeter_joot/geometric_algebra/projection_with_matrix_comparison.pdf}{ my earlier notes comparing the geometric and matrix projection operations }.
...
\subsubsection{ Calculation efficiency. }
