...
Write out directed projection in terms of reciprocal frames.

%Reciprocal frame calculation with alternate dot products?  Want to see how to do this especially for $+,-,-,-$ metric space.

Review the questionable GA algebra reduction earlier for grade $>1$ (following equation \ref{eqn:followup}).
