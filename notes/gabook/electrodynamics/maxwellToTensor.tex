...
Since he uses the positive end of the metric for spatial indexes this works fine.  Contrast to \citep{doran2003gap} who write:
...
\begin{align*}
\grad (\grad \wedge A)
&= \grad \cdot (\grad \wedge A) + \myMathWithDescription{\grad \wedge \grad}{$=0$}{1} \wedge A \\
