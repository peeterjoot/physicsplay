...
which were solutions to \ref{eqn:em_wave:waveEquation} provided that
...
for equation \ref{eqn:em_wave:solutionTensor} to be a solution.  This is somewhat surprising since I would not have expected a symmetric tensor to fall out of
the analysis.
