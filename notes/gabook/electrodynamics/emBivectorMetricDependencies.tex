...
In equation \ref{eqn:emBiMetDep:gamma} we did not define $\Bv$, only implicitly requiring that its square was $\sum (dx^i/dt)^2$, as we require for correspondence with Euclidean meaning.  This can be made more exact by
