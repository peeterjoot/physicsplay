...
We now seek the constraints on $\Bk$, $\omega$, and $F_0$ that allow this to be a solution to \ref{eqn:gaPlaneWaveSolutions:150}
...
One can find easily that \ref{eqn:gaPlaneWaveSolutions:430} and \ref{eqn:gaPlaneWaveSolutions:450} provide the same relationship between the $\BE_0$ and $\BB_0$ components of $F_0$.  Writing out the complete expression for $F_0$ we have
