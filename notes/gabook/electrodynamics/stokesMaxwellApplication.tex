...
&= \grad \cdot (I D) \\
&= \gpgradeone{ \grad I D } \\
&= -\gpgradeone{ I (\mathWithDescription{\grad \cdot D}{1 vector}{1} + \mathWithDescription{\grad \wedge D}{3 vector}{2}) } \\
&= - I (\grad \wedge D) \\
\end{align*}
...
&=
\inv{\epsilon_0}
\mathWithDescription{{\gamma_0}^2 {\gamma_1}^2}{$=-1$}{1}
\mathWithDescription{{\gamma_2}^2 {\gamma_3}^2}{$=(\pm 1)^2$}{2}
