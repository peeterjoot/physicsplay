...
\begin{align}\label{eqn:transverseField:blah1}
\spacegrad \cdot \BE &= 0 \\
\spacegrad \cdot \BB &= 0 \\
...
\begin{align}\label{eqn:transverseField:blah2}
...
These can be further merged without any loss, into the GA first order equation for Maxwell's equation in cgs \index{cgs} units
...
&=
\pm k \zcap (-\zcap) \spacegrad_t E_z + \frac{\omega}{c} \myMathWithDescription{\gpgradeone{I \spacegrad_t \zcap}}{$-I^2 \zcap \cross \spacegrad_t$}{1} B_z \\
&=
...
\begin{align}\label{eqn:transverseField:transversePair}
...
From this the transverse electric and magnetic fields may be picked off using the projective grade selection operations of (\ref{eqn:transverseField:foo8}), and are
