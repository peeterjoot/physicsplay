...
FIXME: the following is busted.  Both $\spacegrad \cdot (I \BB)$ and $\spacegrad \wedge (I\BB)$ are malformed.
...
equation \ref{eqn:maxwellsGa:5}, to get the propagation and relativistic
corrections.
