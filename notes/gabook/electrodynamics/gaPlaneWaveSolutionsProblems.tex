...
It was claimed that equations \ref{eqn:gaPlaneWaveSolutionsProblems:430} and \ref{eqn:gaPlaneWaveSolutionsProblems:450} relating the electric and magnetic field of electrodynamic plane waves (repeated here)
...
This can be shown by crossing $\kcap$ with \ref{eqn:gaPlaneWaveSolutionsProblems:430a} and using the identity
