...
\revisionInfo{$RCSfile: stokesGradeTwo.tex,v $ Last $Revision: 1.2 $ $Date: 2009/07/19 04:14:44 $}
...
\begin{figure}[htp]
\centering
\includegraphics[totalheight=0.4\textheight]{surface_area_element}
...
\begin{figure}[htp]
\centering
\includegraphics[totalheight=0.4\textheight]{volume_element}
...
These are the surfaces of constant parameterization, respectively, $\sigma = \sigma_0$, $\alpha = \alpha_1$, and $\beta = \beta_1$.  For a bivector, the flux through the surface is therefore
