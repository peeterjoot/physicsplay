...
are both real numbers, we have seen for the electric and magnetic fields that we do not get scalars from the Hermitian conjugates, instead get a spatial vector where we'd get a real number in complex arithmetic.  Similarly we get a (bi)vector in the dual
