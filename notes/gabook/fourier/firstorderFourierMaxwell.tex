...
Will the computation of $\FF^{-1}(\FF(f(x)))$ produce $f(x)$?  Let us try
...
Let us also expand the integral completely, employing a permutation of indexes $\pi(1,2,3) = (m,n,p)$.
