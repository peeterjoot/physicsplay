...
\author{Peeter Joot}
\date{ Jan 01, 2009.  Last Revision: $Date: 2009/01/02 04:34:57 $ }
...
&= a^\alpha \gamma_\beta \left(T(\gamma_\alpha) \cdot \gamma^\beta \right) \\
\end{align*}

It's this last bit that has the form of a traditional tensor, so we can write

\begin{align}
T(a) &= a^\alpha \gamma_\beta {T_\alpha}^{\beta} \\
...
%&=
%(
%  \gamma^{a} {\delta^{b}}_{d} {\delta^{\alpha}}_{c}
%- \gamma^{a} {\delta^{\alpha}}_{d} {\delta^{b}}_{c}
%+ \gamma^{b} {\delta^{\alpha}}_{d} {\delta^{a}}_{c}
%- \gamma^{b} {\delta^{a}}_{d} {\delta^{\alpha}}_{c}
%+ \gamma^{\alpha} {\delta^{a}}_{d} {\delta^{b}}_{c}
%- \gamma^{\alpha} {\delta^{b}}_{d} {\delta^{a}}_{c}
%)
%\\
&=
  \gamma^{a} ({\delta^{b}}_{d} {\delta^{\alpha}}_{c}
-            {\delta^{\alpha}}_{d} {\delta^{b}}_{c})
+ \gamma^{b} ({\delta^{\alpha}}_{d} {\delta^{a}}_{c}
-            {\delta^{a}}_{d} {\delta^{\alpha}}_{c})
+ \gamma^{\alpha} ({\delta^{a}}_{d} {\delta^{b}}_{c}
...
\begin{align*}
\partial^{c} A^{d} &(((\gamma^{a} \wedge \gamma^{b}) \wedge \gamma^{\alpha}) \cdot \gamma_{c} ) \cdot \gamma_{d} \\
&=
  \partial^{\alpha} A^{b} \gamma^{a}
- \partial^{b} A^{\alpha} \gamma^{a}
+ \partial^{a} A^{\alpha} \gamma^{b}
- \partial^{\alpha} A^{a} \gamma^{b}
+ \partial^{b} A^{a} \gamma^{\alpha}
- \partial^{a} A^{b} \gamma^{\alpha}
\\
&=
(  \partial^{\alpha} A^{b}
- \partial^{b} A^{\alpha} ) \gamma^{a}
...
\\
&=
%(  \partial^{\alpha} A^{b} - \partial^{b} A^{\alpha} )
F^{\alpha b}
\gamma^{a}
+
%( \partial^{a} A^{\alpha} - \partial^{\alpha} A^{a} )
F^{a \alpha}
\gamma^{b}
+
...
\begin{align*}
((\grad \wedge A) \wedge \gamma_\alpha) \cdot (\grad \wedge A) &=
(\gamma_\alpha)^2 \partial_{a} A_{b}
(
  F^{\alpha b} \gamma^{a}
+ F^{a \alpha} \gamma^{b}
+ F^{b a} \gamma^{\alpha}
...
&=
  (\gamma_\alpha)^2 \partial_{b} A_{a} F^{\alpha a} \gamma^{b}
+ (\gamma_\alpha)^2 \partial_{a} A_{b} F^{a \alpha} \gamma^{b}
+ (\gamma_\alpha)^2 \partial_{a} A_{b} F^{b a} \gamma^{\alpha}
\\
&=
  F^{b a} F_{\alpha a} \gamma_{b}
...
This can now be dotted with $\gamma^\beta$,

\begin{align*}
((\grad \wedge A) \wedge \gamma_\alpha) \cdot (\grad \wedge A) \cdot \gamma^\beta
&=
 F^{b a} F_{\alpha a} {\delta_{b}}^\beta
+ \partial_{a} A_{b} F^{b a} {\delta_{\alpha}}^\beta
\\
%&= F^{\beta a} F_{\alpha a} + \inv{2} F_{a b} F^{b a} {\delta_{\alpha}}^\beta \\
\end{align*}
...
((\grad \wedge A) \wedge \gamma_\alpha) \cdot (\grad \wedge A) \cdot \gamma^\beta
&= F^{\beta a} F_{\alpha a} + \inv{2} F_{a b} F^{b a} {\delta_{\alpha}}^\beta
%F^{\beta b} F_{\alpha b} +\inv{2} F_{a b} F^{b a} {\delta_{\alpha}}^\beta
\end{align}
...
\begin{align*}
(F \gamma_\alpha F ) \cdot \gamma^\beta
&=
