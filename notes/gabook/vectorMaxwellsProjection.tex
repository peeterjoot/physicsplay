...
\title{Vector forms of Maxwell's equations as projection and rejection operations.} % Declares the document's title.
\author{Peeter Joot}         % Declares the author's name.
\date{ Sept 9, 2008.  Last Revision: $Date: 2008/09/11 13:06:54 $ } % Deleting this command produces today's date.
...
FIXME: have used $i$ here as a pseudoscalar and an index depending on context.  Switch to $I$ instead for the pseudoscalar for clarity.
...
{\gamma^{\mu}}_{i 0} \in \Span \{ \gamma_{\mu}, \gamma_{0ij} \}
\end{equation}
...
the span of equation \ref{eqn:spanpartialE}.  Similarily the magnetic partials
...
\begin{equation}\label{eqn:guasselectro}
...
\begin{equation}\label{eqn:guassmagnet}
...
which we can put in the projection form of equation \ref{eqn:guasselectro} and equation \ref{eqn:guassmagnet} as:
