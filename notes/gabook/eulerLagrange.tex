...
%Observe that for a single particle Lagrangian with a position (non-velocity dependent potential $V$)
%... corresponds to the total energy 
%FIXME: work through examples here to get a feel for this.
