...
\[
\Bx \wedge \dcap + \alpha \mathWithDescription{\dcap \wedge \dcap}{$=0$}{1} = \beta \pcap \wedge \dcap
\]
\[
\implies
...
\begin{equation*}
\Bx \wedge P + \alpha \BD \wedge P = \sum_{i=1}^k \beta_i \mathWithDescription{\BP_i \wedge P}{$=0$}{1}
\end{equation*}
...
\begin{align*}
\Bx \cdot \BP^i
&= \mathWithDescription{\Be \cdot \BP^i}{$=0$}{1} + \sum \beta_j \BP_j \cdot \BP^i \\
