...
\date{ Mar 17, 2008.  Last Revision: $Date: 2009/05/31 21:48:43 $ }

\begin{document}             % End of preamble and beginning of text.

\maketitle{}

\section{ Angle between geometric elements. }

Have the calculation for the angle between bivectors done elsewhere

\begin{equation}\label{eqn:bivectorangle}
...
\begin{equation}\label{eqn:vectorangle}
...
Restated for consistency with equations \ref{eqn:vectorangle} and \ref{eqn:bivectorangle} in terms of not necessarily 
