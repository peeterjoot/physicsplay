...
\date{ May 30, 2009.  Last Revision: $Date: 2009/05/31 04:12:28 $ }
...
For a Euclidean space where each of the ${e_k}^2 = 1$, we have ${i_4}^2 = 1$, but for a Minkowski space where one would have for $k\ne0$, ${e_0}^2 {e_k}^2 = -1$, we have $i^2 = -1$
