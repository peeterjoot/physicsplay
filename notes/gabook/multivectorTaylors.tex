...
\date{ April 28, 2009.  Last Revision: $Date: 2009/04/28 14:16:51 $ }
...
\begin{align}
(\epsilon \cdot \spacegrad) f(x) &= \lim_{h \rightarrow 0} \frac{f(x + h \epsilon) - f(x)}{h}
\end{align}

Observe that this defintion as a limit avoids the requirement to define the gradient upfront, something not neccessarily 
