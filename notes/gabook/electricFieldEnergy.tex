...
\title{ Electrostatic field energy. }
\author{Peeter Joot}
\date{ Jan 03, 2009.  Last Revision: $Date: 2009/01/03 18:35:14 $ }
...
%\tableofcontents
\section{ Field and wave energy and momentum. }
...
\subsection{ Electrostatic energy in a field. } 
...
Now, Feynman's last step was a bit sneaky, which was to convert the $\phi \spacegrad^2 \phi$ term into a divergence integral.  Working backwards to derive the identity that he used we want to calculate
...
So we can employ Stokes theorem in its dual form to convert this into a $\spacegrad^2$ term and a surface integral term
\begin{align*}
W 
