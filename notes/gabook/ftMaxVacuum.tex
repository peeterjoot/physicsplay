...
\begin{align}
\spacegrad \cdot \BA &= \text{constant} \\
\inv{c^2} \partial_{tt} \BA - \spacegrad^2 \BA &= 0.
\end{align}
\end{subequations}
...
Let's consider Maxwell's equations in all three forms, \label{eqn:ftMaxVacuum:26}, \label{eqn:ftMaxVacuum:28b}, and \label{eqn:ftMaxVacuum:29} and apply these constraints to the assumed Fourier solution.
