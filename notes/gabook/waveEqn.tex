...
\date{ Nov 30, 2008.  $RCSfile: waveEqn.tex,v $ Last $Revision: 1.8 $ $Date: 2009/06/11 16:45:58 $ }

\section{Mechanical Wave equation Solutions. }

For the unforced wave equation in 3D one wants solutions to

\begin{align}\label{eqn:wave_eqn:waveEquation}
...
Lets try the following as a possible solution to \ref{eqn:wave_eqn:waveEquation}
