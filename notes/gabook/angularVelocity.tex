...
This follows Salas/Hille's treatment, modified for the GA notation.
...
The first of these equations is the result from Salus and Hille (integration constant differs in sign though).
...
%Diverging from the Salus and Hille treatment, instead of producing a scalar
