...
\date{July 30, 2009}
\revisionInfo{$RCSfile: transverseField.tex,v $ Last $Revision: 1.8 $ $Date: 2009/08/01 17:58:43 $}
...
A less exploratory summary of the previous results above is called for.  In the CGS units our field $F$, and Maxwell's equation (in absence of charge and current), take the form
...
\begin{align}\label{eqn:summaryMax2}
...
Multiplication of both the numerator and denominator by the conjugate normalizes this.  Finally, the transverse electric and magnetic fields can be picked off using the projective grade selection operations of (\ref{eqn:foo8}).
