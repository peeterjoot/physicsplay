...
\date{July 30, 2009}
\revisionInfo{$RCSfile: transverseField.tex,v $ Last $Revision: 1.10 $ $Date: 2009/08/01 22:10:07 $}
...
\begin{align}\label{eqn:summaryTransverseBoth}
F_t &= \frac{i}{k^2 - \mu\epsilon\frac{\omega^2}{c^2}} \left( \pm k \zcap + \sqrt{\mu\epsilon}\frac{\omega}{c}\right) \spacegrad_t F_z
\end{align}

From this the transverse electric and magnetic fields may be picked off using the projective grade selection operations of (\ref{eqn:foo8}), and are

\begin{align}\label{eqn:SummaryTransversePair}
\BE_t &= \frac{i}{\mu\epsilon\frac{\omega^2}{c^2} -k^2} \left( \pm k \spacegrad_t E_z - \frac{\omega}{c} \zcap \cross \spacegrad_t B_z \right) \\
