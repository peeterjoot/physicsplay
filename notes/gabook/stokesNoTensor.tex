...
\revisionInfo{$RCSfile: stokesNoTensor.tex,v $ Last $Revision: 1.6 $ $Date: 2009/07/23 03:51:36 $}
...
Similarily for even grade blades we have
...
the orientation of the fourspace volume element and the boundary normal is defined in terms of the parameterization, the duality relations and our explicit expansion of the 4D stokes boundary integral above.
