...
It's not obvious that the RHS of this equation is a vector and not a multivector, especially when the vector $\Bx$ lies in \R{3} or higher dimensional space.  To get a feel for this, let's start by write this out in components for $\ncap = \Be_1$ and $p=2$.  We obtain for the product term
