...
%\section{ Repeat: As on paper. }
%\subsubsection{ zero divergence }
%
%\begin{align}\label{eqn:testSol2}
%F = \gamma^\mu \wedge \gamma^\nu \left( K_{\mu\nu} f( x \cdot K_\nu ) -K_{\nu\mu} f( x \cdot K_\mu ) \right)
%\end{align}
%
%So, let's substitute equation \ref{eqn:testSol2} and see what comes out, starting with the zero divergence equation
%
%\begin{align*}
%\grad \cdot F 
%&= \gamma^\alpha \cdot
...
%\left( K_{\mu\nu} f( x \cdot K_\nu ) -K_{\nu\mu} f( x \cdot K_\mu ) \right) \\
%&= 
%(\gamma_\mu)^2 \gamma^\nu \left( K_{\mu\nu} K_{\nu\mu} f'( x \cdot K_\nu ) -K_{\nu\mu} K_{\mu\mu} f'( x \cdot K_\mu ) \right) 
%-(\gamma_\nu)^2 \gamma^\mu \left( K_{\mu\nu} K_{\nu \nu} f'( x \cdot K_\nu ) -K_{\nu\mu} K_{\mu \nu} f'( x \cdot K_\mu ) \right) \\
%&= 
%2 (\gamma_\mu)^2 \gamma^\nu \left( K_{\mu\nu} K_{\nu\mu} f'( x \cdot K_\nu ) -K_{\nu\mu} K_{\mu\mu} f'( x \cdot K_\mu ) \right) \\
%\end{align*}
%
%%\begin{align*}
%%\partial_\mu ( x \cdot K_\beta ) = K_{\beta\mu}
%%\partial_\nu ( x \cdot K_\beta ) = K_{\beta\nu}
%%\end{align*}
%
%% FIX:
%%\begin{align*}
...
%%\partial_\alpha ( x \cdot K_\beta ) &= K_{\beta\alpha}
%\left( \gamma^\alpha \wedge \gamma^\mu \wedge \gamma^\nu\right)
%\left( K_{\mu\nu} K_{\nu\alpha} f'( x \cdot K_\nu ) -K_{\nu\mu} K_{\mu\alpha} f'( x \cdot K_\mu ) \right) \\
%% FIX:
%%&= 2\left( \gamma^\alpha \wedge \gamma^\mu \wedge \gamma^\nu\right) K_{\mu\nu} K_{\mu\alpha} f'( x \cdot K_\mu ) \\
%\end{align*}
%
