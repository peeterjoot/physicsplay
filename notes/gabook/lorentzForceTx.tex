...
%
%From the commutation relation (definition) we have
%
%\begin{align*}
%\vcap x_\parallel &= x_\parallel \vcap \\
%u \gamma_0 x_\parallel &= x_\parallel u \gamma_0 \\
%- \gamma_0 u x_\parallel &= 
%\end{align*}
%
%So we have
%\begin{align}
%u x_\parallel &= -\gamma_0 x_\parallel u \gamma_0 
%\end{align}
%
%With this we can compute the dot and wedge products
%
%\begin{align*}
%2 x_\parallel \cdot u 
%&= x_\parallel u  + u x_\parallel \\
%&= x_\parallel u  -\gamma_0 x_\parallel u \gamma_0  \\
%&= x_\parallel u \gamma_0 \gamma_0 -\gamma_0 x_\parallel u \gamma_0  \\
%&= ( -x_\parallel \gamma_0 -\gamma_0 x_\parallel ) u \gamma_0 
%\end{align*}
%%2 x_\parallel \wedge u &= ( -x_\parallel \gamma_0 +\gamma_0 x_\parallel ) u \gamma_0 
%
%From this, and a similar computation for the wedge product we have
%\begin{align}
%%x_\parallel \cdot u &= - ( x_\parallel \cdot \gamma_0 ) \vcap \\
%%x_\parallel \wedge u &= - ( x_\parallel \wedge \gamma_0 ) \vcap 
%x_\parallel \cdot u &= ( x_\parallel \cdot \gamma_0 ) \gamma_0 u \\
%x_\parallel \wedge u &= ( x_\parallel \wedge \gamma_0 ) \gamma_0 u  
%\end{align}
%
%Inserting back into \ref{eqn:blah} we have
%
%\begin{align*}
%L(x)
%&= x_\perp  \\
%&+ \left(x_\parallel \wedge \gamma_0 \right) \gamma_0 \cosh\alpha 
%- \left(x_\parallel \cdot \gamma_0 \right) u \sinh\alpha  \\
%&+ (x_\parallel \cdot \gamma_0)\gamma_0 \cosh\alpha 
%- \left(x_\parallel \wedge \gamma_0 \right) u \sinh\alpha
%\end{align*}
