...
\title{}
\author{Peeter Joot}
\date{ Mmm dd, 2009.  Last Revision: $Date: 2009/01/18 04:55:25 $ }
...
\begin{align}
0 = \partial_0 (\BB \wedge \BE) + (\spacegrad \wedge \BE) \cdot \BE + (\spacegrad \wedge \BB) \cdot \BB + \BB \wedge \Bj
\end{align}
...
\begin{itemize}
\item Put this in traditional vector form.
