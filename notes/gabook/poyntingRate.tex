...
\author{Peeter Joot}
\date{ Jan 18, 2009.  Last Revision: $Date: 2009/01/18 20:05:02 $ }
...
Can we express these in terms of a gradient of squared terms?  We have such $\BE^2$ and $\BB^2$ terms in the energy so it would make some logical sense if this
could be done.

%This has a natural symmetric to it that one can expect to be tidyupable.
