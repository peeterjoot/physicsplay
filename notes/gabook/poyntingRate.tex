...
\author{Peeter Joot}
\date{ Jan 18, 2009.  Last Revision: $Date: 2009/01/19 13:26:51 $ }
...
\begin{align*}
\inv{c^2}\PD{t}{\BP} &+ (\Bj \cross \BB + \rho \BE) 
= \\
&{\epsilon_0} \left( 
\BE \cdot (\spacegrad \wedge \BE) + \BE (\spacegrad \cdot \BE) 
+ c^2 \BB \cdot (\spacegrad \wedge \BB) 
...
FIXME: decided that I wanted the signs of $\BT_k$ to have the energy term positive, and hacked things up above.  It should be all correct, but the 
sign placement is not all natural.
