...
&= \gpgradezero{T^\dagger v' \cdot w' T} + \mathWithDescription{\gpgradezero{T^\dagger v' \wedge w' T}}{$=0$}{1} \\
...
&= \mathWithDescription{\gpgradetwo{T^\dagger v' \cdot w' T}}{$=0$}{1} + \gpgradetwo{T^\dagger v' \wedge w' T} \\
