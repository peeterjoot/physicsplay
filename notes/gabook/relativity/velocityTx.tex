...
&= \gpgradezero{T^\dagger v' \cdot w' T} + \mathLabelBox{\gpgradezero{T^\dagger v' \wedge w' T}}{$=0$} \\
...
&= \mathLabelBox{\gpgradetwo{T^\dagger v' \cdot w' T}}{$=0$} + \gpgradetwo{T^\dagger v' \wedge w' T} \\
