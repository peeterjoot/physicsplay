...
&= \gpgradezero{T^\dagger v' \cdot w' T} + \myMathWithDescription{\gpgradezero{T^\dagger v' \wedge w' T}}{$=0$}{1} \\
...
&= \myMathWithDescription{\gpgradetwo{T^\dagger v' \cdot w' T}}{$=0$}{1} + \gpgradetwo{T^\dagger v' \wedge w' T} \\
