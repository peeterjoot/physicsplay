...
\author{Peeter Joot}
\date{ Jan 19, 2009.  Last Revision: $Date: 2009/01/21 15:10:40 $ }
...
FIXME: all wrong from here with extra factors of $2\pi$ all over the place.
Write up notebook page and correct everything below.
...
Now, it's not exactly clear to me how to translate this linear solution to the
wave equation for a particle on a circle.  In particular would you make the initial function $f$ zero or periodic?  How about the integration bounds?  Also of interest is to understand how a solution of this form relates to the bra ket
