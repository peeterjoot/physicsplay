...
\gpgradezero{ \grad f } \\
&=
-\gpgradezero{ \grad i (\mathWithDescription{i f}{grade 3}{1}) } \\
&=
\gpgradezero{ i \grad (i f) } \\
%&=
%\gpgradezero{ i ( \grad \cdot (i f) + \grad \wedge (i f) ) } \\
&=
\gpgradezero{ i ( \mathWithDescription{\grad \cdot (i f)}{grade 2}{2} + \mathWithDescription{\grad \wedge (i f)}{grade 4}{3} ) } \\
&=
i (\grad \wedge (i f)) \\
\end{align*}
