...
\gpgradezero{ \grad f } \\
&=
-\gpgradezero{ \grad i (\myMathWithDescription{i f}{grade 3}{1}) } \\
&=
\gpgradezero{ i \grad (i f) } \\
%&=
%\gpgradezero{ i ( \grad \cdot (i f) + \grad \wedge (i f) ) } \\
&=
\gpgradezero{ i ( \myMathWithDescription{\grad \cdot (i f)}{grade 2}{2} + \myMathWithDescription{\grad \wedge (i f)}{grade 4}{3} ) } \\
&=
i (\grad \wedge (i f)) \\
\end{align*}
