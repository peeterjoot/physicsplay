...
Here the indexes have the range $\{r, s, \cdots, t, u\} \in \{1, 2, \cdots k\}$.  This with the definitions \eqnref{eqn:stokesNoTensor:oneForm}, and \eqnref{eqn:stokesNoTensor:volumeElement} is really Stokes theorem in its full glory.
