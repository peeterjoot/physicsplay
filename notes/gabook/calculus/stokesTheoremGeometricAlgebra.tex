...
\begin{equation}\label{eqn:stokesTheoremGeometricAlgebra:5790}
...
We will see that Green's theorem is a special case of the Curl (Stokes) theorem.  This observation will also provide a geometric interpretation of the right hand side area integral of \cref{thm:stokesTheoremGeometricAlgebra:1660}, and allow for a coordinate free representation.
...
It may be useful to formulate the curl integrals in tensor form.  For vectors $\Bf$, and bivectors $B$, the coordinate representations of those differential forms (\cref{pr:stokesTheoremGeometricAlgebra:1}) are
