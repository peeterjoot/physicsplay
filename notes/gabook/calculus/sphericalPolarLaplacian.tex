...
We will need the partials.  Most of these can be computed from \ref{eqn:sphericalPolarLaplacian:205} by inspection, and are
...
It is simple to verify that this is identical to \ref{eqn:sphericalPolarLaplacian:400}.
