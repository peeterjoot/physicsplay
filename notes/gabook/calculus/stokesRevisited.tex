...
\imageFigure{figures/parallelogram_parameterized}{Two variable parametrization of \R{n} parallelogram}{fig:parallelogram}{0.4}
...
\imageFigure{figures/parallelopiped_parameterized}{Three variable parametrization of \R{n} parallelepiped}{fig:parallelepiped}{0.4}
...
%\myMathWithDescription{\PD{u_1}{x^{j_1}} \cdots \PD{u_k}{x^{j_{k-1}}}}{$\partial_{u_i}$ \,omitted}{1}
...
After nicely arranging the $m_i$ indexes to match equation \ref{eqn:stokesR:curldot}, the partials do not match.  Perhaps about a change of variables:
\begin{align*}
m_1 &= n_i \\
m_k &= n_1 \\
m_{k-1} &= n_2 \\
