...
In \chapcite{PJ4dFourier} a 4D Fourier transform solution of Maxwell's equation yielded a Green's function of the form
...
\imageFigure{figures/tangent_area_form}{Tangent vector along curves of parametrized vector}{fig:tangent_area_form}{0.4}
...
\begin{align*}
\Br 
&= \gamma_0 (\cosh \phi - \sinh\phi (\myMathWithDescription{\sigma_1 \cos\psi + \sigma_2 \sin\psi}{spatial vector parametrization of circle}{1}) ) \\
\end{align*}
