...
\date{ Feb 1, 2009.  $RCSfile: 4dFourier.tex,v $ Last $Revision: 1.12 $ $Date: 2009/06/11 16:45:58 $ }

\section{Notation. }

Please see \ref{eqn:4d_fourier:notation} below for a summary of prerequisite notation used here.

\section{Motivation. }

In \ref{chap:PJfirstOrderMaxwell}, a solution of the first order Maxwell equation
...
Similarly, in \ref{chap:PJfourierMaxwellSecondOrder} solutions of the second order Maxwell equation in the Lorentz gauge
$\grad \cdot A = 0$ 
...
FIXME: In \ref{chap:PJpoisson} I worked through how to evaluate such an integral
...
English indexes range over $1,2,3$.  Bold vectors are spatial entities and non-bold is used for four vectors and scalars.
...
\begin{equation*}\label{eqn:4d_fourier:notation}
\begin{array}{l l l}
