...
\author{Peeter Joot}
\date{ Dec 27, 2008.  Last Revision: $Date: 2008/12/28 06:08:58 $ }
...
Bohm writes maxwell's equations in non-SI units, and also, naturally, not in STA form which would be somewhat more natural for a guage
discussion.
...
Now how about the guage variations of the fields?  Bohm writes that we can alter the potentials by
...
Now, Bohm says he wants to pick $\spacegrad \cdot \Ba' = 0$, and requires

\begin{align*}
\spacegrad \cdot \Ba - \spacegrad^2 \psi = 0
\end{align*}

to do so?  FIXME: continue from here.
