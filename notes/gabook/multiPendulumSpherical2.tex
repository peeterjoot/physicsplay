...
\date{Nov 4, 2009}
\revisionInfo{$RCSfile: multiPendulumSpherical2.tex,v $ Last $Revision: 1.9 $ $Date: 2009/11/07 09:52:52 $}
...
FIXME: expand this here.  Can then work with regular old scalars for the rest of the problem.
...
FIXME: gut this.  Work with $Q$ and $\gpgradezero{Q}$ instead.  This will mean that we want $\partial_k A_a A_b^\dagger$ derivatives instead.
