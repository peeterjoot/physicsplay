...
\date{Nov 4, 2009}
\revisionInfo{$RCSfile: multiPendulumSpherical2.tex,v $ Last $Revision: 1.10 $ $Date: 2009/11/07 18:04:40 $}
...
\end{bmatrix}}_{rc} 
%\inv{2} \sum_{k=1}^N m_k
%\left( \PD{\theta_a}{B_k} B_k^\dagger + B_k \PD{\theta_a}{B_k^\dagger } \right)
\dot{\BTheta}
