...
\date{Nov 4, 2009}
\revisionInfo{$RCSfile: multiPendulumSpherical2.tex,v $ Last $Revision: 1.16 $ $Date: 2009/11/08 23:12:57 $}
...
FIXME: some of this below based on earlier attempt, but I don't trust it all.  Redo on paper, verify, and finalize the result.
