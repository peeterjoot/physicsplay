...
\date{Nov 4, 2009}
\revisionInfo{$RCSfile: multiPendulumSpherical2.tex,v $ Last $Revision: 1.18 $ $Date: 2009/11/09 17:40:40 $}
...
Can the $\BTheta_a$ matrices be factored out?  How to do that is not obvious.
