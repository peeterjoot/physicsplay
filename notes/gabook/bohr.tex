\chapter{Bohr Model.}
\label{chap:bohr}
\date{ Dec 11, 2008.  $RCSfile: bohr.tex,v $ Last $Revision: 1.10 $ $Date: 2009/10/22 02:07:20 $ }
...
the angular momentum example from \chapcite{PJEulerLagrange} (which was done for the more general case of any radial potential), we 
