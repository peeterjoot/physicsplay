...
%\date{ Dec 21, 2008.  Last Revision: $Date: 2009/06/02 04:32:03 $ }
...
Ah ha!  Recalling the conjugation results from \cite{PJDiracGamma}, one sees that this sandwich operation is in fact just the equivalent of the conjugate operation on Dirac matrix algebra elements.  So we can write
