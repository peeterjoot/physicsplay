...
\title{ Lorentz Gauge Fourier Vacuum potential solutions. }
\author{Peeter Joot \quad peeter.joot@gmail.com}
\date{ Feb 07, 2009.  Last Revision: $Date: 2009/02/22 15:11:52 $ }
...
In \cite{PJFourierVacuum} a first order Fourier solution of the Vacuum
...
in the original notes \cite{PJFourierVacuum}.  Also included there is a
...
This, somewhat suprisingly, is strikingly similar to what we had for the bivector field.  That was:
...
A consequense of working in the Lorentz gauge ($\grad \cdot A = 0$) is that our field solution should be a gradient
