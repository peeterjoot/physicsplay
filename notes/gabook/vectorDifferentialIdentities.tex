...
\date{ Jan 05, 2009.  $RCSfile: vectorDifferentialIdentities.tex,v $ Last $Revision: 1.10 $ $Date: 2009/06/15 00:48:32 $ }
...
Now, let's expand this quantity
\begin{align*}
\spacegrad \cdot (\spacegrad \wedge \Bh)
\end{align*}
...
for \R{3}.  However, this also allows starting with the simpler \R{2} case, so let's do that one first.
...
%sign intrinsically related to the curl.  That's been explored in \ref{chap:PJStokes1}, and \ref{chap:PJStokes2}, and intuitively one expects that
...
%\end{align*}
%
%... this doesn't seem right.  Think it through better.
%
...
Equation \ref{eqn:vecDiffIdent:blah} becomes
\begin{align*}
