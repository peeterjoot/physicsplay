...
\author{Peeter Joot}
\date{ Jan 31, 2009.  Last Revision: $Date: 2009/01/31 21:55:09 $ }
...
\section{ Fourier transforming the gradient equation. }
...
\partial_0 \hat{F} + \Bk i \hat{F} &= \gamma_0 \hat{J}/ \epsilon_0 c
\end{align}

Observe that we have commuted $i = \gamma_0 \gamma_1 \gamma_2 \gamma_3$ with $\hat{F}$ in the transition from the general equation
\ref{eqn:waveDomainGeneral}.  This is possible in this case since $F$ and its Fourier transform is a grade two STA object so we have
two sign interchanges in the commutation process.
