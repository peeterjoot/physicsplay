...
\date{ April 11, 2008.  Last Revision: $Date: 2009/05/31 18:27:11 $ }
...
When the $A^\T A$ matrix of equation \ref{eqn:AtA} is invertible that inverse can be written using a cofactor matrix (adjoint expansion):
