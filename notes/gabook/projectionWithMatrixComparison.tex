...
\Bx 
&= \Bv \inv{\Bv} \Bx \\
&= \Bv (\inv{\Bv} \cdot \Bx) + \Bv (\inv{\Bv} \wedge \Bx) \\
&= \Bv (\underbrace{\frac{\Bv}{\Bv^2} \cdot}_{\frac{\Bv^\T}{\Bv^\T \Bv}} \Bx) + \Bv (\frac{\Bv}{\Bv^2} \wedge \Bx) \\
\end{align*}

We can therefore describe the moore penrose vector left inverse as the matrix of the GA linear transformation $\inv{\Bv} \cdot$.
