...
%, which I don't have.
%However, if I can't explain the ideas to myself, or write them up in a way that I feel would explain to others, then I obviously don't understand them sufficiently.
...
\imageFigure{figures/Projection_line}{Projection onto line}{fig:Projection_line}{0.4}
...
\imageFigure{figures/Projection_plane}{Projection onto plane}{fig:Projection_plane}{0.4}
