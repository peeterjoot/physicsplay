...
\author{Peeter Joot}
\date{ Feb 08, 2009.  Last Revision: $Date: 2009/02/09 19:21:00 $ }
...
%FIXME: think I messed up with search and replace here: redo.
%Swapping some free index and integration variables, and 
...
%\int 
%\left(
%e^{i \Bm \cdot (\Bb-\Bx) - i \Bk \cdot (\Ba-\Bx) } F(\Bb, 0) \gamma_0 F(\Ba, 0) \gamma_0 
%+ e^{- i \Bm \cdot (\Bb-\Bx) + i \Bm \cdot (\Ba-\Bx) } \gamma_0 F(\Bb, 0) \gamma_0 F(\Ba, 0) 
%\right)
%d^3 a d^3 b \\
\end{align*}
