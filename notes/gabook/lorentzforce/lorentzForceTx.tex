...
&=
\left( \mathLabelBox{\EE_\parallel' -\Vcap (\EE_\parallel' \cdot \Vcap)}{$\EE_\parallel' - \EE_\parallel'$} \right)
+\EE_\perp'
-\gamma \left( \mathLabelBox{\EE_\parallel - \Vcap (\EE_\parallel' \cdot \Vcap)}{$\EE_\parallel - \EE_\parallel$} \right)
-\gamma \EE_\perp
+ \gamma (\HH_\perp \cross \BV/c) \\
\end{align*}
