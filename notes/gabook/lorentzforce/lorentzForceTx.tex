...
&=
\left( \mathWithDescription{\EE_\parallel' -\Vcap (\EE_\parallel' \cdot \Vcap)}{$\EE_\parallel' - \EE_\parallel'$}{1} \right)
+\EE_\perp'
-\gamma \left( \mathWithDescription{\EE_\parallel - \Vcap (\EE_\parallel' \cdot \Vcap)}{$\EE_\parallel - \EE_\parallel$}{2} \right)
-\gamma \EE_\perp
+ \gamma (\HH_\perp \cross \BV/c) \\
\end{align*}
