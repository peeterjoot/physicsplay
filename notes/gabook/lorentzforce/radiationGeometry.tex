...
\begin{align}\label{eqn:radiationGeometry:fooc3}
...
With this split, noting that $\zcap G_t = -G_t \zcap$, and $\zcap G_z = G_z \zcap$ a rearrangement of (\ref{eqn:radiationGeometry:fooc6}) produces
