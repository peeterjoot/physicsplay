...
&= v^0 \sum E^i \gamma_{i} + \sum E^i v^{j} \mathLabelBox{\gpgradeone{ \gamma_{i0j}}}{$-\delta_{ij} \gamma_0$} \\
...
\frac{dp_0}{d\tau} &= \mathLabelBox{\frac{dt}{d\tau}}{$v/c \cdot \gamma_0$} q\BE \cdot \left( \frac{v \wedge \gamma_0}{v \cdot \gamma_0} \right) \\
