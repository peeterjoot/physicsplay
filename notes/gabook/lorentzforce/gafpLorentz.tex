...
&= v^0 \sum E^i \gamma_{i} + \sum E^i v^{j} \myMathWithDescription{\gpgradeone{ \gamma_{i0j}}}{$-\delta_{ij} \gamma_0$}{1} \\
...
\begin{align*}
(I \BB) \cdot v
&= \left(\sum B^i \myMathWithDescription{\gamma_{102030i0}}{$\gamma_{123i}$}{1} \right) \cdot \left( \sum v^{\mu} \gamma_{\mu} \right) \\
...
\frac{dp_0}{d\tau} &= \myMathWithDescription{\frac{dt}{d\tau}}{$v/c \cdot \gamma_0$}{1} q\BE \cdot \left( \frac{v \wedge \gamma_0}{v \cdot \gamma_0} \right) \\
