...
\date{Sept 24, 2009}
\revisionInfo{$RCSfile: jackson12Dash1Gauge.tex,v $ Last $Revision: 1.4 $ $Date: 2009/10/21 03:35:59 $}

%\beginArtWithToc
\beginArtNoToc

At the end of section 12.1 in Jackson \cite{jackson1975cew} he states that it is obvious that the Lorentz force equations are gauge invariant.
