...
\author{Peeter Joot}
\date{ October 10, 2008.  Last Revision: $Date: 2008/10/12 03:31:30 $ }
...
for convience $\kappa = -\epsilon_0 c /2$ this is
...
It appears that there's a cancellation of $\sigma$ terms possible in that last term above too.
Observe that the original Lagrangian of \ref{eqn:maxlag}, 
...
Because of this that bivector product can be commuted
