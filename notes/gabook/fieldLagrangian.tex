...
\author{Peeter Joot}
\date{ October 10, 2008.  Last Revision: $Date: 2008/12/03 02:34:40 $ }
...
treating $\psi$, and $\psi^\conj$ as separate fields and show that Schroedinger's equation and its conjugate follows.  (note: I've added a 1/2 fact in the
...
\subsection{ Relativistic Schroedinger's equation. }

The wiki article on Noether's theorem lists the relativistic quantum Lagrangian as
...
Much different looking than the classical time dependent Schroedinger's equation in \ref{eqn:schrod}.  It is the expected result however.
Note that there is an ambiguity in the Lagrangian
and the end result since it isn't specified what signature metric tensor $\eta$ is used.  I would suspect $+,-,-,-$ given the positive
$m^2$.
