...
+ \alpha^2 (a \cdot f_1) (b \cdot f_1) \myMathWithDescription{f_2 \wedge f_2}{$=0$}{1} \\
&= a \wedge b 
...
The right hand expression in equation \ref{eqn:outermorphism_det:r1} can be shown to equal zero.  That is messier still and the calculation can be found 
at the end.
...
I believe I have seen a still more general form of equation \ref{eqn:outermorphism_det:distrib}
in a
