...
\author{Peeter Joot}
\date{ Feb 18, 2009.  Last Revision: $Date: 2009/02/19 14:41:43 $ }
...
First we want the volume element in spherical polar form.  That is

\begin{align*}
d^3 k = dk_1 dk_2 dk_3 = k^2 \cos\phi d\theta d\phi dk
\end{align*}
