...
\author{Peeter Joot}
\date{ Feb 18, 2009.  Last Revision: $Date: 2009/02/20 20:51:30 $ }
...
k^2 dk \\
&= \frac{4 \pi i}{x} \int_{k=0}^\infty \frac{1}{k + \alpha} 
\sin\left( k c t \right) 
\sin\left( k x \right) 
k dk \\
&= \frac{2 \pi i}{x} \int_{k=0}^\infty \frac{1}{k + \alpha} 
...
\begin{align}
{\psi}(\Bx, t) &= \IIinf \IIinf \IIinf \IIinf \rho(\Bx - \Bx', t - t') G(\Bx', t') d^3 x' dt' \\
G(\Bx, t) &= u(t) 
\frac{c i}{(2\pi) \Abs{\Bx}} 
