...
\author{Peeter Joot}
\date{ Sept 26, 2008.  Last Revision: $Date: 2008/10/01 02:56:10 $ }
...
FIXME: guessing that this one comes from integrating the current over a volume that excludes the current contributions (unlike Maxwell-Ampere above).
