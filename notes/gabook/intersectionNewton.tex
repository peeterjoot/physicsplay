...
\begin{figure}[htp]
\centering
\includegraphics[totalheight=0.8\textheight]{newtonsIntersectionHorizontal}
...
\begin{figure}[htp]
\centering
\includegraphics[totalheight=0.8\textheight]{newtonsIntersectionAnyOrientation}
...
\begin{figure}[htp]
\centering
\includegraphics[totalheight=0.8\textheight]{newtonsIntersectionTwoCurves}
