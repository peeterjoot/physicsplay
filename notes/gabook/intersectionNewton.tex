...
\imageFigure{figures/newtonsIntersectionHorizontal}{Refining an approximate horizontal intersection}{fig:newtonsIntersectionHorizontal}{0.8}
...
\imageFigure{figures/newtonsIntersectionAnyOrientation}{Refining an approximation for the intersection with an arbitrarily oriented line}{fig:newtonsIntersectionAnyOrientation}{0.8}
...
\imageFigure{figures/newtonsIntersectionTwoCurves}{Refining an approximation for the intersection of two curves in a plane}{fig:newtonsIntersectionTwoCurves}{0.8}
