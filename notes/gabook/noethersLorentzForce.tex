\chapter{Lorentz transform Noether current (interaction Lagrangian)}\label{chap:PJLorentzTxInteraction}
\date{ October 22, 2008.  Last Revision: $Date: 2009/06/04 13:13:27 $ } % Deleting this command produces today's date.
...
\begin{align}\label{eqn:noethers_lorentz_force:lorentzforce}
\LL = \inv{2}m v \cdot v + q A \cdot v/c
\end{align}

Let's see if Noether's can be used to extract an invariant from 
the Lorentz force Lagrangian \ref{eqn:noethers_lorentz_force:lorentzforce} under a
