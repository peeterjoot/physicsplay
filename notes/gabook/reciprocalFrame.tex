...
\date{ March 29, 2008}        % Deleting this command produces today's date.
...
equation \ref{eqn:rejonevector} can be expressed in a form that will be slightly more convenient for larger sets of
vectors:
...
\subsection{ Example.  \R{3} case.  Perpendicular to two vectors. }
...
demonstrates equation \ref{eqn:recipdot}, and with some incomprehensible steps skips to a generalized
result of the form
