...
Or
\begin{align}\label{eqn:qmAngularMom:withScalar}
...
\begin{align}\label{eqn:qmAngularMom:onGradeTwo3}
(x \wedge \grad)^2 &=
(n-2)(x \wedge \grad)
+
(x \wedge \grad) \wedge (x \wedge \grad) 
...
\begin{align}\label{eqn:qmAngularMom:onGradeTwo4}
...
\begin{align}\label{eqn:qmAngularMom:onGradeTwo5}
...
\begin{align}\label{eqn:qmAngularMom:rotationGen1}
\partial (\tilde{R} e R)
&=
...
\begin{align}\label{eqn:qmAngularMom:rotationGen2}
...
\begin{align}\label{eqn:qmAngularMom:rotationGen3}
\partial \sigma = \antisymmetric{\sigma}{\Omega}
\end{align}

Our spherical polar rotor was given by

\begin{align}\label{eqn:qmAngularMom:rotationGen4}
R = e^{\Be_{31}\theta/2} e^{\Be_{12}\phi/2}
\end{align}
...
Summarizing we have
\begin{align}\label{eqn:qmAngularMom:vecBivecDerivatives1}
...
\begin{align}\label{eqn:qmAngularMom:vecBivecDerivatives2}
...
\begin{align}\label{eqn:qmAngularMom:vecBivecDerivatives3}
...
\begin{align}\label{eqn:qmAngularMom:vecBivecDerivatives4}
...
\begin{align}\label{eqn:qmAngularMom:vecBivecDerivatives5}
\rcap \phicap = \Be_3 \phicap \cos\theta + i \sin\theta 
\end{align}

Tabulating all the bivector derivatives (details omitted) we have

\begin{align}\label{eqn:qmAngularMom:vecBivecDerivatives6}
...
\begin{align}\label{eqn:qmAngularMom:squaring1}
-\gpgradezero{ (\Bx \wedge \spacegrad)^2 } =
...
\begin{align}\label{eqn:qmAngularMom:squaring0}
\Bx \wedge \spacegrad 
&=
\rcap \left( \thetacap \partial_\theta + \phicap \inv{\sin\theta} \partial_\phi \right)  
\end{align}
...
\begin{align}\label{eqn:qmAngularMom:squaring2}
\Bx \wedge \spacegrad 
&=
...
\begin{align}\label{eqn:qmAngularMom:squaring3}
...
\begin{align}\label{eqn:qmAngularMom:squaring4}
\gpgradezero{ \rcap\phicap \inv{\sin\theta} \partial_\phi (\Bx \wedge \spacegrad) }
=
...
\begin{align}\label{eqn:qmAngularMom:squaring5}
-\gpgradezero{ (\Bx \wedge \spacegrad)^2 }
=
...
\begin{align}\label{eqn:qmAngularMom:threeDqm1}
...
\begin{align}\label{eqn:qmAngularMom:threeDqm2}
r \frac{\partial}{\partial r} r \frac{\partial R}{\partial r} - \frac{2m r^2 R}{\Hbar^2} (V(r) - E) = c R
\end{align}

\begin{align}\label{eqn:qmAngularMom:threeDqm3}
...
\begin{align}\label{eqn:qmAngularMom:threeDqm4p}
...
\begin{align}\label{eqn:qmAngularMom:threeDqm4}
...
\begin{align}\label{eqn:qmAngularMom:polar1}
...
\begin{align}\label{eqn:qmAngularMom:polar2}
...
\begin{align}\label{eqn:qmAngularMom:polar3}
...
\begin{align}\label{eqn:qmAngularMom:polar4}
...
\begin{align}\label{eqn:qmAngularMom:polar5}
\Bx \wedge \spacegrad = 
...
\begin{align}\label{eqn:qmAngularMom:polar6}
\Be_{31} \Be_{13} \inv{i} \partial_\phi f = \lambda f
\end{align}

Since $\Be_{31} \Be_{13} = 1$ we want solutions of

\begin{align}\label{eqn:qmAngularMom:polar7}
\partial_\phi f = i \lambda f
\end{align}

Solutions are

\begin{align}\label{eqn:qmAngularMom:polar12}
...
\begin{align}\label{eqn:qmAngularMom:polar8}
...
\begin{align}\label{eqn:qmAngularMom:polar9}
...
\begin{align}\label{eqn:qmAngularMom:polar10}
...
\begin{align}\label{eqn:qmAngularMom:polar11}
...
\begin{align}\label{eqn:qmAngularMom:polar13}
...
\begin{align}\label{eqn:qmAngularMom:polar14}
...
\begin{align}\label{eqn:qmSum:goo1}
L_1 &= -i \Hbar( x_2 \partial_3 - x_3 \partial_2 ) \\
L_2 &= -i \Hbar( x_3 \partial_1 - x_1 \partial_3 ) \\
L_3 &= -i \Hbar( x_1 \partial_2 - x_2 \partial_1 ) 
\end{align}
...
\begin{align}\label{eqn:qmSum:goo2}
\BL &= - \Hbar \Bx \wedge \spacegrad
\end{align}
...
\begin{align}\label{eqn:qmSum:goo3}
...
\begin{align}\label{eqn:qmSum:goo4}
...
\begin{align}\label{eqn:qmSum:goo5}
...
\begin{align}\label{eqn:qmSum:goo8}
\grad^2 &= 
\inv{x^2} \left( 
...
\begin{align}\label{eqn:qmSum:goo9}
\spacegrad^2 &= 
...
\begin{align}\label{eqn:qmSum:goo10}
\spacegrad^2 &= 
...
\begin{align}\label{eqn:qmSum:goo11}
...
\begin{align}\label{eqn:qmSum:goo12}
R &= e^{\Be_{31}\theta/2} e^{\Be_{12}\phi/2} \\
\Bx &= r \tilde{R} \Be_3 R 
\end{align}
...
\begin{align}\label{eqn:qmSum:goo13}
\Bx \wedge \spacegrad 
&= \tilde{R} \left( \Be_3 \Be_1 R \partial_\theta + \Be_3 \Be_2 R \inv{\sin\theta} \partial_\phi \right) \\
&= \rcap \left( \thetacap \partial_\theta + \phicap \inv{\sin\theta} \partial_\phi \right) 
\end{align}
...
\begin{align}\label{eqn:qmSum:goo16}
-\gpgradezero{ (\Bx \wedge \spacegrad)^2 } =
\inv{\sin\theta} \PD{\theta}{} \sin\theta \PD{\theta}{} + \inv{\sin^2\theta} \frac{\partial^2}{\partial \phi^2}
\end{align}
...
\begin{align}\label{eqn:qmSum:goo17}
\Bx \wedge \spacegrad &= \Be_{31} \left( e^{i\phi} (\partial_\theta + i \cot\theta \partial_\phi) + \Be_{13} \inv{i} \partial_\phi \right) \\
