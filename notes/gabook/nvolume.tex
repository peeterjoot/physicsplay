...
\date{ Feb 26, 2009.  Last Revision: $Date: 2009/04/30 04:22:49 $ }
...
We can form a parallelogram area (or parallopiped volume, ...) element for any parameterized surface by taking wedge products, as in figure \ref{fig:tangent_area_form}.
...
\caption{Tangent vector along curves of parameterized vector.}\label{fig:tangent_area_form}
\end{figure}
