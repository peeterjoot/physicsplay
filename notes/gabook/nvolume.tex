...
The most informative of these is for $\phi_1 = \pi/2$, where we had $\Br = (0, \cos\phi_2, \sin\phi_2)$, and our points trace out a path along the unit circle of the $y,z$ plane.  At $\phi_1 = 0$ our point $\Br = e^1$ didn't move, and at $\phi_1 = \pi$ we are at the other end of the sphere, also fixed.  A reasonable guess is that at each $\phi_1$ we trace out a different circle in the $y,z$ plane.
...
\Br &= \cos\phi_1 e^1 + \sin\phi_1 e^2 \exp( i_{23} \phi_2 )
\end{align}
