...
\date{Aug 31, 2009}
\revisionInfo{$RCSfile: rotationGenerator.tex,v $ Last $Revision: 1.4 $ $Date: 2009/09/02 02:26:34 $}
...
\section{Some explicit expansions of the angular momentum operator.}
