...
J/\epsilon_0 c = \grad (\grad \wedge (A + \grad \psi) = \grad (\grad \wedge A) + \grad (\myMathWithDescription{\grad \wedge \grad \psi}{$=0$}{1}),
\end{align}
...
+ \partial_0 ( \spacegrad \wedge \BA ) 
+ \myMathWithDescription{\spacegrad \cdot ( \spacegrad \wedge \BA ) }{$\spacegrad^2 \BA - \spacegrad (\spacegrad \cdot \BA)$}{1}
+ \myMathWithDescription{\spacegrad \wedge ( \spacegrad \wedge \BA )}{$=0$}{2} \\
\end{align*}
