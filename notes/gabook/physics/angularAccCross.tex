...
\Bv'
&= (
\myMathWithDescription{\left(\rcap \cdot \Bv\right) \rcap}{$r'\rcap$}{1}
)' + (
\myMathWithDescription{\Bomega \cross \Br}
{$(\Br \cross \Bv) \cross \frac{\Br}{r^2}$}{2}
)' \\
&= r'' \rcap 
 + r' \frac{\Bomega \cross \Br}{r}
 + (\rcap \cross \Ba) \cross \rcap
 + (\myMathWithDescription{\Bv \cross \Bv)}{$=0$}{3} \cross \frac{\Br}{r^2}
