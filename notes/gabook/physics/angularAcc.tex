...
&= \left( \rcap \cdot \left(\Br \wedge \Bv\right) \right)' \\
&= \rcap' \cdot \left(\Br \wedge \Bv\right) +\rcap \cdot (\myMathWithDescription{\Bv \wedge \Bv}{$=0$}{1}) + \rcap \cdot \left(\Br \wedge \Ba\right) \\
\end{align*}
...
\begin{align*}
\Ba
&= \rcap' r' + \rcap r'' + \frac{\Br}{r^2} \myMathWithDescription{\left(\Bv \wedge \Bv\right)}{$=0$}{1} + \frac{\Br}{r^2} \left(\Br \wedge \Ba\right) + \left(\frac{\rcap}{r}\right)' \left(\Br \wedge \Bv\right) \\
&=
\rcap r''
...
\[
\Br \BOmega = \Br \cdot \BOmega + \myMathWithDescription{\Br \wedge \BOmega}{$=0$}{1} = -\BOmega \cdot \Br = -\BOmega \Br
\]
