...
\[
a_1 \alpha_1 \wedge \alpha_2 + P_1 \wedge \alpha_2 = a_2 \myMathWithDescription{\alpha_2 \wedge \alpha_2}{$=0$}{1} + P_2 \wedge \alpha_2
\]
...
&= \myMathWithDescription{\cos(\psi/2)\cos(\lambda/2)}{$a_0$}{1} \\
&\qquad + \myMathWithDescription{-\Be_{32}\sin(\psi/2)\cos(\lambda/2) - \Be_{31} \cos(\psi/2) \sin(\lambda/2)}{$A$}{2} \\
&\qquad + \myMathWithDescription{\Be_{21} \sin(\psi/2) \sin(\lambda/2)}{$B$}{3}
\end{align*}
