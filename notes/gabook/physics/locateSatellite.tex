...
\[
a_1 \alpha_1 \wedge \alpha_2 + P_1 \wedge \alpha_2 = a_2 \mathWithDescription{\alpha_2 \wedge \alpha_2}{$=0$}{1} + P_2 \wedge \alpha_2
\]
...
&= \mathWithDescription{\cos(\psi/2)\cos(\lambda/2)}{$a_0$}{1} \\
&\qquad + \mathWithDescription{-\Be_{32}\sin(\psi/2)\cos(\lambda/2) - \Be_{31} \cos(\psi/2) \sin(\lambda/2)}{$A$}{2} \\
&\qquad + \mathWithDescription{\Be_{21} \sin(\psi/2) \sin(\lambda/2)}{$B$}{3}
\end{align*}
