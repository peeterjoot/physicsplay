...
Let us try the solid torus problem for fun using the geometric algebra toolbox.  To setup the problem, it seems reasonable to introduce two angle, plus radius, toroidal parametrization as shown in figure (\ref{fig:toriodalSegment}).

\imageFigure{figures/toriodalSegment}{Toroidal parametrization}{fig:toriodalSegment}{0.7}
