...
\author{Peeter Joot}
\date{ October 8, 2008.  Last Revision: $Date: 2008/10/09 13:06:28 $ }
...
First calculate the field velocity product in terms of electric and magnetic components.  In this new frame of reference write the velocity of the charged particle as
$v = e_\mu \fdot^\mu$
...
This has discarded the timelike components of the force equation with respect to this observer rest frame.  Introducing the basis
$\{\sigma_i = e_i \wedge e_0\}$ for this observers' Euclidian space (these spacetime bivectors square to unity, and behave in every respect like
spatial vector basis vectors), and writing $\BE = E^i \sigma_i$, $\BB = B^i \sigma_i$, and $\Bv = \sigma_i dx^i/dt$, this is
...
Equating with \ref{eqn:FdotVwedge}, cancelling the $\gamma = dt/d\tau$ factors, leaves the traditional Lorentz force law in observed dependent form
...
\cite{doran2003gap}.  There the equation was obtained using some subtle relativistic symmetry arguments not especially easy to follow.
