...
\date{ Sept 7, 2008.  $RCSfile: maxwellToTensor.tex,v $ Last $Revision: 1.10 $ $Date: 2009/10/22 02:07:20 $ }
...
Since he uses the positive end of the metric for spatial indexes this works fine.  Contrast to \cite{doran2003gap} who write:
...
The reciprocal frame representation of equation \ref{eqn:maxToTensor:Fcomp} is %metric dependent when expressed
...
These potential based equations of \ref{eqn:maxToTensor:tensorpot}, are consistent with the definition of the field tensor in terms of potential in the 
