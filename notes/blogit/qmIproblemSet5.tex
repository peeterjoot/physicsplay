...
This is zero for odd $n$.  For even $n$ is appears that $H_n(0)^2$ may equal $2^n$ (this is true at least up to n=4).  If that's the case we have for even energy states at $x=0$ a probability per unit length value of $\Abs{u(0,t_0)}^2 = \frac{\alpha}{\sqrt{\pi} n!}$.
