...
Using each of the four possible spacetime volume elements, take the volume element to its infinesimal limit, and recover the differential form of Gauss's law and the Ampere-Maxwell equation.  What happened to Faraday's law and Gauss's law for magnetism?
} % problem
...
Wedging the area element with \( F \) will produce pseudoscalar multiples of the various \( \BE \) and \( \BB \) components.  We need a recipe for these components.
} % answer
