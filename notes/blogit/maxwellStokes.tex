...
It can be demonstrated that using this with each of the standard basis spacetime 3-volume elements recovers Gauss's law and the Ampere-Maxwell equation.  So, what happened to Faraday's law and Gauss's law for magnetism?  Application of Stokes to the curl equation from \eqnref{eqn:maxwellStokes:40}, those equations take the form
