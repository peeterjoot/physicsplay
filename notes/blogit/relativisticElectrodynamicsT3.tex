...
\frac{d(\mathcal{E}/c)}{d\tau} \propto e F^{0 j} u_j,
\end{equation}

which is, using \ref{eqn:relativisticElectrodynamicsT3:910}

\begin{equation}\label{eqn:relativisticElectrodynamicsT3:950}
\frac{d(\mathcal{E}/c)}{dt} \propto e \left(\BE \cdot \frac{\Bv}{c}\right) 
\end{equation}
...
\begin{align*}
\mathcal{E} 
&\propto e \int \BE \cdot \Bv dt \\
&= -e \int (\spacegrad \phi) \cdot \frac{\Bx}{dt} dt \\
&= -e \int \PD{x^\alpha}{\phi} \PD{t}{x^\alpha} dt
&= -e \phi
\end{align*}
