...
FIXME: explore this.  ie: calculate the Lorentz force Hamiltonian.  That should provide the energy component of the Lorentz force without resorting to $F^{ij} u_j$ products as mentioned (looking ahead) in class.
