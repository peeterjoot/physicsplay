...
The outer and inner products respectively, expressed using the wedge and dot operators, of blades $u$, and $v$ of grade $r$ and $s$ respectively is defined as
...
u \cdot v \equiv \gpgrade{ u v }{\Abs{r - s}}.
\end{dmath}
\end{subequations}
