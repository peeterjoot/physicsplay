...
\begin{dmath}\label{eqn:fermiFunctionExpansionsForNandP:80}
\myBoxed{
\mathcal{D}(\epsilon)
=
\frac{V}{(2 \pi)^2 }
...
\begin{equation}\label{eqn:fermiFunctionExpansionsForNandP:160}
\myBoxed{
\frac{N}{V}
=
...
P V \beta 
= 
g \sum \ln \lr{ 1 + z e^{-\beta \epsilon} }
\sim
g \frac{V}{(2 \pi)^2 }
\lr{ \frac{2 m}{\Hbar^2} }
^{3/2}
\int_0^\infty d\epsilon \epsilon^{1/2} \ln \lr{ 1 + z e^{-\beta \epsilon} }
=
- g \frac{V}{(2 \pi)^2 }
\lr{ \frac{2 m}{\Hbar^2} }
^{3/2}
...
\begin{equation}\label{eqn:fermiFunctionExpansionsForNandP:200}
\myBoxed{
...
\begin{dmath}\label{eqn:fermiFunctionExpansionsForNandP:260}
\myBoxed{
U
= \frac{3}{2} N \kB T 
\frac{f_{5/2}(z)}{
...
\begin{dmath}\label{eqn:fermiFunctionExpansionsForNandP:320}
\myBoxed{
P V = \frac{2}{3} U.
}
\end{dmath}
