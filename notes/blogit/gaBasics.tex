...
\begin{align}\label{eqn:gaBasics:how:foo1}
...
\begin{align}\label{eqn:gaBasics:how:foo2}
\Bx \cdot \By \equiv \inv{2}(\Bx \By + \By \Bx)
\end{align}
\begin{align}\label{eqn:gaBasics:how:foo3}
...
\begin{exersize}\label{ex:linearityAxiom}
...
\begin{align}\label{eqn:gaBasics:perp:foo1}
...
\begin{align}\label{eqn:gaBasics:dotprod:foo1}
\Norm{\Bb - \Ba}^2 
...
\begin{align}\label{eqn:gaBasics:dotprod:inCoords}
...
\begin{exersize}\label{ex:euclideanDot}
...
\begin{exersize}\label{ex:R3pseudoscalarCommute}
...
\begin{align}\label{eqn:gaBasics:r3Cross}
\Ba \Bb 
&=
...
\begin{exersize}\label{ex:R3pseudoscalarBivectorProducts}
...
\begin{align}\label{sol:dotprod:inCoords}
...
\begin{align}\label{eqn:gaBasics:anticommutator}
...
\begin{align}\label{eqn:gaBasics:dotDefined}
...
\begin{align}\label{eqn:gaBasics:commutator}
...
\begin{align}\label{eqn:gaBasics:wedge}
...
\begin{align}\label{eqn:gaBasics:wedgeTwo}
a_1 \wedge a_2 = \inv{2}
...
\begin{align}\label{eqn:gaBasics:wedgeDefined}
...
\begin{align}\label{eqn:gaBasics:dotPlusWedge}
...
\begin{align}\label{eqn:gaBasics:wedgeAsCross}
...
\begin{align}\label{eqn:gaBasics:scalarPlusIcross}
...
\begin{align*}%\label{eqn:gaBasics:gaWiki:orthoD}
