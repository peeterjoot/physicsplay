...
where $z = e^{\beta \mu}$ as usual, and we write $x = \beta \epsilon$.   For the low temperature asymptotic behavior see \citep{pathriastatistical} appendix \S E.  For $z$ large it can be shown that this is
