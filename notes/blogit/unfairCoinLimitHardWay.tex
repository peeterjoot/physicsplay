...
Part of the problem was to calculate the limit for $N \gg 1$ and $N \gg X$.  I did this with the central limit theorem, and presumed that I had the answer wrong since I did not get any marks for doing so.
...
Taking logs of \ref{eqn:unfairCoinLimitHardWay:60} we have
...
\begin{equation}\label{eqn:unfairCoinLimitHardWay:280}
\myBoxed{
P_N(r, k) \approx
\inv{\sqrt{2 \pi N r s}} 
\exp
