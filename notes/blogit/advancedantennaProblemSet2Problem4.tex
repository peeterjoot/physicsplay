...
since \( \rcap \) and \( \phicap \) are orthonormal, and \( \phicap \) lies in the x-y plane, always perpendicular to \( \zcap \).
...
This reproduces the near field electric field equations (4.20a,b) from the text \citep{balanis2005antenna} in the limit \( k r \rightarrow 0 \).
}
