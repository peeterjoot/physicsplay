...
In the problem set we'll look at interference patterns for two slit electron interference given a magnetic whisker that introduces flux into the mix.
...
Why do we have the zeros at integral multiples of \( h/q \)?  Consider
...
Just like He^4 can undergo bose condensation, superconductivity can be explained by a hybrid bosonic state where electrons are paired into one state containing integral spin.
...
= \inv{2 m} \Bp_x^2 + \inv{2 m} \lr{ \phat_y - e B \xhat }^2
\end{dmath}
...
\begin{dmath}\label{eqn:qmLecture7:360}
