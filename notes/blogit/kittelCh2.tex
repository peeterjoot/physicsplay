...
This doesn't seem particularly suprising if we look at the plots.  For example for $C = 1$ and $3N/2 = 1$ we have \cref{fig:kittelCh2:kittelCh2Fig1}.

\imageFigure{kittelCh2Fig1}{Plots of entropy and its derivatives for this multiplicity function}{fig:kittelCh2:kittelCh2Fig1}{0.3}
