...
\imageFigure{statMechProblemSet3Problem3Fig1}{Distribution of number of configurations for $N = 20$ magnets as a function of magnetization}{fig:statMechProblemSet3Problem3:statMechProblemSet3Problem3Fig1}{0.3}
...
\imageFigure{statMechProblemSet3Problem3Fig2}{$N = 20$ differences between the exact binomial expression and the Gaussian approximation}{fig:statMechProblemSet3Problem3:statMechProblemSet3Problem3Fig2}{0.3}
}
