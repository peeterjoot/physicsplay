...
can only have a value in a neighbourhood of point $\Bx$.  Writing $\Delta = \spacegrad \cdot \spacegrad$ we have
...
\begin{align*}\label{eqn:relativisticElectrodynamicsL18:340}
\Delta \int d^3 \Bx' \inv{\Abs{\Bx - \Bx'} } f(\Bx') 
&=
\lim_{\epsilon = \Abs{\Bx -\Bx'} \rightarrow 0}
...
\subsubsection{Returning to the d'Alambertian Green's function.}
