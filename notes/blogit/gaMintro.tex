...
k^2 
&= \Be_2 \Be_3 \Be_2 \Be_3 \\
&= -\Be_3 \mathWithDescription{\Be_2 \Be_2}{$=1$}{1} \Be_3 \\
&= -\Be_3 \Be_3 \\
&= -1.
\end{align*}
...
&=
\Be_2 \cos\theta + \mathWithDescription{\Be_2 \Be_2}{$=1$}{1} \Be_3 \sin\theta.
\end{align*}
...
\dot{\rcap}^2 = 
\dot{\theta}^2 \mathWithDescription{\Be_1 e^{i\phi} e^{j \theta} e^{-j\theta} e^{-i \phi} \Be_1 }{$=1$}{1}
+ S_\theta^2 \dot{\phi}^2 \mathWithDescription{\Be_2 e^{i \phi} e^{-i \phi} \Be_2 }{$=1$}{2}
+ 
\dot{\theta} 
\dot{\phi}
S_\theta
