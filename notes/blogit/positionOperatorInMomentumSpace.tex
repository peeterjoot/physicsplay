...
%\chapter{Position operator in momentum space representation}
...
The we want to do is expand the matrix element of the commutator.  First using the definition of the commutator
