...
\begin{equation}\label{eqn:relativisticElectrodynamicsPS6P1:350}
T^{1 1} 
= \inv{4 \pi} \left( 
- E_x^2 + B_y^2 + B_z^2
- \inv{2} (\BB^2 - \BE^2) \right)
...
\begin{equation}\label{eqn:relativisticElectrodynamicsPS6P1:370}
T^{1 1} 
= \inv{8 \pi} \left( 
- E_x^2 + E_y^2 + E_z^2
- B_x^2 + B_y^2 + B_z^2
...
\begin{align}\label{eqn:relativisticElectrodynamicsPS6P1:390}
...
\begin{align}\label{eqn:relativisticElectrodynamicsPS6P1:410}
...
\begin{equation}\label{eqn:relativisticElectrodynamicsPS6P1:430}
\boxed{
...
\begin{equation}\label{eqn:relativisticElectrodynamicsPS6P1:450}
...
\begin{equation}\label{eqn:relativisticElectrodynamicsPS6P1:470}
\Bx = \Bx(a_1, a_2, a_3).
\end{equation}
...
\begin{align}\label{eqn:relativisticElectrodynamicsPS6P1:490}
...
\begin{equation}\label{eqn:relativisticElectrodynamicsPS6P1:510}
...
\begin{equation}\label{eqn:relativisticElectrodynamicsPS6P1:530}
\int 
\Abs{ \frac{\partial(x^1, x^2, x^3)}{\partial (a_1, a_2, a_3)}}
da_1 da_2 da_3 
...
\begin{equation}\label{eqn:relativisticElectrodynamicsPS6P1:550}
d\Bn_{1+} 
...
\begin{equation}\label{eqn:relativisticElectrodynamicsPS6P1:570}
d\Bn_{2+} 
...
\begin{equation}\label{eqn:relativisticElectrodynamicsPS6P1:590}
d\Bn_{3+} 
...
\begin{equation}\label{eqn:relativisticElectrodynamicsPS6P1:610}
d\Bn_{\sigma\pm} 
...
Suppose, to start with, our divergence volume integral \ref{eqn:relativisticElectrodynamicsPS6P1:530} has just the following term

\begin{equation}\label{eqn:relativisticElectrodynamicsPS6P1:630}
...
\begin{equation}\label{eqn:relativisticElectrodynamicsPS6P1:720}
\int d^3 \Bx \partial_\beta T^{\beta \alpha} = 
...
\begin{equation}\label{eqn:relativisticElectrodynamicsPS6P1:740}
d \sigma^\beta = 
\epsilon_{\mu\nu\beta} \left(
\PD{a_2}{x^\mu}
\PD{a_3}{x^\nu} da_2 da_3
...
\begin{equation}\label{eqn:relativisticElectrodynamicsPS6P1:760}
\int d^3 \Bx = 
...
\begin{equation}\label{eqn:relativisticElectrodynamicsPS6P1:780}
\int d^3 \Bx = \oint d \sigma^\beta T^{\beta \alpha},
\end{equation}

To encode (or imply) whether we require a positive or negative sign on the area element tensor of \ref{eqn:relativisticElectrodynamicsPS6P1:740} for the surface in question.
...
\begin{equation}\label{eqn:relativisticElectrodynamicsPS6P1:790}
