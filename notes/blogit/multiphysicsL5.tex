...
\imageFigure{../../figures/ece1254/lecture5Fig2}{Some vector norms}{fig:lecture5:lecture5Fig2}{0.2}

\section{Matrix norm}

A matrix operation \( \overbar{y} = M \overbar{x} \) can be thought of as a transformation as in \cref{fig:lecture5:lecture5Fig3}.

\imageFigure{../../figures/ece1254/lecture5Fig3}{Matrix as a transformation}{fig:lecture5:lecture5Fig3}{0.15}
