...
FIXME: show that this is the pertubation result.
...
This has been worked out for $\mathcal{P}_{+}$.  This can also be done for $\mathcal{P}_{-}$, the probability that the electron will end up in a left trending contiuum state.
