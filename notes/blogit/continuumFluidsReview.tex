...
\keywords{PHY454H1S, PHY454H1, strain, displacement vector, stress, constitutive relation, Navier-Stokes, incompressible fluid, capillary constant, Surface tension, Laplace pressure, channel flow, pressure gradient, shear flow, Poiseuille flow, film flow, flux, traction vector, no-slip condition, interface, hydrostatics,
Buoyancy force, mass conservation
}
...
\imageFigure{tapFlowCropped6cmFig3}{Tap flow measurement.}{fig:tapFlowCropped6cm:tapFlowCropped6cmFig3}{0.3}
...
\imageFigure{tapFlowCropped6cmFig4}{Comparison of measured stream radii and calculated.}{fig:tapFlowCropped6cm:tapFlowCropped6cmFig4}{0.3}

% earlier more turbulant tap flow pic:
%figure (\ref{fig:tapFlowCropped6cm:tapFlowCropped6cmFig5}).
%\imageFigure{tapFlowCropped6cmFig5}{5: FIXME: CAPTION}{fig:tapFlowCropped6cm:tapFlowCropped6cmFig5}{0.2}

\section{Surface tension.  Laplace pressure.}

We covered some aspects of this topic in class.  \cite{landau1987course} covers this topic in (hard to comprehend) detail.  \S 2.4.9-2.4.10 of \cite{granger1995fluid} has small section that's a bit easier to understand, with less detail.  Recommended in that text is the ``Surface Tension in Fluid Mechanics'' movie which can be found on youtube in three parts \youtubehref{DkEhPltiqmo}, \youtubehref{yiixltf\_HKw}, \youtubehref{5d6efCcwkWs}, which is very interesting and entertaining to watch.

In the film it is pointed out that the surface tension equation we were shown in class
