...
Given a number of sources as illustrated in

FIXME: F1

when we move the sources we may get fringes.  In general we can consider these multiple sources as a sum over all the electric fields
...
Did we have interference in the diffraction example 
...
Here $y$ is the position of observation, as illustrated in
...
where after zoom we see the same image.  This is called Heterodyne amplification.

% FIXME: def:

\underline{Heterodyne Detection}
