...
We see that the stress tensor at this point is also neccessarily diagonal if the strain is diagonal in that basis (with the implicit assumption here that we are talking about an isotropic material).  Noting that the Poisson ratio is bounded according to
...
We see that at this point the $(1,1)$ and $(3,3)$ components of stress is positive (expansion in those directions) regardless of the material, and provided
...
In matrix form we wish to operate (to the left) with the gradient
