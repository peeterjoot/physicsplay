...
\chapter{PHY456H1S Continuum mechanics.  Problem Set 1.  Stress, Strain, Traction vector.  Force free equilibrium.}
...
For a Mathematica animation with slider controls for $x, y, z$, and $\nu$ (i.e. points other than $(1,2,4)$, see \href{https://raw.github.com/peeterjoot/physicsplay/master/notes/phy454/continuumProblemSet1Q2animated.cdf}{https://raw.github.com/peeterjoot/physicsplay/master/notes/phy454/continuumProblemSet1Q2animated.cdf}.  This requires either a Mathematica client or the \href{http://www.wolfram.com/cdf-player/}{Wolfram CDF player}.
...
These all require either a Mathematica client or the \href{http://www.wolfram.com/cdf-player/}{Wolfram CDF player (freely available)}.  Note that I haven't figured out a way to get a browser based CDF player to play these without explicit download.
