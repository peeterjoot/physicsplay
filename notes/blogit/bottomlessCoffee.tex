...
\imageFigure{coffeeCupDiagramFig1}{Fluid flow in nested cylinders.}{fig:coffeeCupDiagram:coffeeCupDiagramFig1}{0.3}
...
\begin{equation}\label{eqn:bottomlessCoffee:n}
\inv{\nu} \frac{T'}{T} = \inv{R} \left( 
