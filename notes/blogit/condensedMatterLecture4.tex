...
Monoclinic?: Very rare: only \ce{Po}, which is very toxic (what was used in the likely russian secret service assination by injection).
...
Face centered cubic (FCC) is actually a stack of 2-d \underlineAndIndex{hexagonal close packed} (HCP) \index{HCP} planes (fig: see slides 04_handout.pdf).
