...
We have seven possibilities that fill space (see handout).  We need 3 vectors or three lengths angle pairs to describe the geometries.
...
One way to distinuish crystal structures is according to the symmetries that they have.  Each crystal structure has symmetry operations that map the crystal onto itself.

To illustrate

F2: slide: graphene lattice
...
\underlineAndIndex{Simple cubic} Very rare: only \ce{Po}, which is very toxic (what was used in the likely russian secret service assination by injection).

%\cref{fig:simpleCubicPacking:simpleCubicPackingFig1}.
\imageFigure{simpleCubicPackingFig1}{Simple cubic}{fig:simpleCubicPacking:simpleCubicPackingFig1}{0.3}

\underlineAndIndex{Face centered cubic} (FCC) \index{FCC} (\ce{Cu}, \ce{Ni}, \ce{Au}, \ce{Pd})

This one is very common 

\imageFigure{../phy452/figures/problemSet2Problem2faceCenteredCubicFig4b}{Element of a face centered cubic}{fig:problemSet2Problem2faceCenteredCubic:problemSet2Problem2faceCenteredCubicFig4}{0.3}
...
\imageFigure{HexClosePackingFig1}{Hex close packing}{fig:HexClosePacking:HexClosePackingFig1}{0.3}
...
Transition metals often like FCC because of covalent d bonding.
...
\underlineAndIndex{Body centered cubic} (BCC) \index{BCC}

% from: statMechProblemSet3.nb
%\cref{fig:bccPacking:bccPackingFig1}.
\imageFigure{bccPackingFig1}{Element of a face centered cubic}{fig:bccPacking:bccPackingFig1}{0.3}
...
\underlineAndIndex{Diamond lattice} 
