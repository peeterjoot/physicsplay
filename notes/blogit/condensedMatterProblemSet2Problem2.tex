...
The base is depicted in \cref{fig:tetrahedralBase:tetrahedralBaseFig7}

\imageFigure{tetrahedralBaseFig7}{CAPTION}{fig:tetrahedralBase:tetrahedralBaseFig7}{0.3}
