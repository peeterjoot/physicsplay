...
\imageFigure{hcpUnitHexCellFig1}{Hex Close Packed unit cell}{fig:hcpUnitHexCell:hcpUnitHexCellFig1}{0.2}
...
\imageFigure{hcpUnitHexCellInThreePiecesFig4}{hcp primitive unit cell}{fig:hcpUnitHexCellInThreePieces:hcpUnitHexCellInThreePiecesFig4}{0.2}
...
\imageFigure{tetrahedralBaseFig5}{Tetrahedral base}{fig:tetrahedralBase:tetrahedralBaseFig5}{0.2}
...
\imageFigure{tetrahedralHeightFig6}{Tetrahedral height}{fig:tetrahedralHeight:tetrahedralHeightFig6}{0.2}
...
\imageFigure{tetrahedralBaseFig7}{Hex cell base area calculation}{fig:tetrahedralBase:tetrahedralBaseFig7}{0.2}
