...
In \citep{qftLectureNotes} it is left as an exersize to expand the scalar field Hamiltonian in terms of the raising and lowering operators.  Let's do that.
} % problem
