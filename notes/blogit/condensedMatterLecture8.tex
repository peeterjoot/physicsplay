...
\imageFigure{qmSolidsL8Fig1a}{Uniform motion}{fig:qmSolidsL8:qmSolidsL8Fig1a}{0.1}

(b) At $q = a$, \cref{fig:qmSolidsL8:qmSolidsL8Fig1b}, we have displaced, but also uniform translation of the entire chain.

\imageFigure{qmSolidsL8Fig1b}{Displaced uniform motion}{fig:qmSolidsL8:qmSolidsL8Fig1b}{0.1}

(c) At $q = a/2$, \cref{fig:qmSolidsL8:qmSolidsL8Fig1c}, we have maximum oscillation.

\imageFigure{qmSolidsL8Fig1c}{Maximum oscillation}{fig:qmSolidsL8:qmSolidsL8Fig1c}{0.1}
...
\imageFigure{qmSolidsL8Fig6}{Uniform translation}{fig:qmSolidsL8:qmSolidsL8Fig6}{0.1}

(b)

%\cref{fig:qmSolidsL8:qmSolidsL8Fig7}.
\imageFigure{qmSolidsL8Fig7}{Pairwise oscillation}{fig:qmSolidsL8:qmSolidsL8Fig7}{0.1}

(c)

%\cref{fig:qmSolidsL8:qmSolidsL8Fig8}.
\imageFigure{qmSolidsL8Fig8}{Heavier atoms oscillating}{fig:qmSolidsL8:qmSolidsL8Fig8}{0.1}

(d)

%\cref{fig:qmSolidsL8:qmSolidsL8Fig9}.
\imageFigure{qmSolidsL8Fig9}{Lighter atoms oscillating}{fig:qmSolidsL8:qmSolidsL8Fig9}{0.1}
