...
Since \( \spacegrad \cross \BE = - \mu (j \omega) \BH \), the \( \BE \propto e^{-\gamma z } \) dependence, we have

\begin{dmath}\label{eqn:uwavesLecture3:n}
\eta_\txtc = \frac{\Abs{\BE}{\BH}} = \frac{- \mu (j \omega)}{-\gamma} = \frac{j \omega \mu}{\gamma}
\end{dmath}
