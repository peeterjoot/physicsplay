...
Today we want to use the variational degree of freedom to try to solve some problems that we don't have anylitical solutions for.
...
\imageFigure{../../figures/phy1520/lecture19Fig1a}{Energy after pertubation.}{fig:lecture19:lecture19Fig1}{0.2}
...
We are interested in the regiem where \( a_0^2 = \frac{\Hbar}{m \omega} \ll a^2 \).
...
\paragraph{Pertubation theory (outline)}
...
We are hoping that the level transisions have adiabatic transitions between the original and perturbed levels as sketched in \cref{fig:lecture19:lecture19Fig6}.
...
If we have level crossings (which can in general occur), as opposed to adiabatic transitions, then we have no hope of using pertubation theory.
