...
\imageFigure{qmSolidsPs4QzeroFig1}{Pairwise oscillation}{fig:qmSolidsPs4Qzero:qmSolidsPs4QzeroFig1}{0.3}

% FIXME for phy487.pdf: \nbref{qmSolidsPs4P2cAnimation.nb}
...
\imageFigure{qmSolidsPs4P2dFig1}{Frequencies for $\delta/k_\nought \in \{0.9, 0.1, 0\}$}{fig:qmSolidsPs4P2d:qmSolidsPs4P2dFig1}{0.3}

\makeSubAnswer{}{condensedMatter:problemSet4:2e}

To examine both the limiting scenerio and the case $\delta/k_\nought = 0.9$, let
...
In the accoustic \index{accoustic dispersion} range we have a uniformly damped sinusoid.  For this $0.9$ case that is
...
The $\delta = 0$ values are somewhat tricky to distinguish in \cref{fig:qmSolidsPs4P2d:qmSolidsPs4P2dFig1} above.  The optical case is replotted separately in \cref{fig:qmSolidsPs4OpticalDeltaZero:qmSolidsPs4OpticalDeltaZeroFig1}, and the accoustic in \cref{fig:qmSolidsPs4AccousticDeltaZero:qmSolidsPs4AccousticDeltaZeroFig1}.

\imageFigure{qmSolidsPs4OpticalDeltaZeroFig1}{Optical dispersion at $\delta = 0$}{fig:qmSolidsPs4OpticalDeltaZero:qmSolidsPs4OpticalDeltaZeroFig1}{0.3}
\imageFigure{qmSolidsPs4AccousticDeltaZeroFig1}{Accoustic dispersion at $\delta = 0$}{fig:qmSolidsPs4AccousticDeltaZero:qmSolidsPs4AccousticDeltaZeroFig1}{0.3}
...
provided $qa < \pi$ we can write the optical and accoustic ranges for $\omega$ at $\delta = 0$ respectively as
