...
Prof. Eleftheriades explained the the send-recieve equivalence using the concepts of a two-port network (\citep{irwin2007bec}, \citep{sedra1982microelectronic}).

An alternate, and very intuitive, explaination can be found in appendix A.1 \citep{chen2005reciprocity}, that directly related the current density sources and scalar current to the voltages in those regions using an integral representation of the reciprocity theorem.
