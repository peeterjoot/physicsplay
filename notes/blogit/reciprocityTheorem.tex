...
Part of this send-recieve equivalence relies on the concepts of a two-port network.  Two port networks are probably covered in most elementary circuits texts, including the two that I have \citep{irwin2007bec} and \citep{sedra1982microelectronic}.  The idea is : ... FIXME
