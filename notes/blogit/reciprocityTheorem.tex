...
FIXME: Followup Questions:

\begin{enumerate}
\item
What does the energy momentum conservation relation look like with magnetic sources?
\item
What does that look like in geometric algebra form?
\item
What does the stress energy tensor look like with magnetic sources?
\item
Investigate the relation between the stress energy tensor (in GA and std forms), and the reciprocity theorem.
\end{enumerate}
