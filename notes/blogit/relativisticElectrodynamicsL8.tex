...
&=
\frac{d}{dt} \inv{(1 - \frac{\Bv^2}{c^2})^{3/2}} (-1/2) (2) (-\Bv \cdot \dot{\Bv}) /c^2 \\
&= 0.
\end{align*}
...
This now puts things in a nice invariant form, with no bias towards any specific observer's time coordinates

\begin{equation}\label{eqn:relativisticElectrodynamicsL8:160}
\frac{d u^i}{ds} = 0.
\end{equation}

\paragraph{Reviewed to here.}
...
\begin{equation}\label{eqn:relativisticElectrodynamicsL8:240}
