...
\begin{dmath}\label{eqn:oneAtomBasisPhonon:640}
\myBoxed{
\omega^2 = 
...
\omega^2 = 
\frac{2}{m} \lr{ \sum_i K_i S_i \pm \sqrt{ (K_2 S_2 - K_1 S_1)^2 + (K_3 S_3 - K_4 S_4)^2 } }
\end{dmath}
...
\omega^2 = 
\frac{2}{m} \lr{ K_1 (S_1 + S_2) + K_3(S_3 + S_4) \pm \sqrt{ K_1^2 (S_2 - S_1)^2 + K_3^2 (S_3 - S_4)^2 } }
\end{dmath}
...
\lr{
(S_1 - S_2)
\pm \sqrt{ (S_2 - S_1)^2 + \lr{\frac{K_3}{K_1}}^2 (S_3 - S_4)^2 }
}
\end{bmatrix}.
\end{dmath}
\end{subequations}
...
\begin{aligned}
S_1 &= \sin^2 \lr{ \frac{a}{\sqrt{2}} (k_u - k_v) } \\
S_2 &= \sin^2 \lr{ \frac{a}{\sqrt{2}} (k_u + k_v) } \\
S_3 &= \sin^2 \lr{ \sqrt{2} a k_u } \\
S_4 &= \sin^2 \lr{ \sqrt{2} a k_v }
\end{aligned}
\end{dmath}
...
\lr{
S_4 - S_3 
\mp \sqrt{ \lr{\frac{K_1}{K_3}}^2 (S_2 - S_1)^2 + (S_3 - S_4)^2 } 
}
\end{bmatrix}.
\end{dmath}
...
A Manipulate allowing for choice of the spring constants and lattice orientation, as shown in \cref{fig:oneAtomBasisPhonon:oneAtomBasisPhononFig2}, is available in phy487/oneAtomBasisPhonon.nb.  This interface also provides a numerical calculation of the distribution relation as shown in \cref{fig:oneAtomBasisPhonon:oneAtomBasisPhononFig3}, and provides an animation of the normal modes for any given selection of $\Bq$ and $\omega(\Bq)$ (not shown).

%FIXME: nbref.

\imageFigure{../../figures/phy487/oneAtomBasisPhononFig2}{2D Single atom basis Manipulate interface}{fig:oneAtomBasisPhonon:oneAtomBasisPhononFig2}{0.2}
\imageFigure{../../figures/phy487/oneAtomBasisPhononFig3}{Sample distribution relation for 2D single atom basis.}{fig:oneAtomBasisPhonon:oneAtomBasisPhononFig3}{0.2}
