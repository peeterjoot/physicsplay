...
FIXME: constrains on $S_1, S_2, S_3, S_4$ for horizontal and vertical motion.
...
FIXME: constrains on $S_1, S_2, S_3, S_4$ for horizontal and vertical motion in this coordinate system.

FIXME: use my pre-calcuated expressions for $\omega^2$ and $\Bepsilon$ and verify that they work now that my expressions for $A$ are fixed up.
