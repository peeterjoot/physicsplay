...
and \textAndIndex{Fermi-Dirac distribution} as illustrated in F1
...
In F2 the distribution derivative $\PDi{T}{f}$ is plotted.  An important feature is that this derivative is zero except in the region $E \sim \EF \pm \kB T$.
...
{
zero excepth within a few $\kB T$ of $\EF$
}
\end{dmath}
