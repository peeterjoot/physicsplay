...
Here $\mu + e \phi(\Br)$ is the chemical potential shifted at $\Br$ by $e \phi(\Br)$.  As $T \rightarrow 0$
...
where the width of $\PDi{E}{f} \rightarrow 0$.  This is very much like a delta function as sketched in \cref{fig:qmSolidsL13:qmSolidsL13Fig8}, so we can write
