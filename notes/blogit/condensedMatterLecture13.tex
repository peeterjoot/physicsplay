...
\imageFigure{qmSolidsL13Fig3}{Density of states point approximation}{fig:qmSolidsL13:qmSolidsL13Fig3}{0.2}
...
\imageFigure{qmSolidsL13Fig4a}{Thermally excited region}{fig:qmSolidsL13:qmSolidsL13Fig4a}{0.2}
%\cref{fig:qmSolidsL13:qmSolidsL13Fig4b}.
\imageFigure{qmSolidsL13Fig4b}{Momentum space for linear frequency temperature region}{fig:qmSolidsL13:qmSolidsL13Fig4b}{0.2}
...
\imageFigure{qmSolidsL13Fig5a}{Free particle energy levels}{fig:qmSolidsL13:qmSolidsL13Fig5a}{0.2}
%\cref{fig:qmSolidsL13:qmSolidsL13Fig5b}.
\imageFigure{qmSolidsL13Fig5b}{Phase space region for Fermi momentum}{fig:qmSolidsL13:qmSolidsL13Fig5b}{0.2}
...
\imageFigure{qmSolidsL13Fig6}{Field in conducting metal}{fig:qmSolidsL13:qmSolidsL13Fig6}{0.2}

%\cref{fig:qmSolidsL13:qmSolidsL13Fig7}.
\imageFigure{qmSolidsL13Fig7}{Point charge in a box}{fig:qmSolidsL13:qmSolidsL13Fig7}{0.2}
...
\imageFigure{fermiDiracLevelCurvesAndEnergyDerivativesFig4pn}{Delta function like region}{fig:fermiDiracLevelCurvesAndEnergyDerivatives:fermiDiracLevelCurvesAndEnergyDerivativesFig4pn}{0.3}
%\imageFigure{qmSolidsL13Fig8}{Delta function like region}{fig:qmSolidsL13:qmSolidsL13Fig8}{0.2}
...
\imageFigure{thomasFermiScreeningFig5}{Screened vs unscreened Coulomb potential}{fig:thomasFermiScreening:thomasFermiScreeningFig5}{0.2}

%\cref{fig:qmSolidsL13:qmSolidsL13Fig9}.
%\imageFigure{qmSolidsL13Fig9}{Screened vs unscreened Coulomb potential}{fig:qmSolidsL13:qmSolidsL13Fig9}{0.2}
...
\begin{dmath}\label{eqn:condensedMatterLecture13:560}
\inv{r^2} \frac{d}{dr} \lr{ r^2 \frac{df}{dr} } = a f.
\end{dmath}

We can make this more tractable with a substitution 

\begin{dmath}\label{eqn:condensedMatterLecture13:580}
g = r f,
\end{dmath}

for which we have
\begin{dmath}\label{eqn:condensedMatterLecture13:600}
r \frac{dg}{dr} = r \lr{ f + r \frac{df}{dr} },
\end{dmath}

or

\begin{equation}\label{eqn:condensedMatterLecture13:620}
r^2 \frac{df}{dr} = 
r \frac{dg}{dr} - r f 
=
r \frac{dg}{dr} - g.
...
\begin{dmath}\label{eqn:condensedMatterLecture13:640}
\begin{aligned}
\frac{d}{dr} \lr{ 
...
\begin{dmath}\label{eqn:condensedMatterLecture13:660}
\frac{d^2 g}{dr^2} = a g.
\end{dmath}

This has the solution (see: \cref{pr:condensedMatterLecture13:1}) 

\begin{dmath}\label{eqn:condensedMatterLecture13:680}
g = \sum_{\pm} A_{\pm} e^{\pm \sqrt{a} r},
\end{dmath}

Picking the non-hyperbolic solution, that is

\begin{dmath}\label{eqn:condensedMatterLecture13:700}
