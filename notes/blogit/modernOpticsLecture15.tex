...
We are going to look at the far field of a diffraction grating with $N$ illuminated slits

F1

using the convolution theorem, constructing the object as a convolution, with transmission
...
\fxwarning{exercise: prove convolution theorem}{prove it.}
...
\Delta \gamma 
= \gamma_{\text{zero}} - \gamma_{\text{peak}} 
= \frac{l}{N} \pi - m \pi
...
\gamma_{\text{peak}, 1} = \pi \frac{\omega_1}{\omega_0} \sin\theta = m \pi
\end{dmath}
\begin{dmath}\label{eqn:modernOpticsLecture15:520}
\gamma_{\text{peak}, 2} = \pi \frac{\omega_2}{\omega_0} \sin\theta = m \pi
\end{dmath}
