...
Scrouge for notes to scan from somebody else so I can fill in.  Suggested reading for this lecture is \S 5 from
\cite{hecht1998hecht}.
...
\begin{dmath}\label{eqn:modernOpticsLecture1:n}
n \theta = n' \theta'
\end{dmath}
