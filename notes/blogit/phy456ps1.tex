...
Squaring, utilizing the hermition nature of the $X$ operator %, we have for $n > 2$
...
From \ref{eqn:phy456ps1:590} we see that we have the same sort of commutator relationship as in the original Hamiltionian
...
\begin{equation}\label{eqn:phy456ps1:650}
L_i \psi(r) = 0,
\end{equation}

for $r = \Abs{\Br}$.

Lets consider a specific component, say $L_z$.
