...
\phi(z) =
2 \pi \rho G 
\left( -\epsilon + R \epsilon \frac{R}{z} \right)
\end{equation}

If it were not for the inverted $R/z$ here, then everything would work out.  We want a $z/R$ so that the $R$ factors cancel and we would be left with

\begin{equation}\label{eqn:classicalMechanicsPs2:n}
\phi(z) =
2 \pi (\rho \epsilon) G (z - 1)
\end{equation}

Since $\rho \Delta A \epsilon = \lambda A$, we'd then have
...
%%%%2 \pi \rho G 
%%%%\left( -\epsilon +
%%%%R \int_{-z/R}^{(\epsilon - z)/R}
%%%%du 
%%%%\sqrt{1 + \inv{u^2}} \right).
%%%%\end{equation}
%%%%
%%%%This can be evaluated obtaining for finite $\epsilon$ and $R$
%%%%
%%%%\begin{equation}\label{eqn:classicalMechanicsPs2:n}
%%%%\begin{aligned}
%%%%\phi(z) &=
...
%%%%-\epsilon 
%%%%+R \Biggl( \\
%%%%&\frac{\sqrt{1+\frac{R^2}{z^2}} z \left(\sqrt{1+\frac{z^2}{R^2}}+\ln\left(-\frac{z}{R}\right)-\ln\left(1+\sqrt{1+\frac{z^2}{R^2}}\right)\right)}{R \sqrt{1+\frac{z^2}{R^2}}} \\
%%%%&+
%%%%\frac{(-z+\epsilon ) \sqrt{1+\frac{R^2}{(-z+\epsilon )^2}} \left(\sqrt{1+\frac{(-z+\epsilon )^2}{R^2}}+\ln\left(\frac{-z+\epsilon }{R}\right)-\ln\left(1+\sqrt{1+\frac{(-z+\epsilon )^2}{R^2}}\right)\right)}{R \sqrt{1+\frac{(-z+\epsilon )^2}{R^2}}}
%%%%\Biggr)
%%%%\Biggr)
%%%%\end{aligned}
%%%%\end{equation}
%%%%
%%%%Taking limits with $\epsilon \rightarrow 0$, and $R \rightarrow \infty$ we have
%%%%
%%%%\begin{equation}\label{eqn:classicalMechanicsPs2:n}
%%%%\phi(z) =
%%%%2 \pi \rho G 
...
%%%%\end{equation}
%%%%
%%%%I think my evaluation of the limits may have been too cavalier, because we have an $R - R$ term with $R \rightarrow \infty$.  The logs in the interior factors are also troublesome with negative arguments.
