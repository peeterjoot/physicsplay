...
\beginArtNoToc
\generatetitle{ECE1236H Microwave and Millimeter-Wave Techniques.  Lecture 1: XXX.  Taught by Prof.\ G.V. Eleftheriades}
%\chapter{XXX}
\label{chap:uwaves1}
...
\item \( \BD \) \si{Cb/m^2} : Electric flux density
FIXME: Cb?
...
Consider a closed surface S with interior volume V
...
\int_\txtV \lr{ 
\spacegrad \cdot \BJ +\PD{t}{} \int \rho } dV = 0.
\end{dmath}

Hence
\begin{dmath}\label{eqn:uwavesLecture1:340}
\spacegrad \cdot \BJ = -\PD{t}{} \int \rho.
\end{dmath}
