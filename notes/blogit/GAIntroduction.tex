...
\section{Did you ever ask your grade school teacher how to multiply vectors?}

In high school you first see vectors as sets of coordinates
...
Soon enough you will eventually learn of two multiplication like operations for vectors, the dot and cross products
...
Should you study quantum field theory, you'll encounter yet another algebraic structure, the Dirac matrices.  Products of vectors expressed with this algebra also highlight how the generalization of the dot and cross products are related to a single vector multiplication operation.  Unfortunately, this algebra comes with still another different notation
...
Here we have yet another notation, once again considerably different than the vector notation that we are comfortable with, that expresses the idea that the dot and cross products are related operations.

It should not be suprising that all of these ideas, and many others, are special cases of something more general.  The aim of this material is to provide the instruction manual for an enhanced toolbox of vector algebra techniques.  There are many applications for this new set of tools once learned.  Of particular interest here is their application to the study of electromagnetism.
