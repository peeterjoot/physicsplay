...
The aim of this material is to provide the instruction manual for an enhanced toolbox of vector algebra techniques.  These are tools that can be learned without having to first study the esoteric arts of quantum mechanics or differential forms.
