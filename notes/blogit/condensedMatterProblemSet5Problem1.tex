...
\begin{dmath}\label{eqn:condensedMatterProblemSet5Problem1:200}
\myBoxed{
Z(\omega)
= 
...
This has a minimum at $\omega = 0$, and in that neighbourhood is approximately parabolic function
...
As $\omega \rightarrow \pm \sqrt{4 K/M}$, the density of states approaches vertical asymptotes $Z(\omega) \rightarrow \infty$.  Observe that these extremes are the edges of the Brillion zone where $q a/2 = \pm \pi/2$.  For $Z(\omega)$ to be useful for probability calculations, we expect that the integral over this first Brillion zone will be finite, despite these infinite asymptotes.  Let's verify this
...
\imageFigure{1dSpringLatticeDensityOfStatesFig1}{1D density of states for Harmonic chain}{fig:1dSpringLatticeDensityOfStates:1dSpringLatticeDensityOfStatesFig1}{0.4}
