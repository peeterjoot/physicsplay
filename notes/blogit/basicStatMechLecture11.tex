...
\item $S_{\text{Statistical entropy}}$.  This is the thermodynamic entropy introduced by Boltzman (microscopics).
\end{enumerate}
...
\imageFigure{lecture11Fig1}{Partitioning out a subset of a larger system}{fig:lecture11:lecture11Fig1}{0.3}

Breaking the system into a subsystem $1$ and the resoivoir $2$ so that with
...
d\{x_1\}
d\{p_1\}
e^{\frac{S}{k_{\mathrm{B}}}(E - H_1), N - N_1}
\end{dmath}
...
d\{p_1\}
\mathLabelBox{
e^{\frac{S}{k_{\mathrm{B}}}(E, N)}
e^{-\frac{N_1 }{k_{\mathrm{B}}}
\lr{
\PD{N}{S}
}_{E, V}
}
}{``environment'', or ``heat bath''}
e^{-\frac{H_1 }{k_{\mathrm{B}}}
\lr{
\PD{E}{S}
}_{N, V}
}
...
\mathcal{P} \propto
e^{-\frac{H( \{x_1\} \{x_2\} ) }{k_{\mathrm{B}} T} }
\end{equation}
...
\mathcal{P}_1 
=
\frac{e^{-\frac{H_1}{k_{\mathrm{B}} T} }}{
\int 
d\{x_1\}
d\{p_1\}
e^{-\frac{H_1}{k_{\mathrm{B}} T} }
}
\end{equation}
...
\imageFigure{lecture11Fig2}{Larger system partitioned into many small subsystems}{fig:lecture11:lecture11Fig2}{0.3}
...
We'd have to understand how large the differences between the energy fluctuations of the different subsystems are.  We've already assumed that we have minimal long range interactions since we've treated the subsystem $1$ above in isolation.
...
\begin{equation}\label{eqn:basicStatMechLecture11:420}
Z \equiv \inv{h^{3N} N!}
\int 
d\{x_1\}
d\{p_1\}
...
\begin{equation}\label{eqn:basicStatMechLecture11:440}
\expectation{E} = -\inv{Z} \PD{\beta}{Z} = - \PD{\beta}{\ln Z}.
\end{equation}

Noting that 

\begin{equation}\label{eqn:basicStatMechLecture11:460}
\PD{\beta}{\expectation{E}} = 
\PD{T}{\expectation{E}} \lr{
-\PD{\beta}{T}
}
= k_{\mathrm{B}} T^2 \PD{T}{\expectation{E}}
\end{equation}

we find
\begin{equation}\label{eqn:basicStatMechLecture11:480}
\PDSq{\beta}{\ln Z} = \expectation{E^2} - \expectation{E}^2 = \sigma_{\mathrm{E}}^2
\end{equation}

\begin{equation}\label{eqn:basicStatMechLecture11:500}
\sigma_{\mathrm{E}}^2 = k_{\mathrm{B}} T^2 C_V \propto N
\end{equation}

\begin{equation}\label{eqn:basicStatMechLecture11:520}
\frac{\sigma_{\mathrm{E}}}{\expectation{E}} \propto \inv{\sqrt{N}}
\end{equation}
