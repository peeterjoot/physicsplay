...
d\{x_1\}
d\{p_1\}
e^{\inv{k_{\mathrm{B}}} S(E - H_1, N - N_1)}
\end{dmath}
...
\mathcal{P} \propto
e^{-\frac{H( \{x_1\} \{p_1\} ) }{k_{\mathrm{B}} T} }
\end{equation}
...
\begin{equation}\label{eqn:basicStatMechLecture11:n}
\PD{\beta}{Z} = 
-\inv{h^{3N} N!}
\int 
d\{x_1\}
...
= \expectation{E^2} - \expectation{E}^2 = \sigma_{\mathrm{E}}^2
\end{dmath}
...
= 
-\PD{T}{\expectation{E}} 
\PD{\beta}{} \inv{k_{\mathrm{B}} \beta}
= 
\PD{T}{\expectation{E}} 
\inv{k_{\mathrm{B}} \beta^2} 
