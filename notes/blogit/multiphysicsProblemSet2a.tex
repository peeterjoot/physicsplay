...
The matlab code associated with these notes is available from the github repository git@github.com:peeterjoot/matlab.git under
...
FIXME: update commit timestamp before submission (this one from ps1).
\begin{itemize}
