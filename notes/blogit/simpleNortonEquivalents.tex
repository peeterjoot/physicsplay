...
The problem contains a circuit with constant voltage source that makes the associated \textAndIndex{MNA} matrix non-symmetric.  We are given a hint that this source \( V_s \) and its internal resistance \( R_s \) can be replaced by a constant current source.
...
\imageFigure{../../figures/ece1254/nortonEquivalentFig1}{First voltage source configuration}{fig:nortonEquivalent:nortonEquivalentFig1}{0.3}

The nodal equations for this system are

\begin{enumerate}
\item \( -i_L + (V_1 - V_L) Z_s = 0 \)
\item \( V_L Z_L + (V_L - V_1) Z_s = 0 \)
\item \( V_1 = V_s \)
\end{enumerate}
...
\imageFigure{../../figures/ece1254/nortonEquivalentFig2}{Second voltage source configuration}{fig:nortonEquivalent:nortonEquivalentFig2}{0.3}
...
\imageFigure{../../figures/ece1254/nortonEquivalentFig3}{Current source configuration}{fig:nortonEquivalent:nortonEquivalentFig3}{0.3}

There is only one nodal equation for this circuit

\begin{enumerate}
\item \( -I_s + V_L Z_s + V_L Z_L = 0 \)
\end{enumerate}
...
\begin{dmath}\label{eqn:conjugateGradientAlgorithm:220}
I_s 
= 
...
%\begin{equation}\label{eqn:conjugateGradientAlgorithm:240}
