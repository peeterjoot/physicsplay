...
%\chapter{Intro to semiconductor physics}
...
\section{Intro to semiconductor physics}
...
\imageFigure{qmSolidsL22Fig1}{Conduction and valence bands}{fig:qmSolidsL22:qmSolidsL22Fig1}{0.2}
...
What we really want to figure out is how to calculate the density of the electons in the conduction band, and the density of the holes that are left behind.
...
\imageFigure{qmSolidsL22Fig2}{Conduction and valence density of states}{fig:qmSolidsL22:qmSolidsL22Fig2}{0.2}

The ``intrinsic'' number of electrons in the conduction band equals the number of holes in the valence band, so that $n = p:\EF$ adjusts accordingly.
...
=
\lr{ \frac{ 2 \pi m_n^\conj \kB T}{ h^2 }  }^{3/2}
...
p = 
\lr{ \frac{ 2 \pi m_p^\conj \kB T}{ h^2 }  }^{3/2}
...
We introduce a ``donor'', such as \ce{P} in \ce{Si}, as sketched in \cref{fig:qmSolidsL22:qmSolidsL22Fig3}.  Four electrons make $s p^3$ hybrid orbitals with one electon left over.

\imageFigure{qmSolidsL22Fig3}{\ce{P} donor, $T = 0$ (cf. hydrogen atom)}{fig:qmSolidsL22:qmSolidsL22Fig3}{0.2}
...
\imageFigure{qmSolidsL22Fig4}{Donors are ionized at low $T$}{fig:qmSolidsL22:qmSolidsL22Fig4}{0.2}
...
\imageFigure{qmSolidsL22Fig5}{N-type (only donor) temperature dependence}{fig:qmSolidsL22:qmSolidsL22Fig5}{0.2}
...
\imageFigure{qmSolidsL22Fig6}{Acceptor energy distribution with temperature}{fig:qmSolidsL22:qmSolidsL22Fig6}{0.2}
