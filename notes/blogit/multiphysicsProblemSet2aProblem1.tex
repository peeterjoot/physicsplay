...
Code for the netlist generation, the nodal equation generation were implemented in
...
The CG iteration for this matrix (at least for my initial guess) not only did not converge, but diverged.  For example using \href{https://raw.github.com/peeterjoot/matlab/master/ece1254/ps2a/conjugateGradientQuarteroniPrecond.m}{conjugateGradientQuarteroniPrecond.m} the relative error increased with the iteration count as follows
...
600 & 236176069 \\ \hline
800 & 452170345 \\ \hline
1000 & 745234778 \\ \hline
1200 & 1118441441 \\ \hline
1400 & 1574322955 \\ \hline
1600 & 2115039344 \\ \hline
\end{tabular}
}

The driver for the calls to the functions listed above can be found in \href{https://raw.github.com/peeterjoot/matlab/master/ece1254/ps2a/usenetlist.m}{usenetlist.m}
