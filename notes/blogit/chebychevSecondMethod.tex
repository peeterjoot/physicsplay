...
Prof. Eleftheriades desribed a Chebychev antenna array design method that looks different than the one of the text \citep{balanis2005antenna}.
...
However, with this factor of two included, the connection between the final array factor polynomial \cref{eqn:chebychevSecondMethod:180}, and the Chebychev polynomial \( T_m \) is not clear to me.  How does this scaling impact the roots?
...
This array function is highly phase dependent, plotted for \( u_0 = 0 \) in \cref{fig:ChebychevSecondMethodPolar:ChebychevSecondMethodPolarFig3}, and \cref{fig:ChebychevSecondMethodSPolar:ChebychevSecondMethodSPolarFig4}.
...
This can be directed along a single direction (z-axis) with higher phase choices as illustrated in \cref{fig:ChebychevSecondMethodPolar:ChebychevSecondMethodPolarFig1pn}, and \cref{fig:ChebychevSecondMethodSPolar:ChebychevSecondMethodSPolarFig2pn}.
