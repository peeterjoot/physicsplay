...
The geometric of a 3D harmonically coupled system with a non-zero equilibrium length is sketched in
...
Now everything is directed along $\widehat{\Delta \Br}$ (something free to rotate if the system has some angular momentum), which allows for the introduction of scalar displacement coordinates, relative to the center of the equilibrium position
