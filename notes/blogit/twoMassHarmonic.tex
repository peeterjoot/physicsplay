...
K_{\Bn \Bm}
\cos\theta_{\Bn \Bm k}
\widehat{\Delta \Ba} \cdot \Delta \Bu_{\Bn \Bm},
\end{dmath}
...
K_{\Bn \Bm}
\widehat{\Delta \Ba}
\lr{ \widehat{\Delta \Ba} \cdot \Delta \Bu_{\Bn \Bm} },
\end{dmath}

or
\begin{dmath}\label{eqn:twoMassHarmonic:1000}
\myBoxed{
m_\Bn \ddot{\Bu}_\Bn 
= 
-\sum_{\Bm}
K_{\Bn \Bm}
\Proj_{ \widehat{\Delta \Ba} } \Delta \Bu_{\Bn \Bm},
}
\end{dmath}
...
\paragraph{Rectangular lattice}

As a concrete example, let's consider a two atom basis rectangular lattice where the horizontal length is $a$ and vertical height is $b$.
...
%\imageFigure{../../figures/phy487/twoMassSpringCouplingFig7}{Rectangular lattice}{fig:twoMassSpringCoupling:twoMassSpringCouplingFig7}{0.3}
\imageFigure{../../figures/phy487/twoMassSpringCouplingFig8}{Primitive unit cells for rectangular lattice}{fig:twoMassSpringCoupling:twoMassSpringCouplingFig8}{0.3}
...
\begin{subequations}
\begin{dmath}\label{eqn:twoMassHarmonic:n}
m_1 \Bu_\n1 = 
- K_1 
\Proj_\xcap
\lr{
...
Our projection operations, in matrix form, are:
...
\paragraph{Rectangular lattice with cross coupling}
