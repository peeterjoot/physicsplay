...
With a coupling constant of $K_{\Bn \Bm}$ between lattice points indexed $\Bn$ and $\Bm$ (located at $\Ba_\Bn$ and $\Ba_\Bm$ respectively), and direction cosines for the equibrium direction vector between those points given by
...
-\sum_{\Bm}
K_{\Bn \Bm}
\Proj_{ \widehat{\Delta \Ba} } \Bu_{\Bn \Bm},
}
\end{dmath}
