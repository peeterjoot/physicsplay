...
\beginArtNoToc
\generatetitle{PHY452H1S Basic Statistical Mechanics.  Lecture 1: What is statististical mechanics and equilibrium.  Taught by Prof.\ Arun Paramekanti}
...
%\section{What is statististical mechanics and equilibrium}

\fxwarning{review lecture 1}{work through this lecture in detail.}

This is the study of systems in \underline{equilibrium}.  What is equilibrium?

\begin{itemize}
\item Mechanical equilibrium example: ball in bowl
\item Chemical equivibrium: when all the reactants have been consumed, or rates of forward and backwards reactions have become more constant.
\end{itemize}

More generally, equilibrium is a matter of time scales!

Example: Water in a cup.  After 1 min - 1 hour, when any sloshing has stopped, we can say it's in equilibrium.  However, if we consider a time scale like 10 days, we see that there are changes occuring (evaporation).

Example: hot water in a cup.  less than 10 minute time scale: Not in equilibrium (evaporating).  At a longer time scale we may say it's reached equilibrium, but again on a, say, 10 day time scale, we'd again reach the conclusion that this system is also not in equilibrium.
...
\sim 10 years -> equilibrium
\sim 100-1000 years -> not in equilibrium

Feynman
``Fast things have happened and all slow things have not''

Example: battery and resistor
...
Analogy: Election.  We can poll a sample of the population if we want to attempt to predict results.  We want to know things, but not what every person thinks.
