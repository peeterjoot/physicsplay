...
\imageFigure{qmSolidsL5Fig1}{Diffraction in crystal by x-rays, neutrons, ...}{fig:qmSolidsL5:qmSolidsL5Fig1}{0.2}

In the crystal we can imagine light and atom interaction as illustrated in \cref{fig:qmSolidsL5:qmSolidsL5Fig2}.

\imageFigure{qmSolidsL5Fig2}{Diffraction interaction in the crystal}{fig:qmSolidsL5:qmSolidsL5Fig2}{0.2}
...
\imageFigure{qmSolidsL5Fig3}{1D crystal diffraction electron density}{fig:qmSolidsL5:qmSolidsL5Fig3}{0.3}
...
\imageFigure{qmSolidsL5Fig4}{2d periodic lattice}{fig:qmSolidsL5:qmSolidsL5Fig4}{0.2}
