...
\begin{equation}\label{eqn:problemSet4Problem4:920}
M = 
\begin{bmatrix}
A & B \\
C & D
...
\begin{dmath}\label{eqn:problemSet4Problem4:940}
0 
...
\begin{dmath}\label{eqn:problemSet4Problem4:960}
\lambda = 
...
\begin{dmath}\label{eqn:problemSet4Problem4:980}
\Abs{ \frac{\tr M}{2} } < 1,
\end{dmath}

or
\begin{equation}\label{eqn:problemSet4Problem4:1000}
-1 < \frac{\tr M}{2} < 1.
\end{equation}
...
\begin{equation}\label{eqn:problemSet4Problem4:1020}
0 < \frac{\tr M + 2 }{4} < 1.
\end{equation}

Now lets apply this to our ABCD matrix 

\begin{dmath}\label{eqn:problemSet4Problem4:1040}
\frac{\tr M + 2 }{4} 
=
\inv{4}
\left( 
...
\begin{equation}\label{eqn:problemSet4Problem4:1060}
\boxed{
0 < \alpha_1 \alpha_2 < 1
}
\end{equation}
...
%\end{equation}
%\begin{dmath}\label{eqn:problemSet4Problem4:800}
...
%
%\begin{dmath}\label{eqn:problemSet4Problem4:820}
...
%
%or
%\begin{equation}\label{eqn:problemSet4Problem4:900}
%\Abs{
...
%
%See on re-inspection that \ref{eqn:problemSet4Problem4:820} is wrong, which messes up everything after it.  It's also glaringly obvious that I need to somehow get $d$ out of the works if the final inequality is to only involve $\alpha_1$ and $\alpha_2$.  This should probably be done early, but how?
}
