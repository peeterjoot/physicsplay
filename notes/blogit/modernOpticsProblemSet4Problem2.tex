...
Direct niave computation of $0 = \Det( M - \lambda I )$ is hard, it gives a big ass messy expression that's hard to make heads or tails of.  If we consider the 2 dimensional eigenvalue problem more generally, some simplifications can be made.  With 
