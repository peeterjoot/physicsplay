...
We can now state the 3D divergence theorem, cancelling out the metric and orientation dependent term $I^2$ on both sides
...
Observe that the dual representation nicely removes the alternation of sign that we had in the Stokes theorem boundary integral, since each permuation of the vectors whos wedge products make up our pseudoscalar, change the sign once.
...
FIXME: we can use a divergence theorem duality transformation to remove the sign alternation.  Express this in coordinates.
