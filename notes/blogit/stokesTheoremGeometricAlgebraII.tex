...
\makedigression{
As before, it is not too hard to show that the coordinate representation for this volume element dotted with the curl can be represented as a sum of antisymmetric terms.  In this case, that sum is
...
\section{Summary of volume integral coordinate representations}

Should we wish to formulate the curl integrals in tensor form, here is a summary, for vectors $\Bf$, and bivectors $B$, of the coordinate representations of those differential forms 
