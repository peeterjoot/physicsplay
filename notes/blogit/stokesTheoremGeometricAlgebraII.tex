...
Notice that the $(-1)^{k+1}$ factor that appeared on both sides has been canceled, however, we are not able to cancel the $I_k I$ product since $I_k = I_k(\Bx)$ is position dependent.
