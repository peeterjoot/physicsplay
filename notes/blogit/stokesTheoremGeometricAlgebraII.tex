...
Here the bivector is expressed in terms of its components on the tangent space
...
FIXME:todo.  Play \eqnref{eqn:stokesTheoremGeometricAlgebraII:1960} backwards.

\makeSubAnswer{Four parameter volume, curl of vector}{pr:stokesTheoremGeometricAlgebraII:c}

FIXME: fill in the details and expand.

\begin{dmath}\label{eqn:stokesTheoremGeometricAlgebraII:2140}
d^4 \Bx \cdot \lr{ \boldpartial \wedge \Bf }
=
\lr{ d^4 \Bx \cdot \Bx^i } \cdot \partial_i \Bf
=
...
=
- \inv{4} d^4 u \epsilon^{abcd} \Bx_a \wedge \Bx_b \partial_{[c} f_{d]}
.
\end{dmath}
