...
% don't really want lavendar (like the light blue) ... am I getting the default?
...
As an expositional example, let's now consider the curl of a vector field, integrated over a three parameter surface.
