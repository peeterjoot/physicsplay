...
\begin{dmath}\label{eqn:stokesTheoremGeometricAlgebraII:4650}
\int_V \gpgrade{ \Bf' d^k \Bx \spacegrad'}{k} I
=
\int_V \gpgrade{ \Bf' \lr{ 
   \spacegrad' d^k \Bx
   + 2 d^k \Bx \wedge \spacegrad'
}}{k} I
=
\int_V \gpgrade{ \Bf' \spacegrad' d^k \Bx}{k} I
=
\int_V {\Bf' \cdot \spacegrad'} d^k \Bx I
=
I \int_V d^k \Bx \spacegrad \cdot \Bf,
\end{dmath}

and when $k$ is even
\begin{dmath}\label{eqn:stokesTheoremGeometricAlgebraII:4670}
\int_V \gpgrade{ \Bf' d^k \Bx \spacegrad'}{k} I
=
\int_V \gpgrade{ \Bf' \lr{ 
   -\spacegrad' d^k \Bx
   + 2 d^k \Bx \cdot \spacegrad'
}}{k} I
=
\int_V -\lr{\Bf' \cdot \spacegrad'} d^k \Bx I + 2 \lr{ \Bf' \wedge \lr{ d^k \Bx \cdot \spacegrad'}}  I
\end{dmath}

FIXME: continue.  Can the even case be handled differently?  (Generalizing what I did on paper for R2?)
