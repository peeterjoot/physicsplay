...
For blades $F \in \bigwedge^{s}$, and $m$ volume element $d^k \Bx, s < k$, the generalization of Stokes theorem to higher dimensional spaces, expressed in the formalism of geometric algebra is

\begin{theorem}\label{thm:stokesTheoremGeometricAlgebraII:1740}
...
%%%This almost has the form of \eqnref{eqn:stokesTheoremGeometricAlgebraII:1860}.  Let's expand these dot products in coordinates, and as above, introduce the shorthand $u^1 = u$, and $u^2 = v$
%%%
%%%\begin{dmath}\label{eqn:stokesTheoremGeometricAlgebraII:1880}
%%%\PD{u}{\Bf} \cdot \Bx_v
%%%=
%%%\lr{ \PD{u}{} 
%%%\lr{ f_u \Bx^u + f_v \Bx^v + f_\perp \Bx^\perp }
%%%} \cdot \Bx_v
%%%=
%%%\PD{u}{f_u} \cancel{\Bx^u \cdot \Bx_v}
%%%+
%%%\PD{u}{f_v} \Bx^v \cdot \Bx_v
%%%+
%%%\PD{u}{f_\perp} \cancel{\Bx^\perp \cdot \Bx_v}
%%%+
%%%\PD{u}{\Bx^u} 
%%%\cdot \Bx_v
%%%f_u
...
%%%} \cdot \Bx_u
%%%=
%%%-\PD{v}{f_u} \Bx^u \cdot \Bx_u
%%%-
%%%\PD{v}{f_v} \cancel{\Bx^v \cdot \Bx_u}
%%%-
%%%\PD{v}{f_\perp} \cancel{\Bx^\perp \cdot \Bx_u}
%%%-
%%%\PD{v}{\Bx^u} 
%%%\cdot \Bx_u
%%%f_u
