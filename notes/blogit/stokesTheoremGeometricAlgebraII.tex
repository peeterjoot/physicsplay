...
The second last step uses \cref{thm:stokesTheoremGeometricAlgebraII:4690}, and the last writes $d^k \Bx = I \sgn\lr{d^\Bk x} dV$ where the sign depends on the pseudoscalar volume element.
