...
The duality relation \cref{thm:stokesTheoremGeometricAlgebraII:3200} can be recast in a couple other forms
...
If we scale the wedge product $\Ba \wedge \Bb$ by its absolute magnitude, this can serve as a pseudoscalar for the plane that spans $\setlr{\Ba, \Bb}$.  Writing

\begin{dmath}\label{eqn:stokesTheoremGeometricAlgebraII:4910}
I_{\Ba\Bb} = \frac{\Ba \wedge \Bb}{\Abs{\Ba \wedge \Bb}},
\end{dmath}

the unit vector in the direction of $\Ba^\conj$ is

\begin{dmath}\label{eqn:stokesTheoremGeometricAlgebraII:4930}
%\acap^\conj
\aconjcap
= \bcap \frac{\Abs{\Ba \wedge \Bb}}{\Ba \wedge \Bb},
\end{dmath}

%Note the notational abuse, since I don't mean the dual of $\acap$ here.  We can write this as
or
...
\maketheorem{Dual vector in a three vector subspace}{thm:stokesTheoremGeometricAlgebraII:4950}{
