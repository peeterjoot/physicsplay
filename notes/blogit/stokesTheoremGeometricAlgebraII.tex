...
Using can use the duality relationship of \cref{thm:stokesTheoremGeometricAlgebraII:3200} to compute the reciprocal basis for the tangent plane vectors.  This calculation is metric dependent, since $\lr{\Be_3}^2 = \pm 1$ for the specified Euclidean and Minkowski spaces respectively
