...
Phase of a laser, if monochromatic as in 
...
This is a random walk in phase!
...
\begin{dmath}\label{eqn:modernOpticsLecture21:n}
...
\begin{equation}\label{eqn:modernOpticsLecture21:n}
\begin{aligned}
P &\sim 1 \mathrm{mW} \\
L &\sim 1 \mathrm{m} \\
T &\sim 2 \% \\
\lambda &\sim 500 \mathrm{nm} \\
\expectaion{n} &= 8 \times 10^8 \\
