...
The lattice and the primitive lattice vectors are sketched in \eqnref{fig:qmSolidsPs3P2a:qmSolidsPs3P2aFig1}.

\imageFigure{qmSolidsPs3P2aFig1}{Fcc lattice and primative lattice vectors}{fig:qmSolidsPs3P2a:qmSolidsPs3P2aFig1}{0.3}
...
This allows us to read off the corners of the cube in terms of the primative lattice vectors (which perhaps could have been done by inspection)
...
Our lattice points, in terms of the primative vectors are
\begin{enumerate}
\item $\Ba_1 + \Ba_2 - \Ba_3$
\item $2 \Ba_2$
\item $\Ba_1 + \Ba_2 + \Ba_3$
...
We've already computed the (signed) volume element in \eqnref{eqn:condensedMatterProblemSet3Problem2:80}.  The absolute value of this is the volume of the primative unit cell

\begin{dmath}\label{eqn:condensedMatterProblemSet3Problem2:n}
V_{\text{primative cell}}
=
\Abs{
\Ba_1 \cdot \lr{ \Ba_2 \cross \Ba_3 } 
}
