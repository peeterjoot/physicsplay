...
We've already computed the (signed) volume element in \cref{eqn:condensedMatterProblemSet3Problem2:80}.  The absolute value of this is the volume of the primative unit cell
