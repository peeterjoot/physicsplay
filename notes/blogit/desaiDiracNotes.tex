...
Ah.  This is purely imaginary, and accounts for the Hermiticity of $C$ in this specific example.  Are the logs of the eigenvalues of unitary matrixes all purely imaginary?  That seems like a lot to ask for.
...
FIXME: probably also ought to show explicitly that the Unitary eigenvalues are unit norm, since I don't remember how that result was obtained (that hint came curtosy of wikipedia \cite{wiki:unitary}, which references Shankar).
