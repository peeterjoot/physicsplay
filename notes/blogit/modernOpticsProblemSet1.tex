...
Our system and the associated transfer matrices labels is illustrated in figure (\ref{fig:modernOpticsProblemSet1:modernOpticsProblemSet1Fig1aTake2}).
...
Here we refer to figure (\ref{fig:modernOpticsProblemSet1:modernOpticsProblemSet1Fig1c}).
