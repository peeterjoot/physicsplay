...
Given the $y(0) = 0$ boundary constraint, we can only pick the negative root, so 
...
Let's look at the small limit where $s \ll n_0/\beta$.  Borrowing the $L = n_0/\beta$ notation from later in the problem, we have for $s \ll L$
