...
\makeproblem{General case.  Arbitrary polarization angle.}{fresnelAlternatePolarization:pr3}{ }
...
Note that the two wedge product equations above have been separated into $\Be_3 \Be_1$ and $\Be_3 \Be_2$ components.  Because of \ref{eqn:fresnelAlternatePolarization:710}, we see that \ref{eqn:fresnelAlternatePolarization:990} and \ref{eqn:fresnelAlternatePolarization:1050b} are dependent.  Also, as demonstrated in \ref{eqn:fresnelAlternatePolarization:430} we see that \ref{eqn:fresnelAlternatePolarization:1010} and \ref{eqn:fresnelAlternatePolarization:1030a} are also dependent.  We can therefore consider only the last four equations (and still have an additional linear dependencies to be discovered)
}
