...
Referring to figure FIXME we have a bit of a geometrical task to tackle, since we've got to express all the various unit vectors algebraically.  I'll use Geometric Algebra here to do that for its compact expression of rotations.  With
