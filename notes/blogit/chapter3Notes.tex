...
\item Prof. Eleftheriades's J looks like pi with a tail \cref{fig:profJ:profJFig1}.
\imageFigure{../../figures/ece1229/profJFig1}{Prof handwriting decoder: J.}{fig:profJ:profJFig1}{0.05}
\item Prof. Eleftheriades's \( \lambda\) looks like \cref{fig:profLambda:profLambdaFig2} (a mirror image of his 'h'.)
\imageFigure{../../figures/ece1229/profLambdaFig2}{Prof handwriting decoder: \( \lambda \).}{fig:profLambda:profLambdaFig2}{0.1}
\item Prof. Eleftheriades's \( \mu\) can look like an M \cref{fig:profMu:profMuFig3}.
\imageFigure{../../figures/ece1229/profMuFig3}{Prof handwriting decoder: \( \mu \).}{fig:profMu:profMuFig3}{0.05}
