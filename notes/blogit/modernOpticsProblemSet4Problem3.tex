...
%{\bf (b)}
Find the beam waist for a general cavity, in terms of $L$, $R$, and $\lambda$. Do you notice anything strange for the conencentric cavity, $R=L/2$ ? For the confocal case, you should find that $w_0^2 = L/k$. 
