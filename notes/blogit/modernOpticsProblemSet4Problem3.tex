...
%{\bf (b)}
Find the beam waist for a general cavity, in terms of $L$, $R$, and $\lambda$. Do you notice anything strange for the conencentric cavity, $R=L/2$ ? For the confocal case, you should find that $w_0^2 = L/k_0$. 
...
\begin{dmath}\label{eqn:problemSet4Problem3:80}
\boxed{
z_0 
...
Definitions and nice illustrations of the different cavity types can be found in \citep{ wiki:opticalCavity}.  For the \underline{confocal cavity} defined by $L = R$, we have
