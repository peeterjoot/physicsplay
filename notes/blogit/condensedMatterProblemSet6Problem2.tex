...
contained in a three-dimenionsional box, with two of the dimensions 
...
levels are quasicontinuous in two dimensions, but discrete in the
...
one direction in $q$ space is quasicontinuous.)
} % makeproblem
