...
\cref{fig:lecture1:lecture1Fig3}.
...
Returning to the simple static system, and introducing force and joint labels

F6
, we can examine the \textAndIndex{conservation law}, the balance of forces.
