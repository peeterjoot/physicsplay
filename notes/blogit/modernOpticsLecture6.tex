...
Parametrically plotting these we get the \underline{Cornu Spiral} 
...
Once we understand that light does in fact take all the paths, we can utilize this to build a \underline{Fresnel lens} by blocking selectively.  This allows us block all the portions of the phase that negatively interfere.  This can be used for example to focus x-rays.
