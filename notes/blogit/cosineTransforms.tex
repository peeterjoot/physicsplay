...
\begin{dmath}\label{eqn:cosineTransforms:70}
\boxed{
\tilde{f}_c(\omega) = 
\int_0^{\infty} 
\cos( \omega \tau )
...
\begin{dmath}\label{eqn:cosineTransforms:110}
\boxed{
...
\begin{dmath}\label{eqn:cosineTransforms:150}
\boxed{
f(\tau)
=
...
It's not obvious that we can even do this.  If we start
...
\begin{dmath}\label{eqn:cosineTransforms:250}
\boxed{
\int_0^\infty d\tau \cos(\omega \tau) 
% too small:
%\widetilde{
