...
In class when discussing the tight binding characteristics of s-orbital alkali metals (\ce{Li}, \ce{K}, \ce{Na}, ...), it was noted that their Fermi surfaces never get close to the Brillioun boundary, and that they were approximately spherical.  All of the surfaces constrained to the bucket ($E < E_s - A$) are far from the Brillion boundary, but at $E = E_s - A - 2B$ we are just starting to loose the ``spherical'' (aka. circular for this lattice) character of these surfaces.  We expect that the Fermi energy $\EF$ has an upper bound of $\EF = E_s - A - 2B$, a position in the bucket where the contours are still nearly circular.
...
\imageFigure{qmSolidsPs8dFig2}{Energy level curves}{fig:qmSolidsPs8d:qmSolidsPs8dFig2}{0.3}
