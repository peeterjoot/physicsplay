...
The nearest neighbour differerences are illustrated in \cref{fig:qmSolidsPs8a:qmSolidsPs8aFig1}, which we see are

\imageFigure{qmSolidsPs8aFig1}{Cubic nearest neighbour differences}{fig:qmSolidsPs8a:qmSolidsPs8aFig1}{0.3}
...
$E(\Bk)$ ranges from $E_s - A - 2 B(1 + 1)$ to $E_s - A - 2 B ( - 1 - 1)$.  The difference is
