...
\section{Electrical transport (cont.)}
...
\imageFigure{qmSolidsL19Fig1}{Gaussian wave packet}{fig:qmSolidsL19:qmSolidsL19Fig1}{0.2}
...
\begin{dmath}\label{eqn:condensedMatterLecture19:40}
...
\imageFigure{qmSolidsL19Fig2}{Non-spherical Fermi surface}{fig:qmSolidsL19:qmSolidsL19Fig2}{0.3}
\imageFigure{qmSolidsL19Fig3}{Second non-spherical Fermi surface}{fig:qmSolidsL19:qmSolidsL19Fig3}{0.3}
...
\imageFigure{qmSolidsL19Fig4}{Wave packet along distribution curve}{fig:qmSolidsL19:qmSolidsL19Fig4}{0.3}
...
= \sum_j \lr{ \inv{m^\conj}}_{i j} \lr{ -e \mathcal{E}_j }
\end{dmath}
...
\imageFigure{qmSolidsL19Fig5}{Effective mass tensor}{fig:qmSolidsL19:qmSolidsL19Fig5}{0.3}
...
\imageFigure{qmSolidsL19Fig6}{Illustration for points above}{fig:qmSolidsL19:qmSolidsL19Fig6}{0.3}

\section{Electric current}

Reading: \citep{ibach2009solid} \S 9.2
...
= - e\frac{2}{8 \pi^3} \int d\Bk \spacegrad_\Bk E(\Bk) \cdot f(E(\Bk), \EE)
\end{dmath}

Here $f(E(\Bk, \EE)$ is the electron distribution in presensce of field $\EE$.

\paragraph{In equilibrium $\EE = 0$}

%\cref{fig:qmSolidsL19:qmSolidsL19Fig7}.
%\imageFigure{qmSolidsL19Fig7}{?}{fig:qmSolidsL19:qmSolidsL19Fig7}{0.3}
