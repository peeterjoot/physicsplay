...
%spherical tensors
%
%T_1(k_1, q_1)&\qquad q_1 = -k_1, \cdots, k_1 		& \ket{k_1 q_1} 		& \ket{k_2 q_2} \\
%T_2(k_2, q_2)&\qquad q_2 = -k_2, \cdots, k_2		& q_1 = -k_1, \cdots k_1 	& q_2 = -k_2, \cdots k_2 \\
%T(k, q) = \sum_{q_1, q_2} 
%T_1(k_1, q_1)
%T_2(k_2, q_2)
...
%spherical tensor rank 1		(3)			9
%spherical tensor rank 2		(5)
%				---
%				 9
