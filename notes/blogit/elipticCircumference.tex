...
There's two ways that I think of ellipses.  One is the shape that you get when you put a couple tacks in a paper, and use a string and pencil to trace it out.  The other is the basic vector parameterization of that same path 
