...
I_{i j} = \sum_a m_a \left( \delta_{i j} \Br_a^2 - r_{a_i} r_{a_j}
\end{dmath}
...
\imageFigure{parallelAxisTheoremFig1}{Volume element for continous mass distribution}{fig:parallelAxisTheorem:parallelAxisTheoremFig1}{0.3}

For this continuous case we have

\begin{dmath}\label{eqn:parallelAxisTheorem:70}
I_{i j} 
= \int_V d^3 r \rho(\Br) \left( \delta_{i j} \Br^2 - r_{i} r_{j}
\end{dmath}

Another property of $I_{i j}$ is the \underline{parallel axis theorem} (or as it is known in Europe and perhaps elsewhere, as the ``Steiner theorem'').

Let's consider a change of origin as in \cref{fig:parallelAxisTheorem:parallelAxisTheoremFig2}.

\imageFigure{parallelAxisTheoremFig2}{Shift of origin}{fig:parallelAxisTheorem:parallelAxisTheoremFig2}{0.3}
...
\imageFigure{parallelAxisTheoremFig3}{Infinite rolling cylinder on plane}{fig:parallelAxisTheorem:parallelAxisTheoremFig3}{0.3}

Take the mass as uniform and set up coordinates as in \cref{fig:parallelAxisTheorem:parallelAxisTheoremFig4}.

\imageFigure{parallelAxisTheoremFig4}{Coordinates for infinite cylinder}{fig:parallelAxisTheorem:parallelAxisTheoremFig4}{0.3}
...
\imageFigure{parallelAxisTheoremFig5}{Displaced CM for infinite cylinder}{fig:parallelAxisTheorem:parallelAxisTheoremFig5}{0.3}
...
\imageFigure{parallelAxisTheoremFig6}{Hollow tube with blob}{fig:parallelAxisTheorem:parallelAxisTheoremFig6}{0.3}
...
\imageFigure{parallelAxisTheoremFig7}{Hollow tube with cylindrical blob}{fig:parallelAxisTheorem:parallelAxisTheoremFig7}{0.3}

Recall for a general body as in \cref{fig:parallelAxisTheorem:parallelAxisTheoremFig8}.

\imageFigure{parallelAxisTheoremFig8}{general body coordinates}{fig:parallelAxisTheorem:parallelAxisTheoremFig8}{0.3}
...
\begin{dmath}\label{eqn:parallelAxisTheorem:370}
\Bv 
= \BV_{\mathrm{CM}} 
+ \BOmega \cross \Br
...
If $\BV_{\mathrm{CM}}$ and $\BOmega$ are perpencicular always there always exists $\Ba$ such that $A$ is at rest.

Another example is a cone on plane or rod as in \cref{fig:parallelAxisTheorem:parallelAxisTheoremFig9}.

\imageFigure{parallelAxisTheoremFig9}{Cone on rod}{fig:parallelAxisTheorem:parallelAxisTheoremFig9}{0.3}
...
\imageFigure{parallelAxisTheoremFig10}{Momentary axes of rotation}{fig:parallelAxisTheorem:parallelAxisTheoremFig10}{0.3}

\paragraph{Aside}

more interesting is the cone viewed from above as in \cref{fig:parallelAxisTheorem:parallelAxisTheoremFig11}.

\imageFigure{parallelAxisTheoremFig11}{Cone from above}{fig:parallelAxisTheorem:parallelAxisTheoremFig11}{0.3}

Coordinates for this problem as in \cref{fig:parallelAxisTheorem:parallelAxisTheoremFig12}.

\imageFigure{parallelAxisTheoremFig12}{Momentary axes of rotation for cone on stick}{fig:parallelAxisTheorem:parallelAxisTheoremFig12}{0.3}

Using \ref{eqn:parallelAxisTheorem:370} we have
...
\imageFigure{parallelAxisTheoremFig13}{Coordinates}{fig:parallelAxisTheorem:parallelAxisTheoremFig13}{0.3}
...
\Abs{\BV_{\mathrm{CM}}} 
= \Abs{\phidot} \Abs{\Bb}
= \phidot \Abs{\Bb} \times \mbox{movint unit vector in x y plane}
