...
\makeproblem{Geometry of general Jones vector (problem 2.8)}{ch2:pr8}{
...
(with $\atan2 = \atan2(x, y)$).  Since we can absorb a constant phase factor into our $-iu$ argument, we can write this as
