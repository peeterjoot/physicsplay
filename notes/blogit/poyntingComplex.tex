...
The electric fields, with $\phi = k z - \omega t$, are

\begin{enumerate}
\item 
\begin{dmath}\label{eqn:poyntingComplex:n}
\Real\left(
E_0 ( \icap + \jCap ) e^{i \phi}
\right)
=
E_0 (\icap + \jCap) \cos\phi
\end{dmath}
\item 
\begin{dmath}\label{eqn:poyntingComplex:n}
\Real\left(
E_0 ( \icap + 2 \jCap ) e^{i \phi}
\right)
=
E_0 (\icap + 2 \jCap) \cos\phi
\end{dmath}
\item 
\begin{dmath}\label{eqn:poyntingComplex:n}
\Real\left(
E_0 ( \icap - i \jCap ) e^{i \phi}
\right)
=
E_0 
\left(
...
\begin{dmath}\label{eqn:poyntingComplex:n}
\Real\left(
E_0 \left( \icap - \inv{\sqrt{2}} \jCap (1 + i) \right) e^{i \phi}
\right)
=
E_0 
\left(
