...
\beginArtNoToc
\generatetitle{PHY1520H Graduate Quantum Mechanics.  Lecture 4: XXX.  Taught by Prof.\ Arun Paramekanti}
%\chapter{XXX}
\label{chap:lecture4}
...
\paragraph{Classical Harmonic Oscillator}
...
These are ellipses in phase space
...
\hat{H} = \frac{\phat^2}{2 m} + \inv{2} k \xhat^2
\end{dmath}
...
\Xhat = \sqrt{\frac{m \omega}{\Hbar}} \xhat
\end{equation}
\begin{equation}\label{eqn:qmLecture4:220}
\Phat = \sqrt{\inv{m \omega \Hbar}} \phat
\end{equation}
\end{subequations}
...
\antisymmetric{ \xhat}{\phat} = i \Hbar,
\end{equation}

to
\begin{equation}\label{eqn:qmLecture4:260}
\antisymmetric{ \Xhat}{\Phat} = i.
\end{equation}
...
\Hhat 
= \frac{\Hbar \omega}{2} \lr{ \Xhat^2 + \Phat^2 }
= \Hbar \omega \lr{ \frac{\Xhat -i \Phat}{\sqrt{2}} \frac{\Xhat +i \Phat}{\sqrt{2}} + \inv{2} }.
\end{dmath}
...
\ahat^\dagger = \frac{\Xhat -i \Phat}{\sqrt{2}} 
\end{dmath}
\begin{dmath}\label{eqn:qmLecture4:340}
\ahat = \frac{\Xhat +i \Phat}{\sqrt{2}} 
\end{dmath}
\end{subequations}
...
\Hhat = \Hbar \omega \lr{ \ahat^\dagger \ahat^\dagger + \inv{2} }.
\end{dmath}

We can show

\begin{dmath}\label{eqn:qmLecture4:380}
\antisymmetric{\ahat}{\ahat^\dagger} = 1,
\end{dmath}

and

\begin{equation}\label{eqn:qmLecture4:400}
N \ket{n} \equiv \ahat^\dagger a = n \ket{n},
\end{equation}
...
\ahat \ket{n} = \sqrt{n} \ket{n-1}
\end{dmath}
\begin{dmath}\label{eqn:qmLecture4:540}
\ahat^\dagger \ket{n} = \sqrt{n + 1} \ket{n+1}
\end{dmath}
\end{subequations}

\paragraph{Coherent states}

Coherent states for the quantum harmonic oscillator are the eigenkets for the creation and anhillation operators
...
\ahat^\dagger \ket{\tilde{z}} = \tilde{z} \ket{\tilde{z}} ,
\end{dmath}
\end{subequations}
...
\ket{n} = \frac{\lr{ \ahat^\dagger }^n}{\sqrt{n!}} \ket{0},
\end{dmath}
...
\ket{z} 
= c_0 \sum_{n=0}^\infty \frac{\lr{z \ahat^\dagger}^n }{n!} \ket{0}
= c_0 e^{z \ahat^\dagger}  \ket{0}.
\end{dmath}
...
\paragraph{Dynamics} % of coherent states
...
It turns out that these questions are best tackled in the Heisenburg picture, considering

\begin{dmath}\label{eqn:qmLecture4:880}
e^{-i \Hhat t/\Hbar } \ket{z}.
\end{dmath}

For example, what is the average of the position operator

\begin{dmath}\label{eqn:qmLecture4:900}
\bra{z} e^{i \Hhat t/\Hbar } \xhat e^{-i \Hhat t/\Hbar } \ket{z}.
=
\sum_{n, n' = 0}^\infty 
...
\expectation{\xhat}(t) = \bra{z} \xhat_\txtH(t) \ket{z},
\end{dmath}

and for momentum

\begin{dmath}\label{eqn:qmLecture4:960}
\expectation{\phat}(t) = \bra{z} \phat_\txtH(t) \ket{z}.
\end{dmath}
...
\ahat_\txtH(t) = e^{i \Hhat t/\Hbar} \ahat e^{-i \Hhat t/\Hbar}.
\end{dmath}
\begin{dmath}\label{eqn:qmLecture4:1020}
\ahat^\dagger_\txtH(t) = e^{i \Hhat t/\Hbar} \ahat^\dagger e^{-i \Hhat t/\Hbar}.
\end{dmath}
\end{subequations}
...
\ahat_\txtH(t) \ket{n} 
= e^{i \Hhat t/\Hbar} \ahat e^{-i \Hhat t/\Hbar} \ket{n}
= e^{i \Hhat t/\Hbar} \ahat e^{-i t \omega (n + 1/2)} \ket{n}
= 
e^{-i t \omega (n + 1/2)} 
e^{i \Hhat t/\Hbar} 
\sqrt{n} \ket{n-1}
...
\begin{aligned}
\ahat_\txtH(t) &= a e^{-i\omega t} \\
\ahat^\dagger_\txtH(t) &= a^\dagger e^{i\omega t}
\end{aligned}
\end{dmath}
