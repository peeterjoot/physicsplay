...
\imageFigure{modernOpticsLecture9Fig1}{Michaelson}{fig:modernOpticsLecture9:modernOpticsLecture9Fig1}{0.3}
...
\imageFigure{modernOpticsLecture9Fig2}{Equivalent to Michaelson}{fig:modernOpticsLecture9:modernOpticsLecture9Fig2}{0.2}
...
\begin{dmath}\label{eqn:modernOpticsLecture9:150}
\boxed{
\tau = \frac{s_2 - s_1}{c}
}
\end{dmath}
...
\imageFigure{modernOpticsLecture9Fig3}{Random step phase changes}{fig:modernOpticsLecture9:modernOpticsLecture9Fig3}{0.3}
\imageFigure{modernOpticsLecture9Fig4}{Effect of random phase changes}{fig:modernOpticsLecture9:modernOpticsLecture9Fig4}{0.3}

This isn't neccessarily a realistic system, but it one that we can calculate.
...
\imageFigure{modernOpticsLecture9Fig5}{Differences of random phases after time delay}{fig:modernOpticsLecture9:modernOpticsLecture9Fig5}{0.3}
...
To account for the cancelation, note that we are summing over a number of complex numbers, like
...
\imageFigure{modernOpticsLecture9Fig7}{Random walk evolution}{fig:modernOpticsLecture9:modernOpticsLecture9Fig7}{0.3}
...
FIXME: try such a random summation as a problem.
...
Also see \S 3.5 (FIXME: check section number) in \citep{fowles1989introduction} for this derivation.
...
\imageFigure{modernOpticsLecture9Fig6}{Resulting interference intensity}{fig:modernOpticsLecture9:modernOpticsLecture9Fig6}{0.3}
...
\begin{dmath}\label{eqn:modernOpticsLecture9:430}
\expectation{ \Psi_1 \Psi_2^\conj }
\end{dmath}
...
We see that \underline{$\gamma_{12}(\tau)$ is a Fourier transform of power spectrum of the source}.  Explicitly, that is

\begin{dmath}\label{eqn:modernOpticsLecture9:530}
\Abs{\Gamma_{12}} = e^{i \alpha_{12}(\tau)} = 4 
\int_0^\infty G_{12}(\omega) e^{-i(\omega - \bar{\omega}) \tau } d\omega
\end{dmath}
...
\imageFigure{modernOpticsLecture9Fig8}{Gaussian power spectrum and corelation}{fig:modernOpticsLecture9:modernOpticsLecture9Fig8}{0.3}
...
\imageFigure{modernOpticsLecture9Fig9}{Lorentzian power spectrum and corelation}{fig:modernOpticsLecture9:modernOpticsLecture9Fig9}{0.3}
