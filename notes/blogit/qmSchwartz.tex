...
In \citep{sakurai2014modern} the Schwartz inequality
...
\section{Without being sneaky}

My ancient first year linear algebra text \citep{nicholson1990elementary} contains a non-sneaky proof, but it only works for real vector spaces.  Recast in bra-ket notation, this method examines the bounds of the norms of sums and differences of unit states (i.e. \( \braket{a}{a} = \braket{b}{b} = 1 \).)
...
\section{Arguing with projected and rejected components}
