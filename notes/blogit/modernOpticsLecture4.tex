...
\begin{dmath}\label{eqn:modernOpticsLecture4:n}
...
\begin{dmath}\label{eqn:modernOpticsLecture4:n}
\spacegrad \left( \frac{e^{i k r}}{r}} = \rcap \left( i k - \inv{r} \right) \frac{e^{i k r}}{r}
\end{dmath}

Applying this to our problem we find

\Psi(\Br) = -\inv{4 \pi} \iint \frac{e^{i k R}}{R} \ncap \cdot \left( 
\spacegrad' \Psi + \left( i k - \inv{R} \right) \frac{\BR}{R} \Psi \right) da'.
\right)
