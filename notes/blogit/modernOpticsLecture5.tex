...
where $g(\Br')$ is an ``aperature'' function defined in the open portion as illustrated in figure (\ref{fig:modernOpticsLecture5:modernOpticsLecture5Fig4}).

\imageFigure{modernOpticsLecture5Fig4}{Circular aperature}{fig:modernOpticsLecture5:modernOpticsLecture5Fig4}{0.2}
