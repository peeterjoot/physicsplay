...
\imageFigure{qmSolidsL20Fig1}{1:CAPTION}{fig:qmSolidsL20:qmSolidsL20Fig1}{0.3}

Current flows, unless the band is completely full, or empty.

Full band has $f(E, \BE) = F(E, 0)$, so that there is no current 

%\cref{fig:qmSolidsL20:qmSolidsL20Fig2}.
\imageFigure{qmSolidsL20Fig2}{2: CAPTION}{fig:qmSolidsL20:qmSolidsL20Fig2}{0.3}
...
%\cref{fig:qmSolidsL20:qmSolidsL20Fig3}.
\imageFigure{qmSolidsL20Fig3}{3:CAPTION}{fig:qmSolidsL20:qmSolidsL20Fig3}{0.3}

A metric for this is called the resistivity, a temperature dependent effect

%\cref{fig:qmSolidsL20:qmSolidsL20Fig4}.
\imageFigure{qmSolidsL20Fig4}{4:CAPTION}{fig:qmSolidsL20:qmSolidsL20Fig4}{0.3}

\paragraph{Non-equilibrium $f(E, \EE)$}

%\cref{fig:qmSolidsL20:qmSolidsL20Fig5}.
\imageFigure{qmSolidsL20Fig5}{5:CAPTION}{fig:qmSolidsL20:qmSolidsL20Fig5}{0.3}
...
\imageFigure{qmSolidsL20Fig6}{A displaced Fermi sphere}{fig:qmSolidsL20:qmSolidsL20Fig6}{0.3}
...
\imageFigure{qmSolidsL20Fig7}{7:CAPTION}{fig:qmSolidsL20:qmSolidsL20Fig7}{0.3}
...
\imageFigure{qmSolidsL20Fig8}{Drude drift velocity in an electric field}{fig:qmSolidsL20:qmSolidsL20Fig8}{0.3}
