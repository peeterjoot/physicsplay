...
F = \BE + \frac{I}{\sqrt{\mu\epsilon}} \BB.
\end{equation}
...
\begin{dmath}\label{eqn:modernOpticsLecture2:1030}
...
\begin{dmath}\label{eqn:modernOpticsLecture2:1130}
...
Because this is now no longer any different than the result for linear media with a phasor assumed to be of the form $F_0 e^{i \Bk \cdot \Bx - i \omega t}$, we must also have as the general solution to Maxwell's equation given our approximation

\begin{dmath}\label{eqn:modernOpticsLecture2:1150}
F_0 = (1 + \kcap) \BC
\end{dmath}

where $\BC \cdot \kcap = 0$.
}
