...
FIXME: Prof wrote $n = \sqrt{\epsilon}$ ... is he scaling $n$?
...
FIXME: I'd written in class:
\begin{equation}\label{eqn:modernOpticsLecture2:n}
\phi(\Br) = \omega t
\end{equation}

which has zero gradient?  To make \ref{eqn:modernOpticsLecture2:530} work out it looks like we need
...
FIXME: to get this far we required $dn/ds = 0$, but since $\Br = \Br(s)$ it appears that we have an $s$ dependence for $n$.  How can we justify $dn/ds = 0$?
...
\makeanswer{modernOpticsLecture2:pr1}{ TODO. }
...
\makeanswer{modernOpticsLecture2:pr2}{ TODO. }
...
\makeanswer{modernOpticsLecture2:pr3}{ TODO. }
