...
Observe that the wave equation can be found by left multipling with $\spacegrad - (\sqrt{\mu\epsilon}/c) \partial_t$
...
As another check, observe that the wave equation can be found by left multipling with $\spacegrad - (\sqrt{\mu\epsilon}/c) \partial_t$
