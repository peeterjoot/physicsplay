...
\item Reconfiguration and scanning is possible if phase shifting electronsics are included.
\item Large aperature reflectarrays can be folded more easily than parabolic equivalents (for space applications).
...
\begin{itemize}
\item Narrow bandwidth, due to narrow bandwitch of patch elements (3-5\%)
...
\citep{pozar1997design}
\begin{figure}
\includegraphics[scale=0.15]{../../figures/ece1229/project/huangFig2_8_stackedPatchLayers.png}
...
\begin{figure}
\includegraphics[scale=0.15]{../../figures/ece1229/project/huangFig58multifacet.png}
...
%\begin{itemize}
%% book:
%%\item \citep{huang2008reflectarray}
%% phd thesii:
%\item \citep{harackiewicz1990electromagnetic}
%% 2/3 supplied papers:
%\item \citep{encinar2001design}
%\end{itemize}
...
\begin{figure}
\includegraphics[scale=0.15]{../../figures/ece1229/project/huangFig2_10_solarCellWithRA} 
\caption{Hybrid solar cell reflectarray \citep{huang2008reflectarray}}
\end{figure}
\end{itemize}
\end{frame}
...
\begin{figure}
\includegraphics[scale=0.15]{../../figures/ece1229/project/lau_jonathan_figure1_2_transmitarray} 
