...
Ungraded solutions to posted problem set 2 (I'd audited half the lectures for this course and intend to do the course problem sets if time allows after the fact.)
...
\subsection{Solution}
\section{Problem 5.  Find components of angular momentum in spherical and cylindrical coordinates}
\subsection{Statement}
