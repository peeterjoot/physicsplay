...
\makesubproblem{Let now $\BA$ and $\phi$ be spatially homogeneous, i.e. $\Br$-independent. Find the conserved momentum. Is it equal to the usual $m \Bv$?}{\basename:problem:1:3}
\makesubproblem{Consider motion in the field of an electrostatic source (creating an external static $\phi(\Br)$). Find the angular momentum of the particle. Is it conserved for all $\phi(\Br)$?}{\basename:problem:1:4}
}
