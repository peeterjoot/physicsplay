...
\item Is energy conserved? Find the energy of the particle $\mathcal{E}$ as a function of $\Bv$, $\Br$, ... as appropriate to the case in hand.
\end{enumerate}
...
\paragraph{Solution. Spherical coordinates}
...
\paragraph{Solution. Spherical coordinates.  A smarter way}
...
\paragraph{Solution. Cylindrical coordinates}
