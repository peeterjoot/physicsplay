...
That is a curious question.  I wonder what the context for that question was?  The parity operator, as disussed in \cite{wiki:parity}, inverts the sign of sign, so a potential that depends only on the absolute square would conserve parity.  Formally, this operator has the property
