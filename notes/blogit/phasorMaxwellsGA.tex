...
a \( \BE + j \omega \BA = \spacegrad \wedge \psi \), for a higher grade blade \( \psi \) would not work, despite satisifying the condition \( \spacegrad \wedge \spacegrad \wedge \psi  = 0 \).
