...
%\fxusetheme{color}
%\fxwarning{review lecture 7}{work through this lecture in detail.}

\beginArtNoToc
\generatetitle{PHY452H1S Basic Statistical Mechanics.  Lecture 7: XXX.  Taught by Prof.\ Arun Paramekanti}
%\chapter{XXX}
...
How do the multiplicities scale by energy?  We'll have expect something like 
...
graphing the counts we again have stepping as a function of energy, but no multiplicities this time
...
We have a problem with out counting here.  Consider some particles in a box as in
...
Suppose we double the volume as in 

F6

then our total entropy for the bigger system would be

\begin{dmath}\label{eqn:basicStatMechLecture7:480}
S_total^{(\mathrm{E}, \mathrm{N}, mathrm{V})}
= k_{\mathrm{B}} \ln \lr{ \frac{\Omega_{\mathrm{classical}}}{h^{3N}} }
\approx
 k_{\mathrm{B}} \lr{
...
S_total = S_1 + S_2 + k_{\mathrm{B}} (2 N) \ln 2
...
FIXME: something wrong with $k_B$ here?
