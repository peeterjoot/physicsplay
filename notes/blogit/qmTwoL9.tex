...
\chapter{PHY456H1F: Quantum Mechanics II.  Lecture 9 (Taught by Prof J.E. Sipe).  Adiabadic pertubation theory (cont.)}
\label{chap:qmTwoL9}
%\useCCL
\blogpage{http://sites.google.com/site/peeterjoot/math2011/qmTwoL9.pdf}
\date{Oct 5, 2011}
\revisionInfo{qmTwoL9.tex}
...
\section{Adiabadic pertubation theory (cont.)}

We were working through Adiabadic time dependent pertubation (as also covered in \S 17.5.2 of the text \cite{desai2009quantum}.)
...
Taking derivatives of $\bar{b}_s$ and after a bit of manipulation we find that things conviently cancel
...
FIXME: I think we argued in class that the $\Gamma$ contributions are neglible.  Why was that?
...
Suppose we have some branching of energy levels that were initially degenerate, as illustated in figure (\ref{fig:qmTwoL9fig3})
...
We have a neccessity to choose states properly so there is a continuous evolution in the instantaneous eigenvalues as $H(t)$ changes.
