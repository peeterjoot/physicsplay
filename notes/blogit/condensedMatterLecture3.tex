...
= \inv{2} 
\mathLabelBox{N}{number of ions in solid}
\lr{
...
Here $r$ is the nn separation, and $r_{ij} = p_{ij} r$
...
These are big orbitals that extend beyond the nn.
...
F12 rhombic, or centered rectangular
