...
%
\makeproblem{description}{advancedantenna:problemSet1:5}{ 
A repeater link consists of a transmitter and a receiver at 10 \si{GHz} in a line-of-sight
arrangement of distance 10\si{km}. The transmitting and receiving anetnnas are identical
...
expected to exceed 3 \si{dB}. Determine the minum transmitted power that should be used.
} % makeproblem
