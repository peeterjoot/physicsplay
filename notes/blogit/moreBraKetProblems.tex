...
\makeoproblem{Spin half probability and dispersion}{problem:moreBraKetProblems:12}{\citep{sakurai2014modern} pr. 1.12}{
...
\BS \cdot \ncap 
= \frac{\Hbar}{2} \lr{ \cos\gamma \PauliZ + \sin\gamma \PauliX}
= \frac{\Hbar}{2} 
\begin{bmatrix}
\cos\gamma & \sin\gamma \\
\sin\gamma & -\cos\gamma \\
