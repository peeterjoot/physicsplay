...
%\useCCL
\blogpage{http://sites.google.com/site/peeterjoot2/math2012/channelFlowWithStepPressureGradient.pdf}
\date{Mar 31, 2012}
\gitRevisionInfo{channelFlowWithStepPressureGradient}
\keywords{channel flow, Navier-Stokes, PHY454H1S}
...
\begin{figure}[htp]
   \centering
   \includegraphics[totalheight=0.3\textheight]{channelFlowWithStepPressureGradientFig1}
...
\begin{figure}[htp]
   \centering
   \includegraphics[
totalheight=0.3\textheight
]{channelFlowWithStepPressureGradientFig2}
...
An animation of the time evolution above can be found in \ref{fig:channelFlowWithStepPressureGradient:channelFlowWithStepPressureGradientAnimation1}.  If this animation is unavailable, it is also available at \href{http://youtu.be/0vZuv9HBtmo}{http://youtu.be/0vZuv9HBtmo}.
...
%%%%%%addresource=http://peeterjoot.hostei.com/phy454/channelFlowWithStepPressureGradientTimeEvolution.mp4,
%%%%%addresource=channelFlowWithStepPressureGradientTimeEvolution.mp4,
%%%%%%activate=pageopen,
%%%%%%activate=onclick,
%%%%%flashvars={%
%%%%%%source=http://peeterjoot.hostei.com/phy454/channelFlowWithStepPressureGradientTimeEvolution.mp4%
%%%%%source=channelFlowWithStepPressureGradientTimeEvolution.mp4%
%%%%%&autoplay=true%
%%%%%%&autohide=0%
%%%%%}
%%%%%]{Click to animate.}{VPlayer.swf}
%%%%%%{http://mirrors.ibiblio.org/pub/mirrors/CTAN/macros/latex/contrib/media9/players/VPlayer.swf}
%%%%%   \caption{Time evolution of channel flow velocity profile after turning on a constant pressure gradient (CLICK TO ANIMATE).}
%%%%%   \label{fig:channelFlowWithStepPressureGradient:channelFlowWithStepPressureGradientAnimation1}
%%%%%\end{figure}
%%%%%%flashvars={source=channelFlowWithStepPressureGradientTimeEvolution.mp4}
%%%%%%&loop=true%
%%%%%%&vid=./channelFlowWithStepPressureGradientTimeEvolution.mp4
%%%%%
%%%%%%\includemedia[
%%%%%%width=0.6\linewidth,height=0.45\linewidth,
%%%%%%activate=pageopen,
