...
\includemedia[
  ...
  flashvars={%
     source=./channelFlowWithStepPressureGradientTimeEvolution.mp4% same path as in addresource!
...
%   \label{fig:channelFlowWithStepPressureGradient:channelFlowWithStepPressureGradientAnimation2}
%\end{figure}
...
\includemedia[
  activate=pageopen,
  width=200pt,height=150pt,
  addresource=./channelFlowWithStepPressureGradientEarlyTimeEvolution.mp4,
  flashvars={%
     source=./channelFlowWithStepPressureGradientEarlyTimeEvolution.mp4% same path as in addresource!
%   &autoPlay=true%   % optional configuration
%   &loop=true%       % variables
  }  
]{}{VPlayer.swf}
