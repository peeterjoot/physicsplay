...
\int_{-h}^h -\frac{P}{2 \mu} \left( h^2 - y^2 \right) = 2 h C_0,
\end{equation}
...
so if $\nu t >> h^2$ these terms all die off.  That leaves us with the steady state equation, less the non-damped constant factor from the Fourier series.
