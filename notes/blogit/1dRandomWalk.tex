...
\makeproblem{One dimensional random walk}{pr:1dRandomWalk:1}{
...
\begin{equation}\label{eqn:1dRandomWalk:300}
\myBoxed{
...
\begin{equation}\label{eqn:1dRandomWalk:340}
\myBoxed{
\expectation{X} 
= N( 2 p - 1 ).
}
...
\begin{equation}\label{eqn:1dRandomWalk:380}
\myBoxed{
