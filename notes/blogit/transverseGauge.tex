...
The first constraint is the Lorentz gauge.  In vacuum with \( A = (\Phi/c, \BA) \), that is a requirement that \( \partial_\mu A^\mu = 0 \).  I've played with this gauge previously.  Jackson identifies the latter constraint as the transverse gauge.  With this gauge selection, we have
