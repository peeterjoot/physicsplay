...
\begin{equation}\label{eqn:basicStatMechLecture3:80}
\expectation{X^2} 
= 
\expectation{
...
FIXME: where'd the cross terms go?

\paragraph{Two dimensional case}

The two dimensional case can be used for either spatial generalization of the aobove, or a one dimensional problem with time evolution
...
We see that random microsopics lead to a well defined macroscopic equation.
...
This is expressed as a continuity equation
...
F4: (probability changes by flows through the boundary).

\item \underline{Phenomological law}, or \underline{Fick's law}.
...
Here the mean is expected to be zero because the individual collisons are thought to be uncorrelated.
...
However, if we sum the kinetic energy squares above \ref{eqn:basicStatMechLecture3:360} shows that it is growing with the number of collisions.  Fixing this we will arrive at the Maxwell boltszman distribution.
