...
How do we make sense of this?  It appears that we require a constraint
...
Now it is clear that we can satisify our constraint only if the interval $[\pm \omega_\nought -\omega_{\text{cutoff}}, \pm \omega_\nought + \omega_{\text{cutoff}}]$ is made infinitesimal.  Specifically, we require both a $\omega^2 = \omega_\nought^2$ constraint and that the transform $\tilde{x}(\omega)$ have a delta function nature.  That is
...
Substituition back into our transform gives
