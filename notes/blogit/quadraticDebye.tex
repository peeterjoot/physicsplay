...
In terms of $\kB \Theta = \Hbar \omega_{\mathrm{D}}$, and

\begin{equation}\label{eqn:quadraticDebye:10}
\mathcal{I} = \int_0^\infty \frac{y^{5/2} e^{y} dy}{\lr{ e^y - 1}^2 },
\end{equation}

find the specific heat for $\kB T \ll \Hbar \omega_{\mathrm{D}}$.
...
= \frac{V}{(2 \pi)^3 } \lr{ 
\evalbar{\frac{4 \pi q^2}{2 b_{\mathrm{L}} q} }{\mathrm{L}}
+
\evalbar{\frac{2 \times 4 \pi q^2}{2 b_{\mathrm{T}} q} }{\mathrm{T}}
}
= \frac{V}{4 \pi^2 } \lr{ 
\frac{q_{\mathrm{L}}}{b_{\mathrm{L}}}
+
\frac{2 q_{\mathrm{T}}}{b_{\mathrm{T}}} 
}.
\end{dmath}
...
Z(\omega) 
= \frac{V}{4 \pi^2 } \lr{ 
\frac{1}{b_{\mathrm{L}}^{3/2}}
+
\frac{2}{b_{\mathrm{T}}^{3/2}} 
}
\sqrt{\omega}
\end{dmath}
...
Z(\omega) = 
\frac{9 r N}{ 2 \omega_{\mathrm{D}}^{3/2} } \omega^{1/2},
\end{dmath}
...
\CV 
= \frac{d}{d T} \inv{V} \int_0^\infty \frac{9 r N}{ 2 \omega_{\mathrm{D}}^{3/2} } \omega^{1/2} \frac{\Hbar \omega}{ e^{\Hbar \omega/ \kB T } - 1} d\omega
= 
\frac{9 r N}{ 2 V \omega_{\mathrm{D}}^{3/2} } 
\int_0^\infty 
d\omega \omega^{1/2} 
\frac{d}{d T} 
...
\int_0^\infty 
d\omega \omega^{1/2} 
\frac{-\Hbar \omega}{ \lr{e^{\Hbar \omega/ \kB T } - 1}^2 }  e^{\Hbar \omega/\kB T} \Hbar \omega/\kB \lr{-\inv{T^2}}
= 
\frac{9 r N \kB }{ 2 V \omega_{\mathrm{D}}^{3/2} } 
\lr{ \frac{ \kB T}{\Hbar} }^{3/2}
\int_0^\infty 
d \frac{\Hbar \omega}{\kB T} \lr{\frac{\Hbar \omega}{\kB T}}^{1/2} 
\frac{1}{ \lr{e^{\Hbar \omega/ \kB T } - 1}^2 }  e^{\Hbar \omega/\kB T} \lr{ \frac{\Hbar \omega}{\kB T} }^2
= 
\frac{9 r N \kB }{ 2 V \omega_{\mathrm{D}}^{3/2} } 
\lr{ \frac{ \kB T}{\Hbar} }^{3/2}
\int_0^\infty dy \frac{y^{5/2} e^y }{ \lr{e^y - 1}^2 }
=
\frac{9 r N \kB }{ 2 V } 
\lr{ \frac{ T}{\Theta} }^{3/2} \mathcal{I}.
\end{dmath}
} % makeanswer
