...
\generatetitle{energy distribution around mean energy}
%\chapter{energy distribution around mean energy}
...
\inv{k_{\mathrm{B}}} \lr{\PD{E}{S}}_{E = U} = \inv{k_{\mathrm{B}} T} = \beta
\end{equation}
\end{subequations}
...
=
-\beta + \inv{k_{\mathrm{B}}} \evalbar{\PD{E}{S}}{E = U}
= -\beta + \inv{k_{\mathrm{B}} T}
= -\beta + \beta 
= 0.
\end{dmath}
...
I still don't see how to get $C_{\mathrm{V}} = \PDi{T}{U}$ out of this?  $C_{\mathrm{V}}$ is a derivative with respect to temperature, but here we have derivatives with respect to energy (keeping $\beta = 1/k_{\mathrm{B}} T$ fixed)?
