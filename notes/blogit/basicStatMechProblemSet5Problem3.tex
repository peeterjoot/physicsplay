...
%After an $n = m + l$ substitution, we have
%
%\begin{dmath}\label{eqn:basicStatMechProblemSet5Problem2:380}
%Z
%= \sum_{l = 0}^\infty \exp\lr{ -\frac{l (l+1) \hbar^2 \beta}{2 I}} 
%e^{-l \mu \hbar \mathcal{E} \beta}
%\sum_{n = 0}^{2l} 
%e^{n \mu \hbar \mathcal{E} \beta}
%= \sum_{l = 0}^\infty \exp\lr{ -\frac{l (l+1) \hbar^2 \beta}{2 I}} 
%e^{-l \mu \hbar \mathcal{E} \beta}
%\frac{
%e^{\mu \hbar \mathcal{E} \beta (2l + 1)} -1
%}
%{
%e^{\mu \hbar \mathcal{E} \beta} -1
%}
%= 
%e^{\mu \hbar \mathcal{E} \beta/2}
%\sum_{l = 0}^\infty \exp\lr{ -\frac{l (l+1) \hbar^2 \beta}{2 I}} 
%\frac{
%e^{\mu \hbar \mathcal{E} \beta (l + 1/2)} -e^{-\mu \hbar \mathcal{E} \beta(l + 1/2)}
%}
%{
%e^{\mu \hbar \mathcal{E} \beta} -1
%}
...
%\frac
%{
%\sinh \lr{\mu \hbar \mathcal{E} \beta(l + 1/2)}
%}
%{
%\sinh \lr{\mu \hbar \mathcal{E} \beta/2}
%}.
%\end{dmath}
%
%If we drop all but $l = 0, 1$ this is
%
...
%\frac
%{
%\sinh \lr{3 \mu \hbar \mathcal{E} \beta /2}
%}
%{
%\sinh \lr{\mu \hbar \mathcal{E} \beta/2}
%},
