...
\begin{eqnarray*}
\cA(T) = 7.213\, \frac{4rN}{A}\,k_B\,\frac{T^2}{\Theta^2},
\end{eqnarray*}
...
C_T q & \quad \mbox{transverse acoustic} 
\end{array}
\right.
\end{dmath}
...
{$q$ space surface ``area'' element $2 \pi q$}
}{\frac{d\omega}{dq}}
d\omega
=
\int
...
\int_0^{\omega_D} Z(\omega) d\omega = 2 r N
\end{dmath}

\begin{dmath}\label{eqn:condensedMatterProblemSet5Problem3:120}
2 r N
=
\frac{A}{ 2 \pi} \lr{ \inv{C_L^2} + \frac{1}{C_T^2} } \int_0^{\omega_D} \omega d\omega 
=
\frac{A}{ 2 \pi} \lr{ \inv{C_L^2} + \frac{1}{C_T^2} } \inv{2} \omega_D^2,
\end{dmath}

or

\begin{dmath}\label{eqn:condensedMatterProblemSet5Problem3:140}
\frac{A}{ 2 \pi} \lr{ \inv{C_L^2} + \frac{1}{C_T^2} } \omega_D^2 = 4 r N.
\end{dmath}

Inserting this Deybe freqeuency into the density of states gives

\begin{dmath}\label{eqn:condensedMatterProblemSet5Problem3:180}
Z(\omega) =
\frac{4 r N \omega}{ \omega_D^2 }.
\end{dmath}

We can now start the specific heat \index{specific heat} calculation
...
d\omega
= 
\frac{4 r N }{ A \omega_D^2 }
 \int_0^{\omega_D} \frac{d}{dT} \mathcal{E}(\omega, T) \omega d\omega
= 
\frac{4 r N }{ A \omega_D^2 }
\frac{d}{dT}
\int_0^{\omega_D}
...
In the $\kB T \ll \Hbar \omega_D = \kB \Theta$ limit where the integrand is small, the integral limit can be approximated by extension to $\infty$.  This produces the desired result

\begin{dmath}\label{eqn:condensedMatterProblemSet5Problem3:n}
