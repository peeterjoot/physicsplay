...
%\chapter{Solving the homogeneous paraxial wave equation}
...
%\imageFigure{modernOpticsLecture19Fig0}{CAPTION}{fig:modernOpticsLecture19:modernOpticsLecture19Fig0}{0.3}
%
...
Since $p(0)$ contributes only a constant phase term (that can be incorporated into our multiplictive constant phasor $\BE_0$), we can set $p(0) = 1$.  This gives us

\begin{equation}\label{eqn:modernOpticsLecture19:580}
\boxed{
u(r, z) 
= \frac{z_0}{iq} \exp\left( i \frac{ k_0 r^2}{2 q(z)} \right)
%= 
%\frac{z_0}{iq}
...
\imageFigure{modernOpticsLecture19Fig1}{Point source}{fig:modernOpticsLecture19:modernOpticsLecture19Fig1}{0.3}
...
\fxwarning{work through this lecture in detail from here.}

%FIXME: \cref{fig:modernOpticsLecture19:modernOpticsLecture19Fig2}.
%\imageFigure{modernOpticsLecture19Fig2}{CAPTION}{fig:modernOpticsLecture19:modernOpticsLecture19Fig2}{0.3}
Waste angular dependence is roughly illustrated in \cref{fig:modernOpticsLecture19:modernOpticsLecture19Fig3}.

\imageFigure{modernOpticsLecture19Fig3}{Waste angular dependence}{fig:modernOpticsLecture19:modernOpticsLecture19Fig3}{0.3}
