...
\subsection{The physical meaning of this expression.}
...
This inequality holds for all states $\ket{\psi}$ that the system could be observed in.  This includes the state $\ket{\psi} = \ket{x_0}$ of the problem that the system happened to be observed in at the given time.
