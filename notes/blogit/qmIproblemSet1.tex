...
Now, if the question was to find the physical meaning to the matrix element of the operator $-i\antisymmetric{X}{P} = \hbar$, perhaps that would make more sense.  At least that operator is an observable.
