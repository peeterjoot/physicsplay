...
Observe that for an inertial system, this implies that there is only a timelike component for the trajectory, when parametrized by proper length.  That is
