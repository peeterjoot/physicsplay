...
\begin{equation}\label{eqn:condensedMatterProblemSet6Problem3:110}
\myBoxed{
\kappa 
= 
...
\paragraph{What did we assume and neglect?} We have implicitly treated the Alkali metals as a free electron gas, assuming that there was no interaction between the electrons and the nuclei, no interactions between the electrons themselves (except for Pauli exclusion interaction).  We have assumed that only the single outermost (valence) electron of each atom contributes to this energy sum.  We have also assumed that the system is big enough that surface effects are irrelevant, and that we can make a continuum approximation for the summation over all the wave-vector states.
}
