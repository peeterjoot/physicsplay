...
and follow the direction of steepest decent \( \Br^{(k)} = - \spacegrad \Psi \) with the hope of finding the minimum of the energy function.  That iteration is described by
