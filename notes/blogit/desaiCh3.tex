...
Except for the $\text{*}$ part the problem, as stated is complete.  The relationship \ref{eqn:desaiCh3:800} is no help for with $n = m$, so I see no choice but to leave that small part of the expansion in terms of $B$.
