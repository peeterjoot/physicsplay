...
Let's now compute $T(\gamma^k)$.  For this it will be helpful to decompose our vectors into components that anticommute or commute with $\gamma^k$
...
This isn't particularily pretty to expand out.  For all the quadratic electric field products we have
