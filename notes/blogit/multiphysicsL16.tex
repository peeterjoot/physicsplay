...
\beginArtNoToc
\generatetitle{ECE1254H Modeling of Multiphysics Systems.  Lecture 16: LMS systems.  Taught by Prof.\ Piero Triverio}
%\chapter{LMS systems}
...
Suppose \( t \in [0, 1] s \), with \( N = 1/{\Delta t} \) intervals.  For a mehtod with local error of order \( R_{n+1} \sim \lr{ \Delta t}^2 \) the global error is approximately \( N R_{n+1} \sim \Delta t \).
...
The numerial solution \( x_n \) will be stable if \cref{eqn:multiphysicsL16:120} is stable.
...
the coefficents are \( \alpha_{-1} = 1, \alpha_0 = -1, \beta_{-1} = 0, \beta_0 =1 \).  For the simple function above
...
This inequality is illustrated rougly in \cref{fig:lecture16:lecture16Fig4}.

\imageFigure{../../figures/ece1254/lecture16Fig4}{Stability region of FE}{fig:lecture16:lecture16Fig4}{0.3}
