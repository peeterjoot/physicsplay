...
%\chapter{Continuing review of thermodynamics}
...
In \cref{fig:lecture10:lecture10Fig1} we plot changes that are adiabatic processes ($\dbar Q = 0$) and heating and cooling processes (with $\dbar W = 0$).

\imageFigure{lecture10Fig1}{Adiabatic and heating processes}{fig:lecture10:lecture10Fig1}{0.2}
...
\imageFigure{lecture10Fig2}{Cyclic process}{fig:lecture10:lecture10Fig2}{0.2}

Here we've labelled the level curves with a parameter $\sigma$, as yet undefined.  We call $\sigma$ the \underlineAndIndex{thermodynamic entropy}, and say that
...
\imageFigure{lecture10Fig3}{Two systems in contact}{fig:lecture10:lecture10Fig3}{0.2}
...
We must have some quantity that characterizes the state of the system in a non-macroscopic fashion.  The identity \eqref{eqn:basicStatMechLecture10:200} is a statement that we have equal temperatures.
...
We could potentially define different sorts of temperature, for example, perhaps $T^3 \equiv \PDi{\sigma}{E}$.  Should we do this, we effectively also define $\sigma$ in a specific way.  The definition \eqref{eqn:basicStatMechLecture10:220} effectively defines this non-macroscopic parameter $\sigma$ (the entropy) in the simplest possible way.

\paragraph{Cyclic state variable verses non-state variables}
...
This doesn't mean that the closed loop integral of other qualities, such as temperature are neccessarily zero
...
\begin{equation}\label{eqn:basicStatMechLecture10:n}
\lr{ \PD{\sigma}{E} }_x = T
\end{equation}
...
\imageFigure{lecture10Fig4}{Cyclic process}{fig:lecture10:lecture10Fig4}{0.2}
...
\begin{equation}\label{eqn:basicStatMechLecture10:n}
\Delta Q_{12}^{(\mathrm{A})} + \Delta Q_{21}^{(\mathrm{B})} \ne 0,
\end{equation}

or
\begin{equation}\label{eqn:basicStatMechLecture10:n}
\Delta Q_{12}^{(\mathrm{A})} \ne \Delta Q_{12}^{(\mathrm{B})}.
\end{equation}

\paragraph{Irreversible and reversible processes}
...
\imageFigure{lecture10Fig5}{Heat loss and irreversibilty}{fig:lecture10:lecture10Fig5}{0.2}
