...
we plot changes that are adiabatic processes ($\dbar Q = 0$) and heating and cooling processes (with $\dbar W = 0$).
...
Such a cyclic process could be represented as in 
...
Considering two systems in contact as in
...
Graphically we have for a cyclic process
...
Reversible means that an undoing of the macroscopic quantities brings us back to the initial state.  A counter example is a block on a spring as illustrated in 
