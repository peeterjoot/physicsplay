...
and seek to demonstrate \underline{Liouville's theorem}, that the phase space density does not change.  To do so, consider the total time derivative of the phase space density
...
This long term behavior is described by the \underline{Poincar\'e recurrence theorem}.  If we wait long enough a point in phase space will come arbitrarily close to its starting point, recurring or ``closing the trajectory loops''.
