...
\BOmega = \Omega_k \Be_k = \inv{2} \omega_k = fixme
\end{equation}

defined according to

\begin{align}\label{eqn:continuumL9:110}
\Omega_1 &= \omega_{32} = \inv{2} \omega_1 \\
\Omega_2 &= \omega_{13} = \inv{2} \omega_2 \\
\Omega_3 &= \omega_{21} = \inv{2} \omega_3 
\end{align}
...
We can then write (for the special case $e_{ij} = 0$), we can write our displacement equation in vector form as 
...
\begin{equation}\label{eqn:continuumL9:n}A
\PD{t}{} \int \rho dV 
=
-\oint \rho \Bu \cdot d\Bs.
\end{equation}
