...
% FIXME: latex: bar's here look like crap.  Want them to extend all the way over.  Forget how to do that.
...
\imageFigure{modernOpticsProblemSet2Problem3Fig1}{Geometry for solar disk interference problem}{fig:modernOpticsProblemSet2Problem3:modernOpticsProblemSet2Problem3Fig1}{0.3}
...
\imageFigure{modernOpticsProblemSet2Problem3Fig3}{Sinc like first order Bessel function}{fig:modernOpticsProblemSet2Problem3:modernOpticsProblemSet2Problem3Fig3}{0.3}
...
%\imageFigure{modernOpticsProblemSet2Problem3Fig2}{Bessel $J_1$}{fig:modernOpticsProblemSet2Problem3:modernOpticsProblemSet2Problem3Fig2}{0.3}
...
%
%\imageFigure{wikipediaPlanksBlack_body}{Plank's law distributions}{fig:Black_body:wikipediaPlanksBlack_body}{0.3}
...
\begin{subequations}
\begin{dmath}\label{eqn:modernOptics:ProblemSet2:P3:n}
...
\imageFigure{modernOpticsProblemSet2Problem3Fig4}{Possible fringes from two sources at the boundaries of the spectral width}{fig:modernOpticsProblemSet2Problem3:modernOpticsProblemSet2Problem3Fig4}{0.2}
