...
Borrowing a blackbody figure \cref{fig:Black_body:wikipediaPlanksBlack_body} from \citep{wiki:planks}, we see that around the 500 nm range we can approximate the spectral distribution as a Gaussian
