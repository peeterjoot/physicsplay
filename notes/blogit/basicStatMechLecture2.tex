...
How many ways can we find a specific event such as the number of ways we find $2$ heads and $1$ tail?  These are enumerated in
...
P_N(X) = 
\left(\inv{2}\right)^N 
\choose{N}{\frac{N-X}{2}} \quad\mbox{or}\quad
\left(\inv{2}\right)^N 
\choose{N}{\frac{N+X}{2}}
\end{equation}
...
{ e^{-N} N^N \sqrt{ 2 \pi N} }
{ 
e^{-\frac{N+X}{2}} \frac{N+X}{2}^\frac{N+X}{2} \sqrt{ 2 \pi \frac{N+X}{2}} 
e^{-\frac{N-X}{2}} \frac{N-X}{2}^\frac{N-X}{2} \sqrt{ 2 \pi \frac{N-X}{2}} 
}
\end{equation}
...
P_N(X) 
= 
\frac{2}{\sqrt{2 \pi N} e^{-\frac{X^2}{2N}}
\end{equation}
...
we can use the large $\alpha$ behaviour of this function to find approximations of the factorial.  What does the innards of this integral (integrand) look like.  We can plot these
