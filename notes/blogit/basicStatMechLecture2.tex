...
\imageFigure{basicStatMechLecture2Fig1}{Discrete probability distribution}{fig:basicStatMechLecture2:basicStatMechLecture2Fig1}{0.3}
...
\imageFigure{basicStatMechLecture2Fig2}{Continuous probability distribution}{fig:basicStatMechLecture2:basicStatMechLecture2Fig2}{0.3}
...
and a \underline{variance} (or squared standard deviation) of
...
= \inv{\sigma \sqrt{2 \pi}} \exp\left( - \frac{ x - N \mu}{2 \sigma^2} \right)
\end{equation}
...
\imageFigure{basicStatMechLecture2Fig3}{Discrete probability distribution for Heads and Tails coin tosses}{fig:basicStatMechLecture2:basicStatMechLecture2Fig3}{0.3}
...
\imageFigure{basicStatMechLecture2Fig4}{2 tosses distribution}{fig:basicStatMechLecture2:basicStatMechLecture2Fig4}{0.3}
...
\imageFigure{basicStatMechLecture2Fig5}{3 tosses}{fig:basicStatMechLecture2:basicStatMechLecture2Fig5}{0.3}
...
we find the \underline{Binomial distribution}
...
We'll use the \underline{Stirling formula}, to find

\begin{equation}\label{eqn:basicStatMechLecture2:480}
N! \approx \sqrt{ 2 \pi N} N^N e^{-N},
\end{equation}

\begin{equation}\label{eqn:basicStatMechLecture2:500}
P_N(X) 
= 
\left(\inv{2}\right)^N 
\frac{N!}{
...
This can be simplified to (FIXME: do it)
...
We can show (FIXME: fill in details)

\begin{subequations}
\begin{equation}\label{eqn:basicStatMechLecture2:560}
I(0) = 1
\end{equation}
\begin{equation}\label{eqn:basicStatMechLecture2:580}
I(\alpha+1) = (\alpha + 1) I(\alpha)
\end{equation}
\end{subequations}
...
we can use the large $\alpha$ behaviour of this function to find approximations of the factorial.  What does the innards of this integral (integrand) look like.  We can plot these \cref{fig:basicStatMechLecture2:basicStatMechLecture2Fig7}, and find a hump for any non-zero value of $\alpha$ ($\alpha = 0$ is just a line)

\imageFigure{basicStatMechLecture2Fig7}{Some values of $f(y, \alpha)$}{fig:basicStatMechLecture2:basicStatMechLecture2Fig7}{0.3}
...
Dropping all but the quadratic term we have

\begin{dmath}\label{eqn:basicStatMechLecture2:720}
I(\alpha \gg 1) \approx \int_0^\infty
\exp\left(
\inv{2}
\evalbar{\PDSq{y}{f}}{y^\conj}
(y - y^\conj)^2
