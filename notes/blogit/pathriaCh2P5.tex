...
I was able to show that \eqnref{eqn:pathriaCh2P5:40} is equivalent to the WKB condition
...
However, I'm not sure what to make of the condition on the allowed values of the momentum \eqnref{eqn:pathriaCh2P5:20}.  In a classical context, this $\int p dq$ is the area contained by the phase space trajectory.  However, for this quantum problem $p$ and $q$ are operators.  What does this integral even mean?
