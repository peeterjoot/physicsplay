...
We have a different than usual scaling of the STA bivector \( F \) than with the free space formulation, and a different scaling of the time component of the STA gradient.  Inclusion of magnetic charges and currents means that \( J \) is now a multivector that also has a trivector component as well as the vector component.
