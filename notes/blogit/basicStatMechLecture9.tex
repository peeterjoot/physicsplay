...
\beginArtNoToc
\generatetitle{PHY452H1S Basic Statistical Mechanics.  Lecture 9: Lightning review of thermodynamics.  Taught by Prof.\ Eric }
...
\begin{equation}\label{eqn:basicStatMechLecture9:n}
dE = \dbar W + \dbar Q.
\end{equation}

\paragraph{Examples of work}
...
\imageFigure{lecture9Fig1}{System in contact with heat source}{fig:lecture9:lecture9Fig1}{0.3}

\paragraph{Adiabatic processes}
...
We have a coordinate, not yet precisely defined, for which fixed levels indicate that there is no heat exchange occuring, as in \cref{fig:lecture9:lecture9Fig2}.

\imageFigure{lecture9Fig2}{Adiabatic and heat exchange processes}{fig:lecture9:lecture9Fig2}{0.3}

We'll call this axis $\sigma$, the \underlineAndIndex{thermodynamic entropy}.
} % makeexample

We've been introduced to \underlineAndIndex{statistical entropy}
...
\makeexample{$n = 2$}{example:basicStatMechLecture9:1}{
...
\imageFigure{lecture9Fig3}{Adiabatic process}{fig:lecture9:lecture9Fig3}{0.3}

\imageFigure{lecture9Fig4}{Heat exchange process}{fig:lecture9:lecture9Fig4}{0.3}

\imageFigure{lecture9Fig5}{Cyclic process}{fig:lecture9:lecture9Fig5}{0.3}
...
\paragraph{Reversible processes}
...
\imageFigure{lecture9Fig6}{Fast gas compression by a piston}{fig:lecture9:lecture9Fig6}{0.3}

Doing work slowly means that the whole system can react to the change imposed.  If we compressed the gas quickly, then changes to the system start only at the contact point with the piston.  This can't be reversed.  If we pull the piston out at this point, none of the non-front gas particles will be able to react.  The system will not be in \underlineAndIndex{thermal equalibrium} for fast changes.
