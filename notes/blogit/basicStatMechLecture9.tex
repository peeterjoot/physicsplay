...
We have only one type of heat, which we loosely describe as something imbued by contact with a ``hotter'' system.
...
We have a coordinate, not yet precisely defined, for which fixed levels indicate that there is no heat exchange occuring.
...
If we are making changes to the system quickly, imagine that we are compressing a gas
