...
\section{Cooper pairing (cont.)}

Reading: \citep{ibach2009solid} \S 10.2

%\cref{fig:qmSolidsL24:qmSolidsL24Fig1}.
\imageFigure{qmSolidsL24Fig1}{Electron-phonon interaction}{fig:qmSolidsL24:qmSolidsL24Fig1}{0.2}
...
%\imageFigure{qmSolidsL24Fig2}{No idea what this figure was about}{fig:qmSolidsL24:qmSolidsL24Fig2}{0.2}
...
Using pertubation theory, you set an effective interaction
...
{
\lr{ \mathcal{E}_{\Bk+\Bq} - \mathcal{E}_\Bk }^2 - \Hbar^2 \omega_\Bq^2
}
\end{dmath}

%\cref{fig:qmSolidsL24:qmSolidsL24Fig4}.
%\imageFigure{qmSolidsL24Fig4}{What was this}{fig:qmSolidsL24:qmSolidsL24Fig4}{0.2}
%\cref{fig:qmSolidsL24:qmSolidsL24Fig5}.
\imageFigure{qmSolidsL24Fig5}{Limited options for paired states available}{fig:qmSolidsL24:qmSolidsL24Fig5}{0.2}
%\cref{fig:qmSolidsL24:qmSolidsL24Fig6}.
\imageFigure{qmSolidsL24Fig6}{Cooper filled Fermi sphere plus two electrons}{fig:qmSolidsL24:qmSolidsL24Fig6}{0.2}
...
2 \EE_{\Bk'} g(\Bk') + \sum_\Bk V_{\Bk'\Bk} g(\Bk) 
= \lr{ 2 \EF + \mathcal{E} } g(\Bk'),
\end{dmath}
...
\left\{
\begin{array}{l l}
V_\nought & \quad \mbox{if $\mathcal{E}_\Bk,\mathcal{E}_{\Bk'}$ between $\EF$ and $\EF + \Hbar \Omega_D$} \\
...
g(\Bk') = \inv{ 2 \EF + \mathcal{E} - 2 \mathcal{E}_{\Bk'}} \sum_\Bk V_{\Bk', \Bk} g(\Bk)
\end{dmath}
...
\frac{V_\nought}{ 2 \EF + \mathcal{E} - 2 \mathcal{E}_{\Bk'}} \cancel{\sum_\Bk g(\Bk)}
\end{dmath}

\begin{dmath}\label{eqn:condensedMatterPhysicsLecture24:240}
1 = V_\nought \int_\EF^{\EF + \Hbar \omega_{\mathrm{D}}}
\frac{D(E) dE}{
2 \EF + \mathcal{E} - 2 E
}
\approx
V_\nought D(\EF) \inv{2} 
\evalrange{\ln \lr{ 2 \EF + \mathcal{E} - 2 E}}{\EF}{\EF + \Hbar \omega_{\mathrm{D}}}
\approx
\frac{V_\nought D(\EF) }{2} 
\ln 
\frac{ 2 \EF + \mathcal{E} - 2 \EF}
{ 2 \EF + \mathcal{E} - 2 (\EF + \Hbar \omega_{\mathrm{D}}) }
\end{dmath}

Giving 

\begin{dmath}\label{eqn:condensedMatterPhysicsLecture24:260}
e^{ 2/V_\nought D(\EF) } = \frac{\mathcal{E} - 2 \Hbar \omega_{\mathrm{D}}}{\mathcal{E}}
\end{dmath}

or

\begin{dmath}\label{eqn:condensedMatterPhysicsLecture24:280}
\mathcal{E} = \frac{ -2 \Hbar \omega_{\mathrm{D}} }{e^{2/V_\nought D(\EF)} - 1}
\end{dmath}

\begin{dmath}\label{eqn:condensedMatterPhysicsLecture24:300}
\myBoxed{
\mathcal{E} \approx -2 \Hbar \omega_{\mathrm{D}} e^{-2/V_\nought D(\EF)}
}
\end{dmath}

Bound state Fermi surface $(2 \EF + \mathcal{E}) < 2 \EF$.

A filled Fermi sphere at $T = 0$ is unstable against fermation of Cooper pairs.
...
W 
= \sum_\Bk 2 \mathcal{E}_\Bk v_\Bk^2
+ 
\mathLabelBox
{
\sum_{\Bk, \Bk'} V_{\Bk, \Bk'} 
