...
\imageFigure{kittelRotationalPartitionFig4}{Plotting the partition function summand}{fig:kittelRotationalPartition:kittelRotationalPartitionFig4}{0.3}

\imageFigure{kittelRotationalPartitionFig2}{$Z_R(\tau)$ truncated after 30 terms in log plot}{fig:kittelRotationalPartition:kittelRotationalPartitionFig2}{0.3}
...
\imageFigure{kittelRotationalPartitionFig3}{Energy and heat capacity}{fig:kittelRotationalPartition:kittelRotationalPartitionFig3}{0.3}
...
\imageFigure{kittelRotationalPartitionFig5}{Exact plot of the energy for a range of temperatures (30 terms of the sums retained)}{fig:kittelRotationalPartition:kittelRotationalPartitionFig5}{0.3}
...
\imageFigure{kittelRotationalPartitionFig6}{Low temperature approximation of the energy}{fig:kittelRotationalPartition:kittelRotationalPartitionFig6}{0.3}
...
\imageFigure{kittelRotationalPartitionFig7}{Specific heat to 30 terms}{fig:kittelRotationalPartition:kittelRotationalPartitionFig7}{0.3}
} % makeanswer
