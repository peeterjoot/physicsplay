...
This is plotted after truncation at $l = 30$ in \cref{fig:kittelRotationalPartition:kittelRotationalPartitionFig2}.
...
Z_R(\tau) \approx 1 + 2 e^{-2 \epsilon_0/\tau}
\end{equation}

\makeSubAnswer{Energy and heat capacity}{pr:kittelRotationalPartition:3:6:d}

For the small $\epsilon_0/\tau$ case we have
...
The heat capacity in this region is

\begin{equation}\label{eqn:kittelRotationalPartition:190}
C_V = \PD{\tau}{U} = 1,
\end{equation}

which is unity as expected.

In the large $\epsilon_0/\tau$ domain we have

\begin{dmath}\label{eqn:kittelRotationalPartition:210}
U 
= \tau^2 \PD{\tau}{} \ln Z
= \tau^2 \PD{\tau}{} \ln 
\lr{1 + 2 e^{-2 \epsilon_0/\tau}}
= \tau^2 
\frac{2 (-2\epsilon_0)(-1/\tau^2)}{1 + 2 e^{-2 \epsilon_0/\tau}}
= 
\frac{4 \epsilon_0}{1 + 2 e^{-2 \epsilon_0/\tau}}.
\end{dmath}
...
= \PD{\tau}{U}
=
\lr{ \frac{4 \epsilon_0/\tau}{1 + 2 e^{-2 \epsilon_0/\tau}} }^2
\end{dmath}
