...
The directivities (for either configuration) are found to both be 3.97 (5.98 \si{dB} ).
...
These are plotted in \cref{fig:p4:p4Fig1}.  The broadside power pattern is the one pointing to \ang{90} (donut shaped), whereas the x-axis array power pattern is the (barbell shared) double lobe directed forwards and backwards at \ang{0} and \ang{90}.

\imageFigure{../../figures/ece1229/p4Fig1}{Power array factor patterns for \( \phi = 0 \), over \( \theta \in [0,\pi] \).}{fig:p4:p4Fig1}{0.3}
}
