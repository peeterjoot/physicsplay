...
The zeros of the array factor 

TODO.
\makeSubAnswer{}{advancedantenna:problemSet4:4e}

The uniform array factor is

\begin{dmath}\label{eqn:advancedantennaProblemSet4Problem4:180}
\textrm{AF}(z) 
= \sum_{n = 0}^{N-1} z^n 
= \frac{1 - z^N}{1 - z}
= \frac{z^{N/2}}{z^{1/2}} \frac{ z^{N/2} - z^{-N/2}}{z^{1/2} - z^{-1/2}}
\end{dmath}
...
The beamwidth of the main lobe is \( \delta u = 4 \pi/N \), so in this case where \( N = 4 \) it is \( \delta u = \pi \).  With \( u = \pi \sin\theta \cos\phi \), the \( \phi = 0 \) beamwidth is

\begin{dmath}\label{eqn:advancedantennaProblemSet4Problem4:240}
\delta u = \pi = \pi \sin \delta \theta,
\end{dmath}

or

\begin{dmath}\label{eqn:advancedantennaProblemSet4Problem4:260}
\delta \theta = \pi/2.
\end{dmath}
...
\imageFigure{../../figures/ece1229/chebychevBroadside3DFig3}{5 element Chebychev array power pattern in 3D.}{fig:chebychevBroadside3D:chebychevBroadside3DFig3}{0.2}
...
\imageFigure{../../figures/ece1229/chebychevVsLinearArrayBothBroadsideFig2}{Plots of 5 element Chebychev and uniform array power patterns.}{fig:chebychevVsLinearArrayBothBroadside:chebychevVsLinearArrayBothBroadsideFig2}{0.2}

In both power patterns the side lobes are quite minimal.  These side lobes are not visible in the Chebychev power pattern, and can be seen in the linear uniform array power pattern by zooming into the origin, as shown in \cref{fig:chebychevVsLinearArrayBothBroadside:chebychevVsLinearArrayBothBroadsideFig2}.
