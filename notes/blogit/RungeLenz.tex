...
This is
%Here we've written $\rcap = \Be_1 e^{\Be_1 \Be_2 \phi_0}$, and $\Be = \Be_1 e^{\Be_1 \Be_2 \phi}$, where $\Be_1$ and $\Be_2$ are two orthonormal unit vectors in the plane of the tragectory.
