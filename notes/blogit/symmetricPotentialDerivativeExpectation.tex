...
\paragraph{Q: \citep{sakurai2014modern} pr 5.16}

For a particle in a spherically symmetric porential \( V(r) \) show that
...
\paragraph{A: show this is the case for the 3D SHO and hydrogen wave functions}
