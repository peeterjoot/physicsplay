...
This is effectively a $\delta_{\BK, \BG}$ condition, definiting the \underlineAndIndex{Laue condition for constructive interference}
...
with $p = 1$ this gives Miller indexes of
...
\imageFigure{qmSolidsL6Fig6}{Miller index demonstration}{fig:qmSolidsL6:qmSolidsL6Fig6}{0.3}
...
To find the perpendicular, define 2 non-parallel vecotrs in a plane: $\Ba_1 - \Ba_2/2$, $-\Ba_3 - \Ba_2/2$.
...
This is the \underlineAndIndex{Bragg condition}, which we showed is equivalent to the Laue condition.
