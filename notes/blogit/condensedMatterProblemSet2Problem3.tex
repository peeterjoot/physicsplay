...
\imageFigure{../phy487/figures/problemSet2Problem3VisualizationFig1}{Bcc lattice}{fig:problemSet2Problem3Visualization:problemSet2Problem3VisualizationFig1}{0.2}

The primative unit cell volume is that of the parallelopiped formed by the vectors $\Ba, \Bb, \Bc$, which is
...
which is twice the primative cell volume in this case.
}
