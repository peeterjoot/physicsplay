...
\frac{d}{dt} ( m \gamma v^\alpha ) = e E^\alpha + \frac{e}{c} \epsilon_{\alpha\beta\gamma} B_\gamma
\end{equation}
...
I asked this, not because I don't know (I could answer this myself from $\dot{p} = F \cdot v/c$, in the geometric algebra formalism, but I was curious if he had a way of determining this from what we've derived so far (intuitively I'd expect this to be possible).  Answer was:
...
&= - \frac{e}{c} \int ds u^i {A'}_i - \frac{e}{c} \int ds \frac{d}{ds} (\chi )
\end{align*}

\begin{align*}
\frac{d}{ds} \chi(x^{0,1,2,3}) 
&= 
