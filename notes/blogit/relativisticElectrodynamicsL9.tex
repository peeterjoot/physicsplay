...
Without the proper velocity term we don't have a way to simply re-pack the chain rule expanion and eliminate the last two terms as we did with the Lorentz force action.
