...
In QM where we don't know all the components of the angular momenum simultaneously, things get fuzzier.  For example, if the \( \hat{L}_{1z} \) and \( \hat{L}_{2z} \) components have been measured, we have the angular momentum defined within a conical region as sketched in \cref{fig:qmLecture16:qmLecture16Fig2}.
