...
Classically if we have measured \( \hat{\BL}_{1} \) and \( \hat{\BL}_{2} \) then we know the total angular momentum as sketched in 

F1

In QM where we don't know all the components of the angular momenum simultaneously, things get fuzzier.  For example, if the \( \hat{L}_{1z} \) and \( \hat{L}_{2z} \) components have been measured, we have the angular momentum defined within a conical region as sketched in 
