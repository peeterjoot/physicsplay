...
These are drawn out on the \cref{fig:qmSolidsL6:qmSolidsL6Fig11}.

%\imageFigure{qmSolidsL6Fig10}{Drawings of reciprocal vectors}{fig:qmSolidsL6:qmSolidsL6Fig11}{0.5}
\imageFigure{qmSolidsL6Fig11}{reciprocal vectors and sample wave trains}{fig:qmSolidsL6:qmSolidsL6Fig11}{0.5}

\makeSubAnswer{}{condensedMatter:problemSet3:1c}

Referring again to \cref{fig:qmSolidsL6:qmSolidsL6Fig11}.

\begin{itemize}
\item The wave crests for $\Bk_a = \Bg_1$ are shown in blue.  The wave length for this wave is $2 \pi/\Abs{\Bg_1}$
\item The wave crests for $\Bk_b = \Bg_1$ are shown in red.  The wave length for this wave is $2 \pi/\Abs{\Bg_2}$.
\item The wave crests for $\Bk_c = \Bg_1 + 2 \Bg_2$ are shown in green and pink, for which the wave lengths are $2 \pi/\Abs{\Bk_c}$, and $2 \pi/\Abs{\Bk_c}$ respectively.
\end{itemize}
}
