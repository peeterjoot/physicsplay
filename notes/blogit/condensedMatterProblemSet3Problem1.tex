...
\begin{itemize}
\item The wave crests for $\Bk_a = \Bg_1$ are shown in blue.  For this wave we have $\Bk_a \cdot \Ba_1 = g_1 a_1 \cos\theta = 2 \pi$, or a wave length of $2 \pi/\Abs{\Bg_1}$.
\item The wave crests for $\Bk_b = \Bg_2$ are shown in red.  For this wave we have $\Bk_b \cdot \Ba_2 = g_2 a_2 \cos\theta = 2 \pi$, or a wave length of $2 \pi/\Abs{\Bg_2}$.
