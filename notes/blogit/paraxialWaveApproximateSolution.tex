...
is an exact solution to the \underline{paraxial wave equation}

\begin{dmath}\label{eqn:paraxialWaveApproximateSolution:10}
\spacegrad_{\mathrm{T}}^2 u + 2 i k \PD{z}{u} = 0.
\end{dmath}

From our lectures, this doesn't seem possible, since we found that this Fresnel like function was an approximation to the $u_{00}$ function for large $z$.  Calculate this directly and verify this suspision.
