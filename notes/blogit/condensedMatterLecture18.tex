...
The two branches are because we have two atoms per unit cell.  Those are due to antibonding and bonding conditions as in
...
We want to talk about how to make an electrical current flow.  Imagine that we are considering a block of material with leads on it, as in
...
\Psi_\Bk(\Br, t) \sim \int_{\Abs{\Bk'} < \Delta} a_{\Bk'} U_\Bk(\Br) e^{ i \lr{\Bk \cdot \Br}} d\Bk'
\end{dmath}

%box:
%a_
%Bk ... eg Guassian, centered on \Bk
...
\begin{dmath}\label{eqn:condensedMatterLecture18:n}
\myBoxed{
