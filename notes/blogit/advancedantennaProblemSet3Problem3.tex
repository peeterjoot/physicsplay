...
\imageFigure{../../figures/ece1229/arrayFactorXYFig4}{Plot of \( \Abs{\textrm{AF}}^2 \) in XY plane with \( \alpha = h/\lambda \).}{fig:arrayFactorXY:arrayFactorXYFig4}{0.2}

This is also plotted in
\cref{fig:arrayFactorXY:arrayFactorXYFig5} for a few selected values of \( h = \alpha \lambda \).

\imageFigure{../../figures/ece1229/arrayFactorXYFig5}{Polar plot of \( \Abs{\textrm{AF}}^2 \) in XY plane for various values of \( \alpha = h/\lambda \).}{fig:arrayFactorXY:arrayFactorXYFig5}{0.2}
