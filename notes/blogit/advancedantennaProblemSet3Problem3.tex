...
For the purp{\textrm{LOS}}es of comparison, it probably makes sense to set the origin at the location of the radiator in the corner-cube antenna, as sketched in \cref{fig:cornerCubeGeometry:cornerCubeGeometryFig2}.
