...
It's helpful to recall the geometry of the energy distribution in k-space.  This is plotted in \cref{fig:qmSolidsPs8d:qmSolidsPs8dFig2}.

\imageFigure{../phy487/figures/qmSolidsPs8dFig2}{Energy level curves}{fig:qmSolidsPs8d:qmSolidsPs8dFig2}{0.2}
...
\begin{dmath}\label{eqn:condensedMatterProblemSet9Problem2:100}
\myBoxed{
...
\begin{dmath}\label{eqn:condensedMatterProblemSet9Problem2:500}
\myBoxed{
D(E) 
=
...
\begin{dmath}\label{eqn:condensedMatterProblemSet9Problem2:520}
\myBoxed{
D(E)
...
\imageFigure{qmSolidsPs9P2cFig1}{$k_x$ component of $\Bv_g$}{fig:qmSolidsPs9P2c:qmSolidsPs9P2cFig1}{0.3}
...
\imageFigure{qmSolidsPs9P2dFig1}{Effective mass for 3D cubic system}{fig:qmSolidsPs9P2d:qmSolidsPs9P2dFig1}{0.3}
}
