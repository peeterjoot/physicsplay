...
In \citep{pathriastatistical} I saw the Euler-summation formula casually used in a few places, allowing an approximation of a sum with derivatives at the origin.  This rather powerful was used in passing, and seemed like it was worth some exploration.
...
With $B_0 = 1$ \eqnref{eqn:fermiNumberDensityLargeVolume:60} provides an iterative method to calculate all the higher Bernoulli numbers.  Without calculating the Bernoulli numbers explicitly, we see that we can related these to the values of the polynomials at the origin
...
\begin{dmath}\label{eqn:fermiNumberDensityLargeVolume:280}
\myBoxed{
B_m(1) = B_m(0) = B_m.
}
\end{dmath}
