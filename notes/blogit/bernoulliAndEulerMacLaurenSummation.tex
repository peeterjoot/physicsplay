...
Before tackling Euler summation, we first need to understand some properties of Bernoulli polynomials \citep{ wiki:bernoulliPolynomial}, and Bernoulli numbers \citep{wiki:bernoulliNumber}.  The properties of interest required for the derivation of the Euler summation formula appear to follow fairly easily with the following choice for the definition of the Bernoulli polynomials $B_k(x)$ and Bernoulli numbers $B_k$
...
or
\begin{equation}\label{eqn:fermiNumberDensityLargeVolume:480}
\myBoxed{
\begin{aligned}
\sum_{k = 0}^{n} f(k)
&=
