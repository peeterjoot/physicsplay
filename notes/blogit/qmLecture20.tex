...
\section{Simplest pertubation example.}
...
The off diagonal terms can be considered to be a pertubation
...
\paragraph{Energy levels after pertubation}
...
% FIXME: nbref: from phy1520:visualizationOfEigenvaluesOfTwoByTwoHermitianMatrix.nb
...
{Plots of \( \lambda_{\pm} \) for \((a,b) \in \setlr{(1,1),(1,0),(1,5),(-8,8)}\)}{fig:lecture20:lecture20Fig3}{scale=0.4}
...
This adiabatic evolution displays a ``level repulsion'', quadradic in \( \Abs{c} \),
% as sketched in \cref{fig:lecture20:lecture20Fig1}, 
and is described as a non-degenerate perbutation.
...
We no longer have the sign of \( a - b \) in the expansion.  This is described as a degenerate perbutation.

%\imageFigure{../../figures/phy1520/lecture20Fig2}{Degenerate perbutation}{fig:lecture20:lecture20Fig2}{0.2}

\section{General non-degenerate pertubation}
...
\paragraph{Power series pertubation expansion}
...
The second order pertubation states are found by selecting only the \( \lambda^2 \) contributions to
...
For the second energy pertubation we have
...
In general, the energy pertubation is given by
