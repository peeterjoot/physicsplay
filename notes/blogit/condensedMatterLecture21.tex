...
Reading: \citep{ibach2009solid} \S 9 (pp 258-259).
...
We now continue to discuss scattering, a phenomina due to departure from periodicity.  For phonons, this is proportional to $\expectation{n_q}_{th}$, where $E_q = (n_q + 1/2) \Hbar \omega_q$.

%\cref{fig:qmSolidsL21:qmSolidsL21Fig1}.
\imageFigure{qmSolidsL21Fig1}{k-space scattering}{fig:qmSolidsL21:qmSolidsL21Fig1}{0.2}
...
%\imageFigure{qmSolidsL21Fig2}{2:CAPTION}{fig:qmSolidsL21:qmSolidsL21Fig2}{0.2}
%\cref{fig:qmSolidsL21:qmSolidsL21Fig3}.
\imageFigure{qmSolidsL21Fig3}{Scattering confinement to small range of k-space}{fig:qmSolidsL21:qmSolidsL21Fig3}{0.2}
...
\imageFigure{qmSolidsL21Fig4}{Resistivity temperature dependence}{fig:qmSolidsL21:qmSolidsL21Fig4}{0.2}

\section{Electron-electron scattering}

Reading: May not be in the text?

Electrons can scatter from oter electrons, but they must conserve energy and (crystal) momentum.

\paragraph{$T = 0$}

%\cref{fig:qmSolidsL21:qmSolidsL21Fig5}.
\imageFigure{qmSolidsL21Fig5}{Filled Fermi sphere}{fig:qmSolidsL21:qmSolidsL21Fig5}{0.2}
...
\imageFigure{qmSolidsL21Fig6}{With temperature dependence state transitions still effectively confined to range of energies}{fig:qmSolidsL21:qmSolidsL21Fig6}{0.2}
...
\begin{equation}\label{eqn:condensedMatterLecture21:240}
\myBoxed{
...
\begin{equation}\label{eqn:condensedMatterLecture21:280}
\myBoxed{
\rho(T) = \rho_\nought + A T^2.
}
\end{equation}

This is \underline{universal}.  This is a famous result, from \dquoteAndIndex{Fermi liquid theory}, developed by Landau and Fermi.
