...
\date{April 6, 2011}
\revisionInfo{relativisticElectrodynamicsL27.tex}
...
We've already considered the effects of the $\BA^{(1)}$ term, and now move on to $\BA^{(2)}$.  We will write $\phi^{(3)}$ as a total derivative
