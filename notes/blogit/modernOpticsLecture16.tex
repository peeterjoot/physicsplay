...
\imageFigure{modernOpticsLecture16Fig1}{Laser cavity}{fig:modernOpticsLecture16:modernOpticsLecture16Fig1}{0.2}

and to prevent losses, we have a \underline{gain medium} (to be defined), and some mechanism to pump in energy (almost always not a thermal source).

Townes and Schawlow were mazer researchers (still important, used in GPS satellites for example as clocks), who realized that the ideas could be carried over into the optical regeim.

The history of this actually goes back to Einstein, who in 1917 did a thought experiment with atoms in a box, stimulating radiation, which is bouncing around, eciting the atoms, so that they in turn emit again.  We'll consider $N$ atoms in thermal equalibrium with the light in the box as in \cref{fig:modernOpticsLecture16:modernOpticsLecture16Fig2}.
\imageFigure{modernOpticsLecture16Fig2}{Atoms in a box}{fig:modernOpticsLecture16:modernOpticsLecture16Fig2}{0.2}

We expect more in the ground state \cref{fig:modernOpticsLecture16:modernOpticsLecture16Fig3}.

\imageFigure{modernOpticsLecture16Fig3}{Ground and excited state separation}{fig:modernOpticsLecture16:modernOpticsLecture16Fig3}{0.2}

\begin{dmath}\label{eqn:modernOpticsLecture16:10}
\frac{N_e}{N_g}
=\frac{P_e}{P_g} = e^{-(E_e - E_g)/kT}
\end{dmath}
...
How do the number of excited states change, given absorbtion probability $B_{\mathrm{abs}} u(\omega)$ and stimulated emission probability $B_{\mathrm{se}} u(\omega)$, and spontaneous emmission probability $A$ (see figure in the slides)

\begin{subequations}
\begin{dmath}\label{eqn:modernOpticsLecture16:90}
...
\imageFigure{modernOpticsLecture16Fig4}{Population inversion}{fig:modernOpticsLecture16:modernOpticsLecture16Fig4}{0.2}
...
If the $\text{mode occupation} \gg 1$, then $B u > A$, we have more stimulated than sponaneous radiation.
