...
The basic idea is that we have a cavity as in
...
The history of this actually goes back to Einstein, who in 1917 did a thought experiment with atoms in a box, stimulating radiation, which is bouncing around, eciting the atoms, so that they in turn emit again.  We'll consider $N$ atoms in thermal equalibrium with the light in the box.

F2

We expect more in the ground state
...
This is very small, and in order to get there we need a population inversion with more atoms in the excited state than in the ground state.
