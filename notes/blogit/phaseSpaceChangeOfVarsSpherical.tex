...
\makeproblem{Cartesian to spherical change of variables in 3d phase space}{pr:phaseSpaceChangeOfVarsSpherical:1}{
\citep{pathriastatistical} problem 2.2 (a).  Try a spherical change of vars to verify explicitly that phase space volume is preserved.
}
