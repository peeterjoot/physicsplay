...
Ignoring the details about the range restriction we require for $\tau$ for now, our interference term will then be proportional to the plain old convolution integral, and we can reexpress this beastie using our final selected Fourier representation \cref{eqn:modernOpticsMidtermReflection:280}
