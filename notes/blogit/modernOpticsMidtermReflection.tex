...
dx' 
\left(
e^{i k L \sqrt{ 1 + (x - H)^2/L^2 } }
+ e^{i k L \sqrt{ 1 + (x + 2h + H)^2/L^2 } }
\right)
\approx
...
\frac{k(x - H)^2}{2 L}
=
\frac{ \pi (x - H)^2}{L \lambda}
\end{equation}
\begin{equation}\label{eqn:modernOpticsMidtermReflection:720}
\frac{\pi}{2} w^2
=
\frac{k(x + 2 h + H)^2}{2 L}
=
\frac{ \pi (x + 2 h + H)^2}{L \lambda}
\end{equation}
\end{subequations}
...
{\sqrt{\frac{k}{L \pi}}(h - \Delta x/2 -H)}
{\sqrt{\frac{k}{L \pi}}(h + \Delta x/2 -H)}
+
\evalrange{\left(C(w) + iS(w)\right)}
{\sqrt{\frac{k}{L \pi}}(3h - \Delta x/2 + H)}
{\sqrt{\frac{k}{L \pi}}(3h + \Delta x/2 + H)}
\right)
=
...
\left(
\evalrange{\left(C(w) + iS(w)\right)}
{\sqrt{\frac{2}{L \lambda}}(h - \Delta x/2 -H)}
{\sqrt{\frac{2}{L \lambda}}(h + \Delta x/2 -H)}
+
\evalrange{\left(C(w) + iS(w)\right)}
{\sqrt{\frac{2}{L \lambda}}(3h - \Delta x/2 + H)}
{\sqrt{\frac{2}{L \lambda}}(3h + \Delta x/2 + H)}
\right)
\end{dmath}
