...
There's one more part to this problem, doing the antisymmetric sums over the indexes $s, t, \cdots$.  For the \R{2} case we have
...
It's clear what the pattern is, and if we evaluate the sum of the antisymmetric tensor squares in \R{4} we have
