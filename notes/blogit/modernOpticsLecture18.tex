...
Taking curls of both sides of the $\BE$ curl equation \ref{eqn:modernOpticsLecture18:40}
...
\imageFigure{modernOpticsLecture18Fig1}{Possible $\epsilon$ dependence in medium}{fig:modernOpticsLecture18:modernOpticsLecture18Fig1}{0.3}
...
This is the \underline{paraxial wave equation}
...
\begin{dmath}\label{eqn:modernOpticsLecture18:520}
...
\imageFigure{modernOpticsLecture18Fig2}{Radiation and matter wave equivalence}{fig:modernOpticsLecture18:modernOpticsLecture18Fig2}{0.3}
...
\imageFigure{modernOpticsLecture18Fig3u0}{First order 1D SHO matter wave}{fig:modernOpticsLecture18:modernOpticsLecture18Fig3u0}{0.3}
\imageFigure{modernOpticsLecture18Fig3u1}{Second order 1D SHO matter wave}{fig:modernOpticsLecture18:modernOpticsLecture18Fig3u1}{0.3}
\imageFigure{modernOpticsLecture18Fig3u2}{Third order 1D SHO matter wave}{fig:modernOpticsLecture18:modernOpticsLecture18Fig3u2}{0.3}

%Recall that our 1D SHO solutions look like 
%\cref{fig:modernOpticsLecture18:modernOpticsLecture18Fig3}.
%\imageFigure{modernOpticsLecture18Fig3}{First couple SHO solutions}{fig:modernOpticsLecture18:modernOpticsLecture18Fig3}{0.3}
...
\imageFigure{modernOpticsLecture18Fig4}{2D SHO solutions}{fig:modernOpticsLecture18:modernOpticsLecture18Fig4}{0.3}

It wasn't clear to me what these were illustrating, but we can find some better plots on the web.  
\href{http://goo.gl/Q7GZx}{Here's a nice one that has some controls for $m$ and $n$}

\paragraph{Formal mapping}

\fxwarning{review lecture 18 from here}{work through this lecture from here in detail.}
...
\imageFigure{modernOpticsLecture18Fig5}{Dispersive electric field}{fig:modernOpticsLecture18:modernOpticsLecture18Fig5}{0.3}
