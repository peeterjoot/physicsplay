...
\imageFigure{continuumL19Fig1}{Illustrating the boundary layer thickness and associated pressure variation.}{fig:continuumL19:continuumL19Fig1}{0.2}
...
%, we see that we are in trouble.  With both $u$ and $v$ derivatives of $\psi$, and a linear constant relation between $f$ and $\psi$ (\ref{eqn:continuumL19:350}) we cannot possibly arrive at a differential equation that has a plain old (non-derivative) $f$ in it as in \ref{eqn:continuumL19:370} above.  
...
\imageFigure{continuumL19Fig2}{Boundary layer solution to flow over plate.}{fig:continuumL19:continuumL19Fig2}{0.2}
...
\imageFigure{continuumL19Fig3}{Solution to the ill conditioned first order differential equation.}{fig:continuumL19:continuumL19Fig3}{0.2}
