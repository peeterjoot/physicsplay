...
\begin{align}\label{eqn:ftMaxVacuum:3a}
...
where we should have the conservation to relate these two

\begin{align}\label{eqn:ftMaxVacuum:13b}
\PD{t}{H} + \spacegrad \cdot (c \BP) = 0.
\end{align}

Multiplying out \autoref{eqn:ftMaxVacuum:12} yields

\begin{subequations}
\label{eqn:ftMaxVacuum:14}
\begin{align}
H &= \frac{\epsilon_0}{2} \int d^3 \Bk \left(
