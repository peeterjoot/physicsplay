...
\imageFigure{../../figures/ece1254/lecture13Fig1}{CAPTION}{fig:lecture13:lecture13Fig1}{0.3}
...
\imageFigure{../../figures/ece1254/lecture13Fig2}{CAPTION}{fig:lecture13:lecture13Fig2}{0.3}

\section{Assembling equations automatically for dynamical systems}

\makeexample{RC circuit}{example:multiphysicsL13:220}{
To demonstrate the method by example consider the RC circuit \cref{fig:lecture13:lecture13Fig3} which has time dependence that must be considered

\imageFigure{../../figures/ece1254/lecture13Fig3}{CAPTION}{fig:lecture13:lecture13Fig3}{0.3}
...
Such a system may be represented diagramatically as in \cref{fig:lecture13:lecture13Fig4}.

\imageFigure{../../figures/ece1254/lecture13Fig4}{CAPTION}{fig:lecture13:lecture13Fig4}{0.3}
...
\imageFigure{../../figures/ece1254/lecture13Fig5}{CAPTION}{fig:lecture13:lecture13Fig5}{0.3}
...
\imageFigure{../../figures/ece1254/lecture13Fig6}{CAPTION}{fig:lecture13:lecture13Fig6}{0.3}
...
\imageFigure{../../figures/ece1254/lecture13Fig7}{CAPTION}{fig:lecture13:lecture13Fig7}{0.3}

Introducing this into \cref{eqn:multiphysicsL13:340} gives

\begin{equation}\label{eqn:multiphysicsL13:350}
G x_n + C \frac{x_{n+1} - x_n}{\Delta t} = B u(t),
\end{equation}

or

\begin{equation}\label{eqn:multiphysicsL13:380}
C x_{n+1} = \Delta t B u(t) - \Delta t G x_n + C x_n.
\end{equation}

The coefficient \( C \) must be invertable.  Without any loss of generality assume \( C = I \).  The value of the function \( x \) at the next point is then

%\begin{equation}\label{eqn:multiphysicsL13:380}
\boxedEquation{eqn:multiphysicsL13:400}{
x_{n+1} = \Delta t B u(t) - \Delta t G x_n + x_n.
}
%\end{equation}
