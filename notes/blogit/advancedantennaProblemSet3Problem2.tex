...
In \cref{fig:longDipole:longDipoleFig1} \( 8 \pi^2 U /\eta \Abs{I_0}^2 \) is plotted for \( \alpha \in \setlr{0.5, 1, 1.25, 2.0 } \).  For \( \alpha = 1.25 \) some very small side lobes are just barely visible.  For \( \alpha = 2 \) the single lobe directivity is lost, and a significant split of the radiation field along two different directions can be observed.
