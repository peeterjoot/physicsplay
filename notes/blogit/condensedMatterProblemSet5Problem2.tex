...
Based on this, we expect to see small Debye temperatures when the number density is low, which should occur when the atomic radii is large.  That can be observed in \cref{fig:atomicRadiiVsAtomicNumber:atomicRadiiVsAtomicNumberFig2}, looking for example at \ce{K}, \ce{Rb}, and \ce{Cs}, that are positioned at local maxiumums for atomic radii, in contrast to the local miniumums observed for the Debye temperature.

\imageFigure{atomicRadiiVsAtomicNumberFig2}{Atomic radii}{fig:atomicRadiiVsAtomicNumber:atomicRadiiVsAtomicNumberFig2}{0.5}
}
