...
We can define a special primative unit cell, by bisecting the (reciprocal) lattice vectors with a plane.  In 2D

F3: First Brillouin zone.
...
Here will do an introductory calculation not in the text.  Consider a 1D chain of $N$ atoms, coupled by harmonic springs with periodic boundary conditions.  We suppose that we have $N \sim 10^{23}$.

F4

With equilbrium positions $x_j$, and displacement distances from equilibrium of $u_j$.

Our force balance is

\begin{dmath}\label{eqn:condensedMatterLecture7:n}
