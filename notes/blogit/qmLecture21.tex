...
The zeros above are due to the orthogonality of the \( Y_{l m} \)'s.   This leaves
...
There is an exact answer to this, but we aren't going to try to get it here.  Instead let's look for bounds
