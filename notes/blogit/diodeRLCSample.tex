...
e^{ (v^{(1)}(t) - v^{(2)}(t))/V_T}
\simeq
\sum_{n=-N}^N G_n e^{ j \omega_0 n t },
\end{equation}
\end{subequations}
...
The structure of this last non-linear term is what has to be examined.

%Assuming periodic inputs and outputs the frequency domain equivalent 
