...
This shows the stamping pattern required to form the non-linear portion of the Harmonic balance equations.  For the diode exponentials, these non-linear term will be of the form
