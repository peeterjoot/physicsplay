...
\imageFigure{modernOpticsLecture12Fig1}{Two partially silvered mirror configuration with thickness}{fig:modernOpticsLecture12:modernOpticsLecture12Fig1}{0.3}

We are going to ignore the thickness and assume the reflection and transmission coefficents are the same for both surfaces and assume that we have no absorbtion and only treat the $n = 1$ everywhere case for now.  We'll look at the interference of all the internal refections on eventual exit from the pair of mirrors as shown in \cref{fig:modernOpticsLecture12:modernOpticsLecture12Fig2}.

\imageFigure{modernOpticsLecture12Fig2}{Ignoring thickness}{fig:modernOpticsLecture12:modernOpticsLecture12Fig2}{0.3}
...
\imageFigure{modernOpticsLecture12Fig3}{Just the geometry of the problem}{fig:modernOpticsLecture12:modernOpticsLecture12Fig3}{0.3}
...
We lookup (in a spec sheet) the transmission and reflection coefficents and the (associated phase shifts after reflection)
