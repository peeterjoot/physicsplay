...
Reading: \citep{ibach2009solid} \S 6.
...
\item Can bend and hammer it (mallebility).
...
\imageFigure{qmSolidsL11Fig1}{Rough sketch of d orbital radial magnitude}{fig:qmSolidsL11:qmSolidsL11Fig1}{0.15}

We can jusfify our treatment of electrons as a gas by noting that we have significant overlap of these orbitals over many sites in the metallic lattice as in \cref{fig:qmSolidsL11:qmSolidsL11Fig2}.

\imageFigure{qmSolidsL11Fig2}{Overlapping d orbital wavefunctions}{fig:qmSolidsL11:qmSolidsL11Fig2}{0.15}
...
\imageFigure{qmSolidsL11Fig3}{One dimensional particle in a box}{fig:qmSolidsL11:qmSolidsL11Fig3}{0.15}

where we had solutions like those of \cref{fig:qmSolidsL11:qmSolidsL11Fig4}.

\imageFigure{qmSolidsL11Fig4}{First few solutions for particle in a 1D box}{fig:qmSolidsL11:qmSolidsL11Fig4}{0.15}
...
\imageFigure{qmSolidsL11Fig5}{3D particle in a box}{fig:qmSolidsL11:qmSolidsL11Fig5}{0.15}
...
\imageFigure{qmSolidsL11Fig7}{Parabolic energy dispersion}{fig:qmSolidsL11:qmSolidsL11Fig7}{0.15}
...
\imageFigure{qmSolidsL11Fig6}{Volume per k point}{fig:qmSolidsL11:qmSolidsL11Fig6}{0.15}
...
As with the phonon, properties are calcuated via k space sums using the density of states.

\begin{dmath}\label{eqn:condensedMatterLecture11:240}
\sum_{k_x, k_y, k_z, \text{spin}} 
...
\sum_{k_x, k_y, k_z, \text{spin}} 
\rightarrow
\frac{V}{2 \pi^2} \lr{ \frac{2m}{\Hbar^2} }^{3/2} \sqrt{E} dE.
\equiv V \int D(E) dE.
\end{dmath}

The density of states per volume

\begin{dmath}\label{eqn:condensedMatterLecture11:340}
D(E) =
\frac{1}{2 \pi^2} \lr{ \frac{2m}{\Hbar^2} }^{3/2} \sqrt{E} dE.
\end{dmath}

This is sketched in \cref{fig:qmSolidsL11:qmSolidsL11Fig8}.

\imageFigure{qmSolidsL11Fig8}{3D density of states}{fig:qmSolidsL11:qmSolidsL11Fig8}{0.15}

%This is in fact the same type of expression that we get for the density of a gas.

Reading: \S 6.2, Fermi gas at $T = 0 K$.

This assumes that electrons \underline{do not} interact.  This is the operational definition of an ideal gas.
...
\imageFigure{qmSolidsL11Fig9}{Spin packing of energy levels for 1D particle in a box}{fig:qmSolidsL11:qmSolidsL11Fig9}{0.15}
...
\imageFigure{qmSolidsL11Fig10}{Fermi surface in momentum space}{fig:qmSolidsL11:qmSolidsL11Fig10}{0.15}

and determine the energy level $E_F$ and momentum $\kF$ associated with that surface, for which no more states can be occupied.  This is roughly illustrated in \cref{fig:qmSolidsL11:qmSolidsL11Fig11}.

\imageFigure{qmSolidsL11Fig11}{Fermi energy and momentum}{fig:qmSolidsL11:qmSolidsL11Fig11}{0.15}
...
This is typically of the order $10^{10} m^{-1}$ % FIXME: ($\Angstrom^{-1}$) % \AA (text)
