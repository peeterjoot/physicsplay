...
We can jusfify our treatment of electrons as a gas by noting that we have significant overlap of these orbitals over many sites in the metallic lattice as in
...
We try the simple \underlineAndIndex{jellium model}, where we ``smear'' out the positive ions to a uniform background as in the typical 2nd year particle in an infinite potential box problem

F3

where we had solutions like

F4

The difference is that we will consider the 3D generalization of this problem
...
Fermi energy states can only be occupied by one particle with each spin 
...
\begin{dmath}\label{eqn:condensedMatterLecture11:n}
N 
