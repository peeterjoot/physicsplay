...
then multiplying by the inverse \textAndIndex{Jacobian}, and rearranging, we have
...
\section{Automatic assembly of equations for nolinear system}

\paragraph{Nonlinear circuits}

We will start off considering a non-linear resistor, designated within a circuit as sketched in \cref{fig:lecture11:lecture11Fig2}.
...
For the non-linear circuit element of \cref{fig:lecture11:lecture11Fig4}.
