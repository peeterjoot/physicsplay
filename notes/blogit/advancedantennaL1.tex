...
%
%We can think of antennas as sensors of electromagnetic radiation.  A linear passive device that converts a bounded EM wave to an unbounded one.
%
%F1
%
%Issues of interest:
...
\begin{dmath}\label{eqn:advancedantennaL1:n}
U(\theta, \phi) 
= 
...
# surface
\begin{dmath}\label{eqn:advancedantennaL1:n}
P_{\textrm{rad}} = \iint_\Omega ...
\end{dmath}

\section{Directivity}

The ratio of the raditation intensity in a given direction from an antenna to the radition intensity of an isotropic source (radiating in the smae power rad)

\begin{dmath}\label{eqn:advancedantennaL1:n}
D(\theta, \phi) 
= \frac{U(\theta, \phi)}{U_{\textrm{iso}}}
= \frac{U(\theta, \phi)}{P_{\textrm{rad}}/{4 \pi}}
= 4 \pi \frac{U(\theta, \phi)}{P_{\textrm{rad}}}
\end{dmath}

...

\begin{equation}\label{eqn:advancedantennaL1:n}
D_{max} = 4 \pi \frac{U_{max}}{P_{\textrm{rad}}}
\end{equation}
...
\begin{dmath}\label{eqn:advancedantennaL1:n}
\Prad = \\iint_\Omega U\btp d\Omega
...
\begin{dmath}\label{eqn:advancedantennaL1:n}
D_0 = 4 \pi \frac{\Umax}{\Prad} = 4 \pi \frac{U\btp}_\tmax }{
\iiint_\Omega %loop
...
}
\end{dmath}
