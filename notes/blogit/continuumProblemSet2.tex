...
Checking, we see at a glance we see that we have $u^\br2(h) = -U$, $u^\br1(-h) = 0$, $u^\br1(0) = u^\br2(0)$, and $\evalbar{\mu^\br1 du^\br1/dy}{y=0} = \mu^\br2 \evalbar{du^\br2/dy}{y=0}$ as desired.
