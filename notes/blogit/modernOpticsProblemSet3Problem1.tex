...
\imageFigure{frequencySingletsFig2}{Comparison to doubled frequency form}{fig:frequencySinglets:frequencySingletsFig2}{0.3}
...
\imageFigure{problemSet3SketchFig1a}{Intensity as a function of additional path length}{fig:problemSet3Sketch:problemSet3SketchFig1a}{0.3}
...
\imageFigure{problemSet3Problem1bPlotFig4}{10 frequency input to Michelson interferometer}{fig:problemSet3Problem1bPlot:problemSet3Problem1bPlotFig4}{0.3}
}
