...
\beginArtNoToc
\generatetitle{ECE1254H Modeling of Multiphysics Systems.  Lecture 8: Conjugate gradient methods.  Taught by Prof.\ Piero Triverio}
...
\captionedTable{Convergence}{tab:multiphysicsL8:20}{
\begin{tabular}{|l|l|}
\hline
       & Full     \\ \hline
Direct & \(O(n^3)\)   \\ \hline
...
\maketheorem{Gershgorin circle theorem}{thm:multiphysicsL8:1}{
...
\makeexample{Leaky bar}{example:multiphysicsL8:1}{
