...
This gives
%\begin{dmath}\label{eqn:sphericalLaplacian:n}
\boxedEquation{eqn:sphericalLaplacian:n}{
\spacegrad \cross \BA 
=
\rcap \lr{ 
    \inv{r S_\theta} \partial_\theta (S_\theta A_\phi)
...
This and the divergence equation both check against the back cover of \citep{jackson1975cew}.
