...
When this is real valued, there is transmission in the barrier region.  There are a few cases of interest, the \( V_0 < 2 m c^2 \) cases are plotted in \cref{fig:ps4DiracStepPotential:ps4DiracStepPotentialFig1} showing the transmission and decaying cases respectively.  The \( V_0 > 2 m c^2 \) cases are plotted in 
...
Simultaneous solutions of \cref{eqn:diracPlaneWaveDiagonalization:740}, \cref{eqn:diracPlaneWaveDiagonalization:780} only occur at \( k = \pm 0 \), where \( \tan( (1 + 2 n)\pi/2 ) = \pm \infty \).  Since a particle at rest is not at interest in a reflection scenario, this shows that a decaying solution in region II must be introduced to match the boundary value constraints.
...
\begin{dmath}\label{eqn:diracPlaneWaveDiagonalization:1041}
\ket{\pm} \propto
\begin{bmatrix}
\mp m \\
\epsilon_1 \pm k
...
\begin{dmath}\label{eqn:diracPlaneWaveDiagonalization:1061}
\ket{\pm} \propto
\begin{bmatrix}
\mp m \\
\epsilon_2 \pm i k
...
\begin{dmath}\label{eqn:diracPlaneWaveDiagonalization:1081}
\epsilon_2^2 = m^2 - k^2
\end{dmath}

Observe that the \( \psi_2 \) component of this wave function sits on a circle in the complex plane

\begin{dmath}\label{eqn:diracPlaneWaveDiagonalization:1101}
...
\begin{dmath}\label{eqn:diracPlaneWaveDiagonalization:1121}
...
\begin{dmath}\label{eqn:diracPlaneWaveDiagonalization:1141}
\ket{\pm}
=
\inv{\sqrt{2}}
\begin{bmatrix}
...
where the respective eigenvalues are \( \pm \sqrt{ (m c^2)^2 - (\Hbar k c)^2} \).

Observe that the currents for the exponential wave functions are both light-like

\begin{equation}\label{eqn:diracPlaneWaveDiagonalization:1161}
...
\begin{dmath}\label{eqn:diracPlaneWaveDiagonalization:1181}
A 
\begin{bmatrix}
C_1 \\
S_1
...
\begin{dmath}\label{eqn:diracPlaneWaveDiagonalization:1201}
\begin{bmatrix}
a \\
b
\end{bmatrix}
...
\begin{dmath}\label{eqn:diracPlaneWaveDiagonalization:1221}
R 
= \Abs{\frac{B}{A}}^2
= \Abs{\frac{B/D}{A/D}}^2
...
\begin{dmath}\label{eqn:diracPlaneWaveDiagonalization:1241}
T 
= \Abs{\frac{D}{A}}^2
=
...
\begin{dmath}\label{eqn:diracPlaneWaveDiagonalization:1261}
\cos\phi 
= \Real e^{i \phi}
...
so
\begin{dmath}\label{eqn:diracPlaneWaveDiagonalization:1281}
T 
= 
\frac{ 
...
\begin{dmath}\label{eqn:diracPlaneWaveDiagonalization:1301}
T
=
\frac{
   2 (\Hbar k_1 c)^2
