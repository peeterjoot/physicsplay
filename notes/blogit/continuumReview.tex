...
\keywords{strain, displacement vector, stress, constituitive relation, Lame parameters, shear modulus, Cauchy tetrahedron, Uniform hydrostatic compression, Bulk modulus, Uniaxial stress, Young's modulus, Poisson's ratio.}
...
\subsection{relating displacement and position by strain}
...
Useful in many practise problems are the cylindrical coordinate representation of the strain tensor 
