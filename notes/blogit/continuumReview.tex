...
\keywords{strain, displacement vector, stress, constitutive relation, Lame parameters, shear modulus, Cauchy tetrahedron, Uniform hydrostatic compression, Bulk modulus, Uniaxial stress, Young's modulus, Poisson's ratio, Compatibility condition}
...
where $\lambda$ and $\mu$ are the Lame parameters and $\mu$ is called the shear modulus.
...
\subsubsection{Elastostatics, gradient and curl representation of the vector displacement.}

\subsubsection{Phasor description of vector displacement equations and solutions.}
