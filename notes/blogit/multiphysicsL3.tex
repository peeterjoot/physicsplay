...
We want to consider the same circuit
F1
, this time considering only the node voltages.  We'd like to avoid introducing branch currents to reduce the scope of the computational problem.
...
We identify the stamp for the resistor of 
F2
...
The stamp can be found by multipying out the contribution for a single resistor
...
To illustrate the method, consider the same circuit, augmented with an additional voltage source
