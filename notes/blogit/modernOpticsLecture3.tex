...
\keywords{Eikonal equation, ray equation, Optics, PHY485H1F}
...
\begin{dmath}\label{eqn:modernOpticsLecture3:n}
...
\boxed{
n_0 \ddz^2 \Brho = - \alpha \Brho
}
\end{dmath}

Let's write this out

FIXME: \frac{\sqrt{\alpha}}{n_0} should be \sqrt{\frac{\alpha}{n_0}}
...
=
\begin{bmatrix}
A \cos( \frac{\sqrt{\alpha}}{n_0} z ) + B \sin( \frac{\sqrt{\alpha}}{n_0} z) \\
C \cos( \frac{\sqrt{\alpha}}{n_0} z ) + D \sin( \frac{\sqrt{\alpha}}{n_0} z) \\
\end{bmatrix}
\end{dmath}
...
T = \int_0^L \frac{ds}{c/n(\Br)} 
= \int_0^L dz \left( 1 + \inv{2} \Abs{ \ddz \Brho}^2 } \left(n_0 - \frac{\alpha}{2} \rho^2 \right)
...
T 
= \frac{n_0}{c} \int_0^L dz \left( 1 
+ \inv{2} \ddz{} \left( \Brho \cdot \ddz{\Brho} \right) 
...
-\inv{2} \frac{\alpha}{n_0} \rho^2
=
-\inv{2} \underbrace{( ddz2 \Brho - \alpha/n_0 \Brho)}_{ = 0 \text{by Eikonal}} \cdot \Brho
\end{dmath}
...
T 
= \frac{n_0 L}{c} 
+ \underbrace{\evalrange{ \Brho \cdot \ddz{\Brho} }{0}{L}}{ = 0 $\text{if refocused}}
\end{dmath}

Here if refocused means $\Brho = 0$ at both sides.

See chapter 3 of FIXME: Principles of optics by B...?
