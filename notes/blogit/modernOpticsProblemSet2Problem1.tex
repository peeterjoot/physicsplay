...
\imageFigure{modernOpticsProblemSet2Problem1Fig4}{Three slit diffraction aperature}{fig:modernOpticsProblemSet2Problem1:modernOpticsProblemSet2Problem1Fig4}{0.3}
...
Our time averaged intensity, again in terms of the time averaged intensity of the plane waves at the aperature $I_s$, is
...
\left\{
\begin{array}{l l}
1 & \quad \mbox{if $x'$ and $y'$ lie within the aperature} \\
0 & \quad \mbox{otherwise}
\end{array}
\right.
\end{equation}

We are now asked to consider a more general aperature function

\begin{equation}\label{eqn:modernOptics:ProblemSet2:P1:450}
g(x', y') = e^{-{x'}^2/\sigma_x^2 - {y'}^2/\sigma_y^2}
\end{equation}

which fully allows transmission at the origin where $g(0, 0) = 1$, and then gradually lets less and less light through the aperature as illustrated in \cref{fig:modernOpticsProblemSet2Problem1:modernOpticsProblemSet2Problem1Fig5}.

\imageFigure{modernOpticsProblemSet2Problem1Fig5}{Gaussian transmission function aperature}{fig:modernOpticsProblemSet2Problem1:modernOpticsProblemSet2Problem1Fig5}{0.3}
...
and our wave function evaluated at point $\Br = f(\alpha, \beta, 1)$, given plane wave function $\Psi_s$ at the aperature is
