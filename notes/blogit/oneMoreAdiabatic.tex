...
Here I've written $\ket{k'} = d\ket{k}/dt$.  In our original time dependent pertubaton the $-i \alpha_k'$ term was $-i \omega_k$, so this killed off the $E_k$.  If we assume this still kills off the $E_k$, we must have
