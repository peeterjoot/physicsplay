...
Guoy's work was circa 1890.  Was that experiemental or theoretical work?  Some references can be found in \cite{winful2001physical}.

Let's consider the \underline{phase velocity} at $z \ll z_0$.

%\cref{fig:modernOpticsLecture20:modernOpticsLecture20Fig1}.
%\imageFigure{modernOpticsLecture20Fig1}{CAPTION}{fig:modernOpticsLecture20:modernOpticsLecture20Fig1}{0.3}
...
Taking time derivatives of $\phi$, using chain rule and \ref{eqn:modernOpticsLecture20:790}, we have
...
The time derivative of \ref{eqn:modernOpticsLecture20:150} is then
...
\begin{dmath}\label{eqn:modernOpticsLecture20:n}
\frac{k_{\mathrm{eff}}}{k_0}
= 1 - \frac{2}{k_0^2 \omega_0^2} \inv{ 1 + (z/z_0)^2},
\end{dmath}

We have $k_{\mathrm{eff}} > 0$ provided $(z/z_0)^2 > 2/(k_0 \omega_0)^2 -1$.  We have $k_{\mathrm{eff}}$ take its maximum of $k_0$ as $z \rightarrow \infty$, and minimum value of
...
\imageFigure{modernOpticsLecture20Fig5}{Effective Phase velocity}{fig:modernOpticsLecture20:modernOpticsLecture20Fig5}{0.3}
...
\imageFigure{modernOpticsLecture20Fig2}{Gaussian mode confined in cavity by a set of mirrors}{fig:modernOpticsLecture20:modernOpticsLecture20Fig2}{0.3}
...
\imageFigure{modernOpticsLecture20Fig3}{Gaussian modes confined to mirror cavity}{fig:modernOpticsLecture20:modernOpticsLecture20Fig3}{0.3}
...
\imageFigure{modernOpticsLecture20Fig4}{Equivalent to mirror cavity}{fig:modernOpticsLecture20:modernOpticsLecture20Fig4}{0.2}
...
\makeproblem{arctan derivative}{pr:modernOpticsLecture20:1}{
Calculate 
...
\makeanswer{pr:modernOpticsLecture20:1}{
...
\begin{dmath}\label{eqn:modernOpticsLecture20:750}
x^2 
=
\tan^2 f 
...
\begin{dmath}\label{eqn:modernOpticsLecture20:770}
f' = \cos^2 f = \inv{1 + x^2}
\end{dmath}

Our $\phi(z)$ derivative then follows

\begin{dmath}\label{eqn:modernOpticsLecture20:790}
\ddz{} \Atan(z/z_0)
= 
