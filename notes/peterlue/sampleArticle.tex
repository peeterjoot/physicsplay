...
We can refer to equations with references like this (\eqnref{eqn:mysample:10}).  You'll need to run pdflatex twice to resolve the equation numbers in the references (you'll see 'There are undefined references' in the log file to tell you to do so).
