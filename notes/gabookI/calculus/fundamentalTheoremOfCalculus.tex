...
\paragraph{Stokes Theorem, definitions}
...
Stokes' theorem, a single formula, is a loaded and abstract statement, and requires many definitions to make it useful.  
It is worth summarizing all those auxillary definitions associated with it for reference
...
%FIXME: incorporate this section into the previous Stokes content.  It is clearer to have things stated explicitly.
