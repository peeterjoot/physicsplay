...
Geometric Algebra is not the only answer to some of these questions.  The student of differential forms will know that 
...
%
%Here is an attempt to provide a naturally sequenced introduction to the algebra.
