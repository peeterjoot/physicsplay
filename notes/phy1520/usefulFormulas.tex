...
L_{\pm} = -i \Hbar e^{\pm i \phi} \lr{ \pm i \partial_\theta - \cot\theta \partial_\phi } = L_x \pm L_y
\end{equation}

\begin{equation}\label{eqn:usefulFormulas:1881}
L_{\pm} \ket{l,m} =\Hbar \sqrt{(l \pm m)(l \pm m + 1)} \ket{l, m \pm 1}
\end{equation}
