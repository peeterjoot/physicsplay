...
Noting that \( \nu \) is an integer, this is the desired result except for a pesky factor of two difference.
%.  In the rough draft of my solution, I actually had the desired result, but realized I had dropped a factor of two elsewhere.  i.e., I expanded
%
