...
\frac{-\Hbar^2}{2 m \Phi} \partial_{\phi\phi} \Phi + \frac{i \Hbar e B \rho_a^2}{2 m c \Phi} \partial_\phi \Phi
= E_\phi.
\end{dmath}
...
\frac{\Hbar^2}{2 m} 
\lr{
\lr{ \nu - \frac{e B \rho_a^2}{2 \Hbar c} }^2 - \cancel{\lr{ \frac{e B \rho_a^2}{2 \Hbar c} }^2}
}
=
\frac{-\Hbar^2}{2 m} \lr{ 
\frac{\rho}{P} \partial_\rho \lr{ \rho \partial_\rho P } 
...
\frac{2 m E_\phi}{\Hbar^2} = \lr{ N - \theta }^2 - \theta^2,
\end{dmath}

which has zeros for any combination \( N = 2 \theta \), or

\begin{dmath}\label{eqn:gradQuantumProblemSet3Problem3:980}
\frac{N}{2} = \frac{e B \rho_a^2}{2 \Hbar c},
\end{dmath}

Shuffling terms, this is

\begin{dmath}\label{eqn:gradQuantumProblemSet3Problem3:1000}
\frac{2 \pi N \Hbar c}{e} = (2) \times B \pi \rho_a^2.
\end{dmath}

This is the desired result except for a pesky factor of two difference on the RHS.
}
