...
and consider time-evolution under the Hamiltonian \( \hat{H} = - B S_z \),
...
As a check observe that this has the right value for \( t = 0 \).  This also checks against the slightly messier computation \( \phat(t) = U \phat(0) U^\dagger \).
