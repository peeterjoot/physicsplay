...
We could also consider the state in a \textAndIndex{momentum basis}
...
Here we've essentially calculated the position space representation of the \textAndIndex{momentum operator}, allowing identifications of the following form
