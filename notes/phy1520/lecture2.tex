...
\begin{dmath}\label{eqn:lecture2:20}
...
\begin{dmath}\label{eqn:lecture2:80}
...
\begin{dmath}\label{eqn:lecture2:140}
\hat{A} \ket{\Psi(t)}.
\end{dmath}

This will have time evolution of the form

\begin{dmath}\label{eqn:lecture2:160}
\hat{A} e^{-i \hat{H} t/\Hbar} \ket{\Psi(0)},
\end{dmath}

or in matrix element form

\begin{dmath}\label{eqn:lecture2:180}
...
\begin{dmath}\label{eqn:lecture2:200}
\hat{A}(t) = 
e^{i \hat{H} t/\Hbar} 
...
\begin{dmath}\label{eqn:lecture2:220}
\ket{\Psi} 
= 
...
\begin{dmath}\label{eqn:lecture2:240}
...
\begin{dmath}\label{eqn:lecture2:260}
\sum_n \Abs{C_{m, n}}^2
\end{dmath}
...
\begin{dmath}\label{eqn:lecture2:280}
\Abs{C_{m, n}}^2
\end{dmath}
\end{itemize}
...
\begin{dmath}\label{eqn:lecture2:300}
\hat{\rho} = \ket{\Psi} \bra{\Psi}.
\end{dmath}

This is idempotent

\begin{dmath}\label{eqn:lecture2:320}
\hat{\rho}^2 = 
\lr{ \ket{\Psi} \bra{\Psi} }
\lr{ \ket{\Psi} \bra{\Psi} }
=
