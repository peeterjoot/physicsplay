...
\imageFigure{../../figures/phy1520/ps3Fig2}{Some representitive probability density plots}{fig:ps3:ps3Fig2}{0.3}
...
r^2 
= \frac{(2 n + 1)}{2 \alpha}
= (n + \inv{2}) \frac{ 2 \Hbar c}{e B_0}.
\end{dmath}

If this is less than \( R^2 \), and assuming \( n \) large with respect to \( 1/2 \) we have

\begin{equation}\label{eqn:gradQuantumProblemSet3Problem2:n}
n + \inv{2} \approx n < \frac{2 e B_0 R^2}{ \Hbar c},
\end{equation}
...
The approximate number of ground states if the particle is confined to a disk of radius \( R \) is proportional to the magnetic flux \( \Phi = B_0 \pi R^2 \) through that disk.
}
