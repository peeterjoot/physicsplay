...
The wave functions decay exponentially, and beyond a certain threshold, dependent on \( n \), not much of the wave function will contribute to the probability density.
