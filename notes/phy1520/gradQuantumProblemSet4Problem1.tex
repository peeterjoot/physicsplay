...
As we've seen with the Harmonic oscillator, an expectation with respect to a state that is not a single eigenstate, will have non-zero time dependenence.  With
...
\expectation{\hat{x}} 
= \expectation{\hat{x}}(0) + \frac{c \Hbar}{2 m c^2} \sin \lr{ 2 \pi \frac{2 E}{h} t }
= \expectation{\hat{x}}(0) + \frac{\Hbar}{2 m c} \sin \lr{ 2 \pi \frac{2 E}{h} t }.
\end{dmath}
