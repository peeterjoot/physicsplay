...
\begin{itemize}
\item Lecture notes.
\item Personal notes exploring auxillary details.
\item Worked practise problems.

\ifthenelse{\boolean{redacted}}%
{%
\item Links to Mathematica notebooks associated with the course material and problems.
}%
{
\item Assigned problems.%
\item Links to Mathematica notebooks associated with the problem sets.%
}
\end{itemize}
