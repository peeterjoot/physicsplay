...
%
\makeproblem{Angular momentum addition}{gradQuantum:problemSet6:2}{ 
...
A Mathematica notebook clebschGordan2.nb containing a solution of this problem is attached.
%FIXME: on integration use:
% \nbref{clebschGordan2.nb}
}
