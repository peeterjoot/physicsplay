...
%
\makeproblem{Scattering off a potential step}{gradQuantum:problemSet4:3}{ 
...
where the operator \( \hat{p} = - i \Hbar \PDi{x}{} \) is the rest mass, and \( c \) is the speed of light, and with 2-component wavefunctions
...
When this is real valued, there is transmission in the barrier region.  There are a few cases of interest, the \( V_0 < 2 m c^2 \) cases are plotted in \cref{fig:ps4DiracStepPotential:ps4DiracStepPotentialFig1} showing the transmission (\( V_0 = 0.66 m c^2 \)) and decaying cases (\( V_0 = 1.36 m c^2 \)) respectively.
