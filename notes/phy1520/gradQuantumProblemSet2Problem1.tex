...
= 
\frac{\Hbar^2}{2 x_0^2} \lr{ 1 - (z - z^\conj)^2 }.
\end{dmath}
...
\begin{aligned}
\expectation{x} &= \frac{x_0}{\sqrt{2}} \lr{ z e^{-i \omega t} + z^\conj e^{i \omega t} } \\
\expectation{p} &= \frac{-i \Hbar}{x_0 \sqrt{2}} (z e^{-i \omega t} - z^\conj e^{i \omega t} ) \\
\expectation{x^2} &= \frac{x_0^2}{2} \lr{(z e^{-i \omega t} + z^\conj e^{i \omega t} )^2 + 1} \\
\expectation{p^2} &= \frac{\Hbar^2}{2 x_0^2} \lr{ 1 - (z e^{-i \omega t} - z^\conj e^{i \omega t})^2 }.
\end{aligned}
\end{dmath}

TODO: comment on relation to classical.
}
