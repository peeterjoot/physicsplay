...
The momentum \( \hat{p} \) is called a ``Generator'' \index{generator!translation} of translations.  If a Hamiltonian \( H \) is translationally invariant, then
...
{\PD{x}{\Psi}}{\(i \hat{p}_x/\Hbar\)}
-
\epsilon x 
\mathLabelBox
[ labelstyle={below of=m\themathLableNode, below of=m\themathLableNode} ]
{\PD{y}{\Psi}}{\(i \hat{p}_y/\Hbar\)}.
\end{dmath}
...
\paragraph{Rotationally invariant \( \hat{H} \).}
