...
E
= 
\inv{\psi_1(r)} \lr{ \inv{2m} \Bp_1^2 \psi_1(r_1) } 
- 
2 e^2
\inv{4 \pi \epsilon_0 } \inv{r_1} 
+
\inv{\psi_2(r)} \lr{ \inv{2m} \Bp_2^2 \psi_2(r_2) } 
- 
2 e^2
...
This is \( E_{\textrm{He}} = 8 E_\txtH\), a value of about \( -109 eV \).  The computations above can be found in heliumAtomGroundStateNoInteraction.nb, a printout of which is attached.
...
%
To normalize the wavefunction, we need a six-fold integral over both the spatial domains:
...
With the electron-electron interaction added in, the total energy for the Helium ground state is
...
%This portion of this problem is also worked in heliumAtomGroundStateWithInteraction.nb, attached.
}
