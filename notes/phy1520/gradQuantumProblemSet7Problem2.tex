...
This is \( E_{\textrm{He}} = 8 E_\txtH\), a value of \( 110 eV \) not \( E_{\textrm{He}} = 4 E_\txtH\) as expected.  

FIXME: This probably indicates that the ground state wavefunction for the no electron-electron interaction Helium Hamiltonian is not of the form that was guessed.  Without the interaction term, the equations should be separable.  Do that and see if that gives this \( 4 \times \) result directly.
...
\begin{dmath}\label{eqn:gradQuantumProblemSet7Problem2:n}
E_{\textrm{He}}
= 
- \lr{\frac{27}{16}}^2 \frac{e^2}{a_0} \approx -2.848 \frac{e^2}{a_0}.
\end{dmath}

In \citep{desai2009quantum} the measured value is stated as \( -2.90 \ifrac{e^2}{a_0} \).  Table 1 of \citep{aznabayev2015energy}, which lists high precision calculations of all the energy levels, has \( -2.903724 \ifrac{e^2}{a_0} \) for the 1s energy level.
