...
This is \( E_{\textrm{He}} = 8 E_\txtH\), a value of \( 110 eV \) not \( E_{\textrm{He}} = 4 E_\txtH\) as expected.  FIXME: This probably indicates that the ground state wavefunction for the no electron-electron interaction Helium Hamiltonian is not of the form that was guessed.
...
-\frac{4 m e^4}{\Hbar^2 \pi^2 \epsilon_0^2}.
 %= - \frac{4 e^2}{ a_0 \pi^2 \epsilon_0^2}.
}
%\end{dmath}
