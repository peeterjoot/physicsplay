...
%%= \lr{ \hat{\BL}^2 - \hatL_z^2 } -i \lr{ i \Hbar \hatL_z }
...
%%=
%%\expectation{ \hat{\BL}^2 - \hatL_z^2 + \Hbar \hatL_z }.
%%\end{dmath}
%%
%%Similarly
...
The convention is to write \( m \) for the \( \hatL_z \) eigenvalue (the magnetic quantum number), and \( j \), the azimthual quantum number, to describe the \( j(j+1) \) eigenvalue of the \( \hat{\BL}^2 \) operator. 
