...
\begin{dmath}\label{eqn:bernoulliAndEulerMacLarenSummation:20}
B_m(z) = \sum_{k = 0}^m \binom{m}{k} B_k z^{m - k}
\end{dmath}
\begin{dmath}\label{eqn:bernoulliAndEulerMacLarenSummation:60}
...
\begin{dmath}\label{eqn:bernoulliAndEulerMacLarenSummation:80}
0
...
\begin{dmath}\label{eqn:bernoulliAndEulerMacLarenSummation:100}
0
...
\begin{dmath}\label{eqn:bernoulliAndEulerMacLarenSummation:200}
B_m'(z)
=
...
\begin{dmath}\label{eqn:bernoulliAndEulerMacLarenSummation:160a}
B_1(z + 1) - B_1(z)
=
\sum_{k = 0}^1
\binom{1}{k} B_k
...
\begin{dmath}\label{eqn:bernoulliAndEulerMacLarenSummation:160}
B_3(z + 1) - B_3(z)
=
\sum_{k = 0}^3
\binom{3}{k} B_k
...
\begin{dmath}\label{eqn:bernoulliAndEulerMacLarenSummation:180}
B_m(z + 1) - B_m(z)
=
\sum_{k = 0}^{m - 1}
\binom{m}{k} B_k
...
\begin{dmath}\label{eqn:bernoulliAndEulerMacLarenSummation:260}
B_m(1)
...
\begin{dmath}\label{eqn:bernoulliAndEulerMacLarenSummation:240b}
...
\begin{dmath}\label{eqn:bernoulliAndEulerMacLarenSummation:360}
\int_0^n B_m(z) dz
=
\int_0^1 B_m(z) dz
+
...
\begin{dmath}\label{eqn:bernoulliAndEulerMacLarenSummation:440}
\int_k^{k+1} f(x) dx
=
...
\begin{dmath}\label{eqn:bernoulliAndEulerMacLarenSummation:460}
\int_0^{n} f(x) dx
= \sum_{k = 0}^{n-1}
\int_k^{k+1} f(x) dx
=
...
\begin{dmath}\label{eqn:bernoulliAndEulerMacLarenSummation:480}
\sum_{k = 0}^{n} f(k)
=
\int_0^{n} f(x) dx
+
...
\begin{dmath}\label{eqn:bernoulliAndEulerMacLarenSummation:500}
\int_0^{n} f'(x) P_1(x) dx
=
\sum_{k = 0}^{n-1}
\int_k^{k+1} f'(x) P_1(x) dx
