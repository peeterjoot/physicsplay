...
\frac{\sigma_{\mathrm{E}}}{E} \propto \frac{T \sqrt{\CV}}{E} \kB^2
\end{equation}
...
where we've used $S = \kB \ln \Omega$ to express the number of states where the energy matches the average energy $\Omega = \sum \delta_{E, \bar{E}}$.
...
=
\sum_m e^{\inv{\kB} S(E - \mathcal{E}_m)}
\approx
\sum_m 
e^{\inv{\kB} S(E)}
e^{-\beta \mathcal{E}_m}
