...
Obtain the \indexAndText{density of states} $N(\epsilon)$ in one and two dimensions for a particle with an energy-momentum relation
...
\imageFigure{figures/basicStatMechProblemSet7Problem1Fig1}{Density integrals for 1D, 2D and 3D cases}{fig:basicStatMechProblemSet7Problem1:basicStatMechProblemSet7Problem1Fig1}{0.3}
