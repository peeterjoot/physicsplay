...
\imageFigure{figures/lecture7OneDSHOInBoxFig1}{1D Quantum free particle in a box}{fig:lecture7OneDSHOInBox:lecture7OneDSHOInBoxFig1}{0.3}
...
\imageFigure{figures/lecture7ThreeDSHOInBoxNumStatesFig2}{Multiplicities for free quantum particle in a 3D box}{fig:lecture7ThreeDSHOInBoxNumStates:lecture7ThreeDSHOInBoxNumStatesFig2}{0.3}
...
\imageFigure{figures/lecture71DclassicalSHOphasespaceFig3}{1D classical SHO phase space}{fig:lecture71DclassicalSHOphasespace:lecture71DclassicalSHOphasespaceFig3}{0.3}
...
\imageFigure{figures/lecture71DquantumSHOStatesPerEnergyLevelFig4}{1D quantum SHO states per energy level}{fig:lecture71DquantumSHOStatesPerEnergyLevel:lecture71DquantumSHOStatesPerEnergyLevelFig4}{0.3}
...
With the state counting that we've done, we want to look at entropy \index{entropy}
...
For an ideal gas we found in \eqnref{eqn:basicStatMechLecture6:380}

\begin{equation}\label{eqn:basicStatMechLecture6:380b}
\Omega = \frac{V^N}{N!} \inv{h^{3N}} \frac{( 2 \pi m E)^{3 N/2 }}{E} \frac{1}{\Gamma( 3N/2 ) }
\end{equation}

Let's use the large $N$ approximation of this to justify why we are introducing an $N!$ dependence.
...
\imageFigure{figures/lecture7threeParticlesInABoxFig5}{Three particles in a box}{fig:lecture7threeParticlesInABox:lecture7threeParticlesInABoxFig5}{0.3}
...
\imageFigure{figures/lecture7gibbsVolumeDoublingFig6}{Gibbs volume doubling argument.  Two identical systems allowed to mix}{fig:lecture7gibbsVolumeDoubling:lecture7gibbsVolumeDoublingFig6}{0.3}
...
S_{\mathrm{total}} = S_1 + S_2 + \kB (2 N) \ln 2
= S_1 + S_2 + \kB \ln 2^{2 N}.
\end{equation}
