...
Back in my undergrad days, I rarely took notes, since most of what we covered was in the text books.  The only notes I'd taken from the course where we did some thermodynamics was half an $8\, 1/2 \times 11$ scrap paper with a simple Stirling like approximation for $\ln N!$ (sitting in my old text \citep{kittel1980thermal}).  Here it is
...
Merging \ref{eqn:stirlingLike:60} and \ref{eqn:stirlingLike:80} into two differentials, and integrating we have
...
\begin{equation}\label{eqn:stirlingLike:180}
\boxed{
...
\begin{dmath}\label{eqn:stirlingLike:200}
\boxed{
N! \approx N^N e^{-N}
}.
\end{dmath}

I think that our Professor's point at the time was that when we only care about the logarithm of $N!$ we can get away with \ref{eqn:stirlingLike:180}, and can avoid the complexity and care required to do a proper \underlineAndIndex{Stirling's approximation}.
