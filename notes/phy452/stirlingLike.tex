...
I think that our Professor's point at the time was that when we only care about the logarithm of $N!$ we can get away with \ref{eqn:stirlingLike:180}, and can avoid the complexity and care required to do a proper \underlineAndIndex{Stirling approximation}.
