...
\begin{equation}\label{eqn:pathriaHarmonicOscPertubation:240}
\myBoxed{
Z \approx
\frac{\pi}{\beta}
\sqrt{ \frac{2 m}{c} }
...
\begin{equation}\label{eqn:pathriaHarmonicOscPertubation:220}
\myBoxed{
\CV = 
\kB
+ \kB^2 T 
...
\begin{equation}\label{eqn:pathriaHarmonicOscPertubation:280}
\myBoxed{
