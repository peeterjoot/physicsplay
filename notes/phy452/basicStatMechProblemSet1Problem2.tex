...
This is $1/2$ times \ref{eqn:basicStatMechProblemSet1Problem1:180} (also in the class notes).  I'd have expected an exact match, but it appears this Central limit theorem derived result has the correct unit normalization and the class result derived above is not normalized.
}
