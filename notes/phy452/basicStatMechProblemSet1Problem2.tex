...
\begin{equation}\label{eqn:basicStatMechProblemSet1Problem2:240}
\boxed{
...
Observe that both this and \ref{eqn:basicStatMechProblemSet1Problem1:180} do not integrate to unity, but to $2$.  This is expected given the parity of the discrete random variable $X$.  That integral really only approximates the sum over either all odd or even integer values, depending on whether $N$ itself is odd or even.
