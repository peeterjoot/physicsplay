...
In \citep{pathriastatistical} I saw the Euler-summation \index{Euler-MacLauren summation} formula casually used in a few places, allowing an approximation of a sum with derivatives at the origin.  This rather powerful relationship was used in passing, and seemed like it was worth some exploration.
