...
\imageFigure{figures/lecture20Fig1}{Chemical potential in Bose condensation region}{fig:lecture20:lecture20Fig1}{0.3}
...
\imageFigure{figures/lecture20Fig2x}{Density variation with temperature for Bosons}{fig:lecture20:lecture20Fig2}{0.3}
...
\imageFigure{figures/lecture20Fig3}{Temperature vs pressure demarcation by $T_{\mathrm{BEC}}$ curve}{fig:lecture20:lecture20Fig3}{0.3}
...
\imageFigure{figures/lecture20Fig4}{Specific heat for Bosons, Fermions, and classical ideal gases}{fig:lecture20:lecture20Fig4}{0.3}
...
}{Photon density of states \eqnref{eqn:relativisiticDensityOfStates:380}}
...
%\imageFigure{figures/lecture20Fig5}{CAPTION}{fig:lecture20:lecture20Fig5}{0.3}

\paragraph{Phonons and other systems}

There is a very similar phenomena in matter.  We can discuss lattice vibrations in a solid.  These are called phonon modes, and will have the same distribution function where the only difference is that the speed of light is replaced by the speed of the sound wave in the solid.  Once we understand the photon system, we are able to look at other Bose distributions such as these phonon systems.  We'll touch on this very briefly next time.
