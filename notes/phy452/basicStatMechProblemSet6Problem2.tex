...
\begin{equation}\label{eqn:basicStatMechProblemSet6Problem2:100}
\myBoxed{
f_\nu^\pm(z) =
z
\mp
...
or
\begin{equation}\label{eqn:basicStatMechProblemSet6Problem2:460}
\myBoxed{
f_\nu^+(e^y) \approx
\frac{y^\nu}{\Gamma(\nu + 1)}
\lr{
...
\begin{equation}\label{eqn:basicStatMechProblemSet6Problem2:520}
\myBoxed{
f_\nu^+(e^y) \approx
\frac{y^\nu}{\Gamma(\nu + 1)}
\lr{
...
\begin{equation}\label{eqn:basicStatMechProblemSet6Problem2:740}
\myBoxed{
f_\nu^-( e^{-\alpha} )
\approx
\frac{ \Gamma(1 - \nu)}{ \alpha^{1 - \nu} }.
