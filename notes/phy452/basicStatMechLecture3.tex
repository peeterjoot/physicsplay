...
\imageFigure{figures/basicStatMechLecture3Fig1}{One dimensional random walk}{fig:basicStatMechLecture3:basicStatMechLecture3Fig1}{0.1}
...
\imageFigure{figures/basicStatMechLecture3Fig2}{Two dimensional random walk}{fig:basicStatMechLecture3:basicStatMechLecture3Fig2}{0.3}
...
%\imageFigure{figures/basicStatMechLecture3Fig3}{A couple Gaussians}{fig:basicStatMechLecture3:basicStatMechLecture3Fig3}{0.3}

\imageFigure{figures/basicStatMechLecture3Fig3a}{Spatial and temporal evolution}{fig:basicStatMechLecture3:basicStatMechLecture3Fig3a}{0.2}
...
\inv{2}
\left(
\mathcal{P}(x, t - \delta t) + 
\cancel{\PD{x}{\mathcal{P}}(x, t - \delta t) \delta x}
+
\inv{2} \PDSq{x}{\mathcal{P}}(x, t - \delta t) (\delta x)^2
\right)
+
\inv{2}
\left(
...
\mathcal{P}(x, t - \delta t) 
+
\inv{2} \PDSq{x}{\mathcal{P}}(x, t) (\delta x)^2
\end{equation}

\begin{dmath}\label{eqn:basicStatMechLecture3:140}
\delta t \PD{t}{\mathcal{P}}(x, t) \approx 
\inv{2} \PDSq{x}{\mathcal{P}}(x, t) (\delta x)^2
\end{dmath}
...
}{$\equiv D$, the diffusion constant}
...
This is expressed as a continuity equation and illustrated in \cref{fig:basicStatMechLecture3:basicStatMechLecture3Fig4}.

\begin{equation}\label{eqn:basicStatMechLecture3:200}
\PD{t}{\mathcal{P}} + \PD{x}{J} = 0.
\end{equation}

\imageFigure{figures/basicStatMechLecture3Fig4}{probability changes by flows through the boundary}{fig:basicStatMechLecture3:basicStatMechLecture3Fig4}{0.3}

Here $J$ is the probability current density, and $\mathcal{P}$ is the probability density.

\item \underline{Phenomenological law}, or \underline{Fick's law}.
...
\imageFigure{figures/basicStatMechLecture3Fig5}{Probability current proportional to gradient}{fig:basicStatMechLecture3:basicStatMechLecture3Fig5}{0.3}
...
\begin{equation}\label{eqn:basicStatMechLecture3:260}
\boxed{
\PD{t}{\mathcal{P}} = D \PDSq{x}{\mathcal{P}} .
}
\end{equation}
...
\imageFigure{figures/basicStatMechLecture3Fig6}{Single atom velocity view}{fig:basicStatMechLecture3:basicStatMechLecture3Fig6}{0.2}
...
\Bv_i(N_{\mathrm{c}}) = \Bv_i(0) 
+ \Delta \Bv_i(1) 
+ \Delta \Bv_i(2) 
+ \cdots
+ \Delta \Bv_i(N_{\mathrm{c}}) 
\end{equation}
...
\expectation{\Bv_i^2} \propto N_{\mathrm{c}}
\end{equation}
...
\begin{equation}\label{eqn:basicStatMechLecture3:n}
\text{KE}_i = \inv{2} m \Bv_i^2
\end{equation}

and the sum of this is fixed for the complete system.

However, if we sum the kinetic energy squares above \ref{eqn:basicStatMechLecture3:360} shows that it is growing with the number of collisions.  Fixing this we will arrive at the Maxwell Boltzmann distribution.
