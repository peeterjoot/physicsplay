...
So for positive values of $b$, integer or otherwise, and negative non-integer values, we see that is then very reasonable to define the binomial coefficient \index{binomial coefficient} explicitly in terms of the gamma function
