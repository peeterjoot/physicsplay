...
\begin{equation}\label{eqn:fermiFunctionExpansionsForNandP:80}
\myBoxed{
\mathcal{D}(\epsilon)
=
\frac{V}{(2 \pi)^2 }
...
\begin{equation}\label{eqn:fermiFunctionExpansionsForNandP:260}
\myBoxed{
U
= \frac{3}{2} N \kB T 
\frac{f_{5/2}(z)}{
...
\begin{equation}\label{eqn:fermiFunctionExpansionsForNandP:320}
\myBoxed{
P V = \frac{2}{3} U.
}
\end{equation}
