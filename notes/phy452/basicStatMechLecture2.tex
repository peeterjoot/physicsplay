...
With a substitution $x = (y - \alpha)/\sqrt{2 \alpha}$ terms of the error function, this integral can be split into a constant term and an error function component, where the error function is

\begin{equation}\label{eqn:basicStatMechLecture2:820b}
\erf(z) = \frac{2}{\sqrt{\pi}} \int_0^\infty e^{-t^2} dt.
\end{equation}
