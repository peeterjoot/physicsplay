...
%\fxusetheme{color}
%
%%\fxwarning{review lecture 2}{work through this lecture in detail.}
%\beginArtNoToc
...
\imageFigure{figures/basicStatMechLecture2Fig1}{Discrete probability distribution}{fig:basicStatMechLecture2:basicStatMechLecture2Fig1}{0.3}
...
\imageFigure{figures/basicStatMechLecture2Fig2}{Continuous probability distribution}{fig:basicStatMechLecture2:basicStatMechLecture2Fig2}{0.3}
...
\begin{subequations}
\begin{equation}\label{eqn:basicStatMechLecture2:220}
\boxed{
...
\imageFigure{figures/basicStatMechLecture2Fig3}{Discrete probability distribution for Heads and Tails coin tosses}{fig:basicStatMechLecture2:basicStatMechLecture2Fig3}{0.3}
...
X \rightarrow 2, 0, 0, 2
\end{equation}

%\cref{fig:basicStatMechLecture2:basicStatMechLecture2Fig4}.
\imageFigure{figures/basicStatMechLecture2Fig4}{2 tosses distribution}{fig:basicStatMechLecture2:basicStatMechLecture2Fig4}{0.3}
...
\imageFigure{figures/basicStatMechLecture2Fig5}{3 tosses}{fig:basicStatMechLecture2:basicStatMechLecture2Fig5}{0.3}
...
\text{Tails} - \text{Heads} = X 
\end{equation}
\begin{equation}\label{eqn:basicStatMechLecture2:420}
\text{Total tosses} = \text{Tails} + \text{Heads} = N 
\end{equation}

So that
\begin{itemize}
\item Heads: $\frac{N - X}{2}$
\item Tails: $\frac{N + X}{2}$
\end{itemize}
...
Demonstrating this limit is left to the problems \ref{basicStatMech:problemSet1:1}.
} % makeexample
...
I(\alpha) = \int_0^\infty dy e^{-y} y^\alpha
\end{equation}
...
\imageFigure{figures/basicStatMechLecture2Fig7}{Some values of $f(y, \alpha)$}{fig:basicStatMechLecture2:basicStatMechLecture2Fig7}{0.3}
...
at $y = y^\conj = \alpha$ we have $f''(y^\conj) = -\inv{\alpha}$ and
...
%{
\alpha
%}{Question: Was this factor on the board.  I didn't have it in my notes?}
}
}
%\approx
%e^{f(\alpha)}
%\int_0^\infty dy e^{-(y - \alpha)^2/2}
\end{dmath}

For the integral Mathematica \nbref{lecture2Figures.nb} gives
%\begin{dmath}\label{eqn:basicStatMechLecture2:800}
%\int_0^\infty dy 
%e^{
...
%%{
%u
%%}{$u= (y-\alpha)/\sqrt{2 \alpha}$}
%e^{
%-u^2
%}
%=
%\frac{\sqrt{2 \pi \alpha}}{2} 
%\end{dmath}
...
From \cref{fig:basicStatMechLecture2:basicStatMechLecture2Fig8} observe that $\erf(x) \rightarrow 1$ in the limit

\imageFigure{figures/basicStatMechLecture2Fig8}{Error function}{fig:basicStatMechLecture2:basicStatMechLecture2Fig8}{0.3}
