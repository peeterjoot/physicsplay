...
\begin{itemize}
\item Fermion \index{Fermion}.  Antisymmetric under exchange.  $n_k = 0, 1$.  Paramekanti: ``Fermions: basically they hate each other''.
\item Boson \index{Boson}.  Symmetric under exchange.  $n_k = 0, 1, 2, \cdots$.  Unlike Fermions, Bosons love each other.  You can pack as many Bosons as you want into a space.  This allows Bosons to all collectively collapse into the ground state (Bose-Einstein condensation).
\end{itemize}
...
\imageFigure{figures/lecture15Fig1a}{Fermionic energy level filling for free particle in a box}{fig:lecture15:lecture15Fig1a}{0.3}
\imageFigure{figures/lecture15Fig1b}{Bosonic free particle in a box energy level filling}{fig:lecture15:lecture15Fig1b}{0.3}
...
FIXME: Something with the index fudging above doesn't seem right to me.
...
\begin{dmath}\label{eqn:basicStatMechLecture15:220b}
\myBoxed{
\expectation{n_k^f}
=
\inv
...
or
\begin{dmath}\label{eqn:basicStatMechLecture15:340a}
\myBoxed{
\expectation{n_k^b}
=
\inv{ e^{\beta(\epsilon_k - \mu)} - 1}.
...
This is illustrated in \cref{fig:lecture15:lecture15Fig2}, where the smearing that occurs with increasing temperature is also indicated.  \citep{kittel1980thermal} \S 7 calls $E_F$ as defined above the \underlineAndIndex{Fermi energy}, the energy at which all the lowest order orbitals are exactly filled.  Without any limiting assumption, a discussion of why this energy is being equated with the $T = 0$ chemical potential energy can be found in \citep{pathriastatistical} \S 8.1 (where the exact integral is evaluated, or at least expressed).  When that integral approximation of the sum is performed exactly, we see that at $T = 0$, the illustrated cutoff occurs at this $E_F = \mu(0)$ point.

\imageFigure{figures/lecture15Fig2}{Occupation numbers for different energies}{fig:lecture15:lecture15Fig2}{0.3}
...
\imageFigure{figures/lecture15Fig3}{Large negative chemical potential at high temperatures}{fig:lecture15:lecture15Fig3}{0.3}
