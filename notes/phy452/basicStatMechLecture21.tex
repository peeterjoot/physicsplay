...
\imageFigure{figures/lecture21Fig1}{Solid oscillator model}{fig:lecture21:lecture21Fig1}{0.15}
...
\imageFigure{figures/lecture21Fig2}{Angular frequency of solid oscillator model.}{fig:lecture21:lecture21Fig2}{0.3}
...
{B T^3}{Contribution due to phonon like modes where there are linear energy momentum relations.}.
\end{equation}
