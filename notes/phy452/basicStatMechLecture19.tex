...
The physics of Fermi gases has an extremely wide range of applicability.  Illustrating some of this range, here are some examples of Fermi temperatures (from $E_{\mathrm{F}} = \kB T_{\mathrm{F}}$)

\begin{itemize}
\item Electrons in copper: $T_{\mathrm{F}} \sim 10^4 \mbox{K}$
\item Neutrons in neutron star: $T_{\mathrm{F}} \sim 10^7 - 10^8 \mbox{K}$
...
n_{\mathrm{B}}(\Bk) = \inv{ e^{\beta(\epsilon_\Bk - \mu)} - 1 }
\end{dmath}
...
n_{\mathrm{B}}(\Bk \rightarrow 0) \sim \inv{z^{-1} - 1} = \frac{z}{1 - z}
\end{dmath}
...
\begin{equation}\label{eqn:basicStatMechLecture19:380}
\myBoxed{
\kB T_{\mathrm{c}} = 
