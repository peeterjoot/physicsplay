...
{
   \int_{\epsilon_0}^\infty \inv{ z^{-1} e^{\beta \epsilon} + 1 }
   \epsilon \sqrt{ \epsilon^2 - \epsilon_0^2} d \epsilon
}
= \frac{n \epsilon_0}{3}
\frac{
...
{
   \int_{1}^\infty \inv{ z^{-1} e^{\beta \epsilon_0 x} + 1 }
   x \sqrt{ x^2 - 1} dx
}.
\end{dmath}
...
Switching to a dimensionless variable $y = \epsilon/\epsilon_0 - 1$, this is

\begin{dmath}\label{eqn:huang93:580}
\myBoxed{
n 
= 
\frac{4 \pi \epsilon_0}{(c h)^3} 
\int_{0}^\infty dy
\frac{
(y + 1)\sqrt{(y + 1)^2 - 1} 
}
...
% x = \epsilon - \epsilon_0
% \epsilon = x + \epsilon_0
\begin{dmath}\label{eqn:huang93:540}
\myBoxed{
\expectation{\epsilon - \epsilon_0}
=
\epsilon_0
