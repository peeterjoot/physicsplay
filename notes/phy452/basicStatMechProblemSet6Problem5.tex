...
\imageFigure{huang93Fig2s}{Modified Bessel function of the second kind}{fig:huang93:huang93Fig2}{0.3}
...
%\imageFigure{huang93Fig3}{Pressure summands $(-1)^s \frac{\theta}{s + 1} e^{ (s + 1)/\theta} K_1\left((s+1)/\theta\right)$ for $\barz = 1$}{fig:huang93:huang93Fig3}{0.3}

Further plotting the sum numerically, we end up with something that looks fairly exponential.
