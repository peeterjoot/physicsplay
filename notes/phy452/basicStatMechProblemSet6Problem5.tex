...
Plotting this sum in \cref{fig:huang93:huang93Fig5sv} numerically to 10 terms, shows that we have a function that appears roughly bi-exponential in $\barz$ and $\theta$.
