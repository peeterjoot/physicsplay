...
\imageFigure{figures/lecture11Fig1}{Partitioning out a subset of a larger system}{fig:lecture11:lecture11Fig1}{0.3}
...
\imageFigure{figures/lecture11Fig2}{Larger system partitioned into many small subsystems}{fig:lecture11:lecture11Fig2}{0.3}
...
\begin{equation}\label{eqn:basicStatMechLecture11:481}
\myBoxed{
\sigma_{\mathrm{E}}^2
...
C_{\mathrm{V}} = \PD{T}{\expectation{E}},
\end{equation}

we have
\begin{equation}\label{eqn:basicStatMechLecture11:500}
\sigma_{\mathrm{E}}^2 = k_{\mathrm{B}} T^2 C_{\mathrm{V}} \propto N
\end{equation}
