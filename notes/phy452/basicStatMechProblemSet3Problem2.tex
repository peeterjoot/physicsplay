...
\imageFigure{figures/problemSet3problem2touchingCirclesFig3}{Touching ``spheres''}{fig:problemSet3problem2touchingCircles:problemSet3problem2touchingCirclesFig3}{0.3}
...
%\imageFigure{figures/problemSet2Problem2faceCenteredCubicFig4}{Element of a face centered cubic}{fig:problemSet2Problem2faceCenteredCubic:problemSet2Problem2faceCenteredCubicFig4}{0.3}
% This one from mathematica curtosy of Jens 
% http://mathematica.stackexchange.com/questions/18789/can-a-latticedata-image-be-displayed-in-a-space-filled-fashion
\imageFigure{figures/problemSet2Problem2faceCenteredCubicFig4b}{Element of a face centered cubic}{fig:problemSet2Problem2faceCenteredCubic:problemSet2Problem2faceCenteredCubicFig4}{0.3}
