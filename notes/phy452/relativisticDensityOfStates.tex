...
For photons and high velocity particles our non-relativistic \indexAndText{density of states} is insufficient.  Let's redo these calculations for particles for which the energy is given by
...
\begin{dmath}\label{eqn:relativisticDensityOfStates:360}
\myBoxed{
\mathcal{D}_3(\epsilon)
=
\frac{4 \pi V}{ (c h)^3 } 
...
\begin{dmath}\label{eqn:relativisticDensityOfStates:380}
\myBoxed{
\mathcal{D}_3(\epsilon)
\approx
...
\begin{dmath}\label{eqn:relativisticDensityOfStates:240}
\myBoxed{
\mathcal{D}_2(\epsilon)
=
\frac{2 \pi A}{ (c h)^2 } 
...
\begin{dmath}\label{eqn:relativisticDensityOfStates:260}
\myBoxed{
\mathcal{D}_2(\epsilon)
\approx
...
\begin{dmath}\label{eqn:relativisticDensityOfStates:300}
\myBoxed{
\mathcal{D}_1(\epsilon)
=
\frac{2 L}{ c h } 
...
\begin{dmath}\label{eqn:relativisticDensityOfStates:320}
\myBoxed{
\mathcal{D}_1(\epsilon)
=
\frac{2 L}{ c h }.
