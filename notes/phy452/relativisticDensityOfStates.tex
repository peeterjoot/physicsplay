...
\begin{equation}\label{eqn:relativisticDensityOfStates:360}
\myBoxed{
\mathcal{D}_3(\epsilon)
=
\frac{4 \pi V}{ (c h)^3 } 
...
\begin{equation}\label{eqn:relativisticDensityOfStates:380}
\myBoxed{
\mathcal{D}_3(\epsilon)
\approx
...
\begin{equation}\label{eqn:relativisticDensityOfStates:240}
\myBoxed{
\mathcal{D}_2(\epsilon)
=
\frac{2 \pi A}{ (c h)^2 } 
...
\begin{equation}\label{eqn:relativisticDensityOfStates:260}
\myBoxed{
\mathcal{D}_2(\epsilon)
\approx
...
\begin{equation}\label{eqn:relativisticDensityOfStates:300}
\myBoxed{
\mathcal{D}_1(\epsilon)
=
\frac{2 L}{ c h } 
...
\begin{equation}\label{eqn:relativisticDensityOfStates:320}
\myBoxed{
\mathcal{D}_1(\epsilon)
=
\frac{2 L}{ c h }.
