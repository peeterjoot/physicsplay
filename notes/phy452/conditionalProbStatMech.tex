...
\imageFigure{figures/conditionalProbStatMechFig1}{Sample space for a die}{fig:conditionalProbStatMechalProbStatMechFig1}{0.2}

The points 1,2,3,4 represent the $i \le 4$ subspace, as in figure (\ref{fig:conditionalProbStatMechalProbStatMechFig2})
\imageFigure{figures/conditionalProbStatMechFig2}{$i \le 4$ compound event}{fig:conditionalProbStatMechalProbStatMechFig2}{0.2}
...
\imageFigure{figures/conditionalProbStatMechFig3}{Incorrect depiction of $i \cap (i \le 4)$ compound event}{fig:conditionalProbStatMech:conditionalProbStatMechFig3}{0.2}
...
\imageFigure{figures/conditionalProbStatMechFig4}{Intersection of the \texorpdfstring{$i = 2$}{i equal 2} and \texorpdfstring{$i \le 4$}{i less than 4} events}{fig:conditionalProbStatMech:conditionalProbStatMechFig4}{0.2}
