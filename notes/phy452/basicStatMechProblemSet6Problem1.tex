...
\begin{equation}\label{eqn:basicStatMechProblemSet6Problem1:360}
\myBoxed{
S = \kB \ln \Omega.
}
\end{equation}
...
\begin{equation}\label{eqn:basicStatMechProblemSet6Problem1:520}
\myBoxed{
p_i = 
\frac{
   \exp\lr{
...
or
\begin{equation}\label{eqn:basicStatMechProblemSet6Problem1:560}
\myBoxed{
\expectation{E} = 
\frac{
...
\begin{equation}\label{eqn:basicStatMechProblemSet6Problem1:680}
\myBoxed{
p_i = 
\frac{
\exp\lr{ -(\beta E_i + \gamma N_i)/\kB }
