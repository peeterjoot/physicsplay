...
so that with Heavyside theta \index{Heavyside theta} as in \cref{fig:basicStatMechLecture6:basicStatMechLecture6Fig2}.
...
\section{To come: entropy}

We'll look at entropy \index{entropy}
