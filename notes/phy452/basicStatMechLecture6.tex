...
We define \underline{Ergodic}, meaning that with time, as you wait for $t \rightarrow \infty$, all \underline{available} phase space will be covered.  Not all systems are necessarily ergodic, but the hope is that all sufficiently complicated systems will be so.
...
\imageFigure{figures/basicStatMechLecture6Fig1}{Phase space volume trajectory}{fig:basicStatMechLecture6:basicStatMechLecture6Fig1}{0.3}
...
\imageFigure{figures/basicStatMechLecture6Fig2}{Heavyside theta, $\Theta(x)$}{fig:basicStatMechLecture6:basicStatMechLecture6Fig2}{0.3}
...
\imageFigure{figures/basicStatMechLecture6Fig3}{Phase space volume adjustment for the uncertainty principle}{fig:basicStatMechLecture6:basicStatMechLecture6Fig3}{0.3}
