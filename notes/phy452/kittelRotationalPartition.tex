...
\imageFigure{figures/kittelCh3Pr6Fig1}{Summation over $m$}{fig:kittelCh3Pr6:kittelCh3Pr6Fig1}{0.3}
...
\imageFigure{figures/kittelRotationalPartitionFig4}{Plotting the partition function summand}{fig:kittelRotationalPartition:kittelRotationalPartitionFig4}{0.3}

\imageFigure{figures/kittelRotationalPartitionFig2}{$Z_R(\tau)$ truncated after 30 terms in log plot}{fig:kittelRotationalPartition:kittelRotationalPartitionFig2}{0.3}
...
The specific heat 
\footnote{ This is a dimensionless specific heat, whereas in traditional units $C_{\mathrm{V}} = \PDi{T}{U}$}
in this domain is
...
\imageFigure{figures/kittelRotationalPartitionFig3}{Energy and heat capacity}{fig:kittelRotationalPartition:kittelRotationalPartitionFig3}{0.3}
...
\imageFigure{figures/kittelRotationalPartitionFig5}{Exact plot of the energy for a range of temperatures (30 terms of the sums retained)}{fig:kittelRotationalPartition:kittelRotationalPartitionFig5}{0.3}
...
\imageFigure{figures/kittelRotationalPartitionFig6}{Low temperature approximation of the energy}{fig:kittelRotationalPartition:kittelRotationalPartitionFig6}{0.3}
...
\imageFigure{figures/kittelRotationalPartitionFig7}{Specific heat to 30 terms}{fig:kittelRotationalPartition:kittelRotationalPartitionFig7}{0.3}
} % makeanswer
