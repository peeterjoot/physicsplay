...
%
%  We also note that $k_1$ and $k_2$ are the same in both equations, where we are solving for a coupled state between the two equations \ref{eqn:continuumL22:310}, \ref{eqn:continuumL22:350}.
%
