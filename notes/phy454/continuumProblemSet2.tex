...
\includemedia[
  ...
  addresource=./animatedTwoLayerFlowMu1GreaterThanMu2Try2.mp4,
  flashvars={%
     source=./animatedTwoLayerFlowMu1GreaterThanMu2Try2.mp4% same path as in addresource!
%   &autoPlay=true%   % optional configuration
%   &loop=true%       % variables
  }  
]{}{VPlayer.swf}
   \caption{Fluids with densities of mercury and water in the lower (1) and upper (2) layers respectively.  (CLICK TO ANIMATE).}
...
\includemedia[
  activate=pageopen,
  width=200pt,height=150pt,
  addresource=./animatedTwoLayerFlowMu2GreaterThanMu1Try2.mp4,
  flashvars={%
     source=./animatedTwoLayerFlowMu2GreaterThanMu1Try2.mp4% same path as in addresource!
%   &autoPlay=true%   % optional configuration
%   &loop=true%       % variables
  }  
]{}{VPlayer.swf}
   \caption{Fluids with densities of water and mercury in the lower (1) and upper (2) layers respectively.  (CLICK TO ANIMATE).}
