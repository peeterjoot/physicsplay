...
\begin{itemize}
\item With $\mu^{(1)} > \mu^{(2)}$.  See figure \ref{fig:continuumProblemSet2:continuumProblemSet2Animation1} (or \youtubehref{2xVoFAL9XGA})

\item With $\mu^{(2)} > \mu^{(1)}$.  See figure \ref{fig:continuumProblemSet2:continuumProblemSet2Animation2} (or \youtubehref{FJekyGf6XJw})
\end{itemize}
