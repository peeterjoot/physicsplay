...
%\usepackage{media9}
\chapter{Steady state velocity profile of stirred cup of non-bottomless coffee (continued).}
...
\frac{Z''}{Z} = \frac{\lambda_i^2}{R^2} - \alpha^2
\end{equation}
\end{subequations}
...
u(r, z, t)
&=
s \Omega \sum_{\alpha^2 \lambda_i^2 > R^2} c_{i \alpha} J_1(\lambda_i r/R) \sinh\left( \sqrt{\frac{\lambda_i^2}{R^2} - \alpha^2} z \right) e^{-\alpha^2 \nu t} \\
&+s \Omega \sum_{\alpha^2 \lambda_i^2 < R^2} d_{i \alpha} J_1(\lambda_i r/R) \sin\left( \sqrt{-\frac{\lambda_i^2}{R^2} + \alpha^2} z \right) e^{-\alpha^2 \nu t}
\end{aligned}
\end{equation}
...
J_1(\lambda_i r/R) \frac{\sinh(\lambda_i z/R)}{\sinh(\lambda_i d/R) } 
&=
\sum_{\alpha^2 \lambda_j^2 > R^2} c_{i \alpha} J_1(\lambda_j r/R) \sinh\left( \sqrt{\frac{\lambda_j^2}{R^2} - \alpha^2} z \right) \\
&+\sum_{\alpha^2 \lambda_j^2 < R^2} d_{i \alpha} J_1(\lambda_j r/R) \sin\left( \sqrt{-\frac{\lambda_j^2}{R^2} + \alpha^2} z \right) 
\end{aligned}
\end{equation}
