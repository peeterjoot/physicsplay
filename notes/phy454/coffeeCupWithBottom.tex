...
It's not clear to me how to compute the velocity profile above the point of lowest stir depth.  However, the next step of interest is to try to compute the time evolution of this flow if we should stop the stirring at $t = 0$.
