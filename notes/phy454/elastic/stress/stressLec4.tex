...
We have illustrated the stress tensor in a couple of 2D examples.  The first we call uniaxial stress \index{uniaxial stress}, having just the $1,1$ element of the matrix as illustrated in figure (\ref{fig:continuumL3:continuumL3fig4}).
...
We will look at the two dimensional case in some detail, as in figure (\ref{fig:continuumL4:continuumL4fig6})
