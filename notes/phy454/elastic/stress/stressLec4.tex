...
\imageFigure{figures/lec3_2D_stress_tensorFig3}{2D stress tensor}{fig:continuumL3:continuumL3fig3}{0.2}
...
We've illustrated the stress tensor in a couple of 2D examples.  The first we call uniaxial stress \index{uniaxial stress}, having just the $1,1$ element of the matrix as illustrated in figure (\ref{fig:continuumL3:continuumL3fig4}).
%figure (\ref{fig:continuumL4:continuumL4fig1})
%\imageFigure{figures/lec4_Uniaxial_stressFig1}{Uniaxial stress}{fig:continuumL4:continuumL4fig1}{0.3}
...
A biaxial stress \index{biaxial stress} is illustrated in figure (\ref{fig:continuumL3:continuumL3fig5}).
%(\ref{fig:continuumL4:continuumL4fig2})
%\imageFigure{figures/lec4_Biaxial_stressFig2}{Biaxial stress}{fig:continuumL4:continuumL4fig2}{0.3}
...
\imageFigure{figures/lec4_General_stressFig3}{General stress}{fig:continuumL4:continuumL4fig3}{0.3}
...
\FIXME{perhaps there was a verbal argument in class here.  This isn't a sensible explanation of the symmetry requirement as is}

%\section{Diagonalization}
We'll look at the two dimensional case in some detail, as in figure (\ref{fig:continuumL4:continuumL4fig6})

\imageFigure{figures/lec4_Area_element_under_stress_with_and_without_rotationFig6}{Area element under stress with and without rotation}{fig:continuumL4:continuumL4fig6}{0.4}
