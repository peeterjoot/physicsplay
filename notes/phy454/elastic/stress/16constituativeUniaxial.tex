...
Referring to figure (\ref{fig:continuumL3:continuumL3fig4}) and expanding out \ref{eqn:continuumL5:110c} we have for the $1,1$ element of the strain tensor
%Again illustrated in the plane as in figure (\ref{fig:continuumL5:continuumL5fig2})
%\imageFigure{figures/lec5_Uniaxial_stressFig2}{Uniaxial stress}{fig:continuumL5:continuumL5fig2}{0.2}
...
\FIXME{random: there is no figure (\ref{fig:continuumL5:continuumL5fig3}) reference that I can find?

\imageFigure{figures/lec5_stress_associated_with_Youngs_modulusFig3}{stress associated with Young's modulus}{fig:continuumL5:continuumL5fig3}{0.2}
}
