\section{Summary}
\unnumberedSubsection{Stress tensor}
...
\unnumberedSubsection{Uniform hydrostatic compression}
...
\unnumberedSubsection{Uniaxial stress.  Young's modulus.  Poisson's ratio}
