...
%
Let's introduce a phasor representation (again following \S 22 of the text \citep{landau1960theory})
...
\item Love wave.  These aren't discussed in the text, but wikipedia \citep{wiki:lovewave} describes them as polarized shear waves (where the figure indicates that the shear displacements are perpendicular to the direction of propagation).
\end{itemize}
