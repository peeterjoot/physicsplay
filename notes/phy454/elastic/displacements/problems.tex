...
\begin{Exercise}[title={Equilibrium}, label={problem:elastic:displacements:exampractiseEquilibrium}]
...
\begin{Exercise}[title={Tsunami}, label={problem:elastic:displacements:exampractiseTsunami}]
