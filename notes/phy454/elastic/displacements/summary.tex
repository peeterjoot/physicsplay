...
\unnumberedSubsection{Elastic displacement equation}
...
\unnumberedSubsection{Equilibrium}
...
\unnumberedSubsection{Scalar and vector potential representation}
...
\unnumberedSubsection{Phasor description}
...
\unnumberedSubsection{Some wave types}
...
\FIXME{despite the fact that we didn't actually attempt to find or analyze any of these solutions}
...
\FIXME{For reasons that aren't clear both the midterm and last years final ask us to spew this sort of stuff (instead of actually trying to do something analytic associated with them).}
