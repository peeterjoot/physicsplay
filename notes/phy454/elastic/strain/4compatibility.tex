...
This relationship is called the \textit{compatibility condition}, and ensures that we do not have a disjoint deformation of the form in figure (\ref{fig:continuumL6:continuumL6fig1}).

\imageFigure{figures/lec6_disjoint_deformation_illustratedFig1}{disjoint deformation illustrated}{fig:continuumL6:continuumL6fig1}{0.3}
