...
\imageFigure{figures/strainFig1}{Deformation of a planar object}{fig:strain:strainFig1}{0.5}
...
\imageFigure{figures/strainFig2}{Transformation under deformation of an infinitesimal line element along a trajectory.}{fig:strain:strainFig2}{0.4}
...
%\imageFigure{figures/continuumL2fig4}{Differential change to the object.}{fig:continuumL2:continuumL2fig4}{0.3}
