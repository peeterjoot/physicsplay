...
\begin{aligned}
(d\Bl')^2 - d\Bx^2 &= \\
& 2 dr^2 \left(\PD{r}{u_r} + \inv{2} \PD{r}{u_r}^2\right) \\ 
&+ 2 r^2 d\phi^2 \left(\inv{r} u_\phi + \inv{2 r^2} u_\phi^2 + \inv{r} \PD{\phi}{u_\phi} + \inv{r^2} u_\phi \PD{\phi}{u_\phi} + \inv{2 r^2} \PD{\phi}{u_\phi}^2 \right) \\
&+2 dz^2 \left(\PD{z}{u_z}+ \inv{2} \PD{z}{u_z}^2\right) \\
&+2 dr r d\phi \left(- \inv{r} u_\phi \PD{r}{u_\phi} + \inv{r} \PD{\phi}{u_r} \PD{r}{u_\phi} \right)  \\
&+2 r d\phi dz \left( \inv{r} \PD{z}{u_\phi} \PD{\phi}{u_z} \right) \\
&+2 dz dr \left( \PD{z}{u_r} \PD{r}{u_z}\right)
\end{aligned}
\end{equation}
