...
% crappy figure.  doens't add much
%\imageFigure{figures/lec2_Physical_bodyFig1}{Physical body}{fig:continuumL2:continuumL2fig1}{0.2}
...
% crappy figure.  doens't add much
%\imageFigure{figures/lec2_Control_volume_elementsFig2}{Control volume elements}{fig:continuumL2:continuumL2fig2}{0.2}
...
\imageFigure{figures/lec2_Mass_and_volume_ratios_at_different_scalesFig3}{Mass and volume ratios at different scales}{fig:continuumL2:continuumL2fig3}{0.3}
