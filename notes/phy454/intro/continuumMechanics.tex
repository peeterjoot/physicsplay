...
A fluid for which the constituative relation is linear.
\end{definition}

Defining these mathematically and using these concepts to model solid, liquid and gaseous materials will allow us to accurately predict the behaviour of many types of continuous substances.
