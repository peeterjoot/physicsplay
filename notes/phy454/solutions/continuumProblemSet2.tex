...
\begin{figure}[htp]
   ...
   \input{continuumProblemSet2Fig1r2.pdf_tex}
   \caption{Velocity profile for 1D constant pressure gradient steady state flow.}\label{fig:continuumProblemSet2:continuumProblemSet2Fig1}
\end{figure}
...
\begin{figure}[htp]
   ...
   \input{continuumProblemSet2Fig2r2.pdf_tex}
   \caption{Two layer flow induced by moving wall.}\label{fig:continuumProblemSet2:continuumProblemSet2Fig2}
\end{figure}
...
\begin{figure}[htp]
   \centering
   \includegraphics[totalheight=0.3\textheight]{continuumProblemSet2Fig4}
...
\begin{figure}[htp]
   \centering
   \includegraphics[totalheight=0.3\textheight]{continuumProblemSet2Fig5}
...
\begin{figure}[htp]
   \centering
   \includegraphics[totalheight=0.3\textheight]{continuumProblemSet2Fig6mu1Gtmu2}
...
\begin{figure}[htp]
   \centering
   \includegraphics[totalheight=0.3\textheight]{continuumProblemSet2Fig6mu2Gtmu1}
