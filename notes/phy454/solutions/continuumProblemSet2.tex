...
%\chapter{PHY454H1S Continuum mechanics.  Problem Set 2.  Rectilinear flow with pressure gradient.  Two layer flow driven by moving surface.}
...
\pdfTexCentered{figures/continuumProblemSet2Fig1r2.pdf_tex}{Velocity profile for 1D constant pressure gradient steady state flow.}{fig:continuumProblemSet2:continuumProblemSet2Fig1}{0.3}
...
\pdfTexCentered{figures/continuumProblemSet2Fig2r2.pdf_tex}{Two layer flow induced by moving wall.}{fig:continuumProblemSet2:continuumProblemSet2Fig2}{0.4}
...
\imageCentered{figures/continuumProblemSet2Fig3}{Two layer shearing flow with water over mercury.}{fig:continuumProblemSet2:continuumProblemSet2Fig3}{0.2}
...
\imageCentered{figures/continuumProblemSet2Fig4}{Superposition of constant pressure gradient and shear flow solutions ($\mu^{(1)} > \mu^{(2)}$).}{fig:continuumProblemSet2:continuumProblemSet2Fig4}{0.3}

\imageCentered{figures/continuumProblemSet2Fig5}{Superposition of constant pressure gradient and shear flow solutions ($\mu^{(1)} < \mu^{(2)}$).}{fig:continuumProblemSet2:continuumProblemSet2Fig5}{0.3}
...
\imageCentered{figures/continuumProblemSet2Fig6mu1Gtmu2}{$\mu^{(1)} > \mu^{(2)}$}{fig:continuumProblemSet2:continuumProblemSet2Fig6mu1Gtmu2}{0.3}

%figure (\ref{fig:continuumProblemSet2:continuumProblemSet2Fig6mu2Gtmu1})
\imageCentered{figures/continuumProblemSet2Fig6mu2Gtmu1}{$\mu^{(2)} > \mu^{(1)}$}{fig:continuumProblemSet2:continuumProblemSet2Fig6mu2Gtmu1}{0.3}
