...
\imageCentered{figures/bottomlessCoffeeFig1}{Fluid flow in nested cylinders.}{fig:coffeeCupDiagram:coffeeCupDiagramFig1}{0.3}
...
\imageCentered{figures/bottomlessCoffeeFig3}{First four zero crossing Bessel functions $J_1( \lambda_i z)$}{fig:bottomlessCoffee:bottomlessCoffeeFig3}{0.2}

Using Mathematica in \href{https://raw.github.com/peeterjoot/physicsplay/master/notes/phy454/mathematica/bottomlessCoffee.cdf}{bottomlessCoffee.cdf}, these coefficients were calculated for $a = 0.6$.  The $n = 1, 3, 5$ approximations to the fitting function are plotted with a comparison to the steady state velocity profile in figure (\ref{fig:bottomlessCoffee:bottomlessCoffeeFig2}).

\imageCentered{figures/bottomlessCoffeeFig2}{Bessel function fitting for the steady state velocity profile for $n = 1, 3, 5$.}{fig:bottomlessCoffee:bottomlessCoffeeFig2}{0.2}
