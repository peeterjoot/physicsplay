...
\imageFigure{figures/bottomlessCoffeeFig1}{Fluid flow in nested cylinders.}{fig:coffeeCupDiagram:coffeeCupDiagramFig1}{0.3}
...
\imageFigure{figures/bottomlessCoffeeFig3}{First four zero crossing Bessel functions $J_1( \lambda_i z)$}{fig:bottomlessCoffee:bottomlessCoffeeFig3}{0.2}
...
\imageFigure{figures/bottomlessCoffeeFig2}{Bessel function fitting for the steady state velocity profile for $n = 1, 3, 5$.}{fig:bottomlessCoffee:bottomlessCoffeeFig2}{0.2}
