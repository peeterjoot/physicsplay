...
We know how to solve a system like \ref{eqn:coffeeCupWithBottom:310} if we did not have the $\sinh$ term in the mix.  Can we look for a numerical (least squares?) solution to this more general problem.  Will it be possible to find something that is a good fit regardless of the value of $z$?
...
We can plot this velocity field as in figure (\ref{fig:coffeeCupWithBottom:coffeeCupWithBottomFig2}), but it is hard to see the radial dependence.
