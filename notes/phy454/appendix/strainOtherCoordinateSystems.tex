...
At the end of the section in the text, the formulas for the spherical and cylindrical versions (to first order) of the strain tensor is given without derivation.  Let us do that derivation for the cylindrical case, which is simpler.  It appears that use of explicit vector notation is helpful here, so we write
...
\begin{align}\label{eqn:continuumL2:910}
...
\begin{align}\label{eqn:continuumL2:930}
...
\begin{align}\label{eqn:continuumL2:950}
...
\begin{align}\label{eqn:continuumL2:970}
\phicap &= \Be_2 e^{i\phi} \\
...
\begin{align}\label{eqn:continuumL2:990}
...
\begin{align}\label{eqn:continuumL2:1010}
d\rcap &= \phicap \sin\theta d\phi + \thetacap d\theta \\
d\thetacap &= \phicap \cos\theta d\phi - \rcap d\theta \\
