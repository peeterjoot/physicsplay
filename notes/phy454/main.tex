...
\chapter{Introduction}
   \include{elastic/intro/continuumMechanics}
\chapter{Strain Tensor}
   \include{elastic/strain/reviewStrainTensor}
   \include{elastic/strain/strainTensor}
   \include{elastic/strain/StrainComponents}
\chapter{Stress tensor.}
   \include{elastic/stress/reviewStressTensor}
   \include{elastic/stress/stressTensor}
   \include{elastic/stress/constitutiveRelationship}
