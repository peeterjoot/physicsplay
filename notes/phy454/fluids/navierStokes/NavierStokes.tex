...
From the constitutive relation \ref{eqn:continuumL9:250}, we have
...
We've seen that incompressibility was equivalent to 
...
\begin{dmath}\label{eqn:continuumL10:230c}
\boxed{
\rho 
 (\Bu \cdot \spacegrad) \Bu + \rho \PD{t}{\Bu} 
= -\spacegrad p + \mu \spacegrad^2 \Bu 
...
We won't treat compressible fluids in this course.
...
\imageFigure{figures/lec10_Rocker_tank_with_two_viscosity_fluidsFig1}{Rocker tank with two viscosity fluids}{fig:continuumL9:continuumL10fig1}{0.2}
