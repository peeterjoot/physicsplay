...
\imageFigure{figures/lec8_Differential_displacementFig1}{Differential displacement}{fig:continuumL8:continuumL8fig1}{0.2}
...
%After this first fluid dynamics lecture I was left troubled.  We'd just been barraged with a set of equations pulled out of a magic hat, with no notion of where they came from.  
Recall that for elastic materials we derived the strain tensor by considering differences in squared displacements?  It was not obvious to me why we had no such term when analyizing solids.
