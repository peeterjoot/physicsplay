...
%\imageFigure{figures/lec9_velocity_displacements_at_a_fluid_pointFig1}{velocity displacements at a fluid point}{fig:continuumL9:continuumL9fig1}{0.2}
%
%we write
%
...
For such a fluid, the constitutive relation \index{constitutive relation} takes the form
...
\imageFigure{figures/lec9_Area_projections_for_mass_conservation_argumentFig2}{Area projections for mass conservation argument}{fig:continuumL9:continuumL9fig2}{0.3}
...
Note that this is what I had thought we called the \underline{continuity equation} in physics, but I think we were using that for $\spacegrad \cdot \Bu = 0$ instead.
}
