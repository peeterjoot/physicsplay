...
%\unnumberedSubsection{Velocity and pressure}
We would like to find the velocity and pressure.  Let us start with the illustration of figure (\ref{fig:twoCylinder:twoCylinderFig1}) to fix coordinates.
...
A plot of this function can be found in figure (\ref{fig:twoCylinder:twoCylinderFig2}), and the Mathematica notebook that generated this plot can be found in \href{https://raw.github.com/peeterjoot/physicsplay/master/notes/phy454/mathematica/twoCylinders.cdf}{twoCylinders.cdf}.  That notebook has some slider controls that can be used interactively.
...
%\unnumberedSubsection{Friction force per unit length}
...
%\unnumberedSubsection{With external pressure gradient}
