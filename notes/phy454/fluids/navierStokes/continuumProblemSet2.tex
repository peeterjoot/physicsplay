...
% 
% 
\makeproblem{Steady rectilinear blood flow}{problem:fluids:blood}{
...
\paragraph{Navier-Stokes equation for the system}
...
\ref{problem:fluids:bloodVelocityProfile}
\paragraph{Velocity profile}
For the velocity profile, integrating \ref{eqn:continuumProblemSet2:140} twice, we have
...
\paragraph{Maximum speed of the flow}
...
\paragraph{Effects of viscosity doubling}
...
\makeproblem{Simple shearing flow}{problem:fluids:simpleShearing}{
...
\makeproblem{Simple shearing flow with constant pressure gradient}{problem:fluids:simpleShearingPressureGrad}{
...
\makeanswer{problem:fluids:problem:fluids:simpleShearingPressureGrad}{
