...
Starting with the velocity profile derivation for the two fluids, we set up coordinates as in figure (\ref{fig:continuumProblemSet2:continuumProblemSet2Fig2}).  Our steady flow for layers $1$ and $2$ has the form
...
We see from \ref{eqn:continuumProblemSet2:600} the tangential components of our traction vectors are
...
We note that due to constant nature of the tangential component of the traction vector shown above, the force per unit width of the upper fluid acting on the lower fluid, is also given by \ref{eqn:continuumProblemSet2:740}.
} % end answer
