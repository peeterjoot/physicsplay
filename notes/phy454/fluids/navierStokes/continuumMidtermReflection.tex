...
\FIXME{This linearity is also how a Newtonian fluid was defined in the notes, but I didn't remember that and lost a mark here on the midterm (this isn't really something we use since we assume all fluids and materials are Newtonian in any calculations that we do)}
