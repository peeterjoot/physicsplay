...
For low $U$ we will let the parabolic dominate, and can graphically add these two as in figure (\ref{fig:continuumMidtermReflection:continuumMidtermReflectionFig5})
...
For high $U$, we will let the shear flow dominate, and have plotted this in figure (\ref{fig:continuumMidtermReflection:continuumMidtermReflectionFig6})
...
We have calculated that derivative above in \ref{eqn:continuumMidTermReflection:690}, so we have
