...
% 
\begin{Exercise}[
title={In continuum mechanics what do you mean by \textit{constitutive relation}?},
...
\begin{Exercise}[
title={What is the definition of a Non-Newtonian fluid?},
label={problem:fluids:midterm:1c}
]
\end{Exercise}

\begin{Answer}[ref={problem:fluids:midterm:1c}]
...
\begin{Exercise}[
title={What do you mean by \emph{no-slip} boundary condition at a fluid-fluid interface?},
label={problem:fluids:midterm:1d}
]
\end{Exercise}

\begin{Answer}[ref={problem:fluids:midterm:1d}]
...
\begin{Exercise}[
title={Write down the continuity equation for an incompressible fluid.},
label={problem:fluids:midterm:1e}
]
\end{Exercise}

\begin{Answer}[ref={problem:fluids:midterm:1e}]
...
\begin{Exercise}[
title={Steady simple shearing flow},
label={problem:fluids:midterm:p2}
]
...
\begin{Answer}[ref={problem:fluids:midterm:p2}]
