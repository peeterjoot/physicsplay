...
\begin{Exercise}[
title={Two layer inclined viscous flow with equal densities},
label={problem:fluids:twoLayerInclinedFlow}
]
...
\begin{Answer}[ref={problem:fluids:twoLayerInclinedFlow}]

\paragraph{Setup of the equations of motion for this system.}

We'll write $H = h^{(1)} + h^{(2)}$.  We have a pair of Navier-Stokes equations to solve
