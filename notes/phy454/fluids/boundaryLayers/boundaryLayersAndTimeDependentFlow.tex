...
% 
% 
%\chapter{PHY454H1S Continuum Mechanics.  Lecture 16: Boundary Layers.  Time dependent flow.  Taught by Prof. K. Das.}
%\chapter{Boundary Layers.  Time dependent flow.}
\label{chap:continuumL16}

\section{Boundary Layers.  Time dependent flow}

Suppose we have an obstacle to fluid flow, as in figure (\ref{fig:continuumL16:continuumL16Fig1})
\imageFigure{figures/continuumL16Fig1}{Flow lines around circular obstacle}{fig:continuumL16:continuumL16Fig1}{0.2}
...
\pdfTexFigure{figures/continuumL16Fig2.pdf_tex}{Viscous and inviscous regions in boundary layer flow.}{fig:continuumL16:continuumL16Fig2}{0.5}
...
\imageFigure{figures/continuumL16Fig3a}{Lagrangian view.}{fig:continuumL16:continuumL16Fig3a}{0.2}
\imageFigure{figures/continuumL16Fig3b}{Eulerian view.}{fig:continuumL16:continuumL16Fig3b}{0.2}
...
\pdfTexFigure{figures/continuumL16Fig4a.pdf_tex}{Plots of separation thickness for different viscosities.}{fig:continuumL16:continuumL16Fig4a}{0.3}
...
\pdfTexFigure{figures/continuumL16Fig4b.pdf_tex}{Linear relation between separation thickness and $\sqrt{\nu t}$}{fig:continuumL16:continuumL16Fig4b}{0.3}
