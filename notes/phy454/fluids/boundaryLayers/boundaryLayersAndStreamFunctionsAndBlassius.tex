...
\keywords{Navier-Stokes, PHY454H1S, Laminar boundary layers, Blasius problem, Singular perturbation theory}

\section{Boundary layers and stream functions.  The Blasius problem.}
\subsection{Review.  Laminar boundary layer theory.}
...
\imageFigure{figures/continuumL19Fig1}{Illustrating the boundary layer thickness and associated pressure variation.}{fig:continuumL19:continuumL19Fig1}{0.2}
...
\subsection{Fluid flow over a flat plate (Blasius problem).}
...
\subsubsection{Numeric solution.}

We can solve this numerically and find solutions that look like figure (\ref{fig:continuumL19:continuumL19Fig2})

\imageFigure{figures/continuumL19Fig2}{Boundary layer solution to flow over plate.}{fig:continuumL19:continuumL19Fig2}{0.2}
