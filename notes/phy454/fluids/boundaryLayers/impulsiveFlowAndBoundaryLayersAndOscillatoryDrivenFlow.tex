...
\subsection{Review.  Impulsively started flow}
...
\imageFigure{figures/lec17_Impulsively_driven_time_dependent_fluid_flowFig1}{Impulsively driven time dependent fluid flow}{fig:continuumL17:continuumL17Fig1}{0.3}
...
\imageFigure{figures/lec17_Error_functionFig2}{Error function}{fig:continuumL17:continuumL17Fig2}{0.3}
...
\pdfTexFigure{figures/continuumL17Fig3.pdf_tex}{Velocity profiles at different times}{fig:continuumL17:continuumL17Fig3}{0.6}

\subsubsection{Universal behavior}
...
\pdfTexFigure{figures/continuumL17Fig4.pdf_tex}{Universal behavior}{fig:continuumL17:continuumL17Fig4}{0.6}

Characterizing this we introduce the concept of boundary layer thickness

\makedefinition{Boundary layer thickness}{dfn:continuumL17:200}{The length scale over which viscosity is dominant.  This is the viscous length scale. \index{boundary layer thickness}}
...
\pdfTexFigure{figures/continuumL17Fig5.pdf_tex}{Characteristic distances in heat flow problems}{fig:continuumL17:continuumL17Fig5}{0.5}

with a temperature $T$ on the bottom plate.  We can ask how fast the heat propagates through the medium.

\subsection{Another worked problem}

Consider an oscillating plate, driving the motion of the fluid, as in figure (\ref{fig:continuumL17:continuumL17Fig6})
\imageFigure{figures/lec17_Time_dependent_fluid_motion_due_to_oscillating_plateFig6}{Time dependent fluid motion due to oscillating plate}{fig:continuumL17:continuumL17Fig6}{0.3}
...
\subsection{Flow over static object}

Next time we'll start considering fluid flow around a fixed object as in figure (\ref{fig:continuumL17:continuumL17Fig7})

\imageFigure{figures/lec17_Fluid_flow_around_fixed_objectFig7}{Fluid flow around fixed object}{fig:continuumL17:continuumL17Fig7}{0.3}
