...
Using Mathematica (\nbref{bottomlessCoffee.cdf}), these coefficients were calculated for $a = 0.6$.  The $n = 1, 3, 5$ approximations to the fitting function are plotted with a comparison to the steady state velocity profile in figure (\ref{fig:bottomlessCoffee:bottomlessCoffeeFig2}).
