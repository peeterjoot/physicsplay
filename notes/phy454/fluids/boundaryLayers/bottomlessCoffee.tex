...
We will work in cylindrical coordinates following the conventions of figure (\ref{fig:coffeeCupDiagram:coffeeCupDiagramFig1}).
...
Our boundary value constraint is that we require this to match \ref{eqn:bottomlessCoffee:370} at $t = 0$.  Let us write $R_2 = R$, $R_1 = a R$, $z = r/R$, so that we are working in the unit circle with $z \in [0, 1]$.  Our boundary problem can now be expressed as
