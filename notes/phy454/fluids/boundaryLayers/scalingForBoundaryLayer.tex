...
\unnumberedSubsection{Scaling arguments.}
...
\unnumberedSubsection{Question:} Why compare the magnitude of the viscous terms for the $y$ momentum to the magnitude of the same terms in the $x$ momentum equation, and not to the LHS of the $y$ momentum equation.

\unnumberedSubsection{Answer} That's a valid point, but our equations are coupled, and contributions from one feed into the other.
