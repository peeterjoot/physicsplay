...
Let us look at the scaling of these equations, starting with the continuity equation \ref{eqn:continuumL18:70}.  This is roughly
...
Utilizing Bernoulli's theorem \ref{eqn:continuumL18:410}, we can deal with the pressure term, the magnitude of which is
...
Observe that if we operate on \ref{eqn:continuumL18:370} with a divergence operation, then we do not have to assume non-viscous flow but in that case we can only say that (for irrotational flow) we have
