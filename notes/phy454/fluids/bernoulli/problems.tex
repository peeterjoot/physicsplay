...
Suppose we measure the volume flux, putting a measuring cup under the tap, and timing how long it takes to fill up.  We then measure the radii at different points.  This can be done from a photo as in figure (\ref{fig:tapFlowCropped6cm:tapFlowCropped6cmFig3}).

\imageFigure{figures/tapFlowMeasurementCropped6cmFig3}{Tap flow measurement}{fig:tapFlowCropped6cm:tapFlowCropped6cmFig3}{0.3}
...
\imageFigure{figures/tapFlowComparison_of_measured_stream_radii_and_calculatedCropped6cmFig4}{Comparison of measured stream radii and calculated}{fig:tapFlowCropped6cm:tapFlowCropped6cmFig4}{0.3}
} % end answer
