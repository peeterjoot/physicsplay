...
\begin{Exercise}[
title={Surface for spinning bucket of water},
label={problem:fluids:constantSpinSurfaces}
]
A problem from the 2009 phy1530 final that serves as a nice example of how to determine a surface as a function of pressure.  This is something I want to do for the non-bottomless coffee problem, so lets try a simpler version first.
...
\label{problem:fluids:constantSpinSurfaces:1}
\Question{What is wrong with the student's argument?}
\label{problem:fluids:constantSpinSurfaces:2}
\Question{Write down the Euler equations in component form and integrate them directly to find the pressure $p$, and hence obtain the correct parabolic shape for the free surface.}
\end{Exercise}

\begin{Answer}[ref={problem:fluids:constantSpinSurfaces}]
\ref{problem:fluids:constantSpinSurfaces:1}
...
\ref{problem:fluids:constantSpinSurfaces:2}
