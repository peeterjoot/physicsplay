...
\imageFigure{figures/lec13_A_control_volume_of_fluid_in_a_fluidFig3a}{A control volume of fluid in a fluid}{fig:continuumL13:continuumL13Fig3a}{0.2}

In the column of fluid above the control volume (\ref{fig:continuumL13:continuumL13Fig3b}) we have
\imageFigure{figures/lec13_column_of_fluid_above_a_control_volumeFig3b}{column of fluid above a control volume}{fig:continuumL13:continuumL13Fig3b}{0.2}
...
If the densities are not equal, then we would have motion of the new bit of mass as depicted in figure (\ref{fig:continuumL13:continuumL13Fig4})
\imageFigure{figures/lec13_A_mass_of_different_density_in_a_fluidFig4}{A mass of different density in a fluid}{fig:continuumL13:continuumL13Fig4}{0.2}
...
\imageFigure{figures/lec13_Various_floating_ice_configurations_on_waterFig5}{Various floating ice configurations on water}{fig:continuumL13:continuumL13Fig5}{0.2}
...
\imageFigure{figures/lec13_flow_through_channel_with_different_aperturesFig6}{flow through channel with different apertures}{fig:continuumL13:continuumL13Fig6}{0.2}
...
\imageFigure{figures/lec13_area_and_velocity_flows_in_unequal_aperture_channel_configurationFig7}{area and velocity flows in unequal aperture channel configuration}{fig:continuumL13:continuumL13Fig7}{0.2}
...
\imageFigure{figures/lec13_velocity_variation_in_channel_with_bulgeFig8}{velocity variation in channel with bulge}{fig:continuumL13:continuumL13Fig8}{0.2}

If we consider half of such a channel as in figure (\ref{fig:continuumL13:continuumL13Fig9a})
\imageFigure{figures/lec13_vorticity_induction_due_to_pressure_gradients_in_unequal_aperture_channelFig9a}{vorticity induction due to pressure gradients in unequal aperture channel}{fig:continuumL13:continuumL13Fig9a}{0.2}

considering the flow around a small triangular section we must have a pressure gradient, which induces a vorticity flow.  We would see something similar in a rectangular channel where there is a block in the channel, as depicted in figure (\ref{fig:continuumL13:continuumL13Fig9b})

\imageFigure{figures/lec13_vorticity_due_to_rectangular_blockageFig9b}{vorticity due to rectangular blockage}{fig:continuumL13:continuumL13Fig9b}{0.2}

\section{Height matching in odd geometries}

Let us consider an arbitrarily weird channel as in figure (\ref{fig:continuumL13:continuumL13Fig10})

\imageFigure{figures/lec13_height_matching_in_odd_geometriesFig10}{height matching in odd geometries}{fig:continuumL13:continuumL13Fig10}{0.2}

This was also illustrated with a glass blown container in class as in figure (\ref{fig:continuumL13:continuumL13Fig11})

\imageFigure{figures/lec13_a_physical_demonstration_with_glass_blown_apparatusFig11}{a physical demonstration with glass blown apparatus}{fig:continuumL13:continuumL13Fig11}{0.2}
...
\imageFigure{figures/lec13_column_volume_element_decomposition_for_odd_geometriesFig12}{column volume element decomposition for odd geometries}{fig:continuumL13:continuumL13Fig12}{0.2}
