...
%
\makeproblem{Alternatives for velocity non-dimensionalisation}{problem:fluids:ps3}{
...
\ref{problem:fluids:ps3:1} Let us check each of the velocity expressions in turn.
...
\ref{problem:fluids:ps3:3} For the mantle convection problem let us compute the characteristic velocities
...
\makeproblem{Nondimensionalise N-S equation}{problem:fluids:ps3:q2}{
