...
\begin{Exercise}[
%title={Steady state inclined flow down a plane of two layers of incompressible viscous fluids},
title={Two layer inclined viscous flow},
label={problem:fluids:twoLayerInclinedFlowDifferentDensities}
]
...
\begin{Answer}[ref={problem:fluids:twoLayerInclinedFlowDifferentDensities}]
