...
\FIXME{
This didn't fit with much of the other lecture material.  Looking at the big picture, it's not clear why it was covered, so have moved it to an appendix.  Doesn't really seem to be a prerequisite for the surface tension content despite that being when it was covered in class.
}

Consider a surface with some variation as in figure (\ref{fig:continuumL13:continuumL13Fig13})

\imageFigure{figures/lec13_variable_surface_geometriesFig13}{variable surface geometries}{fig:continuumL13:continuumL13Fig13}{0.2}
...
\imageFigure{figures/lec13_a_vector_differential_elementFig14}{a vector differential element}{fig:continuumL13:continuumL13Fig14}{0.2}
