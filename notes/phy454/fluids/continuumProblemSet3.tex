...
\subsubsection{Part 1.  Statement.  Check whether the dimensions match in each case above.}
\subsubsection{Solution.}

\subsubsection{Part 2.  Statement. Pure liquid.}
...
\subsubsection{Part 3.  Statement.  Mantle convection.}
