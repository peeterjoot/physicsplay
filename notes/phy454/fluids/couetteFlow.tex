...
% 
\begin{Exercise}[
title={Couette flow of a viscous incompressible fluid},
label={problem:fluids:couetteFlow}
]
...
\begin{Answer}[ref={problem:fluids:couetteFlow}]
...
\paragraph{Navier-Stokes and resulting differential equations}
...
\paragraph{Fixing the constants}
...
\paragraph{Plotting the solutions}
