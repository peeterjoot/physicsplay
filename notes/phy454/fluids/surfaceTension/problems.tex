...
As in the text we will work with $z$ axis up, and the fluid up against a wall at $x = 0$ as illustrated in figure (\ref{fig:continuumFluidsReview:continuumFluidsReviewFig2}).
To get some idea a better feeling for , let us look to a worked problem.  

\imageFigure{figures/fluidsReviewCurvature_of_fluid_against_a_wallFig2}{Curvature of fluid against a wall}{fig:continuumFluidsReview:continuumFluidsReviewFig2}{0.4}
