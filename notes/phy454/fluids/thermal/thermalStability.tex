...
Illustrated in figure (\ref{fig:continuumL22:continuumL22Fig1}) is the heated channel we have been discussing

\imageFigure{figures/lec22_Channel_with_heat_applied_to_the_baseFig1}{Channel with heat applied to the base}{fig:continuumL22:continuumL22Fig1}{0.3}
...
We would like to solve this and \ref{eqn:continuumL22:170} simultaneously.
...
Let us apply this rescaling to our perturbed velocity equation \ref{eqn:continuumL22:170}
...
We have got a pair of nasty looking coupled equations \ref{eqn:continuumL22:310b}, and \ref{eqn:continuumL22:350}.  Repeated so that we can see them together
...
it is clear that we can decouple these by inserting \ref{eqn:continuumL22:670} into \ref{eqn:continuumL22:650}.  Doing that gives us a beastly 6th order spatial equation for the perturbed temperature
...
Let us back up a bit instead.  Looking back to \ref{eqn:continuumL22:670}, it is clear that we will have the same separable form for our perturbed velocity since we have
...
Considering the boundary conditions, if the heating is even then at $z = t = 0$ we can not have any variation with $x$ and $y$, so can only have $\Theta(0) = 0$.  Thus at the boundary, from \ref{eqn:continuumL22:990}, we have
...
\imageFigure{figures/lec22_Critical_Rayleighs_numberFig2}{Critical Rayleigh's number}{fig:continuumL22:continuumL22Fig2}{0.3}

The instability means that we will have instable flows as illustrated in figure (\ref{fig:continuumL22:continuumL22Fig3}).

\imageFigure{figures/lec22_Instability_due_to_heatingFig3}{Instability due to heating}{fig:continuumL22:continuumL22Fig3}{0.2}
...
\imageFigure{figures/lec22_Crude_illustration_of_instability_leading_to_a_drop_pinching_offFig4}{Crude illustration of instability leading to a drop pinching off}{fig:continuumL22:continuumL22Fig4}{0.2}
