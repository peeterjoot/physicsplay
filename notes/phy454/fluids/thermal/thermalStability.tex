...
\keywords{Navier-Stokes, PHY454H1S, Prandtl number, Rayleigh number, thermal stability}
...
%
%  We also note that $k_1$ and $k_2$ are the same in both equations, where we are solving for a coupled state between the two equations \ref{eqn:continuumL22:310b}, \ref{eqn:continuumL22:350}.
%
...
\imageFigure{figures/continuumL22Fig2}{Critical Rayleigh's number.}{fig:continuumL22:continuumL22Fig2}{0.2}
