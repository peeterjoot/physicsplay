...
An animation of the time evolution above can be found in figure \ref{fig:channelFlowWithStepPressureGradient:channelFlowWithStepPressureGradientFig3}.  If this animation is unavailable, it can also be found at \youtubehref{0vZuv9HBtmo}.
