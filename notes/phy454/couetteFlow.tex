...
\imageFigure{couetteFlowFig1}{Couette flow configuration.}{fig:couetteFlow:couetteFlowFig1}{0.3}
...
\imageFigure{couetteFlowFig2}{Couette flow plot}{fig:couetteFlow:couetteFlowFig2}{0.2}
%figure (\ref{fig:couetteFlow:couetteFlowFig3}).
\imageFigure{couetteFlowFig3}{Couette flow plot}{fig:couetteFlow:couetteFlowFig3}{0.2}
%figure (\ref{fig:couetteFlow:couetteFlowFig4}).
\imageFigure{couetteFlowFig4}{Couette flow plot}{fig:couetteFlow:couetteFlowFig4}{0.2}
%figure (\ref{fig:couetteFlow:couetteFlowFig5}).
\imageFigure{couetteFlowFig5}{Couette flow plot}{fig:couetteFlow:couetteFlowFig5}{0.2}

For Acrobat viewers of this document, figure (\ref{fig:couetteFlow:couetteFlowFig6}), has an animation of the above images.
...
These were all generated from the Mathematica workbook \href{https://raw.github.com/peeterjoot/physicsplay/master/notes/phy454/couetteFlow.cdf}{phy454/couetteFlow.cdf}, which has some slider controls that can be used to play with the radii and angular velocities in an interactive fashion.
