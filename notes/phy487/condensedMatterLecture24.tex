...
\approx
V_\nought D(\EF) \inv{2} 
\evalrange{\ln \lr{ 2 \EF + \calE - 2 E}}{\EF}{\EF + \Hbar \omega_{\mathrm{D}}}
\approx
\frac{V_\nought D(\EF) }{2} 
\ln 
\frac{ 2 \EF + \calE - 2 \EF}
{ 2 \EF + \calE - 2 (\EF + \Hbar \omega_{\mathrm{D}}) }
\end{dmath}

Giving 

\begin{dmath}\label{eqn:condensedMatterPhysicsLecture24:260}
e^{ 2/V_\nought D(\EF) } = \frac{\calE - 2 \Hbar \omega_{\mathrm{D}}}{\calE}
\end{dmath}

or

\begin{dmath}\label{eqn:condensedMatterPhysicsLecture24:280}
\calE = \frac{ -2 \Hbar \omega_{\mathrm{D}} }{e^{2/V_\nought D(\EF)} - 1}
\end{dmath}

\boxedEquation{eqn:condensedMatterPhysicsLecture24:300}{
\calE \approx -2 \Hbar \omega_{\mathrm{D}} e^{-2/V_\nought D(\EF)}
}
