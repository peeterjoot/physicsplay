...
and determine the energy level $\EF$ and momentum $\kF$ associated with that surface, for which no more states can be occupied.  This is roughly illustrated in \cref{fig:qmSolidsL11:qmSolidsL11Fig11}.
