...
\imageFigure{figures/DebyeTemperaturesVsAtomicNumberFig1}{Debye temperature vs atomic number}{fig:DebyeTemperaturesVsAtomicNumber:DebyeTemperaturesVsAtomicNumberFig1}{0.5}
...
\begin{dmath}\label{eqn:condensedMatterProblemSet5Problem2:n}
\omega_D \propto \lr{\frac{N}{V}}^{1/3}.
\end{dmath}
...
\imageFigure{figures/atomicRadiiVsAtomicNumberFig2}{Atomic radii}{fig:atomicRadiiVsAtomicNumber:atomicRadiiVsAtomicNumberFig2}{0.5}
...
\imageFigure{figures/atomicRadiusAndDebyeTempOverlappedFig3}{Debye and atomic radius}{fig:atomicRadiusAndDebyeTempOverlapped:atomicRadiusAndDebyeTempOverlappedFig3}{0.5}
...
\imageFigure{figures/atomicInvRadiusAndDebyeTempOverlappedFig4}{Inverse Atomic Radius and Debye temperature}{fig:figuresatomicInvRadiusAndDebyeTempOverlapped:atomicInvRadiusAndDebyeTempOverlappedFig4}{0.5}
}
