...
\underlineAndIndex{Simple cubic} Very rare: only \ce{Po}, which is very toxic (what was used in the likely Russian secret service assassination by injection).
...
\imageFigure{figures/bccPackingFig1}{Element of a face centered cubic}{fig:bccPacking:bccPackingFig1}{0.2}
