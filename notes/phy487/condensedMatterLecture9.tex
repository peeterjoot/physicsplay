...
\paragraph{Examination hint:} He'll expect us to look at a phonon diagram and see where the density of states is high or low.
...
Define the Debye frequency $\omega_D$ \index{Debye frequency} by
