...
\int 
\sum_{LA, TA} 
\frac{d f_\omega }{\frac{d\omega}{dq}}
=
\frac{V}{(2\pi)^3} 
\lr{
\inv{C_L} + \frac{2}{C_T}
...
Here the sum over TA and LA states, and \cref{eqn:condensedMatterLecture9:340} introduce the $C_L$ and $C_T$ factors.
...
\omega_D = \int_0^{\omega_D} Z(\omega) d\omega = 3 r N
\end{dmath}
