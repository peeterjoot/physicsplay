...
calling this the distance to the ``nearest'' lattice plane.

It initially seemed to me that $d'_{hkl}$ ought to be described as the distance to the nearest lattice plane, since the distance from the origin appeared like it was the separation of the two closest planes.  What I failed to understand is the entire geometry that the sample primative lattice cell would generate.  It is replicated not only for integer multiples of $2 \Ba_1$, but all the multiples of $\Ba_1$.   This is illustrated in \cref{fig:qmSolidsL6:qmSolidsL6Fig10}.
