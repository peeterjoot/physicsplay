...
\imageFigure{figures/qmSolidsL6Fig1}{Cancellation}{fig:qmSolidsL6:qmSolidsL6Fig1}{0.15}

This is effectively a $\delta_{\BK, \BG}$ condition, defining the \underline{Laue condition for constructive interference} \index{Laue condition}.
...
\imageFigure{figures/qmSolidsL6Fig2}{Diffraction}{fig:qmSolidsL6:qmSolidsL6Fig2}{0.2}
...
\imageFigure{figures/qmSolidsL6Fig3}{Ewald sphere}{fig:qmSolidsL6:qmSolidsL6Fig3}{0.2}
...
\imageFigure{figures/qmSolidsL6Fig4}{Cubic miller planes}{fig:qmSolidsL6:qmSolidsL6Fig4}{0.2}
...
\imageFigure{figures/qmSolidsL6Fig5}{fcc Miller planes}{fig:qmSolidsL6:qmSolidsL6Fig5}{0.2}
%}
...
\imageFigure{figures/qmSolidsL6Fig6}{Miller index demonstration}{fig:qmSolidsL6:qmSolidsL6Fig6}{0.2}
...
\imageFigure{figures/qmSolidsL6Fig9}{Lattice planes example}{fig:qmSolidsL6:qmSolidsL6Fig9}{0.3}
...
calling this the distance to the ``nearest'' lattice plane.  It initially seemed to me that $d'_{hkl}$ ought to be described as the distance to the nearest lattice plane, since the distance from the origin appeared like it was the separation of the two closest planes.  What I failed to understand is the entire geometry that the sample primative lattice cell would generate.  It is replicated not only for integer multiples of $2 \Ba_1$, but all the multiples of $\Ba_1$.   This is illustrated in \cref{fig:qmSolidsL6:qmSolidsL6Fig10}.

\imageFigure{figures/qmSolidsL6Fig10}{Primative cell replication and all the Miller 122 planes}{fig:qmSolidsL6:qmSolidsL6Fig10}{0.3}
...
\imageFigure{figures/qmSolidsL6Fig7}{Diffraction geometry}{fig:qmSolidsL6:qmSolidsL6Fig7}{0.2}
...
\imageFigure{figures/qmSolidsL6Fig8}{Bragg condition}{fig:qmSolidsL6:qmSolidsL6Fig8}{0.3}
