...
\paragraph{Question: Why introduce this scaling and describe the result as the distance to the nearest lattice plane.  Nearest to what?  I don't see any geometrical construct that this is the metric for?  Is $d'_{h k l}$ not the distance between any two lattice planes identified by the reciprocal indices $h k l$?}
