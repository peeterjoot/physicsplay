...
Verification of orthonormality of the $2s$ and $2p$ orbital basis functions can be found in \nbref{qmSolidsPs1P2.nb}
%\href{https://raw.github.com/peeterjoot/physicsplay/master/notes/phy487/mathematica/qmSolidsPs1P2.nb}{phy487/mathematica/qmSolidsPs1P2.nb}
...
Neglecting the first common factor, some experimentation yields the solution $\phi = \pi/2, \theta \in \{0, \pi\}$.  The probability density is maximized along the $z,y$ plane pointing towards either of the poles.

\makeSubAnswer{}{condensedMatter:problemSet1:2c}

%%\cref{fig:qmSolidsPs1P2bPsi1:qmSolidsPs1P2bPsi1Fig1}.
%\imageFigure{figures/qmSolidsPs1P2bPsi1Fig1}{$\Abs{\psi_1}^2$ in $x-y$ plane}{fig:qmSolidsPs1P2bPsi1:qmSolidsPs1P2bPsi1Fig1}{0.3}
%%\cref{fig:qmSolidsPs1P2bPsi2:qmSolidsPs1P2bPsi2Fig2}.
%\imageFigure{figures/qmSolidsPs1P2bPsi2Fig2}{$\Abs{\psi_2}^2$ in $x-y$ plane}{fig:qmSolidsPs1P2bPsi2:qmSolidsPs1P2bPsi2Fig2}{0.3}
%
%%\cref{fig:qmSolidsPs1P23d:qmSolidsPs1P23dFig4}.
%%\imageFigure{figures/qmSolidsPs1P23dFig4}{3d $\Abs{\psi_1}^2$}{fig:qmSolidsPs1P23d:qmSolidsPs1P23dFig4}{0.3}

See \nbref{qmSolidsPs1P2.nb} for interactive figures.

%\cref{fig:qmSolidPs1OrbitalsPsi1AbsDensity:qmSolidPs1OrbitalsPsi1AbsDensityFig3}.
\imageFigure{figures/qmSolidPs1OrbitalsPsi1AbsDensityFig3}{$\Abs{\psi_1}^2$, density plot in $x - y$ plane}{fig:qmSolidPs1OrbitalsPsi1AbsDensity:qmSolidPs1OrbitalsPsi1AbsDensityFig3}{0.2}
%\cref{fig:qmSolidPs1OrbitalsPsi1Abs:qmSolidPs1OrbitalsPsi1AbsFig2}.
\imageFigure{figures/qmSolidPs1OrbitalsPsi1AbsFig2}{$\Abs{\psi_1}^2$, contour plot in $x - y$ plane}{fig:qmSolidPs1OrbitalsPsi1Abs:qmSolidPs1OrbitalsPsi1AbsFig2}{0.2}
%\cref{fig:qmSolidPs1OrbitalsPsi1Signed:qmSolidPs1OrbitalsPsi1SignedFig1}.
\imageFigure{figures/qmSolidPs1OrbitalsPsi1SignedFig1}{$\psi_1$, contour plot in $x - y$ plane}{fig:qmSolidPs1OrbitalsPsi1Signed:qmSolidPs1OrbitalsPsi1SignedFig1}{0.2}
%\cref{fig:qmSolidPs1OrbitalsPsi2AbsDensity:qmSolidPs1OrbitalsPsi2AbsDensityFig6}.
\imageFigure{figures/qmSolidPs1OrbitalsPsi2AbsDensityFig6}{$\Abs{\psi_2}^2$, density plot in $x - y$ plane}{fig:qmSolidPs1OrbitalsPsi2AbsDensity:qmSolidPs1OrbitalsPsi2AbsDensityFig6}{0.2}
%\cref{fig:qmSolidPs1OrbitalsPsi2Abs:qmSolidPs1OrbitalsPsi2AbsFig5}.
\imageFigure{figures/qmSolidPs1OrbitalsPsi2AbsFig5}{$\Abs{\psi_2}^2$, contour plot in $x - y$ plane}{fig:qmSolidPs1OrbitalsPsi2Abs:qmSolidPs1OrbitalsPsi2AbsFig5}{0.2}
%\cref{fig:qmSolidPs1OrbitalsPsi2Signed:qmSolidPs1OrbitalsPsi2SignedFig4}.
\imageFigure{figures/qmSolidPs1OrbitalsPsi2SignedFig4}{$\psi_2$, contour plot in $x - y$ plane}{fig:qmSolidPs1OrbitalsPsi2Signed:qmSolidPs1OrbitalsPsi2SignedFig4}{0.2}
%\cref{fig:qmSolidPs1OrbitalsPsi3AbsDensity:qmSolidPs1OrbitalsPsi3AbsDensityFig9}.
\imageFigure{figures/qmSolidPs1OrbitalsPsi3AbsDensityFig9}{$\Abs{\psi_3}^2$, density plot in $x - y$ plane}{fig:qmSolidPs1OrbitalsPsi3AbsDensity:qmSolidPs1OrbitalsPsi3AbsDensityFig9}{0.2}
%\cref{fig:qmSolidPs1OrbitalsPsi3Abs:qmSolidPs1OrbitalsPsi3AbsFig8}.
\imageFigure{figures/qmSolidPs1OrbitalsPsi3AbsFig8}{$\Abs{\psi_3}^2$, contour plot in $x - y$ plane}{fig:qmSolidPs1OrbitalsPsi3Abs:qmSolidPs1OrbitalsPsi3AbsFig8}{0.2}
%\cref{fig:qmSolidPs1OrbitalsPsi3Signed:qmSolidPs1OrbitalsPsi3SignedFig7}.
\imageFigure{figures/qmSolidPs1OrbitalsPsi3SignedFig7}{$\psi_3$, contour plot in $x - y$ plane}{fig:qmSolidPs1OrbitalsPsi3Signed:qmSolidPs1OrbitalsPsi3SignedFig7}{0.2}
%\cref{fig:qmSolidPs1OrbitalsPsi4AbsDensity:qmSolidPs1OrbitalsPsi4AbsDensityFig12}.
\imageFigure{figures/qmSolidPs1OrbitalsPsi4AbsDensityFig12}{$\Abs{\psi_4}^2$, density plot in $x - y$ plane}{fig:qmSolidPs1OrbitalsPsi4AbsDensity:qmSolidPs1OrbitalsPsi4AbsDensityFig12}{0.2}
%\cref{fig:qmSolidPs1OrbitalsPsi4Abs:qmSolidPs1OrbitalsPsi4AbsFig11}.
\imageFigure{figures/qmSolidPs1OrbitalsPsi4AbsFig11}{$\Abs{\psi_4}^2$, contour plot in $x - y$ plane}{fig:qmSolidPs1OrbitalsPsi4Abs:qmSolidPs1OrbitalsPsi4AbsFig11}{0.2}
%\cref{fig:qmSolidPs1OrbitalsPsi4Signed:qmSolidPs1OrbitalsPsi4SignedFig10}.
\imageFigure{figures/qmSolidPs1OrbitalsPsi4SignedFig10}{$\psi_4$, contour plot in $x - y$ plane}{fig:qmSolidPs1OrbitalsPsi4Signed:qmSolidPs1OrbitalsPsi4SignedFig10}{0.2}
...
\imageFigure{figures/qmSolidPs1OrbitalsPsi5AbsDensityFig15}{$\Abs{\psi_5}^2$, density plot in $x - y$ plane}{fig:qmSolidPs1OrbitalsPsi5AbsDensity:qmSolidPs1OrbitalsPsi5AbsDensityFig15}{0.2}
%\cref{fig:qmSolidPs1OrbitalsPsi5Abs:qmSolidPs1OrbitalsPsi5AbsFig14}.
\imageFigure{figures/qmSolidPs1OrbitalsPsi5AbsFig14}{$\Abs{\psi_5}^2$, contour plot in $x - y$ plane}{fig:qmSolidPs1OrbitalsPsi5Abs:qmSolidPs1OrbitalsPsi5AbsFig14}{0.2}
%\cref{fig:qmSolidPs1OrbitalsPsi5Signed:qmSolidPs1OrbitalsPsi5SignedFig13}.
\imageFigure{figures/qmSolidPs1OrbitalsPsi5SignedFig13}{$\psi_5$, contour plot in $x - y$ plane}{fig:qmSolidPs1OrbitalsPsi5Signed:qmSolidPs1OrbitalsPsi5SignedFig13}{0.2}
...
%\imageFigure{figures/qmSolidsPs1P2dFig3}{Probability density in $x-y$ plane for $\psi_1$ superposition with shifted and reversed self}{fig:qmSolidsPs1P2d:qmSolidsPs1P2dFig3}{0.3}
