...
\imageFigure{figures/qmSolidsL3Fig1}{Madelung separation}{fig:qmSolidsL3:qmSolidsL3Fig1}{0.1}

As an additional illustration, we have the \ce{NaCl} configuration in \cref{fig:qmSolidsL3:qmSolidsL3Fig2}.

\imageFigure{figures/qmSolidsL3Fig2}{\ce{NaCl} lattice separation}{fig:qmSolidsL3:qmSolidsL3Fig2}{0.2}

\paragraph{Examination hint:} Eminently examinable material (since it can be calculated).
...
\imageFigure{figures/qmSolidsL3Fig3}{Metallic bonding regions in the periodic table}{fig:qmSolidsL3:qmSolidsL3Fig3}{0.2}
...
\imageFigure{figures/qmSolidsL3Fig4}{Extensive wave function}{fig:qmSolidsL3:qmSolidsL3Fig4}{0.2}
...
\imageFigure{figures/qmSolidsL3Fig6}{Overlapping $s$ and $p$ orbitals}{fig:qmSolidsL3:qmSolidsL3Fig6}{0.2}

%\cref{fig:qmSolidsL3:qmSolidsL3Fig5}.
%\imageFigure{figures/qmSolidsL3Fig5}{Overlapping orbitals}{fig:qmSolidsL3:qmSolidsL3Fig5}{0.2}
