...
\imageFigure{figures/fourierReciprocalUnitCellFig1}{Unit cell}{fig:fourierReciprocalUnitCell:fourierReciprocalUnitCellFig1}{0.3}
...
\begin{dmath}\label{eqn:fourierReciprocal:320b}
\myBoxed{
\begin{aligned}
V_{r s t} 
&=
