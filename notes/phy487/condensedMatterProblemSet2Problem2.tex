...
\begin{equation}\label{eqn:condensedMatterProblemSet2Problem2:40}
\myBoxed{
\rho_{fcc} 
...
\begin{equation}\label{eqn:condensedMatterProblemSet2Problem2:80}
\myBoxed{
\rho_{bcc} 
\frac{\sqrt{3} \pi }{8} 
\approx
...
\begin{dmath}\label{eqn:condensedMatterProblemSet2Problem2:280}
\rho_{simple cubic} = \frac{\pi}{6} \approx 0.5236
\end{dmath}
...
\imageFigure{figures/hcpUnitHexCellFig1}{Hex Close Packed unit cell}{fig:hcpUnitHexCell:hcpUnitHexCellFig1}{0.2}
...
\imageFigure{figures/hcpUnitHexCellInThreePiecesFig4}{hcp primitive unit cell}{fig:hcpUnitHexCellInThreePieces:hcpUnitHexCellInThreePiecesFig4}{0.2}
...
\imageFigure{figures/hcpSecondLayerFittingFig2}{Second layer overlap packing in hcp.}{fig:hcpSecondLayerFitting:hcpSecondLayerFittingFig2}{0.3}
...
\imageFigure{figures/hcpTetrahedralUnitFig3}{Tetrahedral packing of two hcp layers}{fig:hcpTetrahedralUnit:hcpTetrahedralUnitFig3}{0.3}
...
\imageFigure{figures/tetrahedralBaseFig5}{Tetrahedral base}{fig:tetrahedralBase:tetrahedralBaseFig5}{0.2}
...
\imageFigure{figures/tetrahedralHeightFig6}{Tetrahedral height}{fig:tetrahedralHeight:tetrahedralHeightFig6}{0.2}
...
\imageFigure{figures/tetrahedralBaseFig7}{Hex cell base area calculation}{fig:tetrahedralBase:tetrahedralBaseFig7}{0.2}
...
\begin{equation}\label{eqn:condensedMatterProblemSet2Problem2:240}
\myBoxed{
\rho_{hcp} 
= \frac{ \sqrt{2} \pi }{6}
\approx 0.740.
