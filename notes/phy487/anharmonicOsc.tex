...
How that the equation of motion for an anharmonic oscillator
...
\begin{dmath}\label{eqn:anharmonicOsc:n}
...
\imageFigure{figures/anharmonicOscFig1}{Anharmonic sum and two components}{fig:anharmonicOsc:anharmonicOscFig1}{0.3}
