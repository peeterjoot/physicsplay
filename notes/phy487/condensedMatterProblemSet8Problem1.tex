...
\imageFigure{../../figures/phy487/qmSolidsPs8biFig1}{$E(k)$ on $k \in [(0,0), 2 \pi (1,0)/a]$}{fig:qmSolidsPs8bi:qmSolidsPs8biFig1}{0.2}
...
\imageFigure{../../figures/phy487/qmSolidsPs8biiFig2}{$E(k)$ on $k \in [(0,0), 2 \pi (0,1)/a]$}{fig:qmSolidsPs8bii:qmSolidsPs8biiFig2}{0.2}
...
\imageFigure{../../figures/phy487/qmSolidsPs8biiiFig3}{$E(k)$ on $k \in [(0,0), 2 \pi (1,1)/a]$}{fig:qmSolidsPs8biii:qmSolidsPs8biiiFig3}{0.2}
...
\imageFigure{../../figures/phy487/qmSolidsPs8dFig1}{2D Contour plots of selected tight binding energy levels}{fig:qmSolidsPs8d:qmSolidsPs8dFig1}{0.3}

\imageFigure{../../figures/phy487/qmSolidsPs8dFig2}{Energy level curves}{fig:qmSolidsPs8d:qmSolidsPs8dFig2}{0.2}
...
\paragraph{Grading remark:} Originally had $-\Abs{B_x}$, which resulted in a squished plot instead of the one below that has a saddle.  The comment was ``negative $B_x$ makes $(0, 0)$ a saddle point''.  FIXME: plot the 3D curve too.
...
Plotted for $\mu \in [-1, 1]$, and $\Abs{B_y/B_x} = 0.41$ in \cref{fig:qmSolidsPs8e:qmSolidsPs8eFig2} (FIXME: is that still the ratio for this corrected plot)
