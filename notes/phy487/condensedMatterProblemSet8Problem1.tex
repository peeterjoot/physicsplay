...
\(E_s\): 
\(\hat{\mathcal{H}_A}(\Br - \Br_n) \phi_s(\Br - \Br_n) = E_s\phi_s(\Br - \Br_n)\), where 
...
In class (or \citep{ibach2009solid} \eqntext (7.37)) we found for the tight binding energy at the lattice point at \(\Br_n\)
