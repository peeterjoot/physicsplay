...
\imageFigure{figures/two_springsFig1}{Two springs chain}{fig:two_springs:two_springsFig1}{0.1}
%
...
\imageFigure{figures/qmSolidsPs4QzeroFig1}{Pairwise oscillation}{fig:qmSolidsPs4Qzero:qmSolidsPs4QzeroFig1}{0.3}
...
\imageFigure{figures/qmSolidsPs4P2dFig1}{Frequencies for $\delta/k_\nought \in \{0.9, 0.1, 0\}$}{fig:qmSolidsPs4P2d:qmSolidsPs4P2dFig1}{0.3}
...
\paragraph{Grading remark:} ``Explain physically what is going on.''  FIXME: review posted solution when available.
...
\imageFigure{figures/qmSolidsPs4OpticalDeltaZeroFig1}{Optical dispersion at $\delta = 0$}{fig:qmSolidsPs4OpticalDeltaZero:qmSolidsPs4OpticalDeltaZeroFig1}{0.3}
\imageFigure{figures/qmSolidsPs4AccousticDeltaZeroFig1}{Acoustic dispersion at $\delta = 0$}{fig:qmSolidsPs4AccousticDeltaZero:qmSolidsPs4AccousticDeltaZeroFig1}{0.3}

\paragraph{Grading remark:} ``Only one mode'' was marked under \cref{fig:qmSolidsPs4AccousticDeltaZero:qmSolidsPs4AccousticDeltaZeroFig1}, with an X beside the figure.  FIXME: Consider this and understand what is meant.  Also look at the posted solution when available.
