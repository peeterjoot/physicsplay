...
n \approx 2 N_{\mathrm{D}} 
\lr{ 1 + \sqrt{ 1 + 4 \frac{N_{\mathrm{D}}}{N_{\mathrm{eff}}^{\mathrm{C}}} e^{E_{\mathrm{d}}/\kB T}} }^{-1},
\end{dmath}
...
\frac{E_{\mathrm{d}}}{\kB} \sim 147 \Unit{K},
\end{dmath}

so the exponential is large for small temperatures.  How about the ratio \(N_{\mathrm{D}}/N_{\mathrm{eff}}^{\mathrm{C}}\)?  For \ce{Ge}, \S 12.3 says we have \(m_n^\conj \sim 0.13 m_e\), so

\begin{dmath}\label{eqn:condensedMatterProblemSet10Problem2:60}
N_{\mathrm{eff}}^{\mathrm{C}} 
\sim 2 \lr{ \frac{2 \pi \times 0.13 m_{\mathrm{e}} \times \kB T}{h^2} }^{3/2}
...
\mathImageFigure{../../figures/phy487/ps10p2Fig2}{\(N_{\mathrm{eff}}^{\mathrm{C}}\) for \ce{Ge}}{fig:ps10p2:ps10p2Fig2}{0.2}{ps10plots.nb}
...
4 \frac{N_{\mathrm{D}}}{N_{\mathrm{eff}}^{\mathrm{C}}} e^{E_{\mathrm{d}}/\kB T}
...
This justifies a \(4 \frac{N_{\mathrm{D}}}{N_{\mathrm{eff}}^{\mathrm{C}}} e^{E_{\mathrm{d}}/\kB T} \gg 1\) approximation of \eqnref{eqn:condensedMatterProblemSet10Problem2:20}

\begin{dmath}\label{eqn:condensedMatterProblemSet10Problem2:100}
n 
\approx 
2 N_{\mathrm{D}} 
\lr{ 1 + \sqrt{4 \frac{N_{\mathrm{D}}}{N_{\mathrm{eff}}^{\mathrm{C}}} e^{E_{\mathrm{d}}/\kB T}} }^{-1}
\approx
\frac{
2 N_{\mathrm{D}} 
}
...
\ln n 
\sim \inv{2} \ln N_{\mathrm{D}} + \inv{2} \ln N_{\mathrm{eff}}^{\mathrm{C}} - \frac{E_{\mathrm{d}}}{2 \kB T}.
...
This is plotted for \(T^{-1} \in [1/293, 1]\) in \cref{fig:ps10p2:ps10p2Fig1}, along the nearly linear asymptote (with slope \(-E_{\mathrm{d}}/2\kB\)).  The lowest temperature range in this plot is the \dquoteAndIndex{freeze out} range where a large number of the donors still retain their electrons.
