...
\reading \citep{ashcroft1976solid} \ch 23.
...
\reading \citep{ashcroft1976solid} \ch 22, 23.
...
=
\frac{d}{dT} 
 \int_0^{\omega_{\mathrm{D}}} 
\mathcal{E}(\omega, T) 
Z(\omega) 
d\omega
= \inv{2 \pi^2} \lr{ 
\inv{C_{\mathrm{L}}^3} + \frac{2}{C_{\mathrm{T}}^3} 
}
 \int_0^{\omega_{\mathrm{D}}} \omega^2 \frac{d}{dT} \mathcal{E}(\omega, T) d\omega
= 
\frac{ 9 r N}{V} 
\inv{\omega_{\mathrm{D}}^3}
\frac{d}{dT}
\int_0^{\omega_{\mathrm{D}}}
{\Hbar \omega^3}
\lr{
...
where $r$ is the number of atoms in the unit cell.  In the limit $\kB T \gg \Hbar \omega_{\mathrm{D}}$, we have
...
\CV(T) = 
\lr{ 
   \frac{ 9 r N }{V} \inv{\omega_{\mathrm{D}}^3} 
}
\frac{d}{dT}
\int_0^{\omega_{\mathrm{D}}} 
\Hbar \omega^3 \lr{
...
d\omega
= 
\lr{ \frac{ 9 r N }{V} \inv{\omega_{\mathrm{D}}^3} }
\int_0^{\omega_{\mathrm{D}}} 
-\Hbar \omega^3
\inv
{
...
\mathLabelBox{\kB \Theta}{Debye temp} = \Hbar \omega_{\mathrm{D}}
\end{dmath}
\end{subequations}
...
y(\omega_{\mathrm{D}}) = \frac{\Hbar \omega_{\mathrm{D}}}{ \kB T} = \frac{\kB \Theta}{\kB T} = \frac{\Theta}{T},
\end{dmath}
...
In the $T \ll \Hbar \omega_{\mathrm{D}}/\kB$ limit, we have
