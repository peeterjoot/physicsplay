...
We'll work from the text \citep{ibach2009solid}.  I personally found \citep{ashcroft1976solid} not only helpful, but superior in almost every aspect, containing better diagrams, clearer descriptions, more complete and clearer mathematics, and no typos (that I spotted).
