...
\item At local extremums of $E(\Bk)$ you get a peak in $D(E)$.  This is called a Van Hove singularity.  See slides.
\end{itemize}
...
Moves with group velocity

\begin{equation}\label{eqn:condensedMatterLecture18:n}
\myBoxed{
\Bv_\Bk = \frac{d\omega(\Bk)}{d\Bk} = \spacegrad_\Bk E(\Bk).
}
\end{equation}
