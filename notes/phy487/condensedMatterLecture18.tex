...
\imageFigure{figures/qmSolidsL18Fig1}{Diamond bandstructure}{fig:qmSolidsL18:qmSolidsL18Fig1}{0.2}
...
\imageFigure{figures/qmSolidsL18Fig2}{Bonding and antibonding functions in unit cells}{fig:qmSolidsL18:qmSolidsL18Fig2}{0.1}
}
...
\imageFigure{figures/qmSolidsL18Fig3}{\ce{Ge}, \ce{Si} band structure}{fig:qmSolidsL18:qmSolidsL18Fig3}{0.2}
...
\imageFigure{figures/qmSolidsL18Fig4}{\ce{K Cl} band structure}{fig:qmSolidsL18:qmSolidsL18Fig4}{0.2}
...
\reading \citep{ashcroft1976solid} \ch 8.
...
D(E) dE = \frac{2}{\lr{2\pi}^3} \int \frac{df_{\mathrm{E}}}{ \Abs{\spacegrad_\Bk E(\Bk)}} dE.
\end{dmath}

Referring to \cref{fig:qmSolidsL18:qmSolidsL18Fig5}.

\imageFigure{figures/qmSolidsL18Fig5}{Fermi surface for constant energy}{fig:qmSolidsL18:qmSolidsL18Fig5}{0.2}

\begin{dmath}\label{eqn:condensedMatterLecture18:80}
d\Bk = df_{\mathrm{E}} dk_\perp 
= df_{\mathrm{E}} \frac{dE}{\Abs{\spacegrad_\Bk E(\Bk)}}.
\end{dmath}
...
\item At local extremums of $E(\Bk)$ you get a peak in $D(E)$.  This is called a \textAndIndex{van Hove singularity}.  See slides and \citep{ashcroft1976solid} fig. 8.3.
\end{itemize}
...
Here we have Van Hove singularities.  Note that max/min at $\Gamma$ do not produce a Van Hove singlularity, because $d f_{\mathrm{E}}$ is vanishingly small.

\section{Electrical transport}

\reading \citep{ibach2009solid} \S 9.1,\citep{ashcroft1976solid} \ch 12.
...
\imageFigure{figures/qmSolidsL18Fig6}{Conducting block of metal}{fig:qmSolidsL18:qmSolidsL18Fig6}{0.1}
...
%\imageFigure{figures/qmSolidsL18Fig7}{Packet spreading with time}{fig:qmSolidsL18:qmSolidsL18Fig7}{0.1}
\imageFigure{figures/qmSolidsL18PacketSpreadingFig1}{Packet spreading with time}{fig:qmSolidsL18:qmSolidsL18Fig7}{0.3}

Moves with \textAndIndex{group velocity}

\begin{equation}\label{eqn:condensedMatterLecture18:n}
\myBoxed{
