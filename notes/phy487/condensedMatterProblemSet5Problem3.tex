...
in the crystal, 
\(\Theta\) is defined by \(\kB\Theta = \hbar\omega_{\mathrm{D}}\), 
and 
\begin{eqnarray*}
...
C_{\mathrm{T}} q & \quad \mbox{transverse acoustic} 
\end{array}
\right.
\end{dmath}
...
\frac{A}{(2\pi)^2} 
\lr{
\inv{C_{\mathrm{L}}} + \frac{1}{C_{\mathrm{T}}}
}
\mathLabelBox
[
   labelstyle={xshift=2cm},
...
\frac{A}{2\pi} 
\lr{
\frac{q}{C_{\mathrm{L}}} + \frac{q}{C_{\mathrm{T}}}
}
d \omega
=
\int
\frac{A}{2\pi} 
\lr{
\frac{1}{C_{\mathrm{L}}^2} + \frac{1}{C_{\mathrm{T}}^2}
}
\omega d \omega,
\end{dmath}
...
Define the Debye frequency \(\omega_{\mathrm{D}}\) by

\begin{dmath}\label{eqn:condensedMatterProblemSet5Problem3:100}
\int_0^{\omega_{\mathrm{D}}} Z(\omega) d\omega = 2 r N
\end{dmath}

\begin{dmath}\label{eqn:condensedMatterProblemSet5Problem3:120}
2 r N
=
\frac{A}{ 2 \pi} \lr{ \inv{C_{\mathrm{L}}^2} + \frac{1}{C_{\mathrm{T}}^2} } \int_0^{\omega_{\mathrm{D}}} \omega d\omega 
=
\frac{A}{ 2 \pi} \lr{ \inv{C_{\mathrm{L}}^2} + \frac{1}{C_{\mathrm{T}}^2} } \inv{2} \omega_{\mathrm{D}}^2,
\end{dmath}

or

\begin{dmath}\label{eqn:condensedMatterProblemSet5Problem3:140}
\frac{A}{ 2 \pi} \lr{ \inv{C_{\mathrm{L}}^2} + \frac{1}{C_{\mathrm{T}}^2} } \omega_{\mathrm{D}}^2 = 4 r N.
\end{dmath}
...
Z(\omega) =
\frac{4 r N \omega}{ \omega_{\mathrm{D}}^2 }.
\end{dmath}
...
d\omega
= 
\frac{4 r N }{ A \omega_{\mathrm{D}}^2 }
 \int_0^{\omega_{\mathrm{D}}} \frac{d}{dT} \mathcal{E}(\omega, T) \omega d\omega
= 
\frac{4 r N }{ A \omega_{\mathrm{D}}^2 }
\frac{d}{dT}
\int_0^{\omega_{\mathrm{D}}}
...
In the \(\kB T \ll \Hbar \omega_{\mathrm{D}} = \kB \Theta\) limit where the integrand is small, the integral limit can be approximated by extension to \(\infty\).  This produces the desired result
