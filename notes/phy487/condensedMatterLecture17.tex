...
\imageFigure{figures/qmSolidsLecture17Fig1}{Simple cubic Brillouin zone}{fig:qmSolidsLecture17:qmSolidsLecture17Fig1}{0.2}

%\cref{fig:qmSolidsLecture17:qmSolidsLecture17Fig2}.
\imageFigure{figures/qmSolidsLecture17Fig2}{Two frequency distributions}{fig:qmSolidsLecture17:qmSolidsLecture17Fig2}{0.3}
%\cref{fig:qmSolidsLecture17:qmSolidsLecture17Fig3}.
\imageFigure{figures/qmSolidsLecture17Fig3}{Center edge contour distribution}{fig:qmSolidsLecture17:qmSolidsLecture17Fig3}{0.3}
...
%\imageFigure{figures/qmSolidsLecture17Fig4}{4: CAPTION}{fig:qmSolidsLecture17:qmSolidsLecture17Fig4}{0.3}
%\cref{fig:qmSolidsLecture17:qmSolidsLecture17Fig5}.
%\imageFigure{figures/qmSolidsLecture17Fig5}{5: CAPTION}{fig:qmSolidsLecture17:qmSolidsLecture17Fig5}{0.3}
...
We have \underline{half filled} orbitals.  Where $\EF$ crosses $E(k)$ is a Fermi surface.  It never gets close to the Brillouin zone boundary.
...
This point is also discussed with typical clarity in \citep{ashcroft1976solid} \ch 15, ``The Alkaki Metals''.

\paragraph{Valence 2}

For alkali earth's \ce{Mg}, \ce{Ca}, $\cdots$, we have $2 \times 2 s$ valence electrons.  This \underline{doesn't} fill the band, because of dispersion.
...
%F7
%F8 ... 
\imageFigure{figures/qmSolidsLecture17Fig6}{Fermi surfaces for \ce{Cu} like simple cubic}{fig:qmSolidsLecture17:qmSolidsLecture17Fig6}{0.3}
%\cref{fig:qmSolidsLecture17:qmSolidsLecture17Fig7}.
\imageFigure{figures/qmSolidsLecture17Fig7}{Copper Fermi surface side view?}{fig:qmSolidsLecture17:qmSolidsLecture17Fig7}{0.3}
...
\imageFigure{figures/qmSolidsLecture17Fig8}{d electron distribution}{fig:qmSolidsLecture17:qmSolidsLecture17Fig8}{0.3} 

The \underline{occupancy} for \ce{Cu} is $3 d^{10} 4 s^1$.  The d orbitals are \underline{filled}.
