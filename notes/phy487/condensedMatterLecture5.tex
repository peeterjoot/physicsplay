...
An example of reciprocal projection is illustrated in 

\imageFigure{../papers/minkowskiReciprocal}{reciprocal projection}{fig:minkowskiReciprocal}{0.3}

(Here $f^i \cdot f_j = \delta^i_j$, using a different scaling than in this diffraction context).
