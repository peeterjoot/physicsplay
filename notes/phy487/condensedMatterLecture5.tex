...
\imageFigure{figures/obliqueReciprocalFig1}{reciprocal projection}{fig:obliqueReciprocal:obliqueReciprocalFig1}{0.3}

Here $f^i \cdot e_j = \delta^i_j$, not using the $2 \pi$ scaling factor that we are using in this diffraction context.
