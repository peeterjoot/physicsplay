...
\imageFigure{figures/potassium_CofTFig1}{Potassium specific heat temperature dependence}{fig:potassium_CofT:potassium_CofTFig1}{0.3}
%\vspace{-0.5cm}
%
%\begin{center}
...
\paragraph{Grading remark:} The grader didn't like my use of ergs as a unit, and said I should use either $\Unit{eV}$ or $\Unit{J}$.
