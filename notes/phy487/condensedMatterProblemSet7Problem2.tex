...
\imageFigure{figures/condensedMatterProblemSet7Fig1}{dispersion relation for a one-dimensional metal}{fig:condensedMatterProblemSet7:condensedMatterProblemSet7Fig1}{0.3}
...
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:380}
\myBoxed{
\Delta E = E_{+} - E_{-} 
...
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:1280}
\myBoxed{
\Delta E = E_{+} - E_{-} = V_2.
}
\end{equation}
...
\begin{dmath}\label{eqn:condensedMatterProblemSet7Problem2:500}
V(x) 
...
where
\begin{dmath}\label{eqn:condensedMatterProblemSet7Problem2:520}
G_h = G h = \frac{ 2 \pi }{a} h,
\end{dmath}

and $h$ is an integer.  Forming the Fourier integral

\begin{dmath}\label{eqn:condensedMatterProblemSet7Problem2:540}
...
\imageFigure{figures/ps7p2cFig1}{implicit function curves for delta-function-potential energy}{fig:ps7p2c:ps7p2cFig1}{0.3}
...
\begin{dmath}\label{eqn:condensedMatterProblemSet7Problem2:780}
\myBoxed{
...
\begin{dmath}\label{eqn:condensedMatterProblemSet7Problem2:880}
\begin{aligned}
...
\begin{dmath}\label{eqn:condensedMatterProblemSet7Problem2:900}
\begin{aligned}
...
\begin{dmath}\label{eqn:condensedMatterProblemSet7Problem2:920}
\begin{aligned}
...
\imageFigure{figures/ps7p2dDensityPlotsFig2}{Density plots}{fig:ps7p2dDensityPlots:ps7p2dDensityPlotsFig2}{0.3}
...
\begin{dmath}\label{eqn:condensedMatterProblemSet7Problem2:1020}
\psi_{k,\pm}(x)
\propto -V_1 e^{i (k - G) x} + 
\lr{
\frac{\Hbar^2 \lr{ G^2 - 2 k G} }{2m}
...
Some of these curves are plotted in \cref{fig:ps7p2e:ps7p2eFig1pn} for various relative values of ${E_{k -2\pi/2}^\nought} - {E_{k }^\nought}, V_1$, where the most peaked is near the $k = \pi/a$ boundary, and the flattest, near the origin.

\imageFigure{figures/ps7p2eFig1pn}{Real space variation with $k$ in the Brillouin zone}{fig:ps7p2e:ps7p2eFig1pn}{0.2}
}
