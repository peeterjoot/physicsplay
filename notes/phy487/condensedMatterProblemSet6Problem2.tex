...
\imageFigure{figures/qmSolidsPs6P2Fig1}{Particle in a pizza box}{fig:qmSolidsPs6P2:qmSolidsPs6P2Fig1}{0.3}
...
\imageFigure{figures/qmSolidsPs6P2Fig2}{K space points for pizza box wavefunction}{fig:qmSolidsPs6P2:qmSolidsPs6P2Fig2}{0.3}
...
\imageFigure{figures/qmSolidsPs6P2Fig3}{Particle in a cigar box}{fig:qmSolidsPs6P2:qmSolidsPs6P2Fig3}{0.15}
...
\myBoxed{
D(E) = \inv{\pi} \sqrt{\frac{2m}{\Hbar^2}} E^{-1/2}.
}
\end{dmath}
