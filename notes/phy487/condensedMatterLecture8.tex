...
\imageFigure{figures/qmSolidsL8Fig1}{Harmonic oscillator chain normal mode frequencies}{fig:qmSolidsL8:qmSolidsL8Fig1}{0.3}

(a) At $q = 0$, \cref{fig:qmSolidsL8:qmSolidsL8Fig1a}, we really have uniform translation of the entire chain.

\imageFigure{figures/qmSolidsL8Fig1a}{Uniform motion}{fig:qmSolidsL8:qmSolidsL8Fig1a}{0.1}

(b) At $q = a$, \cref{fig:qmSolidsL8:qmSolidsL8Fig1b}, we have displaced, but also uniform translation of the entire chain.

\imageFigure{figures/qmSolidsL8Fig1b}{Displaced uniform motion}{fig:qmSolidsL8:qmSolidsL8Fig1b}{0.1}

(c) At $q = a/2$, \cref{fig:qmSolidsL8:qmSolidsL8Fig1c}, we have maximum oscillation.

\imageFigure{figures/qmSolidsL8Fig1c}{Maximum oscillation}{fig:qmSolidsL8:qmSolidsL8Fig1c}{0.1}
...
\imageFigure{figures/qmSolidsL8Fig2}{Displacement relative to primitive cell origin}{fig:qmSolidsL8:qmSolidsL8Fig2}{0.3}
...
%This generalizes the quadratic potential to multiple coordinates.  The Lagrangian for our system is thus
%
%\LL = \inv{2} \sum_{n \alpha i} M_n \dot{u}_{n \alpha i}
...
\imageFigure{figures/qmSolidsL8Fig3}{direction relative indexing example}{fig:qmSolidsL8:qmSolidsL8Fig3}{0.15}
...
As a second example consider \cref{fig:qmSolidsL8:qmSolidsL8Fig4} for a diatomic linear chain.

\imageFigure{figures/qmSolidsL8Fig4}{Diatomic linear chain}{fig:qmSolidsL8:qmSolidsL8Fig4}{0.2}
...
\imageFigure{figures/qmSolidsL8Fig5}{Optic and acoustic modes}{fig:qmSolidsL8:qmSolidsL8Fig5}{0.3}
...
\imageFigure{figures/qmSolidsL8Fig6}{Uniform translation}{fig:qmSolidsL8:qmSolidsL8Fig6}{0.1}

(b)

%\cref{fig:qmSolidsL8:qmSolidsL8Fig7}.
\imageFigure{figures/qmSolidsL8Fig7}{Pairwise oscillation}{fig:qmSolidsL8:qmSolidsL8Fig7}{0.1}

(c)

%\cref{fig:qmSolidsL8:qmSolidsL8Fig8}.
\imageFigure{figures/qmSolidsL8Fig8}{Heavier atoms oscillating}{fig:qmSolidsL8:qmSolidsL8Fig8}{0.1}

(d)

%\cref{fig:qmSolidsL8:qmSolidsL8Fig9}.
\imageFigure{figures/qmSolidsL8Fig9}{Lighter atoms oscillating}{fig:qmSolidsL8:qmSolidsL8Fig9}{0.1}
