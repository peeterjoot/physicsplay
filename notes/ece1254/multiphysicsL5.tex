...
With a linear dependency an additional solution, given solution \( \Bx \) is \( \Bx^1 = \Bx + \alpha y \).  This becomes relevant for numerical processing since for a system \( M \Bx^1 = \Bb \) we can often find \( \alpha M \By \), for which
