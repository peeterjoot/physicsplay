...
Laplace transforms \index{Laplace transform} were used to solve the MNA equations for time dependent systems, and to find the moments used to in \textAndIndex{MOR}.
