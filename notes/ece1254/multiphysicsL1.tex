...
Continuing the application of circuits like linear systems to other systems, let's consider a truss system as illustrated in \cref{fig:lecture1:lecture1Fig1}, or in the simpler similar system of \cref{fig:lecture1:lecture1Fig2}.
...
\begin{itemize}
   ...
   \item Strut forces.  Under static conditions the total resulting force on the strut is zero, so $\BF'_j = -\BF_j$.  For this problem it is redundant to label forces on both ends, so we mark the labeled end of the object with an asterisk as in \cref{fig:lecture1:lecture1Fig3}.
\end{itemize}
...
Treatment of this system will be used as the prototype for our handling of other \textAndIndex{nonlinear systems}.

Returning to the simple static system, and introducing force and joint labels as in \cref{fig:lecture1:lecture1Fig6}, we can examine the \textAndIndex{conservation law}, the balance of forces.
