...
Recall that the matrix norm of \( M \), for the system \( \overbar{y} = M \overbar{x} \) was defined as
...
\begin{bmatrix}
\overbar{u}_1^\T \\ \overbar{u}_2^\T \\ \vdots \\ \overbar{u}_m^\T 
\end{bmatrix}
\begin{bmatrix}
\overbar{u}_1 & \overbar{u}_2 & \cdots & \overbar{u}_m 
\end{bmatrix}
=
\begin{bmatrix}
1 &   & & \\
