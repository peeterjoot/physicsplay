...
\makesubproblem{
Write a MATLAB routine [G,b]=NodalAnalysis(filename) that generates the modified nodal analysis (MNA) equations
...
\par
\href{https://raw.github.com/peeterjoot/matlab/master/ece1254/ps1/NodalAnalysis.m}{NodalAnalysis.m}
...
\href{https://raw.github.com/peeterjoot/matlab/master/ece1254/ps1/verifyUpperTriangular.m}{verifyUpperTriangular.m}
	\item
\href{https://raw.github.com/peeterjoot/matlab/master/ece1254/ps1/ps1d.m}{ps1d.m}
\end{itemize}

That last contains is a driver for these functions, callable with \( \mathrm{ps1d}() \).  That will produce the netlist, and its solution, both directly and with the \( \backslash \) operator.
