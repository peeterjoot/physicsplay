...
All of the following plots and associated data for this question were generated with \( \mathrm{problem2driver}(1) \).
...
\imageFigure{../../figures/ece1254/ps1p2cFig5}{Power law fit with original timing data}{fig:ps1p2c:ps1p2cFig5}{0.3}
