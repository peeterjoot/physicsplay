...
We've been presented with the definition \cref{dfn:multiphysicsL6:1} of the \textAndIndex{singular value decomposition} or \textAndIndex{SVD}, but not how to compute it.

% FIXME: omit on integration
%Recall the definition \cref{dfn:multiphysicsL6:1}
%
