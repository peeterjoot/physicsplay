...
We've been presented with \cref{dfn:multiphysicsL6:1}
%We've been presented with definition \ref{dfn:multiphysicsL6:1}
%\ref{dfn:svdNotes:1} 
of the \textAndIndex{singular value decomposition} or \textAndIndex{SVD}, but not how to compute it.
