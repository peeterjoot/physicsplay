...
This document is based on my lecture notes for the Winter 2014, University of Toronto Modeling of Multiphysics course (ECE1254H), taught by Professor P. Triverio.  
...
My thanks go to Professor Triverio for teaching this course, and to Ahmed Dorrah for supplying a copy of his (lecture 8) notes on the conjugate gradient method.

The Harmonic Balance project work, both the code and report content, was a collaborative effort between Mike Royle and myself.
