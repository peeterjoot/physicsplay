...
pdfauthor={Mike Royle, Peeter Joot},
...
\author{ Mike~Royle%~\IEEEmembership{Fellow,~OSA,}
...
%IntroFor  vectors of Fourier components 
%\( 
%\Bx = {\begin{bmatrix}x_k\end{bmatrix}}_k, 
%\BX = {\begin{bmatrix}X_n\end{bmatrix}}_n \), the transform pair can be written
%
%\begin{equation}\label{eqn:discreteFourier:n}
%\Bx =
%\begin{bmatrix}
%e^{2 \pi j N N/(2 N + 1)} &
%e^{-2 \pi j n N/(2 N + 1)} &
...
\begin{IEEEbiographynophoto}{Mike Royle}
