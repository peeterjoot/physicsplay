...
\begin{abstract}
With this work the circuit solution system developed in ECE1254 for linear constant source circuits is extended to compute steady state responses to periodic sources.
It is assumed that all input frequencies are multiples of a single fundamental frequency.
The capability to solve diode models is also added to the RLC solution capacities developed previously.
...
\begin{figure*}[!t]
\centering
\subfloat[Simple rectifier circuit diagram]{\includegraphics[width=1.5in]{../../figures/ece1254/report/simpleRectifierCircuitFig1}%
...
\hfil
\subfloat[Output.]{\includegraphics[width=1.5in]{../../figures/ece1254/report/simpleRectifierCircuitFig2}%
\label{fig:simpleRectifierCircuit:simpleRectifierCircuitFig2}}
\subfloat[Number of harmonics retained.]{\includegraphics[width=1.5in]{../../figures/ece1254/report/simpleRectifierCircuitFig4}%
...
\begin{figure*}[!t]
\centering
\subfloat[Typical rectifier circuit diagram]{\includegraphics[width=1.5in]{../../figures/ece1254/report/typicalRectifierCircuitFig1}%
...
\hfil
\subfloat[Output.]{\includegraphics[width=1.5in]{../../figures/ece1254/report/typicalRectifierCircuitFig2}%
\label{fig:typicalRectifierCircuit:typicalRectifierCircuitFig2}}
\subfloat[Number of harmonics retained.]{\includegraphics[width=1.5in]{../../figures/ece1254/report/typicalRectifierCircuitFig3}%
...
\hfil
\subfloat[Source and output voltages.]{\includegraphics[width=1.5in]{../../figures/ece1254/report/lowPassFilterFig2}%
\label{fig:lowPassFilter:lowPassFilterFig2}}
\subfloat[Input voltage spectrum.]{\includegraphics[width=1.5in]{../../figures/ece1254/report/lowPassFilterFig3}%
\label{fig:lowPassFilter:lowPassFilterFig3}}
\subfloat[Output voltage spectrum.]{\includegraphics[width=1.5in]{../../figures/ece1254/report/lowPassFilterFig4}%
\label{fig:lowPassFilter:lowPassFilterFig3}}
...
\begin{figure*}[!t]
\centering
\subfloat[Bridge rectifier circuit diagram]{\includegraphics[width=1.5in]{../../figures/ece1254/report/bridgeRectifierFig1}%
...
\hfil
\subfloat[Source and output voltages.]{\includegraphics[width=1.5in]{../../figures/ece1254/report/bridgeRectifierFig2}%
\label{fig:bridgeRectifier:bridgeRectifierFig2}}
\subfloat[Source current.]{\includegraphics[width=1.5in]{../../figures/ece1254/report/bridgeRectifierFig3}%
\label{fig:bridgeRectifier:bridgeRectifierFig3}}
\subfloat[Diode voltages.]{\includegraphics[width=1.5in]{../../figures/ece1254/report/bridgeRectifierFig4}%
\label{fig:bridgeRectifier:bridgeRectifierFig3}}
...
\begin{figure*}[!t]
\centering
\subfloat[Bridge rectifier with capacitive filter circuit diagram]{\includegraphics[width=1.5in]{../../figures/ece1254/report/bridgeRectifierCapFilterFig1}%
...
\hfil
\subfloat[Source and output voltages.]{\includegraphics[width=1.5in]{../../figures/ece1254/report/bridgeRectifierCapFilterFig2}%
\label{fig:bridgeRectifierCapFilter:bridgeRectifierCapFilterFig2}}
\subfloat[Source current.]{\includegraphics[width=1.5in]{../../figures/ece1254/report/bridgeRectifierCapFilterFig3}%
\label{fig:bridgeRectifierCapFilter:bridgeRectifierCapFilterFig3}}
\subfloat[Diode voltages.]{\includegraphics[width=1.5in]{../../figures/ece1254/report/bridgeRectifierCapFilterFig4}%
\label{fig:bridgeRectifierCapFilter:bridgeRectifierCapFilterFig3}}
...
%\appendix[Discrete Fourier Transform inversion]
