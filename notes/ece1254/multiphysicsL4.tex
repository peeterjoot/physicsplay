...
Writing out our Gaussian transformation in the form \( U \Bx = b \) we have
...
Using this \textAndIndex{LU} decomposition is generally superior to standard Gaussian elimination, since we can use this for many different \(\Bb\) vectors using the same amount of work.
