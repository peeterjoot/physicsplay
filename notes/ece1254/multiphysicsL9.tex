...
We want to precondition in a way that preserves the symmetric positive definite nature of the matrix so that we can continue to use conjugate gradient methods.
...
for which we can use the diagonal preconditioner
...
Our preconditioned matrix will now have the form
