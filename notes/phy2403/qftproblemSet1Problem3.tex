...
\LL = \int_0^a dx \lr{ \frac{\sigma}{2} \lr{ \PD{t}{y} }^2 - \frac{T}{2} \lr{ \PD{x}{y} }^2 }
\end{dmath}
...
\LL = \sum_{n=1}^\infty \lr{ \frac{\sigma}{2} \dot{q}_n^2 - \frac{T}{2} \lr{ \frac{ n \pi }{2} }^2 q_n^2 } .
\end{dmath}
...
\PD{\dot{q}_n}{\LL} = \sigma \dot{q}_n.
\end{equation}

We also have
\begin{equation}\label{eqn:qftProblemSet1Problem3:160}
\PD{q_n}{\LL} = - T \lr{ \frac{n \pi}{a} }^2 q_n,
\end{equation}
