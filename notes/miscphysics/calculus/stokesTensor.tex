...
\begin{equation}\label{eqn:stokesTensor:470g}
\myBoxed{
\sum_{a < b}
\int
d{\alpha_1} d{\alpha_2}
...
\begin{align}\label{eqn:stokesTensor:580}
...
\begin{align}\label{eqn:stokesTensor:620}
...
\begin{align}\label{eqn:stokesTensor:640}
\PD{\alpha}{x^i}
&=
\begin{bmatrix}
...
\begin{align}\label{eqn:stokesTensor:660}
\PD{\alpha}{x^i}
&=
\begin{bmatrix}
-\cosh\alpha \cos\theta  \\
...
Those are
\begin{align}\label{eqn:stokesTensor:700}
...
\begin{equation}\label{eqn:stokesTensor:820}
\myBoxed{
\begin{aligned}
\sum_{a < b < c}
...
\begin{equation}\label{eqn:stokesTensor:840}
\myBoxed{
\begin{aligned}
\inv{3!} &\int d^4 \alpha 
\Abs{ \frac{\partial(x^a, x^b, x^c, x^d)}{\partial(\alpha_1, \alpha_2, \alpha_3, \alpha_4)} } \partial_a A_{bcd} \\
