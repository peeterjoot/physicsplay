...
\imageFigure{figures/snells}{Snell's law.  Position dependent velocity gradient}{fig:snells}{0.4}
...
I am more comfortable with the upper and lower index notation used for repeated indexes, and will switch to that for the remainder
