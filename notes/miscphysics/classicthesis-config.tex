...
% ****************************************************************************************************
\newcommand{\myTitle}{Miscellaneous Physics and Math Play\xspace}
\newcommand{\mySubtitle}{Stuff that I have no better place for\xspace}
\newcommand{\myDegree}{}
...
% https://sites.google.com/site/peeterjoot/math2009/miscphysics.pdf?revision=4
...
\hypersetup{%
    ...
    pdfsubject={Miscellaneous Physics and Math Play},%
    pdfkeywords={Physics},%
    pdfcreator={pdfLaTeX},%
