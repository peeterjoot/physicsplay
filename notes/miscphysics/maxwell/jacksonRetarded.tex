...
\imageFigure{figures/retardedContourBoth}{Contours strictly above the $k_0 = 0$ axis}{fig:jacksonRet:retardedContourBoth}{0.4}

\imageFigure{figures/retardedContourAroundPole}{Contour around pole}{fig:jacksonRet:retardedContourAroundPole}{0.4}
...
\imageFigure{figures/retardedContourOnAxis}{Contour exactly on the $k_0 = 0$ axis?}{fig:jacksonRet:retardedContourOnAxis}{0.4}
