...
\cite{doran2003gap} treats the solution of the Lorentz force equation in covariant form.  Let us try this for non-relativistic motion for constant fields, but without making the usual assumptions about perpendicular electric and magnetic fields, or alignment of the axis.  Our equation to solve is
...
\begin{align}\label{eqn:lorentzRotation:30}
