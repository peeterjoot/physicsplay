...
The Pauli matrices $\sigma^i$ I had seen, but not the $\tau_i$ matrices, nor the $\otimes$ notation.  Strangerep in \href{http://www.physicsforums.com/showthread.php?p=3365680\#post3365680}{physicsforums} points out that the $\otimes$ is a Kronecker matrix product, a special kind of tensor product \cite{wiki:tensorProduct}.  Let us do the exercise of reverse engineering the $\tau$ matrices as suggested.
