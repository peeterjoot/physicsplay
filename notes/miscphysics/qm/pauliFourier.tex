...
\begin{align}\label{eqn:pauliFourier:1c}
...
Let us now apply each of these derivative operations to our assumed Fourier solution $\Psi(\Bx, t)$ from \ref{eqn:pauliFourier:2a}.  Starting with the Laplacian we have
