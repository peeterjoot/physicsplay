...
That does not really help understanding why \ref{eqn:harmonic_osc:spatial} is labeled the Harmonic oscillator.  Let us instead put the equation into an energy form.  The work done against the spring
...
Compared to \ref{eqn:harmonic_osc:spatial}, this does not really appear to be much of an improvement, but let us work with it, looking for a term by term power series solution.
