...
&= \inv{2\alpha} \myMathWithDescription{\Abs{\alpha_1}^2 \int e^{-\alpha x^2} dx}{$=1$}{1} \\
&= \inv{2\alpha}
\end{align*}
...
&= \hbar^2 \alpha^2 \myMathWithDescription{\Abs{\alpha_1}^2 \int x^2 e^{-\alpha x^2} dx}{$\expectation{x^2} = 1/2\alpha$}{1} \\
&= \hbar^2 \alpha \inv{2}
\end{align*}
