...
So, to start things off let us do the variation on the Lagrangian density of \ref{eqn:klein_gordon:densityUndeterminedCoeff}.  For fun, let us try it with Feynman's method (first order Taylor expansion, and no memorization
