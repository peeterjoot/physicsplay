...
\item Inflatable reflectarrays.  Example at 8.3 \si{GHz}.
\makefigure{0.15}{huang7_1_inflatable1meter.png}{1 \si{m} X-band (JPL and ILC Dover).}
\end{itemize}
\end{frame}
...
%
%Example of 1 \si{m} 8.3 \si{GHz}, and 3 \si{m} 32 \si{GHz} reflectarrays.
%
%\twofigures{0.15}{huang7_1_inflatable1meter.png}{1 \si{m} X-band (JPL and ILC Dover).}{0.15}{huang7_3_inflatable3m.png}{3 \si{m} Ka-band (JPL and ILC Dover).}
%
%\end{frame}
%
TODO: 4-5 page
