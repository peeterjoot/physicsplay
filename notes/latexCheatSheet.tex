...
\captionedTable{caption}{tab:WHAT:n}{\begin{tabular}[]...\end{tabular}}
...
\begin{equation}\label{eqn:latexCheatSheet:20}
\begin{aligned}
\end{aligned}
\end{equation}
\begin{equation*}
\end{equation*}
(\eqnref{eqn:WHAT:4.})
\begin{equation}\label{eqn:WHAT:40}
\begin{aligned}
\end{aligned}
\end{equation}
\paragraph{}
Schr\"{o}dinger
\begin{equation}\label{eqn:WHAT:60}
\end{equation}
\begin{bmatrix}
\end{bmatrix}
\begin{vmatrix}
...
\begin{dmath*}
\end{dmath*}
\begin{dmath}\label{eqn:WHAT:100}
\end{dmath}
\begin{dgroup*}
\end{dgroup*}
\begin{dgroup}
