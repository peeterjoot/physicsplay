...
Let's look at the corresponding current out of curiosity, and evaluate the continuity equation in an infinitesimal spherical volume of radius \( R \) surrounding the initial charge \( \rho_0 dV \) that was placed at the centre of that sphere, far enough from the boundary of the conductor that we can ignore it.  That is
...
Assuming that such a current is radial by symmetry, that is
...
We have a positive current out of the volume that the initial charge \( \rho_0 \) was placed in.  That charge density also decays with time as the charge dissipates, since there is no charge left to flow out of that space.
}
