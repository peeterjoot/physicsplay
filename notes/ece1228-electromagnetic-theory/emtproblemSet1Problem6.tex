...
where \( I = \Be_1 \Be_2 \Be_3 \) is the \R{3} Euclidean pseudoscalar.
%  This identity also applies to the gradient
%
...
To produce the usual result, the \R{3} Euclidean pseudoscalar \( I \) can be cancelled in \cref{eqn:emtProblemSet1Problem6:440} since it commutes with all grades (this isn't the case in \R{2} nor in Minkowski spaces.)
}
