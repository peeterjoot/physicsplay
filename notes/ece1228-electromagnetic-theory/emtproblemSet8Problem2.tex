...
However, one can suppose that there are situations where \( \theta_1 \approx \theta_2 \) with sufficient closeness that \( \cos\theta_2/\cos\theta_1 \approx 1 \).  In this case the transmission function reduces to just a phase shift (a time shift in the time domain)
