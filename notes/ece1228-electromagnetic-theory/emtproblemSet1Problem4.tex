...
In a gross sense, this result can be used for both the large sheet and the hole.  If the large sheet is modelled as a circular disk with radius \( R \gg z \), one way of completely neglecting any edge effects, then the field above the center is from this portion of the sheet is approximately
