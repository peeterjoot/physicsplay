...
Recall that the curl in the standard basis has a determinant representation
...
Note that the Colomb is not a fundamental unit, but the Ampere is.  This is because it is easier to measure.
