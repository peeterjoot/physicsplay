...
+ \spacegrad \cdot \int_V dV' \spacegrad \wedge \inv{\Abs{\Bx - \Bx'}} \BM(\Bx')
=
-\spacegrad \int_V dV' \lr{ \spacegrad' \cdot \inv{\Abs{\Bx - \Bx'}}} \BM(\Bx')
-\spacegrad \cdot \int_V dV' \lr{ \spacegrad' \inv{\Abs{\Bx - \Bx'}} } \wedge \BM(\Bx')
=
-\spacegrad \int_V dV' \spacegrad' \cdot \frac{ \BM(\Bx') }{\Abs{\Bx - \Bx'}}
+\spacegrad \int_V dV' \frac{ \spacegrad' \cdot \BM(\Bx')}{\Abs{\Bx - \Bx'}}
-\spacegrad \cdot \int_V dV' \spacegrad' \wedge \frac{\BM(\Bx')}{\Abs{\Bx - \Bx'}}
+\spacegrad \cdot \int_V dV' \frac{ \spacegrad' \wedge \BM(\Bx')}{\Abs{\Bx - \Bx'}}
%=
