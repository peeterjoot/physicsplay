...
This vector is unique provided the limiting constraints \cref{eqn:emtProblemSet1Problem5:340} \cref{eqn:emtProblemSet1Problem5:380} are imposed on the field specification.  Alternatively, if the
boundary of the integrals is limited, we have a specific solution for each possible set of normal components \( \ncap \cdot \BM \) on the surface of the integral \cref{eqn:emtProblemSet1Problem5:120}.
