...
The trivector grade component of \cref{eqn:emtProblemSet1Problem5:120} was neglected.  For that to be zero means that we must have
...
This result, the zero divergence requirement for \( \BC \), and the chain rule can be used to rewrite the LHS of \cref{eqn:emtProblemSet1Problem5:160}
