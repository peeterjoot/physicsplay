...
Recall that we have differential equations to solve for each type of circuit element in the time domain
...
What if we have more complex time dependencies, such as that sketched in
