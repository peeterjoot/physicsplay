...
If \( \psi \) is any polynomial in \( y \) or \( z\) that has degress less than two, this will be zero.  One such function is
...
provided \( \rho \) is non-zero in some region.  The standard Coloumb solution provides a field with the desired
