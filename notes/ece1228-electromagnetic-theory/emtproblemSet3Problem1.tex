...
&+\oint_{\partial V} dy dz \Be_3 \cross \lr{ \BA(x_0 + \Delta x) - \BA(x_0) } \\
&+\oint_{\partial V} dz dx \Be_3 \cross \lr{ \BA(y_0 + \Delta y) - \BA(y_0) } \\
&=
...
Using the pillbox configuration of \cref{fig:ps3Problem1Pillbox:ps3Problem1PillboxFig1}.
