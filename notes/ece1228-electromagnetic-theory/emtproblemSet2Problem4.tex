...
This is a slightly tidier result that shows the asymptotic inverse-square \( z \) dependence of the potential more clearly than \cref{eqn:emtProblemSet2Problem4:380}, valid for \( z \gg d \).  We also have the volume of the disk as an explicit factor in this approximation.
