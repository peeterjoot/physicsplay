...
Here the vacuum permittitity \( \epsilon_0 \) has the value \( 8.85 \times 10^{-12} \si{F/m} \).  When we are ignoring (fictional) magnetic sources, we have a constant relation between the magnetic fields \( \BB = \mu_0 \BH \).
...
Is it possible to solve electromagnetic problems utilizing the force concepts
