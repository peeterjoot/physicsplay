...
One of the PHY356 exam questions from the final I recall screwing up on, and figuring it out after the fact on the drive home.  The question actually clarified a difficulty I had had, but unfortunately I hhad not had the good luck to perform such a question, to help figure this out before the exam.
...
\subsubsection{Probabilities for \texorpdfstring{\(L_z\)}{L z} measurement outcomes}
...
\subsubsection{Probabilities for \texorpdfstring{\(\BL^2\)}{L squared} measurement outcomes}
