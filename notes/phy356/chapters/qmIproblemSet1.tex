...
\subsection{Problem set I.  Problem 1}
...
\subsubsection{Avoiding Dirac notation}
...
\subsubsection{Using Dirac notation}
...
Anyways, assuming the correctness of all the manipulations above, let us return to the problem.  We refer back to \ref{eqn:qmIproblemSet1:4} and see that we now have
...
\subsubsection{The physical meaning of this expression}
...
\subsection{Problem set 1.  Problem 2}
