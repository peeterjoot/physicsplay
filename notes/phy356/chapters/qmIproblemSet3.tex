...
\subsection{(b). What is the probability for measuring the particle at position \texorpdfstring{$x=x_0>0$}{x positive} at time \texorpdfstring{$t=t_0>0$}{greater than zero}?}
...
\subsection{(c). What is the probability per unit length for measuring the particle at position 
...
\subsection{Solution:  Uncertainty of \texorpdfstring{$S_z$}{S z} with respect to \texorpdfstring{$\ket{z+}$}{ket z plus}}
...
\subsection{Solution:  Uncertainty of \texorpdfstring{$S_x$}{S x} with respect to \texorpdfstring{$\ket{z+}$}{ket z plus}}
