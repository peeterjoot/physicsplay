...
\subsection{Problem Set IV.  Problem 1}
...
\imageFigure{figures/FiniteWellPotential}{8.1.2 Finite Well potential (with energy shifted downwards by $V_0$)}{fig:FiniteWellPotential}{0.4}

\imageFigure{figures/deltaFunctionPotential}{8.2 Delta function potential}{fig:deltaFunctionPotential}{0.4}
