...
In \citep{desai2009quantum} it is argued that the functions $R_l$ are of the form
...
Next it is argued that polynomial multiples of this will also be approximate solutions.  Utilizing monomial multiple of the decreasing exponential as a trial solution, let us compute how this fits into the radial Schr\"{o}dinger's equation \ref{eqn:hyrdogenLaguerre:10} above.  Write
...
Before settling on $s=l$ let us compute the derivatives for a more general trial function, of the form \ref{eqn:hyrdogenLaguerre:20}, and substitute those.  After a bit of computation we find
