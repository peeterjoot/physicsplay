...
\paragraph{Solution:  Uncertainty of \texorpdfstring{\(S_z\)}{S z} with respect to \texorpdfstring{\(\ket{z+}\)}{ket z plus}}
...
\paragraph{Solution:  Uncertainty of \texorpdfstring{\(S_x\)}{S x} with respect to \texorpdfstring{\(\ket{z+}\)}{ket z plus}}
