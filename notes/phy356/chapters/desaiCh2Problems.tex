...
\paragraph{Expansion of \texorpdfstring{\(\antisymmetric{D}{x_i}\)}{D and position commutators}}
...
\paragraph{Alternate expansion of \texorpdfstring{\(\antisymmetric{D}{x_i}\)}{D and position commutators}}
...
\paragraph{\texorpdfstring{\(\symmetric{D}{p_i}\)}{D and momentum anticommutators}}
...
\paragraph{\texorpdfstring{\(\symmetric{D}{L_i}\)}{D and angular momentum anticommutators}}
...
\paragraph{\texorpdfstring{\(e^{i\alpha D/\Hbar} x_i e^{-i\alpha D/\Hbar}\)}{exponential sandwich}}
