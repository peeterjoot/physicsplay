...
\begin{align}\label{eqn:desaiCh2:202}
...
\begin{align}\label{eqn:desaiCh2:204}
...
\begin{align}\label{eqn:desaiCh2:205}
...
\begin{align}\label{eqn:desaiCh2:210}
\expectation{(\Delta X)^2 } \expectation{(\Delta P)^2 }
&\ge \frac{\Hbar^2}{4}
\end{align}
...
\begin{align}\label{eqn:desaiCh2:206}
\Abs{\expectation{\Delta X \Delta P } }
&\ge
\frac{\Hbar}{2}.
\end{align}
...
\begin{align}\label{eqn:desaiCh2:230}
...
Or
\begin{align}\label{eqn:desaiCh2:1000}
\partial_k \inv{r} 
&= - \frac{x_k}{r^3}
\end{align}

\begin{align}\label{eqn:desaiCh2:1001}
\partial_k \frac{x_i}{r}
&=
\frac{\delta_{ik}}{r} - \frac{ x_i }{r^3}
\end{align}

\begin{align}\label{eqn:desaiCh2:1002}
...
\begin{align}\label{eqn:desaiCh2:1003}
...
So
\begin{align}\label{eqn:desaiCh2:1004}
...
\begin{align}\label{eqn:desaiCh2:2000}
...
\begin{align}\label{eqn:desaiCh2:1}
\antisymmetric{H}{ e^{i \Bk \cdot \Br}}
%&= \inv{2m} \antisymmetric{\Bp^2}{e^{i\Bk \cdot \Br}} \\
&= \inv{2m}
e^{i \Bk\cdot \Br} 
...
\begin{align}\label{eqn:desaiCh2:2}
\antisymmetric{\antisymmetric{H}{e^{i \Bk \cdot \Br}}}{e^{-i \Bk \cdot \Br}}
&=
- \inv{m} (\Hbar \Bk)^2 
\end{align}
...
\begin{align}\label{eqn:desaiCh2:110}
\antisymmetric{H}{ e^{i \Bk \cdot \Br}}
&= \inv{2m} \antisymmetric{\Bp^2}{e^{i\Bk \cdot \Br}}.
\end{align}
...
\begin{align}\label{eqn:desaiCh2:111}
...
\begin{align}\label{eqn:desaiCh2:112}
...
\begin{align}\label{eqn:desaiCh2:113}
\antisymmetric{H}{ e^{i \Bk \cdot \Br}}
...
\begin{align}\label{eqn:desaiCh2:114}
\antisymmetric{\antisymmetric{H}{e^{i \Bk \cdot \Br}}}{e^{-i \Bk \cdot \Br}}
&= -\frac{(\Hbar \Bk)^2}{m}.
\end{align}
...
\begin{align}\label{eqn:desaiCh2:115}
...
\begin{align}\label{eqn:desaiCh2:117}
...
\begin{align}\label{eqn:desaiCh2:116}
