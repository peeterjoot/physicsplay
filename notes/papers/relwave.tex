...
Application of the wave equation operator to the product (\ref{eqn:blah}) is now possible.  Let's do this in pieces, starting with the time derivatives
