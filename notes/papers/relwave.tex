...
Pauli's Wave Mechanics (\cite{pauli2000wm}) differs from most of these, utilizing relativistic arguments to motivate the Schr\"odinger equation.  His little quantum book starts off, not with the Bohr model or black bodies, but with a lighting fast two page treatment of special relativity.

The Wikipedia Klein-Gordon article (\cite{wiki:KG}) indicates that this is also the historical approach used initially by Schr\"odinger.
