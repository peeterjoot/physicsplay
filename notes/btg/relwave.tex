...
Schr\"{o}dinger equation discussion a scaling of this four vector so that it has dimensions of energy is required
...
From (\ref{eqn:energyMomentumFourVec}), we will have reason to use the length of this four vector
...
The Fourier conventions that will be used in the wave equation solution of these notes are
...
Our treatment of the wave equation will follow that of Osgood used for the heat equation in (\cite{osgoodFourier}).
