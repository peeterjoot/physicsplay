...
\revisionInfo{$RCSfile: stokesGradeTwo.tex,v $ Last $Revision: 1.2 $ $Date: 2009/12/03 03:24:40 $}
...
\imageFigure{figures/surface_area_element}{Surface area element}{fig:surface_area_element}{0.3}
...
\imageFigure{figures/volume_element}{Differential volume element}{fig:volume_element}{0.3}
