...
There is still mixed coordinates in \ref{eqn:tangentspace:partII} (ie: both $\overbar{x}$, and $x$) and I think that the final result for an incremental displacement
