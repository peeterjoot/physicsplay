...
\date{ May 15, 2008.  $RCSfile: mpInverseSvdRoughNotes.tex,v $ Last $Revision: 1.12 $ $Date: 2009/08/20 02:24:45 $ }
...
%This allows us to write the matrix of equation \ref{eqn:mpInvRough:pseudoprojmatsum} as
...
Equation (FIXME)
%\ref{eqn:mpInvRough:projectiongeneralmatrix} %% ??
...
%\ref{eqn:mpInvRough:projOrthonormal}. % ???
