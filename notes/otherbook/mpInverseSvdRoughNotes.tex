...
\date{ May 15, 2008.  $RCSfile: mpInverseSvdRoughNotes.tex,v $ Last $Revision: 1.11 $ $Date: 2009/06/14 23:51:45 $ }
...
%\begin{equation}\label{eqn:mp_inverse_svd_rough_notes:pseudoprojmatsum}
%A^{+} A =
...
%This allows us to write the matrix of equation \ref{eqn:mp_inverse_svd_rough_notes:pseudoprojmatsum} as
