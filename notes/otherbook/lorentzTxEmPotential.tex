...
Derivations of these can be found in \citep{PJFieldLagrangian}, and \citep{PJSrLorentzForce} respectively.  
...
Some four potentials discussion perhaps useful as background can be found in \citep{PJFourPotential}.
