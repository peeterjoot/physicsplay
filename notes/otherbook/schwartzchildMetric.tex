...
\begin{align}\label{eqn:schwartzchild_metric:geodesics}
0
...
\begin{align}\label{eqn:schwartzchild_metric:shell}
...
\begin{align}\label{eqn:schwartzchild_metric:cyclic}
\dottheta &= \frac{A}{r^2} \\
\tdot &= \frac{ T }{a} 
\end{align}
...
\begin{align}\label{eqn:schwartzchild_metric:schacc}
 \rddot &=
- \frac{G  M }{r^2} 
