...
\date{July 2, 2009}
\revisionInfo{$RCSfile: lightQuantize.tex,v $ Last $Revision: 1.9 $ $Date: 2009/07/09 23:11:12 $}
...
%
% FIXME: motivation now only to understand discrete frequency solutions
% to the maxwell vacuum equation.
%
