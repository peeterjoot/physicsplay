...
\date{Aug 22, 2009}
\revisionInfo{$RCSfile: gradientAltCoord.tex,v $ Last $Revision: 1.2 $ $Date: 2009/08/23 05:28:14 $}
...
In \R{3} the Stokes differential element of (\ref{eqn:foo4}) supplies us, via duality with the vector divergence theorem.  Writing $B = -I a$, we have
