...
\imageFigure{figures/polarAndSpherical}{Spherical and Cylindrical coordinate conventions}{fig:polarAndSpherical}{0.3}
...
\imageFigure{figures/parameterizedSurface}{Two parameter surface}{fig:parameterizedSurface}{0.3}
