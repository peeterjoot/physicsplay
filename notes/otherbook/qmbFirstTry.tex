...
\date{ May 9, 2009.  $RCSfile: qmbFirstTry.tex,v $ Last $Revision: 1.7 $ $Date: 2009/06/11 17:00:37 $ }
...
Solving
\begin{align}\label{eqn:qmb_first_try:uAndv}
...
\begin{align}\label{eqn:qmb_first_try:JtBarrier}
J_t
...
\begin{align}\label{eqn:qmb_first_try:JrBarrier}
J_r
