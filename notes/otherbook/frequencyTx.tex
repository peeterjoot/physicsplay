...
\date{June 27, 2009}
\revisionInfo{\(RCSfile: frequencyTx.tex,v \) Last \(Revision: 1.2 \) \(Date: 2009/12/03 03:24:40 \)}
...
retain its form under linear transformation \citep{gabook:PJLorentzWave}.  Applying spatial Fourier transforms \citep{gabookII:PJwaveFourier}, one finds that solutions to the wave equation 
...
What is missing here is putting this in a physical context properly with source and receiver frequencies spelled out.  That would make this more than just math.
