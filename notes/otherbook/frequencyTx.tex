...
retain its form under linear transformation \citep{gabook:PJLorentzWave}.  Applying spatial Fourier transforms \citep{gabook:PJwaveFourier}, one finds that solutions to the wave equation 
