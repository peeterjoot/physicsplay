...
This appears to say that for any $\Bx \perp \Bk$ (where the sine is zero), $\BE$ is perpendicular to $\BB$.  I do not quite see how to reconcile this with the fact that by (\ref{eqn:splitFields}) the two fields appear to be colinear
