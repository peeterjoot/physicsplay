...
\author{Peeter Joot}
%\date{ Mmm dd, 2009.  Last Revision: $Date: 2009/01/17 19:54:54 $ }
...
\subsection{ page 35. matrixes, properties and nonproperties. } 
...
Then make the expansion of the other grouping as the remainder of the exersize.

\subsection{ Page 37.  ex 3.8, 3.9. }

Inline matrixes missing brackets.
...
I think your notation for transpose will confuse people when they move on to other studies, since asterix is much more normally used for Hermitian transpose,
