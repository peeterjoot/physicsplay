...
&=
\frac{d u^i}{ds} g_{ij} u^j 
+u^j \myMathWithDescription{g_{ji}}{$= g_{ij}$}{1} \frac{d u^i}{ds} \\
&=
\frac{d u^i}{ds} g_{ij} u^j 
...
Note that we have utilized the fact above that the dummy summation indexes can be swapped (or changed to anything else we feel inclined to use).
