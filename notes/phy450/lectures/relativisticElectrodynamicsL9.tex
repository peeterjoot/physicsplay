...
\frac{d}{dt} m \gamma v^\alpha = e \mathWithDescription{\left( - \inv{c} \PD{t}{A^\alpha} - \PD{x^\alpha}{\phi} \right)}{$E^\alpha$}{1} + \frac{e}{c} v^\beta \left( \PD{x^\alpha}{A^\beta} - \PD{x^\beta}{A^\alpha} \right)
\end{equation}
