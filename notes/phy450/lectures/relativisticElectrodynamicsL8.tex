...
&\approx \mathWithDescription{-m c^2 }{constant}{1} + \mathWithDescription{\inv{2} m \Bv^2 }{Classical Lagrangian for free particle}{2}.
\end{align*}
...
\mathWithDescription{p_1^i + p_2^i}{four momentum before}{1} = \mathWithDescription{p_3^i + p_4^i}{four momentum after}{2}
\end{equation}
