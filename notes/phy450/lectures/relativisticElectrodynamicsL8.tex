...
&\approx \mathLabelBox{-m c^2 }{constant} + \mathLabelBox{\inv{2} m \Bv^2 }{Classical Lagrangian for free particle}.
\end{align*}
...
\mathLabelBox{p_1^i + p_2^i}{four momentum before} = \mathLabelBox{p_3^i + p_4^i}{four momentum after}
\end{equation}
