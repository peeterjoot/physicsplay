...
Covering chapter 2 material from the text \citep{landau1980classical}.
...
&\approx \myMathWithDescription{-m c^2 }{constant}{1} + \myMathWithDescription{\inv{2} m \Bv^2 }{Classical Lagrangian for free particle}{2}.
\end{align*}
...
\myMathWithDescription{p_1^i + p_2^i}{four momentum before}{1} = \myMathWithDescription{p_3^i + p_4^i}{four momentum after}{2}
\end{equation}
...
What is the simplest invariant field we can have?  The simplest possibility is to have a relativistic particle which interacts with an external \underline{Lorentz scalar field}.  We would imagine that this is due to some other particle or some distribution of other fields.
