...
Taking the curl of the vector potential \ref{eqn:relativisticElectrodynamicsL21:50} for the magnetic field, we will neglect the contribution from the $1/\Abs{\Bx}$ since that will be inverse square, and die off too quickly far from the source
...
\sin^2(\omega (t - r/c))
\myMathWithDescription{\int \sin^3\theta d\theta}{$=4/3$}{1}
\end{align*}
