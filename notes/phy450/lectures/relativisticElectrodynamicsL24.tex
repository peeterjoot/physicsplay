...
However \ref{eqn:relativisticElectrodynamicsL24:10} becomes infinite due to contributions of the a-th particle itself.  Solution to this is to drop the term, but let us discuss this first.
