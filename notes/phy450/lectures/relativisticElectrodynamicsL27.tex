...
\paragraph{Moral:} $\Bf_{\text{rad}}$ arises in third order term $O((v/c)^3)$ expansion and thus shouldn't be given a weight as important as the two other terms.  i.e.  Its consequences are less.
