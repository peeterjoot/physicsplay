...
Knowing the end goal, a quantity that is expressed in terms of $F^{ij}$ let us raise the $k$ indexes, and any of the $A_i$'s that are along side of those
...
+ \myMathWithDescription{F^{1 1}}{$=0$}{1} F^{2 1} 
+ F^{1 2} \myMathWithDescription{F^{2 2}}{$=0$}{2}
+ F^{1 3} F^{2 3} 
\right) \\
