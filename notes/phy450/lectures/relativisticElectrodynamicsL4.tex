...
Finished covering \href{http://www.physics.utoronto.ca/~poppitz/epoppitz/PHY450_files/RelEM12-26.pdf}{Professor Poppitz's lecture notes}: invariance of finite intervals (25-26).

Started covering \href{http://www.physics.utoronto.ca/~poppitz/epoppitz/PHY450_files/RelEM27-44.pdf}{Professor Poppitz's lecture notes}: analogy with rotations and derivation of Lorentz transformations (27-32); Minkowski space diagram of boosted frame (32.1); using the diagram to find length contraction (32.2) ; nonrelativistic limit of boosts (33).
...
HOLE IN LECTURE NOTES: ON PROPER TIME for ``length'' of straight vs. curved worldlines: TO BE REVISITED.  Prof. Poppitz promised to revisit this again next time ... his notes are confusing him, and he would like to move on.
...
\subsection{Consider a \texorpdfstring{$x,t$}{x,t} transformation}
...
However, using \eqnref{eqn:relativisticElectrodynamicsL4:70} we have for the origin
