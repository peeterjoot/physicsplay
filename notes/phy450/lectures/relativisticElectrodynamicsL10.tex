...
Covering \href{http://www.physics.utoronto.ca/~poppitz/epoppitz/PHY450_files/RelEMpp74-83.pdf}{lecture notes pp. 74-83}: gauge transformations in 3-vector language (74); energy of a relativistic particle in EM field (75); variational principle and equation of motion in 4-vector form (76-77); the field strength tensor (78-80); the fourth equation of motion (81)
...
\mathcal{E} = \myMathWithDescription{\frac{m c^2}{\InvGamma}}{$(\conj)$}{1} + e \phi.
\end{equation}
...
\mathcal{E} = \frac{m c^2}{\InvGamma} + \myMathWithDescription{e \phi}{"potential"}{1}.
\end{equation}
