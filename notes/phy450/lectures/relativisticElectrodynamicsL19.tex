...
\imageFigure{figures/particleAtRestTrCalc}{Retarded time for particle at rest}{fig:particleAtRestTrCalc}{0.4}
...
\BE =
\myMathWithDescription{e 
\frac{\Bx - \Bv t}{\Abs{\Bx - \Bv t}^3}}{($\conj$)}{1}
...
does not grow as distance from the source, so from \ref{eqn:relativisticElectrodynamicsL19:70}, we have for $\Abs{\Bx} \gg l$
