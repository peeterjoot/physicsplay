...
\subsection{Constructing a basis along the worldline}
...
\subsection{Projections and the reciprocal basis}
...
\subsection{An alternate basis for the inertial frame}
...
\subsection{A followup note on the worldline basis}
...
\subsection{Relating the Lorentz transformation and coordinate transformations}
...
\subsection{A coordinate calculation example}
...
\subsection{An initially confusing aspect of the given non-inertial worldline}
