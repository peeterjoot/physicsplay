...
The class notes use ${x'}^i \rightarrow O^{ij} x^j$, which violates our conventions on mixed upper and lower indexes, but the end result \eqnref{eqn:relElectroDynProblemSet3:1280} is the same.
