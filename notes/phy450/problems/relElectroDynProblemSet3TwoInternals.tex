...
% 
% 
\section{Problem 2.  Transformation properties of \texorpdfstring{$\BE$ and $\BB$}{E and B}, again}
...
Let us tackle the two cases separately.  First when $\Abs{\BB} > \Abs{\BE}$, we can transform to a frame where $\BE'=0$.  In coordinates from \ref{eqn:relElectroDynProblemSet3:1380b} this supplies us three sets of equations.  These are
