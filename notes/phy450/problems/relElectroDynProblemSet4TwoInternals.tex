...
\subsubsection{A aside on approaches attempted to find \texorpdfstring{$\vec{B}$}{B}}
...
\begin{equation}\label{eqn:relElectroDynProblemSet4:480}
\begin{aligned}
...
\subsubsection{Finding \texorpdfstring{$\vec{B}$}{B} with a more systematic approach}
...
\begin{equation}\label{eqn:relElectroDynProblemSet4:500}
\begin{aligned}
...
\begin{equation}\label{eqn:relElectroDynProblemSet4:520}
\begin{aligned}
\grad \cdot \BE &= 0 \\
\grad \cdot \BB &= 0 \\
...
From \eqnref{eqn:relElectroDynProblemSet4:600} we have for the divergence
...
which we could calculate from \eqnref{eqn:relElectroDynProblemSet4:400}, and \eqnref{eqn:relElectroDynProblemSet4:610}.  However, that looks like it is going to be a mess to multiply out.  Let us use instead the trick from \S 48 of the course text \citep{landau1980classical}, and work with the complex quantities directly, noting that we have
...
Now we can do the Poynting calculation using the simpler relations \eqnref{eqn:relElectroDynProblemSet4:580}, \eqnref{eqn:relElectroDynProblemSet4:600}.

Let us also write
\begin{equation}\label{eqn:relElectroDynProblemSet4:655}
\begin{aligned}
...
\begin{equation}\label{eqn:relElectroDynProblemSet4:660}
\begin{aligned}
...
\begin{equation}\label{eqn:relElectroDynProblemSet4:670}
\begin{aligned}
...
Through a surface of radius $r$, integration of the intensity vector \eqnref{eqn:relElectroDynProblemSet4:680} is
