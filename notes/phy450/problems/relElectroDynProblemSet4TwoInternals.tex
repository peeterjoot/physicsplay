...
which we could calculate from \ref{eqn:relElectroDynProblemSet4:400}, and \ref{eqn:relElectroDynProblemSet4:610}.  However, that looks like it is going to be a mess to multiply out.  Let us use instead the trick from \S 48 of the course text \citep{landau1980classical}, and work with the complex quantities directly, noting that we have
