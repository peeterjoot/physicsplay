...
\cref{fig:arrayFactorXY:arrayFactorXYCorrectedFig5} for a few selected values of \( \alpha \), and in a log scale \cref{fig:ps3p3LogScale25:ps3p3LogScale25Fig1} for these same \( \alpha \) values, plus one additional.
