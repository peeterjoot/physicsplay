...
An alternate, and very intuitive, explanation can be found in appendix A.1 \citep{chen2005reciprocity}, that directly related the current density sources and scalar current to the voltages in those regions using an integral representation of the reciprocity theorem.
