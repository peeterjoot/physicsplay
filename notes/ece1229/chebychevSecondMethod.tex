...
%\beginArtNoToc
%
\paragraph{Dolfe-Chebychev design procedure from class notes.}
%\chapter{Antenna array design with Chebychev polynomials}
%\label{chap:chebychevSecondMethod}

Prof. Eleftheriades described a Chebychev antenna array design method that looks different than the one of the text \citep{balanis2005antenna}.
