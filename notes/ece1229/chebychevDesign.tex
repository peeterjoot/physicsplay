...
\makeexample{Chebychev antenna design}{example:chebychevDesign:10}{
...
\mathImageFigure{../../figures/ece1229/ChebyChevThreeScaledFig2}{\( T_3( z_0 x) \) for a few different scale factors \( z_0 \).}{fig:ChebyChevThreeScaled:ChebyChevThreeScaledFig2}{0.2}{chebychevPlotsII.nb}
...
These are plotted in \cref{fig:ChebychevT3Fitting:ChebychevT3FittingFig3} (linear scale), and
\cref{fig:ChebychevT3FittingDb:ChebychevT3FittingDbFig4} (\si{dB} scale) for a couple values of \( d/\lambda \).

\mathImageFigure{../../figures/ece1229/ChebychevT3FittingFig3}{\( T_3 \) fitting of \( N = 4 \) array.}{fig:ChebychevT3Fitting:ChebychevT3FittingFig3}{0.2}{polarPlot.nb}
\mathImageFigure{../../figures/ece1229/ChebychevT3FittingDbFig4}{\( T_3 \) fitting of \( N = 4 \) array (dB scale).}{fig:ChebychevT3FittingDb:ChebychevT3FittingDbFig4}{0.2}{polarPlot.nb}
