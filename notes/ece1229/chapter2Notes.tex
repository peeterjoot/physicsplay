...
(this is also \eqntext 2-19 in the text.)
...
Note that the signs of \(\bcE\) vs. \(\bcB\) in \cref{eqn:chapter2Notes:740} and \cref{eqn:chapter2Notes:760} and are determined by the far field relation \( \BE = c \BB \cross \rcap \) (see: \eqntext 9.19,9.39 \citep{jackson1975cew}).  The effect of dependency is that the Poynting vector will be radial, which will be seen below.
...
writes \(\Omega\) as a circle floating above a face up square bracket, as in \cref{fig:greekStyleOmega:greekStyleOmegaFig1}, and \( \sigma \) like a number 6, as in \cref{fig:sigma:sigmaFig1}.  
...
\imageFigure{../../figures/ece1229/greekStyleOmegaFig1}{Prof. handwriting decoder ring: \( \Omega \)}{fig:greekStyleOmega:greekStyleOmegaFig1}{0.05}
\imageFigure{../../figures/ece1229/sigmaFig1}{Prof. handwriting decoder ring: \( \sigma \)}{fig:sigma:sigmaFig1}{0.05}
