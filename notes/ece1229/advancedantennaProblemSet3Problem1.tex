...
Two views of this vector function are plotted in \cref{fig:electricAndMagneticDipoleSuperposition:electricAndMagneticDipoleSuperpositionFig1}, and \cref{fig:electricAndMagneticDipoleSuperposition:electricAndMagneticDipoleSuperpositionFig2} showing the electric and magnetic far field vector directions on the surface of the electric field magnitude.  See \href{http://goo.gl/Sb1Uso}{http://goo.gl/Sb1Uso} for an interactive view of these plots, with \(\theta, \phi\) controls available for the wave vector position.

\imageFigure{../../figures/ece1229/electricAndMagneticDipoleSuperpositionFig1}{Electric and magnetic infinetesimal dipole superposition, view from above.}{fig:electricAndMagneticDipoleSuperposition:electricAndMagneticDipoleSuperpositionFig1}{0.3}

\imageFigure{../../figures/ece1229/electricAndMagneticDipoleSuperpositionFig2}{Electric and magnetic infinetesimal dipole superposition, view from below.}{fig:electricAndMagneticDipoleSuperposition:electricAndMagneticDipoleSuperpositionFig2}{0.3}
...
\imageFigure{../../figures/ece1229/electricAndMagneticDipoleSuperpositionFig3}{Electric and magnetic infinetesimal dipole superposition, polar plot in ZY plane.}{fig:electricAndMagneticDipoleSuperposition:electricAndMagneticDipoleSuperpositionFig3}{0.3}
}
