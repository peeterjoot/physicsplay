...
%
PLEASE FEEL FREE TO EMAIL ME FOR THE FULL VERSION IF YOU AREN'T TAKING PHY1520.%
}%
%
\input{censor1pg.tex}%
%
...
% ****************************************************************************************************
\newcommand{\myTitle}{Graduate Quantum Mechanics\xspace}
\newcommand{\mySubtitle}{Notes and problems from UofT PHY1520H 2015\xspace}
\newcommand{\myDegree}{}
...
% v.5 includes up to some comments after the final exam.
% v.6 not posted yet:
%  - will be redacting this later since Prof. Paramekanti will be teaching this
%    course for at least one more year.
%  - contains additional indexing and some minor editing.
...
\hypersetup{%
    ...
    pdfkeywords={Graduate Quantum Mechanics} {PHY1520H} {University of Toronto},%
    pdfcreator={pdfLaTeX},%
