...
#for i in 2 5 10 ; do
   rm -f dataFilename*out
   echo "# mpirun -n $i ./wave1d  $params >/dev/null"
   ...
   echo "# mpirun -n $i ./wave1d $paramsnc >/dev/null"
